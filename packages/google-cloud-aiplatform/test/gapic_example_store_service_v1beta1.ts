...
describe('v1beta1.ExampleStoreServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          examplestoreserviceModule.v1beta1.ExampleStoreServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        examplestoreserviceModule.v1beta1.ExampleStoreServiceClient.port;
      assert(port);
  ...
  describe('getExampleStore', () => {
    it('invokes getExampleStore without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getExampleStore as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getExampleStore without error using callback', async () => {
      ...
      client.innerApiCalls.getExampleStore =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getExampleStore(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IExampleStore | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getExampleStore with error', async () => {
      ...
      client.innerApiCalls.getExampleStore = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('upsertExamples', () => {
    it('invokes upsertExamples without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.upsertExamples as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.upsertExamples as SinonStub
    ...
    it('invokes upsertExamples without error using callback', async () => {
      ...
      client.innerApiCalls.upsertExamples =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.upsertExamples(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes upsertExamples with error', async () => {
      ...
      const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.upsertExamples = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('removeExamples', () => {
    it('invokes removeExamples without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.removeExamples as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.removeExamples as SinonStub
    ...
    it('invokes removeExamples without error using callback', async () => {
      ...
      client.innerApiCalls.removeExamples =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.removeExamples(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes removeExamples with error', async () => {
      ...
      const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.removeExamples = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('searchExamples', () => {
    it('invokes searchExamples without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.searchExamples as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.searchExamples as SinonStub
    ...
    it('invokes searchExamples without error using callback', async () => {
      ...
      client.innerApiCalls.searchExamples =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.searchExamples(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.ISearchExamplesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes searchExamples with error', async () => {
      ...
      const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.searchExamples = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('createExampleStore', () => {
    it('invokes createExampleStore without error', async () => {
      ...
      client.innerApiCalls.createExampleStore =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createExampleStore(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createExampleStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createExampleStore as SinonStub
    ...
    it('invokes createExampleStore with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createExampleStore = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkCreateExampleStoreProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateExampleStoreProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateExampleStore', () => {
    it('invokes updateExampleStore without error', async () => {
      ...
      client.innerApiCalls.updateExampleStore =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateExampleStore(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateExampleStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateExampleStore as SinonStub
    ...
    it('invokes updateExampleStore with call error', async () => {
      ...
      const expectedHeaderRequestParams = `example_store.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateExampleStore = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkUpdateExampleStoreProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateExampleStoreProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteExampleStore', () => {
    it('invokes deleteExampleStore without error', async () => {
      ...
      client.innerApiCalls.deleteExampleStore =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteExampleStore(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteExampleStore as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteExampleStore as SinonStub
    ...
    it('invokes deleteExampleStore with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteExampleStore = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkDeleteExampleStoreProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteExampleStoreProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listExampleStores', () => {
    it('invokes listExampleStores without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listExampleStores as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listExampleStores as SinonStub
    ...
    it('invokes listExampleStores without error using callback', async () => {
      ...
      client.innerApiCalls.listExampleStores =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listExampleStores with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listExampleStores = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listExampleStoresStream without error', async () => {
      ...
      client.descriptors.page.listExampleStores.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = await client.listExampleStoresStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.aiplatform.v1beta1.ExampleStore[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.ExampleStore) => {
      ...
      assert(
        (client.descriptors.page.listExampleStores.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listExampleStores, request)
      );
      assert(
        (client.descriptors.page.listExampleStores.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listExampleStores without error', async () => {
      ...
      client.descriptors.page.listExampleStores.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.aiplatform.v1beta1.IExampleStore[] =
        [];
      const iterable = await client.listExampleStoresAsync(request);
  ...
  describe('fetchExamples', () => {
    it('invokes fetchExamples without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1beta1.Example()
        ),
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1beta1.Example()
        ),
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.fetchExamples as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.fetchExamples as SinonStub
    ...
    it('invokes fetchExamples without error using callback', async () => {
      ...
      client.innerApiCalls.fetchExamples =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.fetchExamples(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IExample[] | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes fetchExamples with error', async () => {
      ...
      const expectedHeaderRequestParams = `example_store=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.fetchExamples = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes fetchExamplesStream without error', async () => {
      ...
      client.descriptors.page.fetchExamples.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = await client.fetchExamplesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.aiplatform.v1beta1.Example[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.Example) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.fetchExamples.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.fetchExamples, request)
      );
      assert(
        (client.descriptors.page.fetchExamples.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with fetchExamples without error', async () => {
      ...
      client.descriptors.page.fetchExamples.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.aiplatform.v1beta1.IExample[] = [];
      const iterable = await client.fetchExamplesAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
