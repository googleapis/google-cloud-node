...
describe('v1beta1.FeaturestoreOnlineServingServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = featurestoreonlineservingserviceModule.v1beta1.FeaturestoreOnlineServingServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = featurestoreonlineservingserviceModule.v1beta1.FeaturestoreOnlineServingServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', async () => {
            const client = new featurestoreonlineservingserviceModule.v1beta1.FeaturestoreOnlineServingServiceClient({universeDomain: 'example.com'});
        ...
        it('sets apiEndpoint according to universe domain snakeCase', async () => {
            const client = new featurestoreonlineservingserviceModule.v1beta1.FeaturestoreOnlineServingServiceClient({universe_domain: 'example.com'});
            const servicePath = await client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', async () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new featurestoreonlineservingserviceModule.v1beta1.FeaturestoreOnlineServingServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = await client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new featurestoreonlineservingserviceModule.v1beta1.FeaturestoreOnlineServingServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = featurestoreonlineservingserviceModule.v1beta1.FeaturestoreOnlineServingServiceClient.port;
            assert(port);
    ...
    describe('readFeatureValues', () => {
        it('invokes readFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ReadFeatureValuesRequest', ['entityType']);
        ...
        it('invokes readFeatureValues without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.readFeatureValues(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IReadFeatureValuesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('writeFeatureValues', () => {
        it('invokes writeFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.WriteFeatureValuesRequest', ['entityType']);
            request.entityType = defaultValue1;
            const expectedHeaderRequestParams = `entity_type=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes writeFeatureValues without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.writeFeatureValues(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IWriteFeatureValuesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamingReadFeatureValues', () => {
        it('invokes streamingReadFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.StreamingReadFeatureValuesRequest', ['entityType']);
            request.entityType = defaultValue1;
            const expectedHeaderRequestParams = `entity_type=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse()
            ...
            const stream = await client.streamingReadFeatureValues(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse) => {
                    resolve(response);
                });
