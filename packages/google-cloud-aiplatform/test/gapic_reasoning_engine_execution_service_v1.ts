...
describe('v1.ReasoningEngineExecutionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient.port;
            assert(port);
    ...
    describe('queryReasoningEngine', () => {
        it('invokes queryReasoningEngine without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.QueryReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.QueryReasoningEngineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.QueryReasoningEngineResponse()
            );
        ...
        it('invokes queryReasoningEngine without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.queryReasoningEngine(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IQueryReasoningEngineResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('cancelAsyncQueryReasoningEngine', () => {
        it('invokes cancelAsyncQueryReasoningEngine without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CancelAsyncQueryReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CancelAsyncQueryReasoningEngineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CancelAsyncQueryReasoningEngineResponse()
            );
        ...
        it('invokes cancelAsyncQueryReasoningEngine without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.cancelAsyncQueryReasoningEngine(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ICancelAsyncQueryReasoningEngineResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('asyncQueryReasoningEngine', () => {
        it('invokes asyncQueryReasoningEngine without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.asyncQueryReasoningEngine = stubLongRunningCall(expectedResponse);
            const [operation] = await client.asyncQueryReasoningEngine(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.asyncQueryReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.asyncQueryReasoningEngine as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes asyncQueryReasoningEngine without error using callback', async () => {
            const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.asyncQueryReasoningEngine = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.asyncQueryReasoningEngine(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.asyncQueryReasoningEngine as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes asyncQueryReasoningEngine with call error', async () => {
            const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.asyncQueryReasoningEngine = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.asyncQueryReasoningEngine(request), expectedError);
            const actualRequest = (client.innerApiCalls.asyncQueryReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.asyncQueryReasoningEngine as SinonStub)
        ...
        it('invokes asyncQueryReasoningEngine with LRO error', async () => {
            const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.asyncQueryReasoningEngine = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.asyncQueryReasoningEngine(request);
        ...
        it('invokes checkAsyncQueryReasoningEngineProgress without error', async () => {
            const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkAsyncQueryReasoningEngineProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkAsyncQueryReasoningEngineProgress with error', async () => {
            const client = new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkAsyncQueryReasoningEngineProgress(''), expectedError);
    ...
    describe('streamQueryReasoningEngine', () => {
        it('invokes streamQueryReasoningEngine without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.StreamQueryReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.StreamQueryReasoningEngineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
