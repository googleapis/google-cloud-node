...
describe('v1.ReasoningEngineExecutionServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new reasoningengineexecutionserviceModule.v1.ReasoningEngineExecutionServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          reasoningengineexecutionserviceModule.v1
    ...
    it('invokes queryReasoningEngine without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.queryReasoningEngine(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IQueryReasoningEngineResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('cancelAsyncQueryReasoningEngine', () => {
    it('invokes cancelAsyncQueryReasoningEngine without error', async () => {
      ...
      client.innerApiCalls.cancelAsyncQueryReasoningEngine =
        stubSimpleCall(expectedResponse);
      const [response] = await client.cancelAsyncQueryReasoningEngine(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.cancelAsyncQueryReasoningEngine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.cancelAsyncQueryReasoningEngine as SinonStub
    ...
    it('invokes cancelAsyncQueryReasoningEngine without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.cancelAsyncQueryReasoningEngine(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.ICancelAsyncQueryReasoningEngineResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes cancelAsyncQueryReasoningEngine with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.cancelAsyncQueryReasoningEngine = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('asyncQueryReasoningEngine', () => {
    it('invokes asyncQueryReasoningEngine without error', async () => {
      ...
      client.innerApiCalls.asyncQueryReasoningEngine =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.asyncQueryReasoningEngine(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.asyncQueryReasoningEngine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.asyncQueryReasoningEngine as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.asyncQueryReasoningEngine(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineResponse,
              protos.google.cloud.aiplatform.v1.IAsyncQueryReasoningEngineOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes asyncQueryReasoningEngine with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.asyncQueryReasoningEngine = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.asyncQueryReasoningEngine(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.asyncQueryReasoningEngine as SinonStub
    ...
    it('invokes checkAsyncQueryReasoningEngineProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkAsyncQueryReasoningEngineProgress(
    ...
    it('invokes checkAsyncQueryReasoningEngineProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkAsyncQueryReasoningEngineProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
