...
describe('v1beta1.SpecialistPoolServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = specialistpoolserviceModule.v1beta1.SpecialistPoolServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = specialistpoolserviceModule.v1beta1.SpecialistPoolServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new specialistpoolserviceModule.v1beta1.SpecialistPoolServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new specialistpoolserviceModule.v1beta1.SpecialistPoolServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new specialistpoolserviceModule.v1beta1.SpecialistPoolServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new specialistpoolserviceModule.v1beta1.SpecialistPoolServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = specialistpoolserviceModule.v1beta1.SpecialistPoolServiceClient.port;
            assert(port);
    ...
    describe('getSpecialistPool', () => {
        it('invokes getSpecialistPool without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.getSpecialistPool as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSpecialistPool as SinonStub)
        ...
        it('invokes getSpecialistPool without error using callback', async () => {
            ...
            client.innerApiCalls.getSpecialistPool = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSpecialistPool(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ISpecialistPool|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSpecialistPool', () => {
        it('invokes createSpecialistPool without error', async () => {
            ...
            client.innerApiCalls.createSpecialistPool = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createSpecialistPool(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSpecialistPool as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSpecialistPool as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createSpecialistPool without error using callback', async () => {
            ...
            client.innerApiCalls.createSpecialistPool = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSpecialistPool(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.ISpecialistPool, protos.google.cloud.aiplatform.v1beta1.ICreateSpecialistPoolOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.ISpecialistPool, protos.google.cloud.aiplatform.v1beta1.ICreateSpecialistPoolOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSpecialistPool as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateSpecialistPoolProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateSpecialistPoolProgress(expectedResponse.name);
        ...
        it('invokes checkCreateSpecialistPoolProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateSpecialistPoolProgress(''), expectedError);
    ...
    describe('deleteSpecialistPool', () => {
        it('invokes deleteSpecialistPool without error', async () => {
            ...
            client.innerApiCalls.deleteSpecialistPool = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteSpecialistPool(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSpecialistPool as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSpecialistPool as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteSpecialistPool without error using callback', async () => {
            ...
            client.innerApiCalls.deleteSpecialistPool = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes checkDeleteSpecialistPoolProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteSpecialistPoolProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteSpecialistPoolProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteSpecialistPoolProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateSpecialistPool', () => {
        it('invokes updateSpecialistPool without error', async () => {
            ...
            client.innerApiCalls.updateSpecialistPool = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateSpecialistPool(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSpecialistPool as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSpecialistPool as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateSpecialistPool without error using callback', async () => {
            ...
            client.innerApiCalls.updateSpecialistPool = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateSpecialistPool(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.ISpecialistPool, protos.google.cloud.aiplatform.v1beta1.IUpdateSpecialistPoolOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.ISpecialistPool, protos.google.cloud.aiplatform.v1beta1.IUpdateSpecialistPoolOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSpecialistPool as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateSpecialistPoolProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateSpecialistPoolProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateSpecialistPoolProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateSpecialistPoolProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listSpecialistPools', () => {
        it('invokes listSpecialistPools without error', async () => {
            ...
            client.innerApiCalls.listSpecialistPools = stubSimpleCall(expectedResponse);
            const [response] = await client.listSpecialistPools(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSpecialistPools as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSpecialistPools as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSpecialistPools without error using callback', async () => {
            ...
            client.innerApiCalls.listSpecialistPools = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listSpecialistPoolsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.SpecialistPool) => {
            ...
            assert((client.descriptors.page.listSpecialistPools.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listSpecialistPools, request));
            assert(
        ...
        it('uses async iteration with listSpecialistPools without error', async () => {
            ...
            client.descriptors.page.listSpecialistPools.asyncIterate = stubAsyncIterationCall(expectedResponse);
