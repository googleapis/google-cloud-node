...
describe('v1.VizierServiceClient', () => {
  ...
  describe('createStudy', () => {
    it('invokes createStudy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('CreateStudyRequest', [
        'parent',
      ]);
  ...
  describe('getStudy', () => {
    it('invokes getStudy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('GetStudyRequest', ['name']);
  ...
  describe('deleteStudy', () => {
    it('invokes deleteStudy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('DeleteStudyRequest', ['name']);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedResponse = generateSampleMessage(
  ...
  describe('lookupStudy', () => {
    it('invokes lookupStudy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('LookupStudyRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
  ...
  describe('createTrial', () => {
    it('invokes createTrial without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('CreateTrialRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
  ...
  describe('getTrial', () => {
    it('invokes getTrial without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('GetTrialRequest', ['name']);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.Trial()
  ...
  describe('addTrialMeasurement', () => {
    it('invokes addTrialMeasurement without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('AddTrialMeasurementRequest', [
        'trialName',
      ]);
  ...
  describe('completeTrial', () => {
    it('invokes completeTrial without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('CompleteTrialRequest', [
        'name',
      ]);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
  ...
  describe('deleteTrial', () => {
    it('invokes deleteTrial without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('DeleteTrialRequest', ['name']);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.protobuf.Empty()
  ...
  describe('stopTrial', () => {
    it('invokes stopTrial without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('StopTrialRequest', ['name']);
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.Trial()
  ...
  describe('suggestTrials', () => {
    it('invokes suggestTrials without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('SuggestTrialsRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
  ...
  describe('listStudies', () => {
    it('invokes listStudies without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('ListStudiesRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
  ...
  describe('listTrials', () => {
    it('invokes listTrials without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('ListTrialsRequest', [
        'parent',
      ]);
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1}`;
