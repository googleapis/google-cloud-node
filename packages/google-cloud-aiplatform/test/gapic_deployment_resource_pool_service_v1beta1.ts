...
describe('v1beta1.DeploymentResourcePoolServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            ...
            const apiEndpoint = await await await await await await client.apiEndpoint;
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = deploymentresourcepoolserviceModule.v1beta1.DeploymentResourcePoolServiceawait await await await await await await client.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
