  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        reasoningengineserviceModule.v1beta1.ReasoningEngineServiceClient.port;
      assert(port);
    ...
    it('invokes getReasoningEngine without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getReasoningEngine(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IReasoningEngine | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listReasoningEnginesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.ReasoningEngine
          ) => {
