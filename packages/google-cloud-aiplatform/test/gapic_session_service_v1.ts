...
describe('v1.SessionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          sessionserviceModule.v1.SessionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          sessionserviceModule.v1.SessionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new sessionserviceModule.v1.SessionServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getSession', () => {
    it('invokes getSession without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.GetSessionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.aiplatform.v1.GetSessionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.Session(),
      );
    ...
    it('invokes getSession without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSession(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.ISession | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateSession', () => {
    it('invokes updateSession without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.UpdateSessionRequest(),
      );
      request.session ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.aiplatform.v1.UpdateSessionRequest',
        ['session', 'name'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateSession as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateSession as SinonStub
    ...
    it('invokes updateSession without error using callback', async () => {
      ...
      client.innerApiCalls.updateSession =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
  ...
  describe('appendEvent', () => {
    it('invokes appendEvent without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.AppendEventRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.aiplatform.v1.AppendEventRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.AppendEventResponse(),
      );
      client.innerApiCalls.appendEvent = stubSimpleCall(expectedResponse);
      const [response] = await client.appendEvent(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.appendEvent as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.appendEvent as SinonStub
    ...
    it('invokes appendEvent without error using callback', async () => {
      ...
      client.innerApiCalls.appendEvent =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.appendEvent(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IAppendEventResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes appendEvent with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.appendEvent = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createSession', () => {
    it('invokes createSession without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.CreateSessionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.aiplatform.v1.CreateSessionRequest',
        ['parent'],
      );
      ...
      const promise = new Promise((resolve, reject) => {
        client.createSession(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.aiplatform.v1.ISession,
              protos.google.cloud.aiplatform.v1.ICreateSessionOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes createSession with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createSession = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateSessionProgress without error', async () => {
      ...
      const decodedOperation = await client.checkCreateSessionProgress(
    ...
    it('invokes checkCreateSessionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateSessionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteSession', () => {
    it('invokes deleteSession without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.DeleteSessionRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes deleteSession with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteSession = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteSessionProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeleteSessionProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteSessionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteSessionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listSessions', () => {
    it('invokes listSessions without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.ListSessionsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.aiplatform.v1.Session()),
        generateSampleMessage(new protos.google.cloud.aiplatform.v1.Session()),
        generateSampleMessage(new protos.google.cloud.aiplatform.v1.Session()),
      ];
    ...
    it('invokes listSessionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.aiplatform.v1.Session[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.Session) => {
    ...
    it('uses async iteration with listSessions without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1.ISession[] = [];
  ...
  describe('listEvents', () => {
    it('invokes listEvents without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.aiplatform.v1.ListEventsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.aiplatform.v1.ListEventsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1.SessionEvent(),
        ),
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1.SessionEvent(),
        ),
    ...
    it('invokes listEvents without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listEvents(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.ISessionEvent[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listEventsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.aiplatform.v1.SessionEvent[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.SessionEvent) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listEvents without error', async () => {
      ...
      client.descriptors.page.listEvents.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.aiplatform.v1.ISessionEvent[] = [];
