...
describe('v1.SessionServiceClient', () => {
    ...
    describe('getSession', () => {
        it('invokes getSession without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetSessionRequest', ['name']);
        ...
        it('invokes getSession without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSession(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ISession|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateSession', () => {
        it('invokes updateSession without error', async () => {
            ...
            request.session ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateSessionRequest', ['session', 'name']);
    ...
    describe('appendEvent', () => {
        it('invokes appendEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.AppendEventRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes appendEvent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.appendEvent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IAppendEventResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSession', () => {
        it('invokes createSession without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateSessionRequest', ['parent']);
        ...
        it('invokes createSession without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSession(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.ISession, protos.google.cloud.aiplatform.v1.ICreateSessionOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.ISession, protos.google.cloud.aiplatform.v1.ICreateSessionOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSession as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteSession', () => {
        it('invokes deleteSession without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteSessionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listSessions', () => {
        it('invokes listSessions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListSessionsRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listSessionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Session) => {
    ...
    describe('listEvents', () => {
        it('invokes listEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.SessionEvent()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.SessionEvent()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.SessionEvent()),
            ];
        ...
        it('invokes listEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listEvents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ISessionEvent[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listEventsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.SessionEvent) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
