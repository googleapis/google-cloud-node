...
describe('v1beta1.MemoryBankServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          memorybankserviceModule.v1beta1.MemoryBankServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          memorybankserviceModule.v1beta1.MemoryBankServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
  ...
  describe('getMemory', () => {
    it('invokes getMemory without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getMemory as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getMemory without error using callback', async () => {
      ...
      client.innerApiCalls.getMemory =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getMemory(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IMemory | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('retrieveMemories', () => {
    it('invokes retrieveMemories without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.retrieveMemories as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.retrieveMemories as SinonStub
    ...
    it('invokes retrieveMemories without error using callback', async () => {
      ...
      client.innerApiCalls.retrieveMemories =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.retrieveMemories(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes retrieveMemories with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.retrieveMemories = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createMemory', () => {
    it('invokes createMemory without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createMemory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createMemory as SinonStub
    ...
    it('invokes createMemory without error using callback', async () => {
      ...
      client.innerApiCalls.createMemory =
    ...
    it('invokes createMemory with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createMemory = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateMemory', () => {
    it('invokes updateMemory without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateMemory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateMemory as SinonStub
    ...
    it('invokes updateMemory without error using callback', async () => {
      ...
      client.innerApiCalls.updateMemory =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.updateMemory(
          request,
    ...
    it('invokes updateMemory with call error', async () => {
      ...
      const expectedHeaderRequestParams = `memory.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateMemory = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteMemory', () => {
    it('invokes deleteMemory without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteMemory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteMemory as SinonStub
    ...
    it('invokes deleteMemory without error using callback', async () => {
      ...
      client.innerApiCalls.deleteMemory =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteMemory(
          request,
    ...
    it('invokes deleteMemory with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteMemory = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('generateMemories', () => {
    it('invokes generateMemories without error', async () => {
      ...
      client.innerApiCalls.generateMemories =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.generateMemories(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.generateMemories as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.generateMemories as SinonStub
    ...
    it('invokes generateMemories with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.generateMemories = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkGenerateMemoriesProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkGenerateMemoriesProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listMemories', () => {
    it('invokes listMemories without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listMemories as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listMemories as SinonStub
    ...
    it('invokes listMemories without error using callback', async () => {
      ...
      client.innerApiCalls.listMemories =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listMemories(
          request,
    ...
    it('invokes listMemories with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listMemories = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listMemoriesStream without error', async () => {
      ...
      client.descriptors.page.listMemories.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.Memory) => {
      ...
      assert(
        (client.descriptors.page.listMemories.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listMemories, request),
      );
      assert(
        (client.descriptors.page.listMemories.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listMemoriesStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listMemories.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listMemoriesStream(request);
    ...
    it('uses async iteration with listMemories without error', async () => {
      ...
      client.descriptors.page.listMemories.asyncIterate =
