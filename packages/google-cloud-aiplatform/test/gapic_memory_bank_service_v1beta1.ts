...
describe('v1beta1.MemoryBankServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new memorybankserviceModule.v1beta1.MemoryBankServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = memorybankserviceModule.v1beta1.MemoryBankServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = memorybankserviceModule.v1beta1.MemoryBankServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new memorybankserviceModule.v1beta1.MemoryBankServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new memorybankserviceModule.v1beta1.MemoryBankServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new memorybankserviceModule.v1beta1.MemoryBankServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new memorybankserviceModule.v1beta1.MemoryBankServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = memorybankserviceModule.v1beta1.MemoryBankServiceClient.port;
            assert(port);
    ...
    describe('getMemory', () => {
        it('invokes getMemory without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetMemoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetMemoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.Memory()
            );
            client.innerApiCalls.getMemory = stubSimpleCall(expectedResponse);
            const [response] = await client.getMemory(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMemory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMemory as SinonStub)
        ...
        it('invokes getMemory without error using callback', async () => {
            ...
            client.innerApiCalls.getMemory = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMemory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IMemory|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMemory with error', async () => {
            ...
            client.innerApiCalls.getMemory = stubSimpleCall(undefined, expectedError);
    ...
    describe('retrieveMemories', () => {
        it('invokes retrieveMemories without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.RetrieveMemoriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.RetrieveMemoriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.RetrieveMemoriesResponse()
            );
            client.innerApiCalls.retrieveMemories = stubSimpleCall(expectedResponse);
            const [response] = await client.retrieveMemories(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.retrieveMemories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.retrieveMemories as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes retrieveMemories without error using callback', async () => {
            ...
            client.innerApiCalls.retrieveMemories = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.retrieveMemories(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes retrieveMemories with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.retrieveMemories = stubSimpleCall(undefined, expectedError);
    ...
    describe('createMemory', () => {
        it('invokes createMemory without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateMemoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.CreateMemoryRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createMemory = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createMemory(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMemory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMemory as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createMemory without error using callback', async () => {
            ...
            client.innerApiCalls.createMemory = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createMemory(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IMemory, protos.google.cloud.aiplatform.v1beta1.ICreateMemoryOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IMemory, protos.google.cloud.aiplatform.v1beta1.ICreateMemoryOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createMemory as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createMemory with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createMemory = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createMemory(request), expectedError);
            const actualRequest = (client.innerApiCalls.createMemory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createMemory as SinonStub)
        ...
        it('invokes createMemory with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createMemory = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createMemory(request);
        ...
        it('invokes checkCreateMemoryProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateMemoryProgress(expectedResponse.name);
        ...
        it('invokes checkCreateMemoryProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateMemoryProgress(''), expectedError);
    ...
    describe('updateMemory', () => {
        it('invokes updateMemory without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.UpdateMemoryRequest()
            );
            request.memory ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateMemoryRequest', ['memory', 'name']);
            request.memory.name = defaultValue1;
            const expectedHeaderRequestParams = `memory.name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateMemory = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateMemory(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateMemory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateMemory as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateMemory without error using callback', async () => {
            ...
            client.innerApiCalls.updateMemory = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateMemory(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IMemory, protos.google.cloud.aiplatform.v1beta1.IUpdateMemoryOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IMemory, protos.google.cloud.aiplatform.v1beta1.IUpdateMemoryOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateMemory as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateMemory with call error', async () => {
            ...
            const expectedHeaderRequestParams = `memory.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateMemory = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateMemory(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateMemory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateMemory as SinonStub)
        ...
        it('invokes updateMemory with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `memory.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateMemory = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateMemory(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateMemory as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateMemoryProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateMemoryProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateMemoryProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateMemoryProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteMemory', () => {
        it('invokes deleteMemory without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteMemoryRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteMemoryRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteMemory = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteMemory(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteMemory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMemory as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteMemory without error using callback', async () => {
            ...
            client.innerApiCalls.deleteMemory = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteMemory(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteMemoryOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteMemoryOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteMemory as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteMemory with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteMemory = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteMemory(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteMemory as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteMemory as SinonStub)
        ...
        it('invokes deleteMemory with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteMemory = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteMemory(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteMemory as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteMemoryProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteMemoryProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteMemoryProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteMemoryProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('generateMemories', () => {
        it('invokes generateMemories without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GenerateMemoriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GenerateMemoriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.generateMemories = stubLongRunningCall(expectedResponse);
            const [operation] = await client.generateMemories(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateMemories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateMemories as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes generateMemories without error using callback', async () => {
            ...
            client.innerApiCalls.generateMemories = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.generateMemories(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IGenerateMemoriesResponse, protos.google.cloud.aiplatform.v1beta1.IGenerateMemoriesOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IGenerateMemoriesResponse, protos.google.cloud.aiplatform.v1beta1.IGenerateMemoriesOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateMemories as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes generateMemories with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateMemories = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.generateMemories(request), expectedError);
            const actualRequest = (client.innerApiCalls.generateMemories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateMemories as SinonStub)
        ...
        it('invokes generateMemories with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.generateMemories = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.generateMemories(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.generateMemories as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkGenerateMemoriesProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkGenerateMemoriesProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkGenerateMemoriesProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkGenerateMemoriesProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listMemories', () => {
        it('invokes listMemories without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListMemoriesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListMemoriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Memory()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Memory()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Memory()),
            ];
            client.innerApiCalls.listMemories = stubSimpleCall(expectedResponse);
            const [response] = await client.listMemories(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listMemories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMemories as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listMemories without error using callback', async () => {
            ...
            client.innerApiCalls.listMemories = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listMemories(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IMemory[]|null) => {
        ...
        it('invokes listMemories with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listMemories = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listMemories(request), expectedError);
            const actualRequest = (client.innerApiCalls.listMemories as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listMemories as SinonStub)
        ...
        it('invokes listMemoriesStream without error', async () => {
            ...
            client.descriptors.page.listMemories.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listMemoriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Memory[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Memory) => {
            ...
            assert((client.descriptors.page.listMemories.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listMemories, request));
            assert(
        ...
        it('invokes listMemoriesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMemories.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listMemoriesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Memory[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Memory) => {
        ...
        it('uses async iteration with listMemories without error', async () => {
            ...
            client.descriptors.page.listMemories.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.IMemory[] = [];
            const iterable = client.listMemoriesAsync(request);
        ...
        it('uses async iteration with listMemories with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listMemories.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listMemoriesAsync(request);
