...
describe('v1.VertexRagDataServiceClient', () => {
  ...
  describe('getRagEngineConfig', () => {
    it('invokes getRagEngineConfig without error', async () => {
      ...
      client.innerApiCalls.getRagEngineConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getRagEngineConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRagEngineConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRagEngineConfig as SinonStub
    ...
    it('invokes getRagEngineConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRagEngineConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IRagEngineConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRagEngineConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRagEngineConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateRagEngineConfig', () => {
    it('invokes updateRagEngineConfig without error', async () => {
      ...
      client.innerApiCalls.updateRagEngineConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateRagEngineConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateRagEngineConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateRagEngineConfig as SinonStub
        ...
        client.updateRagEngineConfig(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.aiplatform.v1.IUpdateRagEngineConfigOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes updateRagEngineConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `rag_engine_config.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateRagEngineConfig = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateRagEngineConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateRagEngineConfig as SinonStub
    ...
    it('invokes checkUpdateRagEngineConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateRagEngineConfigProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
