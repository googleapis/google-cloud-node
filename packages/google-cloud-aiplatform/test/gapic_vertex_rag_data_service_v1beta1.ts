...
describe('v1beta1.VertexRagDataServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          vertexragdataserviceModule.v1beta1.VertexRagDataServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        vertexragdataserviceModule.v1beta1.VertexRagDataServiceClient.port;
      assert(port);
    ...
    it('invokes getRagCorpus without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRagCorpus(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRagCorpus | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes uploadRagFile without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.uploadRagFile(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IUploadRagFileResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRagFile without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRagFile(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRagFile | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRagEngineConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRagEngineConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRagEngineConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createRagDataSchema', () => {
    it('invokes createRagDataSchema without error', async () => {
      ...
      client.innerApiCalls.createRagDataSchema =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createRagDataSchema(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createRagDataSchema as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createRagDataSchema as SinonStub
    ...
    it('invokes createRagDataSchema without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createRagDataSchema(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRagDataSchema | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createRagDataSchema with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createRagDataSchema = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getRagDataSchema', () => {
    it('invokes getRagDataSchema without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRagDataSchema as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRagDataSchema as SinonStub
    ...
    it('invokes getRagDataSchema without error using callback', async () => {
      ...
      client.innerApiCalls.getRagDataSchema =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes getRagDataSchema with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRagDataSchema = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteRagDataSchema', () => {
    it('invokes deleteRagDataSchema without error', async () => {
      ...
      client.innerApiCalls.deleteRagDataSchema =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteRagDataSchema(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRagDataSchema as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRagDataSchema as SinonStub
    ...
    it('invokes deleteRagDataSchema with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteRagDataSchema = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createRagMetadata', () => {
    it('invokes createRagMetadata without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createRagMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createRagMetadata as SinonStub
    ...
    it('invokes createRagMetadata without error using callback', async () => {
      ...
      client.innerApiCalls.createRagMetadata =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.createRagMetadata(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRagMetadata | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createRagMetadata with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createRagMetadata = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateRagMetadata', () => {
    it('invokes updateRagMetadata without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateRagMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateRagMetadata as SinonStub
    ...
    it('invokes updateRagMetadata without error using callback', async () => {
      ...
      client.innerApiCalls.updateRagMetadata =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateRagMetadata with error', async () => {
      ...
      const expectedHeaderRequestParams = `rag_metadata.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateRagMetadata = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getRagMetadata', () => {
    it('invokes getRagMetadata without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRagMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRagMetadata as SinonStub
    ...
    it('invokes getRagMetadata without error using callback', async () => {
      ...
      client.innerApiCalls.getRagMetadata =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes getRagMetadata with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getRagMetadata = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteRagMetadata', () => {
    it('invokes deleteRagMetadata without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRagMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRagMetadata as SinonStub
    ...
    it('invokes deleteRagMetadata without error using callback', async () => {
      ...
      client.innerApiCalls.deleteRagMetadata =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteRagMetadata with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteRagMetadata = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('batchCreateRagDataSchemas', () => {
    it('invokes batchCreateRagDataSchemas without error', async () => {
      ...
      client.innerApiCalls.batchCreateRagDataSchemas =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchCreateRagDataSchemas(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateRagDataSchemas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateRagDataSchemas as SinonStub
    ...
    it('invokes batchCreateRagDataSchemas with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateRagDataSchemas = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateRagDataSchemas(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateRagDataSchemas as SinonStub
    ...
    it('invokes checkBatchCreateRagDataSchemasProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkBatchCreateRagDataSchemasProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkBatchCreateRagDataSchemasProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkBatchCreateRagDataSchemasProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('batchDeleteRagDataSchemas', () => {
    it('invokes batchDeleteRagDataSchemas without error', async () => {
      ...
      client.innerApiCalls.batchDeleteRagDataSchemas =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchDeleteRagDataSchemas(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeleteRagDataSchemas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeleteRagDataSchemas as SinonStub
    ...
    it('invokes batchDeleteRagDataSchemas with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeleteRagDataSchemas = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeleteRagDataSchemas(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeleteRagDataSchemas as SinonStub
    ...
    it('invokes checkBatchDeleteRagDataSchemasProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkBatchDeleteRagDataSchemasProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkBatchDeleteRagDataSchemasProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkBatchDeleteRagDataSchemasProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('batchCreateRagMetadata', () => {
    it('invokes batchCreateRagMetadata without error', async () => {
      ...
      client.innerApiCalls.batchCreateRagMetadata =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchCreateRagMetadata(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchCreateRagMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchCreateRagMetadata as SinonStub
    ...
    it('invokes batchCreateRagMetadata with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchCreateRagMetadata = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchCreateRagMetadata(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchCreateRagMetadata as SinonStub
    ...
    it('invokes checkBatchCreateRagMetadataProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkBatchCreateRagMetadataProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('batchDeleteRagMetadata', () => {
    it('invokes batchDeleteRagMetadata without error', async () => {
      ...
      client.innerApiCalls.batchDeleteRagMetadata =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.batchDeleteRagMetadata(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.batchDeleteRagMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.batchDeleteRagMetadata as SinonStub
    ...
    it('invokes batchDeleteRagMetadata with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.batchDeleteRagMetadata = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.batchDeleteRagMetadata(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.batchDeleteRagMetadata as SinonStub
    ...
    it('invokes checkBatchDeleteRagMetadataProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkBatchDeleteRagMetadataProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listRagCorpora', () => {
    ...
    it('invokes listRagCorporaStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.RagCorpus) => {
  ...
  describe('listRagFiles', () => {
    ...
    it('invokes listRagFilesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.RagFile) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listRagDataSchemas', () => {
    it('invokes listRagDataSchemas without error', async () => {
      ...
      client.innerApiCalls.listRagDataSchemas =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listRagDataSchemas(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRagDataSchemas as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRagDataSchemas as SinonStub
    ...
    it('invokes listRagDataSchemas with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRagDataSchemas = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listRagDataSchemasStream without error', async () => {
      ...
      client.descriptors.page.listRagDataSchemas.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.RagDataSchema) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listRagDataSchemas.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRagDataSchemas, request),
      );
      assert(
        (client.descriptors.page.listRagDataSchemas.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRagDataSchemas without error', async () => {
      ...
      client.descriptors.page.listRagDataSchemas.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listRagMetadata', () => {
    it('invokes listRagMetadata without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRagMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRagMetadata as SinonStub
    ...
    it('invokes listRagMetadata without error using callback', async () => {
      ...
      client.innerApiCalls.listRagMetadata =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listRagMetadata with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listRagMetadata = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listRagMetadataStream without error', async () => {
      ...
      client.descriptors.page.listRagMetadata.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.RagMetadata) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listRagMetadata.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listRagMetadata, request),
      );
      assert(
        (client.descriptors.page.listRagMetadata.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listRagMetadata without error', async () => {
      ...
      client.descriptors.page.listRagMetadata.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
