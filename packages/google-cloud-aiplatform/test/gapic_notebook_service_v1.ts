...
describe('v1.NotebookServiceClient', () => {
  ...
  describe('listNotebookRuntimeTemplates', () => {
    ...
    it('invokes listNotebookRuntimeTemplatesStream without error', async () => {
      ...
      const stream = await client.listNotebookRuntimeTemplatesStream(request);
      const promise = new Promise((resolve, reject) => {
    ...
    it('uses async iteration with listNotebookRuntimeTemplates without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1.INotebookRuntimeTemplate[] =
        [];
      const iterable = await client.listNotebookRuntimeTemplatesAsync(request);
  ...
  describe('listNotebookRuntimes', () => {
    ...
    it('invokes listNotebookRuntimesStream without error', async () => {
      ...
      client.descriptors.page.listNotebookRuntimes.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = await client.listNotebookRuntimesStream(request);
      const promise = new Promise((resolve, reject) => {
    ...
    it('uses async iteration with listNotebookRuntimes without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1.INotebookRuntime[] =
        [];
      const iterable = await client.listNotebookRuntimesAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
  ...
  describe('listNotebookExecutionJobs', () => {
    ...
    it('invokes listNotebookExecutionJobsStream without error', async () => {
      ...
      client.descriptors.page.listNotebookExecutionJobs.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = await client.listNotebookExecutionJobsStream(request);
      const promise = new Promise((resolve, reject) => {
    ...
    it('uses async iteration with listNotebookExecutionJobs without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1.INotebookExecutionJob[] =
        [];
      const iterable = await client.listNotebookExecutionJobsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
