...
describe('v1.PersistentResourceServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = persistentresourceserviceModule.v1.PersistentResourceServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = persistentresourceserviceModule.v1.PersistentResourceServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({universeDomain: 'example.com'});
        ...
        it('sets apiEndpoint according to universe domain snakeCase', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({universe_domain: 'example.com'});
            const servicePath = await client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', async () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = await client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new persistentresourceserviceModule.v1.PersistentResourceServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = persistentresourceserviceModule.v1.PersistentResourceServiceClient.port;
            assert(port);
    ...
    describe('getPersistentResource', () => {
        it('invokes getPersistentResource without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getPersistentResource = stubSimpleCall(expectedResponse);
            const [response] = await client.getPersistentResource(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPersistentResource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPersistentResource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getPersistentResource without error using callback', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getPersistentResource = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPersistentResource(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IPersistentResource|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getPersistentResource with error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes getPersistentResource with closed client', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('createPersistentResource', () => {
        it('invokes createPersistentResource without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createPersistentResource = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createPersistentResource(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPersistentResource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createPersistentResource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes createPersistentResource without error using callback', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createPersistentResource = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPersistentResource(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IPersistentResource, protos.google.cloud.aiplatform.v1.ICreatePersistentResourceOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IPersistentResource, protos.google.cloud.aiplatform.v1.ICreatePersistentResourceOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createPersistentResource as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createPersistentResource with call error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes createPersistentResource with LRO error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes checkCreatePersistentResourceProgress without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkCreatePersistentResourceProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkCreatePersistentResourceProgress with error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkCreatePersistentResourceProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('deletePersistentResource', () => {
        it('invokes deletePersistentResource without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deletePersistentResource = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deletePersistentResource(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePersistentResource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePersistentResource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deletePersistentResource without error using callback', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deletePersistentResource = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deletePersistentResource(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deletePersistentResource with call error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes deletePersistentResource with LRO error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes checkDeletePersistentResourceProgress without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeletePersistentResourceProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeletePersistentResourceProgress with error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeletePersistentResourceProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('updatePersistentResource', () => {
        it('invokes updatePersistentResource without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updatePersistentResource = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updatePersistentResource(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePersistentResource as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePersistentResource as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes updatePersistentResource without error using callback', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.updatePersistentResource = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updatePersistentResource(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IPersistentResource, protos.google.cloud.aiplatform.v1.IUpdatePersistentResourceOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IPersistentResource, protos.google.cloud.aiplatform.v1.IUpdatePersistentResourceOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePersistentResource as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updatePersistentResource with call error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes updatePersistentResource with LRO error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes checkUpdatePersistentResourceProgress without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdatePersistentResourceProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkUpdatePersistentResourceProgress with error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdatePersistentResourceProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
        ...
        it('invokes rebootPersistentResource without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.rebootPersistentResource(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IPersistentResource, protos.google.cloud.aiplatform.v1.IRebootPersistentResourceOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IPersistentResource, protos.google.cloud.aiplatform.v1.IRebootPersistentResourceOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rebootPersistentResource as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listPersistentResources', () => {
        it('invokes listPersistentResources without error', async () => {
            ...
            client.innerApiCalls.listPersistentResources = stubSimpleCall(expectedResponse);
            const [response] = await client.listPersistentResources(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listPersistentResources as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listPersistentResources as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listPersistentResources without error using callback', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listPersistentResources = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPersistentResources(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IPersistentResource[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listPersistentResources with error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
        ...
        it('invokes listPersistentResourcesStream without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listPersistentResources.createStream = stubPageStreamingCall(expectedResponse);
            const stream = await client.listPersistentResourcesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.PersistentResource[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.PersistentResource) => {
            ...
            assert((client.descriptors.page.listPersistentResources.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPersistentResources, request));
            assert(
                (client.descriptors.page.listPersistentResources.createStream as SinonStub)
        ...
        it('invokes listPersistentResourcesStream with error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
        ...
        it('uses async iteration with listPersistentResources without error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listPersistentResources.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1.IPersistentResource[] = [];
            const iterable = await client.listPersistentResourcesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listPersistentResources.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listPersistentResources with error', async () => {
            const client = new persistentresourceserviceModule.v1.PersistentResourceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
