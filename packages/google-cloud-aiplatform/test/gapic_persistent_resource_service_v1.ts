...
describe('v1.PersistentResourceServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new persistentresourceserviceModule.v1.PersistentResourceServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          persistentresourceserviceModule.v1.PersistentResourceServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        persistentresourceserviceModule.v1.PersistentResourceServiceClient.port;
      assert(port);
  ...
  describe('getPersistentResource', () => {
    it('invokes getPersistentResource without error', async () => {
      ...
      client.innerApiCalls.getPersistentResource =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getPersistentResource(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getPersistentResource as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getPersistentResource without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPersistentResource(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IPersistentResource | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPersistentResource with error', async () => {
      ...
      await assert.rejects(
        client.getPersistentResource(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getPersistentResource as SinonStub
  ...
  describe('createPersistentResource', () => {
    it('invokes createPersistentResource without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createPersistentResource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createPersistentResource as SinonStub
    ...
    it('invokes createPersistentResource with call error', async () => {
      ...
      await assert.rejects(
        client.createPersistentResource(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createPersistentResource as SinonStub
    ...
    it('invokes checkCreatePersistentResourceProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreatePersistentResourceProgress(
    ...
    it('invokes checkCreatePersistentResourceProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreatePersistentResourceProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deletePersistentResource', () => {
    it('invokes deletePersistentResource without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deletePersistentResource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deletePersistentResource as SinonStub
    ...
    it('invokes deletePersistentResource with call error', async () => {
      ...
      await assert.rejects(
        client.deletePersistentResource(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deletePersistentResource as SinonStub
    ...
    it('invokes checkDeletePersistentResourceProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeletePersistentResourceProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeletePersistentResourceProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeletePersistentResourceProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updatePersistentResource', () => {
    it('invokes updatePersistentResource without error', async () => {
      ...
      client.innerApiCalls.updatePersistentResource =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updatePersistentResource(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updatePersistentResource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updatePersistentResource as SinonStub
    ...
    it('invokes updatePersistentResource with call error', async () => {
      ...
      await assert.rejects(
        client.updatePersistentResource(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updatePersistentResource as SinonStub
    ...
    it('invokes checkUpdatePersistentResourceProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdatePersistentResourceProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('rebootPersistentResource', () => {
    it('invokes rebootPersistentResource without error', async () => {
      ...
      client.innerApiCalls.rebootPersistentResource =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.rebootPersistentResource(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.rebootPersistentResource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.rebootPersistentResource as SinonStub
    ...
    it('invokes rebootPersistentResource with call error', async () => {
      ...
      await assert.rejects(
        client.rebootPersistentResource(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.rebootPersistentResource as SinonStub
    ...
    it('invokes checkRebootPersistentResourceProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkRebootPersistentResourceProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkRebootPersistentResourceProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkRebootPersistentResourceProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listPersistentResources', () => {
    it('invokes listPersistentResources without error', async () => {
      ...
      client.innerApiCalls.listPersistentResources =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPersistentResources(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPersistentResources as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPersistentResources as SinonStub
    ...
    it('invokes listPersistentResources with error', async () => {
      ...
      await assert.rejects(
        client.listPersistentResources(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listPersistentResources as SinonStub
    ...
    it('invokes listPersistentResourcesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.PersistentResource) => {
      ...
      assert(
        (
          client.descriptors.page.listPersistentResources
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listPersistentResources, request),
      );
      assert(
        (
          client.descriptors.page.listPersistentResources
