...
describe('v1beta1.ModelGardenServiceClient', () => {
  ...
  describe('checkPublisherModelEulaAcceptance', () => {
    it('invokes checkPublisherModelEulaAcceptance without error', async () => {
      ...
      client.innerApiCalls.checkPublisherModelEulaAcceptance =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.checkPublisherModelEulaAcceptance(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.checkPublisherModelEulaAcceptance as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.checkPublisherModelEulaAcceptance as SinonStub
    ...
    it('invokes checkPublisherModelEulaAcceptance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.checkPublisherModelEulaAcceptance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IPublisherModelEulaAcceptance | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes checkPublisherModelEulaAcceptance with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.checkPublisherModelEulaAcceptance = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.checkPublisherModelEulaAcceptance(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.checkPublisherModelEulaAcceptance as SinonStub
  ...
  describe('acceptPublisherModelEula', () => {
    it('invokes acceptPublisherModelEula without error', async () => {
      ...
      client.innerApiCalls.acceptPublisherModelEula =
        stubSimpleCall(expectedResponse);
      const [response] = await client.acceptPublisherModelEula(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.acceptPublisherModelEula as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.acceptPublisherModelEula as SinonStub
    ...
    it('invokes acceptPublisherModelEula with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.acceptPublisherModelEula = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.acceptPublisherModelEula(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.acceptPublisherModelEula as SinonStub
  ...
  describe('deploy', () => {
    it('invokes deploy without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (client.innerApiCalls.deploy as SinonStub).getCall(
        0
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deploy as SinonStub
      ).getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
    });
    ...
    it('invokes deploy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `destination=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deploy = stubLongRunningCall(
        undefined,
        expectedError
      );
  ...
  describe('deployPublisherModel', () => {
    ...
    it('invokes deployPublisherModel with call error', async () => {
      ...
      const expectedHeaderRequestParams = `destination=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deployPublisherModel = stubLongRunningCall(
        undefined,
        expectedError
      );
  ...
  describe('exportPublisherModel', () => {
    it('invokes exportPublisherModel without error', async () => {
      ...
      client.innerApiCalls.exportPublisherModel =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.exportPublisherModel(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportPublisherModel as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportPublisherModel as SinonStub
    ...
    it('invokes exportPublisherModel with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}&name=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportPublisherModel = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkExportPublisherModelProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkExportPublisherModelProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listPublisherModels', () => {
    it('invokes listPublisherModels without error', async () => {
      ...
      client.innerApiCalls.listPublisherModels =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listPublisherModels(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listPublisherModels as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listPublisherModels as SinonStub
    ...
    it('invokes listPublisherModels with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listPublisherModels = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listPublisherModelsStream without error', async () => {
      ...
      client.descriptors.page.listPublisherModels.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.PublisherModel) => {
      ...
      assert(
        (client.descriptors.page.listPublisherModels.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listPublisherModels, request)
      );
      assert(
        (client.descriptors.page.listPublisherModels.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listPublisherModels without error', async () => {
      ...
      client.descriptors.page.listPublisherModels.asyncIterate =
