  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          llmutilityserviceModule.v1beta1.LlmUtilityServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          llmutilityserviceModule.v1beta1.LlmUtilityServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes computeTokens without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.computeTokens(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IComputeTokensResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
