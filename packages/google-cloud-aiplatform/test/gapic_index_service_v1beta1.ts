...
describe('v1beta1.IndexServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          indexserviceModule.v1beta1.IndexServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          indexserviceModule.v1beta1.IndexServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new indexserviceModule.v1beta1.IndexServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getIndex without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getIndex(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IIndex | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes upsertDatapoints without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.upsertDatapoints(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IUpsertDatapointsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes removeDatapoints without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.removeDatapoints(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRemoveDatapointsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('importIndex', () => {
    it('invokes importIndex without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.importIndex as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.importIndex as SinonStub
    ...
    it('invokes importIndex without error using callback', async () => {
      ...
      client.innerApiCalls.importIndex =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.importIndex(
          request,
    ...
    it('invokes importIndex with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.importIndex = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkImportIndexProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkImportIndexProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('listIndexes', () => {
    ...
    it('invokes listIndexesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.Index) => {
