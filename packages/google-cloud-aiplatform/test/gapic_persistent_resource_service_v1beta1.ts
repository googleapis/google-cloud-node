  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          persistentresourceserviceModule.v1beta1
            .PersistentResourceServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          persistentresourceserviceModule.v1beta1
            .PersistentResourceServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        persistentresourceserviceModule.v1beta1.PersistentResourceServiceClient
          .port;
      assert(port);
    ...
    it('invokes getPersistentResource without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPersistentResource(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IPersistentResource | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listPersistentResourcesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.PersistentResource
          ) => {
