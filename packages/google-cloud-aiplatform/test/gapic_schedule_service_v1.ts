...
describe('v1.ScheduleServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = scheduleserviceModule.v1.ScheduleServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = scheduleserviceModule.v1.ScheduleServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', async () => {
            const client = new scheduleserviceModule.v1.ScheduleServiceClient({universeDomain: 'example.com'});
        ...
        it('sets apiEndpoint according to universe domain snakeCase', async () => {
            const client = new scheduleserviceModule.v1.ScheduleServiceClient({universe_domain: 'example.com'});
            const servicePath = await client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', async () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new scheduleserviceModule.v1.ScheduleServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = await client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new scheduleserviceModule.v1.ScheduleServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createSchedule', () => {
        it('invokes createSchedule without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.createSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createSchedule as SinonStub)
        ...
        it('invokes createSchedule without error using callback', async () => {
            ...
            client.innerApiCalls.createSchedule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSchedule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ISchedule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSchedule', () => {
        it('invokes getSchedule without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('pauseSchedule', () => {
        it('invokes pauseSchedule without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.pauseSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.pauseSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes pauseSchedule without error using callback', async () => {
            ...
            client.innerApiCalls.pauseSchedule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('resumeSchedule', () => {
        it('invokes resumeSchedule without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.resumeSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.resumeSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes resumeSchedule without error using callback', async () => {
            ...
            client.innerApiCalls.resumeSchedule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('updateSchedule', () => {
        it('invokes updateSchedule without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateSchedule without error using callback', async () => {
            ...
            client.innerApiCalls.updateSchedule = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('deleteSchedule', () => {
        it('invokes deleteSchedule without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteSchedule as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteSchedule as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listSchedules', () => {
        it('invokes listSchedules without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listSchedules as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listSchedules as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listSchedulesStream without error', async () => {
            ...
            const stream = await client.listSchedulesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.Schedule[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.Schedule) => {
        ...
        it('uses async iteration with listSchedules without error', async () => {
            ...
            const iterable = await client.listSchedulesAsync(request);
