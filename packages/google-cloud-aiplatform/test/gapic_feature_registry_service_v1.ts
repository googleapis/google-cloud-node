...
describe('v1.FeatureRegistryServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          featureregistryserviceModule.v1.FeatureRegistryServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        featureregistryserviceModule.v1.FeatureRegistryServiceClient.port;
      assert(port);
  ...
  describe('getFeatureGroup', () => {
    it('invokes getFeatureGroup without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getFeatureGroup as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getFeatureGroup without error using callback', async () => {
      ...
      client.innerApiCalls.getFeatureGroup =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFeatureGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IFeatureGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createFeatureGroup', () => {
    it('invokes createFeatureGroup without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createFeatureGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createFeatureGroup as SinonStub
        ...
        client.createFeatureGroup(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.aiplatform.v1.ICreateFeatureGroupOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes checkCreateFeatureGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateFeatureGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateFeatureGroup', () => {
    it('invokes updateFeatureGroup without error', async () => {
      ...
      client.innerApiCalls.updateFeatureGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateFeatureGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateFeatureGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateFeatureGroup as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateFeatureGroup(
          ...
          (
            ...
            result?: LROperation<
              protos.google.cloud.aiplatform.v1.IFeatureGroup,
              protos.google.cloud.aiplatform.v1.IUpdateFeatureGroupOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes checkUpdateFeatureGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateFeatureGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteFeatureGroup', () => {
    it('invokes deleteFeatureGroup without error', async () => {
      ...
      client.innerApiCalls.deleteFeatureGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteFeatureGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteFeatureGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteFeatureGroup as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.updateFeature(
          ...
          (
            ...
            result?: LROperation<
              protos.google.cloud.aiplatform.v1.IFeature,
              protos.google.cloud.aiplatform.v1.IUpdateFeatureOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
  ...
  describe('listFeatureGroups', () => {
    it('invokes listFeatureGroups without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFeatureGroups as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFeatureGroups as SinonStub
    ...
    it('invokes listFeatureGroups without error using callback', async () => {
      ...
      client.innerApiCalls.listFeatureGroups =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listFeatureGroupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.FeatureGroup) => {
      ...
      assert(
        (client.descriptors.page.listFeatureGroups.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listFeatureGroups, request),
      );
      assert(
        (client.descriptors.page.listFeatureGroups.createStream as SinonStub)
          .getCall(0)
