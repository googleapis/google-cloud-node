...
describe('v1.FeatureRegistryServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', async () => {
            const client = new featureregistryserviceModule.v1.FeatureRegistryServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = featureregistryserviceModule.v1.FeatureRegistryServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = featureregistryserviceModule.v1.FeatureRegistryServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', async () => {
            const client = new featureregistryserviceModule.v1.FeatureRegistryServiceClient({universeDomain: 'example.com'});
        ...
        it('sets apiEndpoint according to universe domain snakeCase', async () => {
            const client = new featureregistryserviceModule.v1.FeatureRegistryServiceClient({universe_domain: 'example.com'});
            const servicePath = await client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', async () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new featureregistryserviceModule.v1.FeatureRegistryServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = await client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new featureregistryserviceModule.v1.FeatureRegistryServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = featureregistryserviceModule.v1.FeatureRegistryServiceClient.port;
            assert(port);
    ...
    describe('getFeatureGroup', () => {
        it('invokes getFeatureGroup without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetFeatureGroupRequest()
            );
            const defaultValue1 =
        ...
        it('invokes getFeatureGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFeatureGroup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IFeatureGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createFeatureGroup', () => {
        it('invokes createFeatureGroup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CreateFeatureGroupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateFeatureGroupRequest', ['parent']);
        ...
        it('invokes createFeatureGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFeatureGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeatureGroup, protos.google.cloud.aiplatform.v1.ICreateFeatureGroupOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeatureGroup, protos.google.cloud.aiplatform.v1.ICreateFeatureGroupOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFeatureGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateFeatureGroup', () => {
        it('invokes updateFeatureGroup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.UpdateFeatureGroupRequest()
            );
            request.featureGroup ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateFeatureGroupRequest', ['featureGroup', 'name']);
        ...
        it('invokes updateFeatureGroup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateFeatureGroup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeatureGroup, protos.google.cloud.aiplatform.v1.IUpdateFeatureGroupOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeatureGroup, protos.google.cloud.aiplatform.v1.IUpdateFeatureGroupOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeatureGroup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteFeatureGroup', () => {
        it('invokes deleteFeatureGroup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.DeleteFeatureGroupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteFeatureGroupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes updateFeature without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateFeature(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IFeature, protos.google.cloud.aiplatform.v1.IUpdateFeatureOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IFeature, protos.google.cloud.aiplatform.v1.IUpdateFeatureOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateFeature as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listFeatureGroups', () => {
        it('invokes listFeatureGroups without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListFeatureGroupsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListFeatureGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureGroup()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureGroup()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.FeatureGroup()),
            ];
        ...
        it('invokes listFeatureGroupsStream without error', async () => {
            ...
            const stream = await client.listFeatureGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.FeatureGroup[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.FeatureGroup) => {
        ...
        it('uses async iteration with listFeatureGroups without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1.IFeatureGroup[] = [];
            const iterable = await client.listFeatureGroupsAsync(request);
    ...
    describe('listFeatures', () => {
        ...
        it('invokes listFeaturesStream without error', async () => {
            ...
            const stream = await client.listFeaturesStream(request);
            const promise = new Promise((resolve, reject) => {
        ...
        it('uses async iteration with listFeatures without error', async () => {
            ...
            const iterable = await client.listFeaturesAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
