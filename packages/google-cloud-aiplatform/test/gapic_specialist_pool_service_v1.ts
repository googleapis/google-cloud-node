...
describe('v1.SpecialistPoolServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = specialistpoolserviceModule.v1.SpecialistPoolServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = specialistpoolserviceModule.v1.SpecialistPoolServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', async () => {
            const client = new specialistpoolserviceModule.v1.SpecialistPoolServiceClient({universeDomain: 'example.com'});
        ...
        it('sets apiEndpoint according to universe domain snakeCase', async () => {
            const client = new specialistpoolserviceModule.v1.SpecialistPoolServiceClient({universe_domain: 'example.com'});
            const servicePath = await client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', async () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new specialistpoolserviceModule.v1.SpecialistPoolServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = await client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new specialistpoolserviceModule.v1.SpecialistPoolServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = specialistpoolserviceModule.v1.SpecialistPoolServiceClient.port;
            assert(port);
    ...
    describe('getSpecialistPool', () => {
        it('invokes getSpecialistPool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetSpecialistPoolRequest', ['name']);
        ...
        it('invokes getSpecialistPool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSpecialistPool(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.ISpecialistPool|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSpecialistPool', () => {
        it('invokes createSpecialistPool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateSpecialistPoolRequest', ['parent']);
        ...
        it('invokes createSpecialistPool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSpecialistPool(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.ISpecialistPool, protos.google.cloud.aiplatform.v1.ICreateSpecialistPoolOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.ISpecialistPool, protos.google.cloud.aiplatform.v1.ICreateSpecialistPoolOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createSpecialistPool as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteSpecialistPool', () => {
        it('invokes deleteSpecialistPool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteSpecialistPoolRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateSpecialistPool', () => {
        it('invokes updateSpecialistPool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateSpecialistPoolRequest', ['specialistPool', 'name']);
        ...
        it('invokes updateSpecialistPool without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateSpecialistPool(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.ISpecialistPool, protos.google.cloud.aiplatform.v1.IUpdateSpecialistPoolOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.ISpecialistPool, protos.google.cloud.aiplatform.v1.IUpdateSpecialistPoolOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateSpecialistPool as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listSpecialistPools', () => {
        it('invokes listSpecialistPools without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListSpecialistPoolsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.SpecialistPool()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.SpecialistPool()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.SpecialistPool()),
            ];
        ...
        it('invokes listSpecialistPoolsStream without error', async () => {
            ...
            const stream = await client.listSpecialistPoolsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.SpecialistPool[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.SpecialistPool) => {
        ...
        it('uses async iteration with listSpecialistPools without error', async () => {
            ...
            const iterable = await client.listSpecialistPoolsAsync(request);
