...
describe('v1beta1.JobServiceClient', () => {
  ...
  describe('Path templates', () => {
    ...
    describe('exampleStore', async () => {
      ...
      it('exampleStorePath', () => {
        const result = client.exampleStorePath(
          'projectValue',
          'locationValue',
          'exampleStoreValue',
        );
    ...
    describe('onlineEvaluator', async () => {
      ...
      await client.initialize();
      client.pathTemplates.onlineEvaluatorPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.onlineEvaluatorPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('onlineEvaluatorPath', () => {
        const result = client.onlineEvaluatorPath(
          'projectValue',
          'locationValue',
          'onlineEvaluatorValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.onlineEvaluatorPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromOnlineEvaluatorName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.onlineEvaluatorPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchOnlineEvaluatorFromOnlineEvaluatorName', () => {
        const result =
          client.matchOnlineEvaluatorFromOnlineEvaluatorName(fakePath);
    ...
    describe('projectLocationFeatureGroupFeatures', async () => {
      ...
      it('projectLocationFeatureGroupFeaturesPath', () => {
        const result = client.projectLocationFeatureGroupFeaturesPath(
          'projectValue',
          'locationValue',
          'featureGroupValue',
          'featureValue',
        ...
        assert(
          (
            client.pathTemplates.projectLocationFeatureGroupFeaturesPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationFeatureGroupFeaturesName', () => {
        const result =
          client.matchProjectFromProjectLocationFeatureGroupFeaturesName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationFeatureGroupFeaturesName', () => {
        const result =
          client.matchLocationFromProjectLocationFeatureGroupFeaturesName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchFeatureGroupFromProjectLocationFeatureGroupFeaturesName', () => {
        const result =
          client.matchFeatureGroupFromProjectLocationFeatureGroupFeaturesName(
            fakePath,
          );
        assert.strictEqual(result, 'featureGroupValue');
        assert(
      ...
      it('matchFeatureFromProjectLocationFeatureGroupFeaturesName', () => {
        const result =
          client.matchFeatureFromProjectLocationFeatureGroupFeaturesName(
            fakePath,
          );
    ...
    describe('projectLocationFeaturestoreEntityTypeFeatures', async () => {
      const fakePath =
        '/rendered/path/projectLocationFeaturestoreEntityTypeFeatures';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        featurestore: 'featurestoreValue',
      ...
      it('projectLocationFeaturestoreEntityTypeFeaturesPath', () => {
        const result = client.projectLocationFeaturestoreEntityTypeFeaturesPath(
          'projectValue',
          'locationValue',
          'featurestoreValue',
          'entityTypeValue',
      ...
      it('matchProjectFromProjectLocationFeaturestoreEntityTypeFeaturesName', () => {
        const result =
          client.matchProjectFromProjectLocationFeaturestoreEntityTypeFeaturesName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationFeaturestoreEntityTypeFeaturesName', () => {
        const result =
          client.matchLocationFromProjectLocationFeaturestoreEntityTypeFeaturesName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchFeaturestoreFromProjectLocationFeaturestoreEntityTypeFeaturesName', () => {
        const result =
          client.matchFeaturestoreFromProjectLocationFeaturestoreEntityTypeFeaturesName(
            fakePath,
          );
        assert.strictEqual(result, 'featurestoreValue');
        assert(
      ...
      it('matchEntityTypeFromProjectLocationFeaturestoreEntityTypeFeaturesName', () => {
        const result =
          client.matchEntityTypeFromProjectLocationFeaturestoreEntityTypeFeaturesName(
            fakePath,
          );
        assert.strictEqual(result, 'entityTypeValue');
        assert(
      ...
      it('matchFeatureFromProjectLocationFeaturestoreEntityTypeFeaturesName', () => {
        const result =
          client.matchFeatureFromProjectLocationFeaturestoreEntityTypeFeaturesName(
            fakePath,
          );
        assert.strictEqual(result, 'featureValue');
        assert(
    ...
    describe('ragDataSchema', async () => {
      ...
      await client.initialize();
      client.pathTemplates.ragDataSchemaPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.ragDataSchemaPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('ragDataSchemaPath', () => {
        const result = client.ragDataSchemaPath(
          'projectValue',
          'locationValue',
          'ragCorpusValue',
          'ragDataSchemaValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.ragDataSchemaPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromRagDataSchemaName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.ragDataSchemaPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('ragEngineConfig', async () => {
      ...
      await client.initialize();
      client.pathTemplates.ragEngineConfigPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.ragEngineConfigPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('ragEngineConfigPath', () => {
        const result = client.ragEngineConfigPath(
          'projectValue',
          'locationValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.ragEngineConfigPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromRagEngineConfigName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.ragEngineConfigPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('ragMetadata', async () => {
      ...
      await client.initialize();
      client.pathTemplates.ragMetadataPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.ragMetadataPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('ragMetadataPath', () => {
        const result = client.ragMetadataPath(
          'projectValue',
          'locationValue',
          'ragCorpusValue',
          'ragFileValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.ragMetadataPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromRagMetadataName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.ragMetadataPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('reasoningEngineRuntimeRevision', async () => {
      ...
      it('reasoningEngineRuntimeRevisionPath', () => {
        const result = client.reasoningEngineRuntimeRevisionPath(
          'projectValue',
          'locationValue',
          'reasoningEngineValue',
        ...
        assert(
          (
            client.pathTemplates.reasoningEngineRuntimeRevisionPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromReasoningEngineRuntimeRevisionName', () => {
        const result =
          client.matchProjectFromReasoningEngineRuntimeRevisionName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.reasoningEngineRuntimeRevisionPathTemplate
      ...
      it('matchLocationFromReasoningEngineRuntimeRevisionName', () => {
        const result =
          client.matchLocationFromReasoningEngineRuntimeRevisionName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.reasoningEngineRuntimeRevisionPathTemplate
      ...
      it('matchReasoningEngineFromReasoningEngineRuntimeRevisionName', () => {
        const result =
          client.matchReasoningEngineFromReasoningEngineRuntimeRevisionName(
            fakePath,
          );
        assert.strictEqual(result, 'reasoningEngineValue');
        assert(
      ...
      it('matchRuntimeRevisionFromReasoningEngineRuntimeRevisionName', () => {
        const result =
          client.matchRuntimeRevisionFromReasoningEngineRuntimeRevisionName(
            fakePath,
          );
    ...
    describe('sessionEvent', async () => {
      ...
      await client.initialize();
      client.pathTemplates.sessionEventPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.sessionEventPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('sessionEventPath', () => {
        const result = client.sessionEventPath(
          'projectValue',
          'locationValue',
          'reasoningEngineValue',
          'sessionValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.sessionEventPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromSessionEventName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.sessionEventPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchReasoningEngineFromSessionEventName', () => {
        const result =
          client.matchReasoningEngineFromSessionEventName(fakePath);
        assert.strictEqual(result, 'reasoningEngineValue');
        assert(
          (client.pathTemplates.sessionEventPathTemplate.match as SinonStub)
            .getCall(-1)
