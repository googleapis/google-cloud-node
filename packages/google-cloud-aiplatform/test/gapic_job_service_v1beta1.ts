...
describe('v1beta1.JobServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new jobserviceModule.v1beta1.JobServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new jobserviceModule.v1beta1.JobServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new jobserviceModule.v1beta1.JobServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new jobserviceModule.v1beta1.JobServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createCustomJob', () => {
        it('invokes createCustomJob without error', async () => {
            ...
            const actualRequest = (client.innerApiCalls.createCustomJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createCustomJob as SinonStub)
        ...
        it('invokes createCustomJob without error using callback', async () => {
            ...
            client.innerApiCalls.createCustomJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCustomJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ICustomJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createCustomJob with error', async () => {
            ...
            client.innerApiCalls.createCustomJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getCustomJob', () => {
        it('invokes getCustomJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getCustomJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getCustomJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getCustomJob without error using callback', async () => {
            ...
            client.innerApiCalls.getCustomJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getCustomJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ICustomJob|null) => {
        ...
        it('invokes getCustomJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getCustomJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('cancelCustomJob', () => {
        it('invokes cancelCustomJob without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelCustomJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelCustomJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelCustomJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelCustomJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelCustomJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelCustomJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('createDataLabelingJob', () => {
        it('invokes createDataLabelingJob without error', async () => {
            ...
            client.innerApiCalls.createDataLabelingJob = stubSimpleCall(expectedResponse);
            const [response] = await client.createDataLabelingJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createDataLabelingJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createDataLabelingJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createDataLabelingJob without error using callback', async () => {
            ...
            client.innerApiCalls.createDataLabelingJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createDataLabelingJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IDataLabelingJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createDataLabelingJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createDataLabelingJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getDataLabelingJob', () => {
        it('invokes getDataLabelingJob without error', async () => {
            ...
            client.innerApiCalls.getDataLabelingJob = stubSimpleCall(expectedResponse);
            const [response] = await client.getDataLabelingJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getDataLabelingJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getDataLabelingJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getDataLabelingJob without error using callback', async () => {
            ...
            client.innerApiCalls.getDataLabelingJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getDataLabelingJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getDataLabelingJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('cancelDataLabelingJob', () => {
        it('invokes cancelDataLabelingJob without error', async () => {
            ...
            client.innerApiCalls.cancelDataLabelingJob = stubSimpleCall(expectedResponse);
            const [response] = await client.cancelDataLabelingJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelDataLabelingJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelDataLabelingJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelDataLabelingJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelDataLabelingJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelDataLabelingJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelDataLabelingJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('createHyperparameterTuningJob', () => {
        it('invokes createHyperparameterTuningJob without error', async () => {
            ...
            client.innerApiCalls.createHyperparameterTuningJob = stubSimpleCall(expectedResponse);
            const [response] = await client.createHyperparameterTuningJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createHyperparameterTuningJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createHyperparameterTuningJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createHyperparameterTuningJob without error using callback', async () => {
            ...
            client.innerApiCalls.createHyperparameterTuningJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createHyperparameterTuningJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IHyperparameterTuningJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createHyperparameterTuningJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createHyperparameterTuningJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getHyperparameterTuningJob', () => {
        it('invokes getHyperparameterTuningJob without error', async () => {
            ...
            client.innerApiCalls.getHyperparameterTuningJob = stubSimpleCall(expectedResponse);
            const [response] = await client.getHyperparameterTuningJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getHyperparameterTuningJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getHyperparameterTuningJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getHyperparameterTuningJob without error using callback', async () => {
            ...
            client.innerApiCalls.getHyperparameterTuningJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getHyperparameterTuningJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getHyperparameterTuningJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('cancelHyperparameterTuningJob', () => {
        it('invokes cancelHyperparameterTuningJob without error', async () => {
            ...
            client.innerApiCalls.cancelHyperparameterTuningJob = stubSimpleCall(expectedResponse);
            const [response] = await client.cancelHyperparameterTuningJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelHyperparameterTuningJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelHyperparameterTuningJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelHyperparameterTuningJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelHyperparameterTuningJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelHyperparameterTuningJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelHyperparameterTuningJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('createNasJob', () => {
        it('invokes createNasJob without error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.NasJob()
            );
            client.innerApiCalls.createNasJob = stubSimpleCall(expectedResponse);
            const [response] = await client.createNasJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createNasJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createNasJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createNasJob without error using callback', async () => {
            ...
            client.innerApiCalls.createNasJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createNasJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.INasJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createNasJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createNasJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getNasJob', () => {
        it('invokes getNasJob without error', async () => {
            ...
            client.innerApiCalls.getNasJob = stubSimpleCall(expectedResponse);
            const [response] = await client.getNasJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getNasJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getNasJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getNasJob without error using callback', async () => {
            ...
            client.innerApiCalls.getNasJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getNasJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.INasJob|null) => {
        ...
        it('invokes getNasJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getNasJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('cancelNasJob', () => {
        it('invokes cancelNasJob without error', async () => {
            ...
            client.innerApiCalls.cancelNasJob = stubSimpleCall(expectedResponse);
            const [response] = await client.cancelNasJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.cancelNasJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.cancelNasJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes cancelNasJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelNasJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.cancelNasJob(
                    request,
                    (err?: Error|null, result?: protos.google.protobuf.IEmpty|null) => {
        ...
        it('invokes cancelNasJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelNasJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getNasTrialDetail', () => {
        it('invokes getNasTrialDetail without error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.NasTrialDetail()
            );
            client.innerApiCalls.getNasTrialDetail = stubSimpleCall(expectedResponse);
            const [response] = await client.getNasTrialDetail(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getNasTrialDetail as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getNasTrialDetail as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getNasTrialDetail without error using callback', async () => {
            ...
            client.innerApiCalls.getNasTrialDetail = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getNasTrialDetail(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.INasTrialDetail|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getNasTrialDetail with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getNasTrialDetail = stubSimpleCall(undefined, expectedError);
    ...
    describe('createBatchPredictionJob', () => {
        it('invokes createBatchPredictionJob without error', async () => {
            ...
            client.innerApiCalls.createBatchPredictionJob = stubSimpleCall(expectedResponse);
            const [response] = await client.createBatchPredictionJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createBatchPredictionJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
        ...
        it('invokes createBatchPredictionJob without error using callback', async () => {
            ...
            client.innerApiCalls.createBatchPredictionJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createBatchPredictionJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IBatchPredictionJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createBatchPredictionJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createBatchPredictionJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('getBatchPredictionJob', () => {
        it('invokes getBatchPredictionJob without error', async () => {
            ...
            client.innerApiCalls.getBatchPredictionJob = stubSimpleCall(expectedResponse);
        ...
        it('invokes getBatchPredictionJob without error using callback', async () => {
            ...
            client.innerApiCalls.getBatchPredictionJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getBatchPredictionJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getBatchPredictionJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('cancelBatchPredictionJob', () => {
        it('invokes cancelBatchPredictionJob without error', async () => {
            ...
            client.innerApiCalls.cancelBatchPredictionJob = stubSimpleCall(expectedResponse);
        ...
        it('invokes cancelBatchPredictionJob without error using callback', async () => {
            ...
            client.innerApiCalls.cancelBatchPredictionJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('createModelDeploymentMonitoringJob', () => {
        it('invokes createModelDeploymentMonitoringJob without error', async () => {
            ...
            client.innerApiCalls.createModelDeploymentMonitoringJob = stubSimpleCall(expectedResponse);
            ...
            const actualRequest = (client.innerApiCalls.createModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createModelDeploymentMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.createModelDeploymentMonitoringJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createModelDeploymentMonitoringJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModelDeploymentMonitoringJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getModelDeploymentMonitoringJob', () => {
        it('invokes getModelDeploymentMonitoringJob without error', async () => {
            ...
            client.innerApiCalls.getModelDeploymentMonitoringJob = stubSimpleCall(expectedResponse);
            ...
            const actualRequest = (client.innerApiCalls.getModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getModelDeploymentMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.getModelDeploymentMonitoringJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('pauseModelDeploymentMonitoringJob', () => {
        it('invokes pauseModelDeploymentMonitoringJob without error', async () => {
            ...
            client.innerApiCalls.pauseModelDeploymentMonitoringJob = stubSimpleCall(expectedResponse);
            const [response] = await client.pauseModelDeploymentMonitoringJob(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.pauseModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
        ...
        it('invokes pauseModelDeploymentMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.pauseModelDeploymentMonitoringJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
    ...
    describe('resumeModelDeploymentMonitoringJob', () => {
        it('invokes resumeModelDeploymentMonitoringJob without error', async () => {
            ...
            client.innerApiCalls.resumeModelDeploymentMonitoringJob = stubSimpleCall(expectedResponse);
        ...
        it('invokes resumeModelDeploymentMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.resumeModelDeploymentMonitoringJob = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes resumeModelDeploymentMonitoringJob with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.resumeModelDeploymentMonitoringJob = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteCustomJob', () => {
        it('invokes deleteCustomJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteCustomJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteCustomJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteCustomJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteCustomJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteCustomJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteCustomJob without error using callback', async () => {
            ...
            client.innerApiCalls.deleteCustomJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteCustomJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteCustomJob = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes deleteCustomJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteCustomJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteCustomJob(request);
        ...
        it('invokes checkDeleteCustomJobProgress without error', async () => {
            ...
            const decodedOperation = await client.checkDeleteCustomJobProgress(expectedResponse.name);
        ...
        it('invokes checkDeleteCustomJobProgress with error', async () => {
            ...
            await assert.rejects(client.checkDeleteCustomJobProgress(''), expectedError);
    ...
    describe('deleteDataLabelingJob', () => {
        it('invokes deleteDataLabelingJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteDataLabelingJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteDataLabelingJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteDataLabelingJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteDataLabelingJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataLabelingJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteDataLabelingJob without error using callback', async () => {
            ...
            client.innerApiCalls.deleteDataLabelingJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteDataLabelingJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataLabelingJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteDataLabelingJob(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDataLabelingJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteDataLabelingJob as SinonStub)
        ...
        it('invokes deleteDataLabelingJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteDataLabelingJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteDataLabelingJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteDataLabelingJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteDataLabelingJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteDataLabelingJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteDataLabelingJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteDataLabelingJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteHyperparameterTuningJob', () => {
        it('invokes deleteHyperparameterTuningJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteHyperparameterTuningJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteHyperparameterTuningJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteHyperparameterTuningJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteHyperparameterTuningJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteHyperparameterTuningJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteHyperparameterTuningJob without error using callback', async () => {
            ...
            client.innerApiCalls.deleteHyperparameterTuningJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteHyperparameterTuningJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteHyperparameterTuningJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteHyperparameterTuningJob(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteHyperparameterTuningJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteHyperparameterTuningJob as SinonStub)
        ...
        it('invokes deleteHyperparameterTuningJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteHyperparameterTuningJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteHyperparameterTuningJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteHyperparameterTuningJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteHyperparameterTuningJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteHyperparameterTuningJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteHyperparameterTuningJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteHyperparameterTuningJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteNasJob', () => {
        it('invokes deleteNasJob without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteNasJobRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteNasJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteNasJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteNasJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteNasJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteNasJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteNasJob without error using callback', async () => {
            ...
            client.innerApiCalls.deleteNasJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteNasJob(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteNasJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteNasJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteNasJob(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteNasJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteNasJob as SinonStub)
        ...
        it('invokes deleteNasJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteNasJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteNasJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteNasJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteNasJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteNasJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteNasJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteNasJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteBatchPredictionJob', () => {
        it('invokes deleteBatchPredictionJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteBatchPredictionJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteBatchPredictionJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteBatchPredictionJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteBatchPredictionJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteBatchPredictionJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteBatchPredictionJob without error using callback', async () => {
            ...
            client.innerApiCalls.deleteBatchPredictionJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteBatchPredictionJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteBatchPredictionJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteBatchPredictionJob(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteBatchPredictionJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteBatchPredictionJob as SinonStub)
        ...
        it('invokes deleteBatchPredictionJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteBatchPredictionJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteBatchPredictionJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteBatchPredictionJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteBatchPredictionJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteBatchPredictionJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteBatchPredictionJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteBatchPredictionJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateModelDeploymentMonitoringJob', () => {
        it('invokes updateModelDeploymentMonitoringJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.UpdateModelDeploymentMonitoringJobRequest', ['modelDeploymentMonitoringJob', 'name']);
            ...
            client.innerApiCalls.updateModelDeploymentMonitoringJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateModelDeploymentMonitoringJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateModelDeploymentMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.updateModelDeploymentMonitoringJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateModelDeploymentMonitoringJob(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IModelDeploymentMonitoringJob, protos.google.cloud.aiplatform.v1beta1.IUpdateModelDeploymentMonitoringJobOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IModelDeploymentMonitoringJob, protos.google.cloud.aiplatform.v1beta1.IUpdateModelDeploymentMonitoringJobOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateModelDeploymentMonitoringJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `model_deployment_monitoring_job.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateModelDeploymentMonitoringJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.updateModelDeploymentMonitoringJob(request), expectedError);
            const actualRequest = (client.innerApiCalls.updateModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateModelDeploymentMonitoringJob as SinonStub)
        ...
        it('invokes updateModelDeploymentMonitoringJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `model_deployment_monitoring_job.name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateModelDeploymentMonitoringJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateModelDeploymentMonitoringJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateModelDeploymentMonitoringJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateModelDeploymentMonitoringJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateModelDeploymentMonitoringJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateModelDeploymentMonitoringJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteModelDeploymentMonitoringJob', () => {
        it('invokes deleteModelDeploymentMonitoringJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteModelDeploymentMonitoringJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteModelDeploymentMonitoringJob = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteModelDeploymentMonitoringJob(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteModelDeploymentMonitoringJob without error using callback', async () => {
            ...
            client.innerApiCalls.deleteModelDeploymentMonitoringJob = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteModelDeploymentMonitoringJob with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteModelDeploymentMonitoringJob = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteModelDeploymentMonitoringJob(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteModelDeploymentMonitoringJob as SinonStub)
        ...
        it('invokes deleteModelDeploymentMonitoringJob with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteModelDeploymentMonitoringJob = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteModelDeploymentMonitoringJob(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteModelDeploymentMonitoringJob as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteModelDeploymentMonitoringJobProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteModelDeploymentMonitoringJobProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteModelDeploymentMonitoringJobProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteModelDeploymentMonitoringJobProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listCustomJobs', () => {
        it('invokes listCustomJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListCustomJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.CustomJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.CustomJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.CustomJob()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listCustomJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listCustomJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listCustomJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listCustomJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCustomJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listCustomJobs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCustomJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.CustomJob) => {
            ...
            assert((client.descriptors.page.listCustomJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCustomJobs, request));
            assert(
        ...
        it('invokes listCustomJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCustomJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.CustomJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.CustomJob) => {
        ...
        it('uses async iteration with listCustomJobs without error', async () => {
            ...
            client.descriptors.page.listCustomJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listCustomJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listCustomJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCustomJobsAsync(request);
    ...
    describe('listDataLabelingJobs', () => {
        it('invokes listDataLabelingJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListDataLabelingJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
            ...
            client.innerApiCalls.listDataLabelingJobs = stubSimpleCall(expectedResponse);
            const [response] = await client.listDataLabelingJobs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listDataLabelingJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listDataLabelingJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listDataLabelingJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listDataLabelingJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listDataLabelingJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listDataLabelingJobs = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listDataLabelingJobsStream without error', async () => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listDataLabelingJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listDataLabelingJobs, request));
            assert(
        ...
        it('invokes listDataLabelingJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataLabelingJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listDataLabelingJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.DataLabelingJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.DataLabelingJob) => {
        ...
        it('uses async iteration with listDataLabelingJobs without error', async () => {
            ...
            client.descriptors.page.listDataLabelingJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listDataLabelingJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listDataLabelingJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listDataLabelingJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.IDataLabelingJob[] = [];
                for await (const resource of iterable) {
    ...
    describe('listHyperparameterTuningJobs', () => {
        it('invokes listHyperparameterTuningJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListHyperparameterTuningJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob()),
            ];
            client.innerApiCalls.listHyperparameterTuningJobs = stubSimpleCall(expectedResponse);
            const [response] = await client.listHyperparameterTuningJobs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listHyperparameterTuningJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listHyperparameterTuningJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listHyperparameterTuningJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listHyperparameterTuningJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listHyperparameterTuningJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listHyperparameterTuningJobs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listHyperparameterTuningJobs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listHyperparameterTuningJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listHyperparameterTuningJobs as SinonStub)
        ...
        it('invokes listHyperparameterTuningJobsStream without error', async () => {
            ...
            client.descriptors.page.listHyperparameterTuningJobs.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listHyperparameterTuningJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listHyperparameterTuningJobs, request));
            assert(
                (client.descriptors.page.listHyperparameterTuningJobs.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listHyperparameterTuningJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listHyperparameterTuningJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listHyperparameterTuningJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob) => {
        ...
        it('uses async iteration with listHyperparameterTuningJobs without error', async () => {
            ...
            client.descriptors.page.listHyperparameterTuningJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listHyperparameterTuningJobs.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listHyperparameterTuningJobs.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listHyperparameterTuningJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listHyperparameterTuningJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listHyperparameterTuningJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.IHyperparameterTuningJob[] = [];
                for await (const resource of iterable) {
    ...
    describe('listNasJobs', () => {
        it('invokes listNasJobs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListNasJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListNasJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.NasJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.NasJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.NasJob()),
            ];
            client.innerApiCalls.listNasJobs = stubSimpleCall(expectedResponse);
            const [response] = await client.listNasJobs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listNasJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listNasJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listNasJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listNasJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listNasJobs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.INasJob[]|null) => {
        ...
        it('invokes listNasJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listNasJobs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listNasJobs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listNasJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listNasJobs as SinonStub)
        ...
        it('invokes listNasJobsStream without error', async () => {
            ...
            client.descriptors.page.listNasJobs.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listNasJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.NasJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.NasJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listNasJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listNasJobs, request));
            assert(
        ...
        it('invokes listNasJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listNasJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listNasJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.NasJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.NasJob) => {
        ...
        it('uses async iteration with listNasJobs without error', async () => {
            ...
            client.descriptors.page.listNasJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.INasJob[] = [];
            const iterable = client.listNasJobsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
        ...
        it('uses async iteration with listNasJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listNasJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listNasJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.INasJob[] = [];
                for await (const resource of iterable) {
    ...
    describe('listNasTrialDetails', () => {
        it('invokes listNasTrialDetails without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListNasTrialDetailsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListNasTrialDetailsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.NasTrialDetail()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.NasTrialDetail()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.NasTrialDetail()),
            ];
            client.innerApiCalls.listNasTrialDetails = stubSimpleCall(expectedResponse);
            const [response] = await client.listNasTrialDetails(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listNasTrialDetails as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listNasTrialDetails as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listNasTrialDetails without error using callback', async () => {
            ...
            client.innerApiCalls.listNasTrialDetails = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listNasTrialDetails(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.INasTrialDetail[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listNasTrialDetails with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listNasTrialDetails = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listNasTrialDetails(request), expectedError);
            const actualRequest = (client.innerApiCalls.listNasTrialDetails as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listNasTrialDetails as SinonStub)
        ...
        it('invokes listNasTrialDetailsStream without error', async () => {
            ...
            client.descriptors.page.listNasTrialDetails.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listNasTrialDetailsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.NasTrialDetail[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.NasTrialDetail) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listNasTrialDetails.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listNasTrialDetails, request));
            assert(
        ...
        it('invokes listNasTrialDetailsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listNasTrialDetails.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listNasTrialDetailsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.NasTrialDetail[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.NasTrialDetail) => {
        ...
        it('uses async iteration with listNasTrialDetails without error', async () => {
            ...
            client.descriptors.page.listNasTrialDetails.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.INasTrialDetail[] = [];
            const iterable = client.listNasTrialDetailsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
        ...
        it('uses async iteration with listNasTrialDetails with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listNasTrialDetails.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listNasTrialDetailsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.INasTrialDetail[] = [];
                for await (const resource of iterable) {
    ...
    describe('listBatchPredictionJobs', () => {
        it('invokes listBatchPredictionJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListBatchPredictionJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.BatchPredictionJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.BatchPredictionJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.BatchPredictionJob()),
            ];
            client.innerApiCalls.listBatchPredictionJobs = stubSimpleCall(expectedResponse);
            const [response] = await client.listBatchPredictionJobs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listBatchPredictionJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBatchPredictionJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listBatchPredictionJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listBatchPredictionJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listBatchPredictionJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listBatchPredictionJobs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listBatchPredictionJobs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listBatchPredictionJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listBatchPredictionJobs as SinonStub)
        ...
        it('invokes listBatchPredictionJobsStream without error', async () => {
            ...
            client.descriptors.page.listBatchPredictionJobs.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.BatchPredictionJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listBatchPredictionJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listBatchPredictionJobs, request));
            assert(
                (client.descriptors.page.listBatchPredictionJobs.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listBatchPredictionJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBatchPredictionJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listBatchPredictionJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.BatchPredictionJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.BatchPredictionJob) => {
        ...
        it('uses async iteration with listBatchPredictionJobs without error', async () => {
            ...
            client.descriptors.page.listBatchPredictionJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listBatchPredictionJobs.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listBatchPredictionJobs.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listBatchPredictionJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listBatchPredictionJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listBatchPredictionJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.IBatchPredictionJob[] = [];
                for await (const resource of iterable) {
    ...
    describe('searchModelDeploymentMonitoringStatsAnomalies', () => {
        it('invokes searchModelDeploymentMonitoringStatsAnomalies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.SearchModelDeploymentMonitoringStatsAnomaliesRequest', ['modelDeploymentMonitoringJob']);
            request.modelDeploymentMonitoringJob = defaultValue1;
            const expectedHeaderRequestParams = `model_deployment_monitoring_job=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies()),
            ];
            client.innerApiCalls.searchModelDeploymentMonitoringStatsAnomalies = stubSimpleCall(expectedResponse);
            const [response] = await client.searchModelDeploymentMonitoringStatsAnomalies(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchModelDeploymentMonitoringStatsAnomalies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchModelDeploymentMonitoringStatsAnomalies as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchModelDeploymentMonitoringStatsAnomalies without error using callback', async () => {
            ...
            client.innerApiCalls.searchModelDeploymentMonitoringStatsAnomalies = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchModelDeploymentMonitoringStatsAnomalies(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IModelMonitoringStatsAnomalies[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchModelDeploymentMonitoringStatsAnomalies with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.searchModelDeploymentMonitoringStatsAnomalies = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.searchModelDeploymentMonitoringStatsAnomalies(request), expectedError);
            const actualRequest = (client.innerApiCalls.searchModelDeploymentMonitoringStatsAnomalies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchModelDeploymentMonitoringStatsAnomalies as SinonStub)
        ...
        it('invokes searchModelDeploymentMonitoringStatsAnomaliesStream without error', async () => {
            ...
            client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchModelDeploymentMonitoringStatsAnomaliesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchModelDeploymentMonitoringStatsAnomalies, request));
            assert(
                (client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes searchModelDeploymentMonitoringStatsAnomaliesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `model_deployment_monitoring_job=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchModelDeploymentMonitoringStatsAnomaliesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies) => {
        ...
        it('uses async iteration with searchModelDeploymentMonitoringStatsAnomalies without error', async () => {
            ...
            client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with searchModelDeploymentMonitoringStatsAnomalies with error', async () => {
            ...
            const expectedHeaderRequestParams = `model_deployment_monitoring_job=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchModelDeploymentMonitoringStatsAnomaliesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.IModelMonitoringStatsAnomalies[] = [];
                for await (const resource of iterable) {
    ...
    describe('listModelDeploymentMonitoringJobs', () => {
        it('invokes listModelDeploymentMonitoringJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListModelDeploymentMonitoringJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob()),
            ];
            client.innerApiCalls.listModelDeploymentMonitoringJobs = stubSimpleCall(expectedResponse);
            const [response] = await client.listModelDeploymentMonitoringJobs(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listModelDeploymentMonitoringJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listModelDeploymentMonitoringJobs as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listModelDeploymentMonitoringJobs without error using callback', async () => {
            ...
            client.innerApiCalls.listModelDeploymentMonitoringJobs = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listModelDeploymentMonitoringJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listModelDeploymentMonitoringJobs = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listModelDeploymentMonitoringJobs(request), expectedError);
            const actualRequest = (client.innerApiCalls.listModelDeploymentMonitoringJobs as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listModelDeploymentMonitoringJobs as SinonStub)
        ...
        it('invokes listModelDeploymentMonitoringJobsStream without error', async () => {
            ...
            client.descriptors.page.listModelDeploymentMonitoringJobs.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listModelDeploymentMonitoringJobs.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listModelDeploymentMonitoringJobs, request));
            assert(
                (client.descriptors.page.listModelDeploymentMonitoringJobs.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listModelDeploymentMonitoringJobsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listModelDeploymentMonitoringJobs.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listModelDeploymentMonitoringJobsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob) => {
        ...
        it('uses async iteration with listModelDeploymentMonitoringJobs without error', async () => {
            ...
            client.descriptors.page.listModelDeploymentMonitoringJobs.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listModelDeploymentMonitoringJobs.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listModelDeploymentMonitoringJobs.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listModelDeploymentMonitoringJobs with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listModelDeploymentMonitoringJobs.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listModelDeploymentMonitoringJobsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.aiplatform.v1beta1.IModelDeploymentMonitoringJob[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('projectLocationReasoningEngineSession', async () => {
            ...
            it('projectLocationReasoningEngineSessionPath', () => {
                const result = client.projectLocationReasoningEngineSessionPath("projectValue", "locationValue", "reasoningEngineValue", "sessionValue");
                assert.strictEqual(result, fakePath);
            ...
            it('matchProjectFromProjectLocationReasoningEngineSessionName', () => {
                const result = client.matchProjectFromProjectLocationReasoningEngineSessionName(fakePath);
                assert.strictEqual(result, "projectValue");
            ...
            it('matchLocationFromProjectLocationReasoningEngineSessionName', () => {
                const result = client.matchLocationFromProjectLocationReasoningEngineSessionName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationReasoningEngineSessionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchReasoningEngineFromProjectLocationReasoningEngineSessionName', () => {
                const result = client.matchReasoningEngineFromProjectLocationReasoningEngineSessionName(fakePath);
            ...
            it('matchSessionFromProjectLocationReasoningEngineSessionName', () => {
                const result = client.matchSessionFromProjectLocationReasoningEngineSessionName(fakePath);
        ...
        describe('projectLocationReasoningEngineSessionEvent', async () => {
            ...
            it('projectLocationReasoningEngineSessionEventPath', () => {
                const result = client.projectLocationReasoningEngineSessionEventPath("projectValue", "locationValue", "reasoningEngineValue", "sessionValue", "eventValue");
                assert.strictEqual(result, fakePath);
            ...
            it('matchProjectFromProjectLocationReasoningEngineSessionEventName', () => {
                const result = client.matchProjectFromProjectLocationReasoningEngineSessionEventName(fakePath);
                assert.strictEqual(result, "projectValue");
            ...
            it('matchLocationFromProjectLocationReasoningEngineSessionEventName', () => {
                const result = client.matchLocationFromProjectLocationReasoningEngineSessionEventName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationReasoningEngineSessionEventPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchReasoningEngineFromProjectLocationReasoningEngineSessionEventName', () => {
                const result = client.matchReasoningEngineFromProjectLocationReasoningEngineSessionEventName(fakePath);
                assert.strictEqual(result, "reasoningEngineValue");
                assert((client.pathTemplates.projectLocationReasoningEngineSessionEventPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchSessionFromProjectLocationReasoningEngineSessionEventName', () => {
                const result = client.matchSessionFromProjectLocationReasoningEngineSessionEventName(fakePath);
                assert.strictEqual(result, "sessionValue");
                assert((client.pathTemplates.projectLocationReasoningEngineSessionEventPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEventFromProjectLocationReasoningEngineSessionEventName', () => {
                const result = client.matchEventFromProjectLocationReasoningEngineSessionEventName(fakePath);
        ...
        describe('projectLocationSession', async () => {
            ...
            it('projectLocationSessionPath', () => {
                const result = client.projectLocationSessionPath("projectValue", "locationValue", "sessionValue");
                assert.strictEqual(result, fakePath);
            ...
            it('matchProjectFromProjectLocationSessionName', () => {
                const result = client.matchProjectFromProjectLocationSessionName(fakePath);
                assert.strictEqual(result, "projectValue");
            ...
            it('matchLocationFromProjectLocationSessionName', () => {
                const result = client.matchLocationFromProjectLocationSessionName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationSessionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchSessionFromProjectLocationSessionName', () => {
                const result = client.matchSessionFromProjectLocationSessionName(fakePath);
                assert.strictEqual(result, "sessionValue");
                assert((client.pathTemplates.projectLocationSessionPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationSessionEvent', async () => {
            ...
            it('projectLocationSessionEventPath', () => {
                const result = client.projectLocationSessionEventPath("projectValue", "locationValue", "sessionValue", "eventValue");
                assert.strictEqual(result, fakePath);
            ...
            it('matchProjectFromProjectLocationSessionEventName', () => {
                const result = client.matchProjectFromProjectLocationSessionEventName(fakePath);
                assert.strictEqual(result, "projectValue");
            ...
            it('matchLocationFromProjectLocationSessionEventName', () => {
                const result = client.matchLocationFromProjectLocationSessionEventName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationSessionEventPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchSessionFromProjectLocationSessionEventName', () => {
                const result = client.matchSessionFromProjectLocationSessionEventName(fakePath);
                assert.strictEqual(result, "sessionValue");
                assert((client.pathTemplates.projectLocationSessionEventPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchEventFromProjectLocationSessionEventName', () => {
                const result = client.matchEventFromProjectLocationSessionEventName(fakePath);
                assert.strictEqual(result, "eventValue");
                assert((client.pathTemplates.projectLocationSessionEventPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
