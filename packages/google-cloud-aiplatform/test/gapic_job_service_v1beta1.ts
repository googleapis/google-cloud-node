...
describe('v1beta1.JobServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          jobserviceModule.v1beta1.JobServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          jobserviceModule.v1beta1.JobServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('invokes createCustomJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createCustomJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.ICustomJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createDataLabelingJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createDataLabelingJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IDataLabelingJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createHyperparameterTuningJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createHyperparameterTuningJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IHyperparameterTuningJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createNasJob', () => {
    it('invokes createNasJob without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createNasJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createNasJob as SinonStub
    ...
    it('invokes createNasJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createNasJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.INasJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createNasJob with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createNasJob = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('getNasJob', () => {
    it('invokes getNasJob without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getNasJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getNasJob as SinonStub
    ...
    it('invokes getNasJob without error using callback', async () => {
      ...
      client.innerApiCalls.getNasJob =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getNasJob(
          request,
  ...
  describe('cancelNasJob', () => {
    it('invokes cancelNasJob without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.cancelNasJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.cancelNasJob as SinonStub
    ...
    it('invokes cancelNasJob without error using callback', async () => {
      ...
      client.innerApiCalls.cancelNasJob =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.cancelNasJob(
          request,
    ...
    it('invokes cancelNasJob with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.cancelNasJob = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('getNasTrialDetail', () => {
    it('invokes getNasTrialDetail without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getNasTrialDetail as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getNasTrialDetail as SinonStub
    ...
    it('invokes getNasTrialDetail without error using callback', async () => {
      ...
      client.innerApiCalls.getNasTrialDetail =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getNasTrialDetail(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.INasTrialDetail | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getNasTrialDetail with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getNasTrialDetail = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes createBatchPredictionJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createBatchPredictionJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IBatchPredictionJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createModelDeploymentMonitoringJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createModelDeploymentMonitoringJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IModelDeploymentMonitoringJob | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('deleteNasJob', () => {
    it('invokes deleteNasJob without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteNasJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteNasJob as SinonStub
    ...
    it('invokes deleteNasJob without error using callback', async () => {
      ...
      client.innerApiCalls.deleteNasJob =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.deleteNasJob(
          request,
    ...
    it('invokes deleteNasJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteNasJob = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listDataLabelingJobsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.DataLabelingJob
          ) => {
            responses.push(response);
          }
        );
    ...
    it('invokes listHyperparameterTuningJobsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob
          ) => {
            responses.push(response);
          }
        );
  ...
  describe('listNasJobs', () => {
    it('invokes listNasJobs without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listNasJobs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listNasJobs as SinonStub
    ...
    it('invokes listNasJobs without error using callback', async () => {
      ...
      client.innerApiCalls.listNasJobs =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listNasJobs(
          request,
    ...
    it('invokes listNasJobsStream without error', async () => {
      ...
      client.descriptors.page.listNasJobs.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.NasJob) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listNasJobs.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listNasJobs, request)
      );
      assert(
        (client.descriptors.page.listNasJobs.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listNasJobsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listNasJobs.createStream = stubPageStreamingCall(
        undefined,
        expectedError
      );
      const stream = await client.listNasJobsStream(request);
    ...
    it('uses async iteration with listNasJobs without error', async () => {
      ...
      client.descriptors.page.listNasJobs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      ...
      assert.deepStrictEqual(responses, expectedResponse);
      assert.deepStrictEqual(
        (client.descriptors.page.listNasJobs.asyncIterate as SinonStub).getCall(
          0
        ).args[1],
        request
      );
    ...
    it('uses async iteration with listNasJobs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listNasJobs.asyncIterate = stubAsyncIterationCall(
        undefined,
        expectedError
      );
      const iterable = await client.listNasJobsAsync(request);
  ...
  describe('listNasTrialDetails', () => {
    it('invokes listNasTrialDetails without error', async () => {
      ...
      client.innerApiCalls.listNasTrialDetails =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listNasTrialDetails(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listNasTrialDetails as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listNasTrialDetails as SinonStub
    ...
    it('invokes listNasTrialDetails with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listNasTrialDetails = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listNasTrialDetailsStream without error', async () => {
      ...
      client.descriptors.page.listNasTrialDetails.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.NasTrialDetail) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listNasTrialDetails.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listNasTrialDetails, request)
      );
      assert(
        (client.descriptors.page.listNasTrialDetails.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listNasTrialDetails without error', async () => {
      ...
      client.descriptors.page.listNasTrialDetails.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
    ...
    it('invokes listBatchPredictionJobsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.BatchPredictionJob
          ) => {
            responses.push(response);
          }
        );
  ...
  describe('searchModelDeploymentMonitoringStatsAnomalies', () => {
    ...
    it('invokes searchModelDeploymentMonitoringStatsAnomaliesStream without error', async () => {
      ...
      client.descriptors.page.searchModelDeploymentMonitoringStatsAnomalies.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream =
        await client.searchModelDeploymentMonitoringStatsAnomaliesStream(
          request
        );
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies
          ) => {
            responses.push(response);
          }
        );
    ...
    it('uses async iteration with searchModelDeploymentMonitoringStatsAnomalies without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1beta1.IModelMonitoringStatsAnomalies[] =
        [];
      const iterable =
        await client.searchModelDeploymentMonitoringStatsAnomaliesAsync(
          request
        );
      for await (const resource of iterable) {
        responses.push(resource!);
  ...
  describe('listModelDeploymentMonitoringJobs', () => {
    ...
    it('invokes listModelDeploymentMonitoringJobsStream without error', async () => {
      ...
      client.descriptors.page.listModelDeploymentMonitoringJobs.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream =
        await client.listModelDeploymentMonitoringJobsStream(request);
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob
          ) => {
            responses.push(response);
          }
        );
    ...
    it('uses async iteration with listModelDeploymentMonitoringJobs without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1beta1.IModelDeploymentMonitoringJob[] =
        [];
      const iterable =
        await client.listModelDeploymentMonitoringJobsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('exampleStore', async () => {
      ...
      await client.initialize();
      client.pathTemplates.exampleStorePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.exampleStorePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('exampleStorePath', async () => {
        const result = await client.exampleStorePath(
          'projectValue',
          'locationValue',
          'exampleStoreValue'
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.exampleStorePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      });
      ...
      it('matchProjectFromExampleStoreName', async () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.exampleStorePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath)
        );
      });
      ...
      it('matchExampleStoreFromExampleStoreName', async () => {
        const result =
          await client.matchExampleStoreFromExampleStoreName(fakePath);
    ...
    describe('extension', async () => {
      ...
      it('extensionPath', async () => {
        const result = await client.extensionPath(
          'projectValue',
          'locationValue',
          'extensionValue'
        );
    ...
    describe('featureMonitor', async () => {
      ...
      it('featureMonitorPath', async () => {
        const result = await client.featureMonitorPath(
          'projectValue',
          'locationValue',
          'featureGroupValue',
          'featureMonitorValue'
      ...
      it('matchProjectFromFeatureMonitorName', async () => {
        const result =
          await client.matchProjectFromFeatureMonitorName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromFeatureMonitorName', async () => {
        const result =
          await client.matchLocationFromFeatureMonitorName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (client.pathTemplates.featureMonitorPathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchFeatureGroupFromFeatureMonitorName', async () => {
        const result =
          await client.matchFeatureGroupFromFeatureMonitorName(fakePath);
        assert.strictEqual(result, 'featureGroupValue');
        assert(
          (client.pathTemplates.featureMonitorPathTemplate.match as SinonStub)
            .getCall(-1)
      ...
      it('matchFeatureMonitorFromFeatureMonitorName', async () => {
        const result =
          await client.matchFeatureMonitorFromFeatureMonitorName(fakePath);
    ...
    describe('featureMonitorJob', async () => {
      ...
      it('featureMonitorJobPath', async () => {
        const result = await client.featureMonitorJobPath(
          'projectValue',
          'locationValue',
          'featureGroupValue',
          'featureMonitorValue',
      ...
      it('matchProjectFromFeatureMonitorJobName', async () => {
        const result =
          await client.matchProjectFromFeatureMonitorJobName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.featureMonitorJobPathTemplate
      ...
      it('matchLocationFromFeatureMonitorJobName', async () => {
        const result =
          await client.matchLocationFromFeatureMonitorJobName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.featureMonitorJobPathTemplate
      ...
      it('matchFeatureGroupFromFeatureMonitorJobName', async () => {
        const result =
          await client.matchFeatureGroupFromFeatureMonitorJobName(fakePath);
        assert.strictEqual(result, 'featureGroupValue');
        assert(
          (
            client.pathTemplates.featureMonitorJobPathTemplate
      ...
      it('matchFeatureMonitorFromFeatureMonitorJobName', async () => {
        const result =
          await client.matchFeatureMonitorFromFeatureMonitorJobName(fakePath);
        assert.strictEqual(result, 'featureMonitorValue');
        assert(
          (
            client.pathTemplates.featureMonitorJobPathTemplate
      ...
      it('matchFeatureMonitorJobFromFeatureMonitorJobName', async () => {
        const result =
          await client.matchFeatureMonitorJobFromFeatureMonitorJobName(
            fakePath
          );
    ...
    describe('modelMonitor', async () => {
      ...
      it('modelMonitorPath', async () => {
        const result = await client.modelMonitorPath(
          'projectValue',
          'locationValue',
          'modelMonitorValue'
        );
      ...
      it('matchModelMonitorFromModelMonitorName', async () => {
        const result =
          await client.matchModelMonitorFromModelMonitorName(fakePath);
    ...
    describe('modelMonitoringJob', async () => {
      ...
      it('modelMonitoringJobPath', async () => {
        const result = await client.modelMonitoringJobPath(
          'projectValue',
          'locationValue',
          'modelMonitorValue',
      ...
      it('matchProjectFromModelMonitoringJobName', async () => {
        const result =
          await client.matchProjectFromModelMonitoringJobName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.modelMonitoringJobPathTemplate
      ...
      it('matchLocationFromModelMonitoringJobName', async () => {
        const result =
          await client.matchLocationFromModelMonitoringJobName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.modelMonitoringJobPathTemplate
      ...
      it('matchModelMonitorFromModelMonitoringJobName', async () => {
        const result =
          await client.matchModelMonitorFromModelMonitoringJobName(fakePath);
        assert.strictEqual(result, 'modelMonitorValue');
        assert(
          (
            client.pathTemplates.modelMonitoringJobPathTemplate
      ...
      it('matchModelMonitoringJobFromModelMonitoringJobName', async () => {
        const result =
          await client.matchModelMonitoringJobFromModelMonitoringJobName(
            fakePath
          );
    ...
    describe('projectLocationReasoningEngineSession', async () => {
      ...
      it('projectLocationReasoningEngineSessionPath', async () => {
        const result = await client.projectLocationReasoningEngineSessionPath(
          'projectValue',
          'locationValue',
        ...
        assert(
          (
            client.pathTemplates
              .projectLocationReasoningEngineSessionPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters)
      ...
      it('matchProjectFromProjectLocationReasoningEngineSessionName', async () => {
        const result =
          await client.matchProjectFromProjectLocationReasoningEngineSessionName(
            fakePath
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationReasoningEngineSessionName', async () => {
        const result =
          await client.matchLocationFromProjectLocationReasoningEngineSessionName(
            fakePath
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchReasoningEngineFromProjectLocationReasoningEngineSessionName', async () => {
        const result =
          await client.matchReasoningEngineFromProjectLocationReasoningEngineSessionName(
            fakePath
          );
      ...
      it('matchSessionFromProjectLocationReasoningEngineSessionName', async () => {
        const result =
          await client.matchSessionFromProjectLocationReasoningEngineSessionName(
            fakePath
          );
    ...
    describe('projectLocationReasoningEngineSessionEvent', async () => {
      const fakePath =
        '/rendered/path/projectLocationReasoningEngineSessionEvent';
      const expectedParameters = {
        project: 'projectValue',
        location: 'locationValue',
        reasoning_engine: 'reasoningEngineValue',
      ...
      it('projectLocationReasoningEngineSessionEventPath', async () => {
        const result =
          await client.projectLocationReasoningEngineSessionEventPath(
            'projectValue',
            'locationValue',
            'reasoningEngineValue',
            'sessionValue',
        ...
        assert(
          (
            client.pathTemplates
              .projectLocationReasoningEngineSessionEventPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters)
      ...
      it('matchProjectFromProjectLocationReasoningEngineSessionEventName', async () => {
        const result =
          await client.matchProjectFromProjectLocationReasoningEngineSessionEventName(
            fakePath
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationReasoningEngineSessionEventName', async () => {
        const result =
          await client.matchLocationFromProjectLocationReasoningEngineSessionEventName(
            fakePath
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchReasoningEngineFromProjectLocationReasoningEngineSessionEventName', async () => {
        const result =
          await client.matchReasoningEngineFromProjectLocationReasoningEngineSessionEventName(
            fakePath
          );
        assert.strictEqual(result, 'reasoningEngineValue');
        assert(
      ...
      it('matchSessionFromProjectLocationReasoningEngineSessionEventName', async () => {
        const result =
          await client.matchSessionFromProjectLocationReasoningEngineSessionEventName(
            fakePath
          );
        assert.strictEqual(result, 'sessionValue');
        assert(
      ...
      it('matchEventFromProjectLocationReasoningEngineSessionEventName', async () => {
        const result =
          await client.matchEventFromProjectLocationReasoningEngineSessionEventName(
            fakePath
          );
    ...
    describe('projectLocationSession', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectLocationSessionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationSessionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationSessionPath', async () => {
        const result = await client.projectLocationSessionPath(
          'projectValue',
          'locationValue',
          'sessionValue'
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationSessionPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters)
      ...
      it('matchProjectFromProjectLocationSessionName', async () => {
        const result =
          await client.matchProjectFromProjectLocationSessionName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationSessionPathTemplate
      ...
      it('matchLocationFromProjectLocationSessionName', async () => {
        const result =
          await client.matchLocationFromProjectLocationSessionName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationSessionPathTemplate
      ...
      it('matchSessionFromProjectLocationSessionName', async () => {
        const result =
          await client.matchSessionFromProjectLocationSessionName(fakePath);
        assert.strictEqual(result, 'sessionValue');
        assert(
          (
            client.pathTemplates.projectLocationSessionPathTemplate
    ...
    describe('projectLocationSessionEvent', async () => {
      ...
      client.pathTemplates.projectLocationSessionEventPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.projectLocationSessionEventPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationSessionEventPath', async () => {
        const result = await client.projectLocationSessionEventPath(
          'projectValue',
          'locationValue',
          'sessionValue',
          'eventValue'
        ...
        assert(
          (
            client.pathTemplates.projectLocationSessionEventPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters)
      ...
      it('matchProjectFromProjectLocationSessionEventName', async () => {
        const result =
          await client.matchProjectFromProjectLocationSessionEventName(
            fakePath
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationSessionEventName', async () => {
        const result =
          await client.matchLocationFromProjectLocationSessionEventName(
            fakePath
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchSessionFromProjectLocationSessionEventName', async () => {
        const result =
          await client.matchSessionFromProjectLocationSessionEventName(
            fakePath
          );
        assert.strictEqual(result, 'sessionValue');
        assert(
      ...
      it('matchEventFromProjectLocationSessionEventName', async () => {
        const result =
          await client.matchEventFromProjectLocationSessionEventName(fakePath);
        assert.strictEqual(result, 'eventValue');
        assert(
          (
            client.pathTemplates.projectLocationSessionEventPathTemplate
