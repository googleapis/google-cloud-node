...
describe('v1beta1.EndpointServiceClient', () => {
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', async () => {
          ...
          const client =
            new endpointserviceModule.v1beta1.EndpointServiceClient();
          const servicePath = await client.apiEndpoint;
          assert.strictEqual(servicePath, 'aiplatform.example.com');
          if (saved) {
  ...
  describe('fetchPublisherModelConfig', () => {
    it('invokes fetchPublisherModelConfig without error', async () => {
      ...
      client.innerApiCalls.fetchPublisherModelConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.fetchPublisherModelConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.fetchPublisherModelConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.fetchPublisherModelConfig as SinonStub
    ...
    it('invokes fetchPublisherModelConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.fetchPublisherModelConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes fetchPublisherModelConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.fetchPublisherModelConfig = stubSimpleCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.fetchPublisherModelConfig(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.fetchPublisherModelConfig as SinonStub
  ...
  describe('setPublisherModelConfig', () => {
    it('invokes setPublisherModelConfig without error', async () => {
      ...
      client.innerApiCalls.setPublisherModelConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.setPublisherModelConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.setPublisherModelConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.setPublisherModelConfig as SinonStub
    ...
    it('invokes setPublisherModelConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.setPublisherModelConfig = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(
        client.setPublisherModelConfig(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.setPublisherModelConfig as SinonStub
    ...
    it('invokes checkSetPublisherModelConfigProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkSetPublisherModelConfigProgress(
          expectedResponse.name
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkSetPublisherModelConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkSetPublisherModelConfigProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
