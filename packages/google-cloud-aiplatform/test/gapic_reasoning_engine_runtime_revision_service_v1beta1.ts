...
describe('v1beta1.ReasoningEngineRuntimeRevisionServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.reasoningEngineRuntimeRevisionServiceStub, undefined);
    ...
    describe('getReasoningEngineRuntimeRevision', () => {
        it('invokes getReasoningEngineRuntimeRevision without error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetReasoningEngineRuntimeRevisionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.GetReasoningEngineRuntimeRevisionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision()
            );
            client.innerApiCalls.getReasoningEngineRuntimeRevision = stubSimpleCall(expectedResponse);
            const [response] = await client.getReasoningEngineRuntimeRevision(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getReasoningEngineRuntimeRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getReasoningEngineRuntimeRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getReasoningEngineRuntimeRevision without error using callback', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getReasoningEngineRuntimeRevision = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getReasoningEngineRuntimeRevision(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getReasoningEngineRuntimeRevision with error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getReasoningEngineRuntimeRevision = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getReasoningEngineRuntimeRevision(request), expectedError);
            const actualRequest = (client.innerApiCalls.getReasoningEngineRuntimeRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getReasoningEngineRuntimeRevision as SinonStub)
        ...
        it('invokes getReasoningEngineRuntimeRevision with closed client', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('deleteReasoningEngineRuntimeRevision', () => {
        it('invokes deleteReasoningEngineRuntimeRevision without error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRuntimeRevisionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRuntimeRevisionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteReasoningEngineRuntimeRevision = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteReasoningEngineRuntimeRevision(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteReasoningEngineRuntimeRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteReasoningEngineRuntimeRevision as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes deleteReasoningEngineRuntimeRevision without error using callback', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteReasoningEngineRuntimeRevision = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteReasoningEngineRuntimeRevision(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteReasoningEngineRuntimeRevisionOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteReasoningEngineRuntimeRevisionOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteReasoningEngineRuntimeRevision as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes deleteReasoningEngineRuntimeRevision with call error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteReasoningEngineRuntimeRevision = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteReasoningEngineRuntimeRevision(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteReasoningEngineRuntimeRevision as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteReasoningEngineRuntimeRevision as SinonStub)
        ...
        it('invokes deleteReasoningEngineRuntimeRevision with LRO error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteReasoningEngineRuntimeRevision = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteReasoningEngineRuntimeRevision(request);
        ...
        it('invokes checkDeleteReasoningEngineRuntimeRevisionProgress without error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkDeleteReasoningEngineRuntimeRevisionProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeleteReasoningEngineRuntimeRevisionProgress with error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkDeleteReasoningEngineRuntimeRevisionProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listReasoningEngineRuntimeRevisions', () => {
        it('invokes listReasoningEngineRuntimeRevisions without error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListReasoningEngineRuntimeRevisionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListReasoningEngineRuntimeRevisionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision()),
            ];
            client.innerApiCalls.listReasoningEngineRuntimeRevisions = stubSimpleCall(expectedResponse);
            const [response] = await client.listReasoningEngineRuntimeRevisions(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listReasoningEngineRuntimeRevisions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReasoningEngineRuntimeRevisions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes listReasoningEngineRuntimeRevisions without error using callback', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listReasoningEngineRuntimeRevisions = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listReasoningEngineRuntimeRevisions(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listReasoningEngineRuntimeRevisions with error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listReasoningEngineRuntimeRevisions = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listReasoningEngineRuntimeRevisions(request), expectedError);
            const actualRequest = (client.innerApiCalls.listReasoningEngineRuntimeRevisions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReasoningEngineRuntimeRevisions as SinonStub)
        ...
        it('invokes listReasoningEngineRuntimeRevisionsStream without error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listReasoningEngineRuntimeRevisions.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listReasoningEngineRuntimeRevisionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision) => {
            ...
            assert((client.descriptors.page.listReasoningEngineRuntimeRevisions.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listReasoningEngineRuntimeRevisions, request));
            assert(
                (client.descriptors.page.listReasoningEngineRuntimeRevisions.createStream as SinonStub)
        ...
        it('invokes listReasoningEngineRuntimeRevisionsStream with error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReasoningEngineRuntimeRevisions.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listReasoningEngineRuntimeRevisionsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision) => {
        ...
        it('uses async iteration with listReasoningEngineRuntimeRevisions without error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.descriptors.page.listReasoningEngineRuntimeRevisions.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision[] = [];
            const iterable = client.listReasoningEngineRuntimeRevisionsAsync(request);
            for await (const resource of iterable) {
                responses.push(resource!);
            }
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listReasoningEngineRuntimeRevisions.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listReasoningEngineRuntimeRevisions with error', async () => {
            const client = new reasoningengineruntimerevisionserviceModule.v1beta1.ReasoningEngineRuntimeRevisionServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReasoningEngineRuntimeRevisions.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listReasoningEngineRuntimeRevisionsAsync(request);
