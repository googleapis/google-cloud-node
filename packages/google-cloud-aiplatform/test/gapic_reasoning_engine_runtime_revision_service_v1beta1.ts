...
describe('v1beta1.ReasoningEngineRuntimeRevisionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          reasoningengineruntimerevisionserviceModule.v1beta1
            .ReasoningEngineRuntimeRevisionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          reasoningengineruntimerevisionserviceModule.v1beta1
            .ReasoningEngineRuntimeRevisionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        reasoningengineruntimerevisionserviceModule.v1beta1
          .ReasoningEngineRuntimeRevisionServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(
        client.reasoningEngineRuntimeRevisionServiceStub,
        undefined,
      );
  ...
  describe('getReasoningEngineRuntimeRevision', () => {
    it('invokes getReasoningEngineRuntimeRevision without error', async () => {
      ...
      client.innerApiCalls.getReasoningEngineRuntimeRevision =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.getReasoningEngineRuntimeRevision(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getReasoningEngineRuntimeRevision as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getReasoningEngineRuntimeRevision without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getReasoningEngineRuntimeRevision(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getReasoningEngineRuntimeRevision with error', async () => {
      ...
      client.innerApiCalls.getReasoningEngineRuntimeRevision = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getReasoningEngineRuntimeRevision(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getReasoningEngineRuntimeRevision as SinonStub
  ...
  describe('deleteReasoningEngineRuntimeRevision', () => {
    it('invokes deleteReasoningEngineRuntimeRevision without error', async () => {
      ...
      client.innerApiCalls.deleteReasoningEngineRuntimeRevision =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.deleteReasoningEngineRuntimeRevision(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteReasoningEngineRuntimeRevision as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteReasoningEngineRuntimeRevision as SinonStub
        ...
        client.deleteReasoningEngineRuntimeRevision(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.aiplatform.v1beta1.IDeleteReasoningEngineRuntimeRevisionOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes deleteReasoningEngineRuntimeRevision with call error', async () => {
      ...
      await assert.rejects(
        client.deleteReasoningEngineRuntimeRevision(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteReasoningEngineRuntimeRevision as SinonStub
    ...
    it('invokes checkDeleteReasoningEngineRuntimeRevisionProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkDeleteReasoningEngineRuntimeRevisionProgress(
    ...
    it('invokes checkDeleteReasoningEngineRuntimeRevisionProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteReasoningEngineRuntimeRevisionProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listReasoningEngineRuntimeRevisions', () => {
    it('invokes listReasoningEngineRuntimeRevisions without error', async () => {
      ...
      client.innerApiCalls.listReasoningEngineRuntimeRevisions =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.listReasoningEngineRuntimeRevisions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listReasoningEngineRuntimeRevisions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listReasoningEngineRuntimeRevisions as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.listReasoningEngineRuntimeRevisions(
          ...
          (
            err?: Error | null,
            result?:
              | protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision[]
              | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listReasoningEngineRuntimeRevisions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listReasoningEngineRuntimeRevisions = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listReasoningEngineRuntimeRevisions(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listReasoningEngineRuntimeRevisions as SinonStub
    ...
    it('invokes listReasoningEngineRuntimeRevisionsStream without error', async () => {
      ...
      client.descriptors.page.listReasoningEngineRuntimeRevisions.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listReasoningEngineRuntimeRevisions
    ...
    it('uses async iteration with listReasoningEngineRuntimeRevisions without error', async () => {
      ...
      client.descriptors.page.listReasoningEngineRuntimeRevisions.asyncIterate =
