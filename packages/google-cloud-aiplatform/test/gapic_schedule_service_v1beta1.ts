...
describe('v1beta1.ScheduleServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = scheduleserviceModule.v1beta1.ScheduleServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = scheduleserviceModule.v1beta1.ScheduleServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new scheduleserviceModule.v1beta1.ScheduleServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new scheduleserviceModule.v1beta1.ScheduleServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new scheduleserviceModule.v1beta1.ScheduleServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new scheduleserviceModule.v1beta1.ScheduleServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = scheduleserviceModule.v1beta1.ScheduleServiceClient.port;
            assert(port);
    ...
    describe('createSchedule', () => {
        it('invokes createSchedule without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.CreateScheduleRequest()
            );
            const defaultValue1 =
        ...
        it('invokes createSchedule without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSchedule(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ISchedule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSchedule', () => {
        it('invokes getSchedule without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.GetScheduleRequest()
            );
            const defaultValue1 =
    ...
    describe('pauseSchedule', () => {
        it('invokes pauseSchedule without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.PauseScheduleRequest()
            );
            const defaultValue1 =
    ...
    describe('resumeSchedule', () => {
        it('invokes resumeSchedule without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ResumeScheduleRequest()
            );
            const defaultValue1 =
    ...
    describe('deleteSchedule', () => {
        it('invokes deleteSchedule without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.DeleteScheduleRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteScheduleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listSchedules', () => {
        it('invokes listSchedules without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.ListSchedulesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListSchedulesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Schedule()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Schedule()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Schedule()),
            ];
        ...
        it('invokes listSchedulesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.Schedule[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.Schedule) => {
        ...
        it('uses async iteration with listSchedules without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.ISchedule[] = [];
