...
describe('v1beta1.ModelServiceClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new modelserviceModule.v1beta1.ModelServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes batchImportEvaluatedAnnotations without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.batchImportEvaluatedAnnotations(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IBatchImportEvaluatedAnnotationsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listModels', () => {
    ...
    it('invokes listModelsStream without error', async () => {
      ...
      const stream = await client.listModelsStream(request);
      const promise = new Promise((resolve, reject) => {
    ...
    it('uses async iteration with listModels without error', async () => {
      ...
      const iterable = await client.listModelsAsync(request);
  ...
  describe('listModelVersions', () => {
    ...
    it('invokes listModelVersionsStream without error', async () => {
      ...
      client.descriptors.page.listModelVersions.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = await client.listModelVersionsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.aiplatform.v1beta1.Model[] = [];
        stream.on(
          'data',
    ...
    it('uses async iteration with listModelVersions without error', async () => {
      ...
      client.descriptors.page.listModelVersions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.aiplatform.v1beta1.IModel[] = [];
      const iterable = await client.listModelVersionsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
  ...
  describe('listModelVersionCheckpoints', () => {
    it('invokes listModelVersionCheckpoints without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1beta1.ModelVersionCheckpoint()
        ),
        generateSampleMessage(
          new protos.google.cloud.aiplatform.v1beta1.ModelVersionCheckpoint()
        ),
    ...
    it('invokes listModelVersionCheckpointsStream without error', async () => {
      ...
      client.descriptors.page.listModelVersionCheckpoints.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = await client.listModelVersionCheckpointsStream(request);
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.ModelVersionCheckpoint
          ) => {
            responses.push(response);
          }
        );
      ...
      assert(
        (
          ...
          .getCall(0)
          .calledWith(client.innerApiCalls.listModelVersionCheckpoints, request)
      );
      assert(
        (
          client.descriptors.page.listModelVersionCheckpoints
    ...
    it('uses async iteration with listModelVersionCheckpoints without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1beta1.IModelVersionCheckpoint[] =
        [];
      const iterable = await client.listModelVersionCheckpointsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
  ...
  describe('listModelEvaluations', () => {
    ...
    it('invokes listModelEvaluationsStream without error', async () => {
      ...
      client.descriptors.page.listModelEvaluations.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = await client.listModelEvaluationsStream(request);
      const promise = new Promise((resolve, reject) => {
    ...
    it('uses async iteration with listModelEvaluations without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1beta1.IModelEvaluation[] =
        [];
      const iterable = await client.listModelEvaluationsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
  ...
  describe('listModelEvaluationSlices', () => {
    ...
    it('invokes listModelEvaluationSlicesStream without error', async () => {
      ...
      client.descriptors.page.listModelEvaluationSlices.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = await client.listModelEvaluationSlicesStream(request);
      const promise = new Promise((resolve, reject) => {
    ...
    it('uses async iteration with listModelEvaluationSlices without error', async () => {
      ...
      const responses: protos.google.cloud.aiplatform.v1beta1.IModelEvaluationSlice[] =
        [];
      const iterable = await client.listModelEvaluationSlicesAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
