...
describe('v1beta1.ModelServiceClient', () => {
  ...
  describe('recommendSpec', () => {
    it('invokes recommendSpec without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.recommendSpec as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.recommendSpec as SinonStub
    ...
    it('invokes recommendSpec without error using callback', async () => {
      ...
      client.innerApiCalls.recommendSpec =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.recommendSpec(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IRecommendSpecResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes recommendSpec with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.recommendSpec = stubSimpleCall(
        undefined,
        expectedError,
      );
      ...
      const promise = new Promise((resolve, reject) => {
        client.listModelEvaluations(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.aiplatform.v1beta1.IModelEvaluation[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
