...
describe('v1.ReasoningEngineServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new reasoningengineserviceModule.v1.ReasoningEngineServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          reasoningengineserviceModule.v1.ReasoningEngineServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        reasoningengineserviceModule.v1.ReasoningEngineServiceClient.port;
      assert(port);
  ...
  describe('getReasoningEngine', () => {
    it('invokes getReasoningEngine without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.aiplatform.v1.GetReasoningEngineRequest',
        ['name'],
      );
      ...
      client.innerApiCalls.getReasoningEngine =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getReasoningEngine(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getReasoningEngine as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getReasoningEngine without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getReasoningEngine(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1.IReasoningEngine | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createReasoningEngine', () => {
    it('invokes createReasoningEngine without error', async () => {
      ...
      client.innerApiCalls.createReasoningEngine =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createReasoningEngine(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createReasoningEngine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createReasoningEngine as SinonStub
    ...
    it('invokes createReasoningEngine with call error', async () => {
      ...
      await assert.rejects(
        client.createReasoningEngine(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createReasoningEngine as SinonStub
    ...
    it('invokes checkCreateReasoningEngineProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateReasoningEngineProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateReasoningEngine', () => {
    it('invokes updateReasoningEngine without error', async () => {
      ...
      client.innerApiCalls.updateReasoningEngine =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateReasoningEngine(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateReasoningEngine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateReasoningEngine as SinonStub
    ...
    it('invokes updateReasoningEngine with call error', async () => {
      ...
      await assert.rejects(
        client.updateReasoningEngine(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateReasoningEngine as SinonStub
    ...
    it('invokes checkUpdateReasoningEngineProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateReasoningEngineProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteReasoningEngine', () => {
    it('invokes deleteReasoningEngine without error', async () => {
      ...
      client.innerApiCalls.deleteReasoningEngine =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteReasoningEngine(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteReasoningEngine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteReasoningEngine as SinonStub
    ...
    it('invokes deleteReasoningEngine with call error', async () => {
      ...
      await assert.rejects(
        client.deleteReasoningEngine(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteReasoningEngine as SinonStub
  ...
  describe('listReasoningEngines', () => {
    it('invokes listReasoningEngines without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listReasoningEngines as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listReasoningEngines as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.listReasoningEngines(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.aiplatform.v1.IReasoningEngine[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listReasoningEnginesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1.ReasoningEngine) => {
      ...
      assert(
        (client.descriptors.page.listReasoningEngines.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listReasoningEngines, request),
      );
      assert(
        (client.descriptors.page.listReasoningEngines.createStream as SinonStub)
          .getCall(0)
