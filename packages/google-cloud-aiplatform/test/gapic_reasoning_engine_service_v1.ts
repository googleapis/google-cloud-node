...
describe('v1.ReasoningEngineServiceClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new reasoningengineserviceModule.v1.ReasoningEngineServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = reasoningengineserviceModule.v1.ReasoningEngineServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = reasoningengineserviceModule.v1.ReasoningEngineServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new reasoningengineserviceModule.v1.ReasoningEngineServiceClient({universeDomain: 'example.com'});
            const servicePath = await client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new reasoningengineserviceModule.v1.ReasoningEngineServiceClient({universe_domain: 'example.com'});
            const servicePath = await client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new reasoningengineserviceModule.v1.ReasoningEngineServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = await client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new reasoningengineserviceModule.v1.ReasoningEngineServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = reasoningengineserviceModule.v1.ReasoningEngineServiceClient.port;
            assert(port);
    ...
    describe('getReasoningEngine', () => {
        it('invokes getReasoningEngine without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.GetReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.GetReasoningEngineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ReasoningEngine()
            );
            client.innerApiCalls.getReasoningEngine = stubSimpleCall(expectedResponse);
            const [response] = await client.getReasoningEngine(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getReasoningEngine as SinonStub)
        ...
        it('invokes getReasoningEngine without error using callback', async () => {
            ...
            client.innerApiCalls.getReasoningEngine = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getReasoningEngine(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IReasoningEngine|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getReasoningEngine with error', async () => {
            ...
            client.innerApiCalls.getReasoningEngine = stubSimpleCall(undefined, expectedError);
    ...
    describe('createReasoningEngine', () => {
        it('invokes createReasoningEngine without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.CreateReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.CreateReasoningEngineRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createReasoningEngine = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createReasoningEngine(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createReasoningEngine as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createReasoningEngine without error using callback', async () => {
            ...
            client.innerApiCalls.createReasoningEngine = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createReasoningEngine(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IReasoningEngine, protos.google.cloud.aiplatform.v1.ICreateReasoningEngineOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IReasoningEngine, protos.google.cloud.aiplatform.v1.ICreateReasoningEngineOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createReasoningEngine as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createReasoningEngine with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createReasoningEngine = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createReasoningEngine(request), expectedError);
            const actualRequest = (client.innerApiCalls.createReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createReasoningEngine as SinonStub)
        ...
        it('invokes createReasoningEngine with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createReasoningEngine = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createReasoningEngine(request);
        ...
        it('invokes checkCreateReasoningEngineProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateReasoningEngineProgress(expectedResponse.name);
        ...
        it('invokes checkCreateReasoningEngineProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateReasoningEngineProgress(''), expectedError);
    ...
    describe('updateReasoningEngine', () => {
        it('invokes updateReasoningEngine without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.UpdateReasoningEngineRequest()
            );
            request.reasoningEngine ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.UpdateReasoningEngineRequest', ['reasoningEngine', 'name']);
        ...
        it('invokes updateReasoningEngine without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateReasoningEngine(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1.IReasoningEngine, protos.google.cloud.aiplatform.v1.IUpdateReasoningEngineOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1.IReasoningEngine, protos.google.cloud.aiplatform.v1.IUpdateReasoningEngineOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateReasoningEngine as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteReasoningEngine', () => {
        it('invokes deleteReasoningEngine without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.DeleteReasoningEngineRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.DeleteReasoningEngineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.deleteReasoningEngine = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deleteReasoningEngine(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteReasoningEngine as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteReasoningEngine without error using callback', async () => {
            ...
            client.innerApiCalls.deleteReasoningEngine = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteReasoningEngine(
                    request,
                    (err?: Error|null,
        ...
        it('invokes deleteReasoningEngine with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteReasoningEngine = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deleteReasoningEngine(request), expectedError);
            const actualRequest = (client.innerApiCalls.deleteReasoningEngine as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteReasoningEngine as SinonStub)
        ...
        it('invokes deleteReasoningEngine with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteReasoningEngine = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deleteReasoningEngine(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.deleteReasoningEngine as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkDeleteReasoningEngineProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeleteReasoningEngineProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkDeleteReasoningEngineProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeleteReasoningEngineProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('listReasoningEngines', () => {
        it('invokes listReasoningEngines without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1.ListReasoningEnginesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1.ListReasoningEnginesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReasoningEngine()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReasoningEngine()),
              generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReasoningEngine()),
            ];
            client.innerApiCalls.listReasoningEngines = stubSimpleCall(expectedResponse);
            const [response] = await client.listReasoningEngines(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listReasoningEngines as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReasoningEngines as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listReasoningEngines without error using callback', async () => {
            ...
            client.innerApiCalls.listReasoningEngines = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listReasoningEngines(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1.IReasoningEngine[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listReasoningEngines with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listReasoningEngines = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listReasoningEngines(request), expectedError);
            const actualRequest = (client.innerApiCalls.listReasoningEngines as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listReasoningEngines as SinonStub)
        ...
        it('invokes listReasoningEnginesStream without error', async () => {
            ...
            client.descriptors.page.listReasoningEngines.createStream = stubPageStreamingCall(expectedResponse);
            const stream = await client.listReasoningEnginesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.ReasoningEngine[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.ReasoningEngine) => {
            ...
            assert((client.descriptors.page.listReasoningEngines.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listReasoningEngines, request));
            assert(
        ...
        it('invokes listReasoningEnginesStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReasoningEngines.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = await client.listReasoningEnginesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1.ReasoningEngine[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1.ReasoningEngine) => {
        ...
        it('uses async iteration with listReasoningEngines without error', async () => {
            ...
            client.descriptors.page.listReasoningEngines.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.aiplatform.v1.IReasoningEngine[] = [];
            const iterable = await client.listReasoningEnginesAsync(request);
        ...
        it('uses async iteration with listReasoningEngines with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listReasoningEngines.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = await client.listReasoningEnginesAsync(request);
