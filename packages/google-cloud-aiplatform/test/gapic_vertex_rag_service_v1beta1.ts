    ...
    it('invokes askContexts without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.askContexts(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IAskContextsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.asyncRetrieveContexts(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsResponse,
              protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
