...
describe('v1beta1.OnlineEvaluatorServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        onlineevaluatorserviceModule.v1beta1.OnlineEvaluatorServiceClient.port;
      assert(port);
  ...
  describe('getOnlineEvaluator', () => {
    it('invokes getOnlineEvaluator without error', async () => {
      ...
      client.innerApiCalls.getOnlineEvaluator =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getOnlineEvaluator(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getOnlineEvaluator as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getOnlineEvaluator without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getOnlineEvaluator(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getOnlineEvaluator with error', async () => {
      ...
      client.innerApiCalls.getOnlineEvaluator = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createOnlineEvaluator', () => {
    it('invokes createOnlineEvaluator without error', async () => {
      ...
      client.innerApiCalls.createOnlineEvaluator =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createOnlineEvaluator(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createOnlineEvaluator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createOnlineEvaluator as SinonStub
    ...
    it('invokes createOnlineEvaluator with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createOnlineEvaluator = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createOnlineEvaluator(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createOnlineEvaluator as SinonStub
    ...
    it('invokes checkCreateOnlineEvaluatorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateOnlineEvaluatorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateOnlineEvaluator', () => {
    it('invokes updateOnlineEvaluator without error', async () => {
      ...
      client.innerApiCalls.updateOnlineEvaluator =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateOnlineEvaluator(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateOnlineEvaluator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateOnlineEvaluator as SinonStub
    ...
    it('invokes updateOnlineEvaluator with call error', async () => {
      ...
      const expectedHeaderRequestParams = `online_evaluator.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateOnlineEvaluator = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateOnlineEvaluator(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateOnlineEvaluator as SinonStub
    ...
    it('invokes checkUpdateOnlineEvaluatorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateOnlineEvaluatorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteOnlineEvaluator', () => {
    it('invokes deleteOnlineEvaluator without error', async () => {
      ...
      client.innerApiCalls.deleteOnlineEvaluator =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteOnlineEvaluator(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteOnlineEvaluator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteOnlineEvaluator as SinonStub
    ...
    it('invokes deleteOnlineEvaluator with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteOnlineEvaluator = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteOnlineEvaluator(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteOnlineEvaluator as SinonStub
    ...
    it('invokes checkDeleteOnlineEvaluatorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteOnlineEvaluatorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('activateOnlineEvaluator', () => {
    it('invokes activateOnlineEvaluator without error', async () => {
      ...
      client.innerApiCalls.activateOnlineEvaluator =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.activateOnlineEvaluator(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.activateOnlineEvaluator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.activateOnlineEvaluator as SinonStub
    ...
    it('invokes activateOnlineEvaluator with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.activateOnlineEvaluator = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.activateOnlineEvaluator(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.activateOnlineEvaluator as SinonStub
    ...
    it('invokes checkActivateOnlineEvaluatorProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkActivateOnlineEvaluatorProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkActivateOnlineEvaluatorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkActivateOnlineEvaluatorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('suspendOnlineEvaluator', () => {
    it('invokes suspendOnlineEvaluator without error', async () => {
      ...
      client.innerApiCalls.suspendOnlineEvaluator =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.suspendOnlineEvaluator(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.suspendOnlineEvaluator as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.suspendOnlineEvaluator as SinonStub
    ...
    it('invokes suspendOnlineEvaluator with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.suspendOnlineEvaluator = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.suspendOnlineEvaluator(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.suspendOnlineEvaluator as SinonStub
    ...
    it('invokes checkSuspendOnlineEvaluatorProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkSuspendOnlineEvaluatorProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listOnlineEvaluators', () => {
    it('invokes listOnlineEvaluators without error', async () => {
      ...
      client.innerApiCalls.listOnlineEvaluators =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listOnlineEvaluators(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listOnlineEvaluators as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listOnlineEvaluators as SinonStub
    ...
    it('invokes listOnlineEvaluators with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listOnlineEvaluators = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listOnlineEvaluatorsStream without error', async () => {
      ...
      client.descriptors.page.listOnlineEvaluators.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator,
          ) => {
      ...
      assert(
        (client.descriptors.page.listOnlineEvaluators.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listOnlineEvaluators, request),
      );
      assert(
        (client.descriptors.page.listOnlineEvaluators.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listOnlineEvaluators without error', async () => {
      ...
      client.descriptors.page.listOnlineEvaluators.asyncIterate =
