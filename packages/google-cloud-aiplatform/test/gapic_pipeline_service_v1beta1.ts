  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          pipelineserviceModule.v1beta1.PipelineServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          pipelineserviceModule.v1beta1.PipelineServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new pipelineserviceModule.v1beta1.PipelineServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'aiplatform.example.com');
          if (saved) {
    ...
    it('invokes createTrainingPipeline without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createTrainingPipeline(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.ITrainingPipeline | null,
          ) => {
            if (err) {
              reject(err);
            } else {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listTrainingPipelines(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.aiplatform.v1beta1.ITrainingPipeline[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listTrainingPipelinesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.TrainingPipeline,
          ) => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPipelineJobs(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.aiplatform.v1beta1.IPipelineJob[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
