...
describe('v1beta1.PipelineServiceClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = pipelineserviceModule.v1beta1.PipelineServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = pipelineserviceModule.v1beta1.PipelineServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'aiplatform.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new pipelineserviceModule.v1beta1.PipelineServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new pipelineserviceModule.v1beta1.PipelineServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'aiplatform.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new pipelineserviceModule.v1beta1.PipelineServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new pipelineserviceModule.v1beta1.PipelineServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = pipelineserviceModule.v1beta1.PipelineServiceClient.port;
            assert(port);
    ...
    describe('createTrainingPipeline', () => {
        it('invokes createTrainingPipeline without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.TrainingPipeline()
            );
        ...
        it('invokes createTrainingPipeline without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTrainingPipeline(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.ITrainingPipeline|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createPipelineJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createPipelineJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.aiplatform.v1beta1.IPipelineJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteTrainingPipeline', () => {
        it('invokes deleteTrainingPipeline without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeleteTrainingPipelineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deletePipelineJob', () => {
        it('invokes deletePipelineJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.DeletePipelineJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('batchDeletePipelineJobs', () => {
        it('invokes batchDeletePipelineJobs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.BatchDeletePipelineJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.BatchDeletePipelineJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes batchDeletePipelineJobs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchDeletePipelineJobs(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IBatchDeletePipelineJobsResponse, protos.google.cloud.aiplatform.v1beta1.IDeleteOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IBatchDeletePipelineJobsResponse, protos.google.cloud.aiplatform.v1beta1.IDeleteOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchDeletePipelineJobs as SinonStub)
                .getCall(0).args[0];
    ...
    describe('batchCancelPipelineJobs', () => {
        it('invokes batchCancelPipelineJobs without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.aiplatform.v1beta1.BatchCancelPipelineJobsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.BatchCancelPipelineJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes batchCancelPipelineJobs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchCancelPipelineJobs(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.aiplatform.v1beta1.IBatchCancelPipelineJobsResponse, protos.google.cloud.aiplatform.v1beta1.IBatchCancelPipelineJobsOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.aiplatform.v1beta1.IBatchCancelPipelineJobsResponse, protos.google.cloud.aiplatform.v1beta1.IBatchCancelPipelineJobsOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.batchCancelPipelineJobs as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listTrainingPipelines', () => {
        it('invokes listTrainingPipelines without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListTrainingPipelinesRequest', ['parent']);
            request.parent = defaultValue1;
        ...
        it('invokes listTrainingPipelinesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.aiplatform.v1beta1.TrainingPipeline[] = [];
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.TrainingPipeline) => {
        ...
        it('uses async iteration with listTrainingPipelines without error', async () => {
            ...
            const responses: protos.google.cloud.aiplatform.v1beta1.ITrainingPipeline[] = [];
    ...
    describe('listPipelineJobs', () => {
        it('invokes listPipelineJobs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.aiplatform.v1beta1.ListPipelineJobsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listPipelineJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.aiplatform.v1beta1.PipelineJob) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
