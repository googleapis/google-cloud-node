...
function main(parent, ragMetadata) {
  // [START aiplatform_v1beta1_generated_VertexRagDataService_CreateRagMetadata_async]
  /**
  ...
  async function callCreateRagMetadata() {
    // Construct request
    const request = {
      parent,
      ragMetadata,
    ...
    // Run request
    const response = await aiplatformClient.createRagMetadata(request);
    console.log(response);
  }

  callCreateRagMetadata();
  // [END aiplatform_v1beta1_generated_VertexRagDataService_CreateRagMetadata_async]
}
