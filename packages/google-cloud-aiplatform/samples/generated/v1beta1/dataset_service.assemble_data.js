...
function main(name) {
  // [START aiplatform_v1beta1_generated_DatasetService_AssembleData_async]
  /**
  ...
  async function callAssembleData() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await aiplatformClient.assembleData(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callAssembleData();
  // [END aiplatform_v1beta1_generated_DatasetService_AssembleData_async]
}
