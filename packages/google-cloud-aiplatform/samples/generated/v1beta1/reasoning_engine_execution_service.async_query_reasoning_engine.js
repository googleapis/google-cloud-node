...
function main(name) {
  ...
  async function callAsyncQueryReasoningEngine() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await aiplatformClient.asyncQueryReasoningEngine(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callAsyncQueryReasoningEngine();
