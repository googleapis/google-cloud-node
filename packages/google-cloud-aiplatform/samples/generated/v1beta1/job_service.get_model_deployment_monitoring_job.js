...
function main(name) {
  // [START aiplatform_get_model_deployment_monitoring_job_sample]
  /**
  ...
  async function getModelDeploymentMonitoringJob() {
    ...
    // Run request
    const response = await aiplatformClient.getModelDeploymentMonitoringJob(
      request
    );
  ...
  // [END aiplatform_get_model_deployment_monitoring_job_sample]
}
