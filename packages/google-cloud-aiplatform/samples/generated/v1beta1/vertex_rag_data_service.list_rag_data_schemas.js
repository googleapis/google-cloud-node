...
function main(parent) {
  // [START aiplatform_v1beta1_generated_VertexRagDataService_ListRagDataSchemas_async]
  /**
  ...
  async function callListRagDataSchemas() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = aiplatformClient.listRagDataSchemasAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListRagDataSchemas();
  // [END aiplatform_v1beta1_generated_VertexRagDataService_ListRagDataSchemas_async]
}
