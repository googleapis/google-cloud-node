...
function main(parent, ragDataSchema) {
  ...
  async function callCreateRagDataSchema() {
    // Construct request
    const request = {
      parent,
      ragDataSchema,
    ...
    // Run request
    const response = await aiplatformClient.createRagDataSchema(request);
    console.log(response);
  }

  callCreateRagDataSchema();
