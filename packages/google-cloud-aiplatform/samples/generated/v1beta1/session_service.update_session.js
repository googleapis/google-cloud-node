...
function main(session) {
  // [START aiplatform_v1beta1_generated_SessionService_UpdateSession_async]
  /**
  ...
  async function callUpdateSession() {
    ...
    // Run request
    const response = await aiplatformClient.updateSession(request);
    console.log(response);
  }

  callUpdateSession();
  // [END aiplatform_v1beta1_generated_SessionService_UpdateSession_async]
}
