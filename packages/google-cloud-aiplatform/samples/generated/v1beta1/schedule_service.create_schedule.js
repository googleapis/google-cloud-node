...
function main(parent, schedule) {
  // [START aiplatform_v1beta1_generated_ScheduleService_CreateSchedule_async]
  /**
  ...
  async function callCreateSchedule() {
    ...
    // Run request
    const response = await aiplatformClient.createSchedule(request);
    console.log(response);
  }

  callCreateSchedule();
  // [END aiplatform_v1beta1_generated_ScheduleService_CreateSchedule_async]
}
