...
function main(onlineEvaluator) {
  ...
  async function callUpdateOnlineEvaluator() {
    // Construct request
    const request = {
      onlineEvaluator,
    };
    ...
    // Run request
    const [operation] = await aiplatformClient.updateOnlineEvaluator(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callUpdateOnlineEvaluator();
