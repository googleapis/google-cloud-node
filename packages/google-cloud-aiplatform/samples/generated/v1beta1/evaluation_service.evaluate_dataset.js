...
function main(location, dataset, metrics, outputConfig) {
  ...
  async function callEvaluateDataset() {
    // Construct request
    const request = {
      location,
      dataset,
    ...
    // Run request
    const [operation] = await aiplatformClient.evaluateDataset(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callEvaluateDataset();
  // [END aiplatform_v1beta1_generated_EvaluationService_EvaluateDataset_async]
}
