...
function main(parent) {
  // [START aiplatform_v1_generated_SessionService_ListSessions_async]
  /**
  ...
  const {SessionServiceClient} = require('@google-cloud/aiplatform').v1;
  ...
  callListSessions();
  // [END aiplatform_v1_generated_SessionService_ListSessions_async]
}
