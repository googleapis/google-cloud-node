...
export class EvaluationServiceClient {
  ...
  > | void {
    ...
    return this.innerApiCalls
      .evaluateInstances(request, options, wrappedCallback)
      ?.then(
  ...
  generateInstanceRubrics(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .generateInstanceRubrics(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.IGenerateInstanceRubricsResponse,
          (
  ...
  > | void {
    ...
    return this.innerApiCalls
      .evaluateDataset(request, options, wrappedCallback)
      ?.then(
   ...
   * region_tag:aiplatform_v1beta1_generated_EvaluationService_EvaluateDataset_async
   */
  async checkEvaluateDatasetProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.EvaluateDatasetResponse,
      protos.google.cloud.aiplatform.v1beta1.EvaluateDatasetOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.evaluateDataset,
