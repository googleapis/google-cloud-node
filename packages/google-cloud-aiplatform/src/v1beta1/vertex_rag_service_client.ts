...
export class VertexRagServiceClient {
  ...
  askContexts(
    ...
    callback: Callback<
      protos.google.cloud.aiplatform.v1beta1.IAskContextsResponse,
      | protos.google.cloud.aiplatform.v1beta1.IAskContextsRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  async checkAsyncRetrieveContextsProgress(
    ...
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.AsyncRetrieveContextsResponse,
      protos.google.cloud.aiplatform.v1beta1.AsyncRetrieveContextsOperationMetadata
    >
  > {
