...
export class ExampleStoreServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listExampleStores: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'exampleStores'
      ),
      fetchExamples: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'examples'
      ),
  ...
  getExampleStore(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1beta1.IGetExampleStoreRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getExampleStore(request, options, wrappedCallback)
      ?.then(
  ...
  upsertExamples(
    ...
    callback: Callback<
      protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesResponse,
      | protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesRequest
      | null
      | undefined,
      {} | null | undefined
    >
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .upsertExamples(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.IUpsertExamplesResponse,
          (
  ...
  removeExamples(
    ...
    callback: Callback<
      protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesResponse,
      | protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesRequest
      | null
      | undefined,
      {} | null | undefined
    >
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .removeExamples(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.IRemoveExamplesResponse,
          (
  ...
  searchExamples(
    ...
    callback: Callback<
      protos.google.cloud.aiplatform.v1beta1.ISearchExamplesResponse,
      | protos.google.cloud.aiplatform.v1beta1.ISearchExamplesRequest
      | null
      | undefined,
      {} | null | undefined
    >
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .searchExamples(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.ISearchExamplesResponse,
          (
  ...
  > | void {
    ...
    return this.innerApiCalls
      .createExampleStore(request, options, wrappedCallback)
      ?.then(
   ...
   * region_tag:aiplatform_v1beta1_generated_ExampleStoreService_CreateExampleStore_async
   */
  async checkCreateExampleStoreProgress(
    name: string
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.ExampleStore,
      protos.google.cloud.aiplatform.v1beta1.CreateExampleStoreOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.createExampleStore,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .updateExampleStore(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IExampleStore,
   ...
   * region_tag:aiplatform_v1beta1_generated_ExampleStoreService_UpdateExampleStore_async
   */
  async checkUpdateExampleStoreProgress(
    name: string
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.ExampleStore,
      protos.google.cloud.aiplatform.v1beta1.UpdateExampleStoreOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.updateExampleStore,
      this._gaxModule.createDefaultBackoffSettings()
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.ExampleStore,
  ...
  deleteExampleStore(
    ...
    [
      LROperation<
        ...
        protos.google.cloud.aiplatform.v1beta1.IDeleteExampleStoreOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .deleteExampleStore(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.protobuf.IEmpty,
   ...
   * region_tag:aiplatform_v1beta1_generated_ExampleStoreService_DeleteExampleStore_async
   */
  async checkDeleteExampleStoreProgress(
    name: string
  ): Promise<
    LROperation<
      protos.google.protobuf.Empty,
      protos.google.cloud.aiplatform.v1beta1.DeleteExampleStoreOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.deleteExampleStore,
      this._gaxModule.createDefaultBackoffSettings()
    );
    return decodeOperation as LROperation<
      protos.google.protobuf.Empty,
