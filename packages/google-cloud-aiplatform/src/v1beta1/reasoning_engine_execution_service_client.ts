...
export class ReasoningEngineExecutionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const asyncQueryReasoningEngineResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineResponse') as gax.protobuf.Type;
    const asyncQueryReasoningEngineMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.reasoningEngineExecutionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService,
 ...
 */
  queryReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineResponse,
        protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest|undefined, {}|undefined
      ]>;
  queryReasoningEngine(
      request: protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineResponse,
          protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest|null|undefined,
          {}|null|undefined>): void;
  queryReasoningEngine(
      request: protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.CancelAsyncQueryReasoningEngineResponse|CancelAsyncQueryReasoningEngineResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/reasoning_engine_execution_service.cancel_async_query_reasoning_engine.js</caption>
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineExecutionService_CancelAsyncQueryReasoningEngine_async
 */
  cancelAsyncQueryReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineResponse,
        protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineRequest|undefined, {}|undefined
      ]>;
  cancelAsyncQueryReasoningEngine(
      request: protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineResponse,
          protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineRequest|null|undefined,
          {}|null|undefined>): void;
  cancelAsyncQueryReasoningEngine(
      request: protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineRequest,
      callback: Callback<
  ...
  cancelAsyncQueryReasoningEngine(
    ...
    return this.innerApiCalls.cancelAsyncQueryReasoningEngine(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineResponse,
        protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('cancelAsyncQueryReasoningEngine response %j', response);
        return [response, options, rawResponse];
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/reasoning_engine_execution_service.stream_query_reasoning_engine.js</caption>
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineExecutionService_StreamQueryReasoningEngine_async
 */
  streamQueryReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1beta1.IStreamQueryReasoningEngineRequest,
      options?: CallOptions):
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/reasoning_engine_execution_service.async_query_reasoning_engine.js</caption>
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineExecutionService_AsyncQueryReasoningEngine_async
 */
  asyncQueryReasoningEngine(
      request?: protos.google.cloud.aiplatform.v1beta1.IAsyncQueryReasoningEngineRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IAsyncQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1beta1.IAsyncQueryReasoningEngineOperationMetadata>,
 ...
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineExecutionService_AsyncQueryReasoningEngine_async
 */
  async checkAsyncQueryReasoningEngineProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineOperationMetadata>;
  }
/**
