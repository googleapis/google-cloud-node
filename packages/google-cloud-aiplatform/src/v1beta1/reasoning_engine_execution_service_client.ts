...
export class ReasoningEngineExecutionServiceClient {
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof ReasoningEngineExecutionServiceClient;
    if (
    ...
    this.descriptors.stream = {
      streamQueryReasoningEngine: new this._gaxModule.StreamDescriptor(
    ...
    this.descriptors.longrunning = {
      asyncQueryReasoningEngine: new this._gaxModule.LongrunningDescriptor(
        ...
        asyncQueryReasoningEngineResponse.decode.bind(
          asyncQueryReasoningEngineResponse,
        ),
        asyncQueryReasoningEngineMetadata.decode.bind(
          asyncQueryReasoningEngineMetadata,
        ),
      ),
    };
  ...
  queryReasoningEngine(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  cancelAsyncQueryReasoningEngine(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'cancelAsyncQueryReasoningEngine response %j',
            response,
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .cancelAsyncQueryReasoningEngine(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.ICancelAsyncQueryReasoningEngineResponse,
          (
  ...
  asyncQueryReasoningEngine(
    ...
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IAsyncQueryReasoningEngineResponse,
        protos.google.cloud.aiplatform.v1beta1.IAsyncQueryReasoningEngineOperationMetadata
      >,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .asyncQueryReasoningEngine(request, options, wrappedCallback)
      ?.then(
   ...
   * region_tag:aiplatform_v1beta1_generated_ReasoningEngineExecutionService_AsyncQueryReasoningEngine_async
   */
  async checkAsyncQueryReasoningEngineProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineResponse,
      protos.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.asyncQueryReasoningEngine,
