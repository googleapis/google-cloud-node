...
export class MatchServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.MatchService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.matchServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.MatchService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.MatchService,
 ...
 */
  findNeighbors(
      request?: protos.google.cloud.aiplatform.v1beta1.IFindNeighborsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IFindNeighborsResponse,
        protos.google.cloud.aiplatform.v1beta1.IFindNeighborsRequest|undefined, {}|undefined
      ]>;
  findNeighbors(
      request: protos.google.cloud.aiplatform.v1beta1.IFindNeighborsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IFindNeighborsResponse,
          protos.google.cloud.aiplatform.v1beta1.IFindNeighborsRequest|null|undefined,
          {}|null|undefined>): void;
  findNeighbors(
      request: protos.google.cloud.aiplatform.v1beta1.IFindNeighborsRequest,
      callback: Callback<
  ...
  findNeighbors(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.findNeighbors(request, options, wrappedCallback)
 ...
 */
  readIndexDatapoints(
      request?: protos.google.cloud.aiplatform.v1beta1.IReadIndexDatapointsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IReadIndexDatapointsResponse,
        protos.google.cloud.aiplatform.v1beta1.IReadIndexDatapointsRequest|undefined, {}|undefined
      ]>;
  readIndexDatapoints(
      request: protos.google.cloud.aiplatform.v1beta1.IReadIndexDatapointsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IReadIndexDatapointsResponse,
          protos.google.cloud.aiplatform.v1beta1.IReadIndexDatapointsRequest|null|undefined,
          {}|null|undefined>): void;
  readIndexDatapoints(
      request: protos.google.cloud.aiplatform.v1beta1.IReadIndexDatapointsRequest,
      callback: Callback<
  ...
  readIndexDatapoints(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.readIndexDatapoints(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.IReadIndexDatapointsResponse,
