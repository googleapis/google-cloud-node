 ...
 */
import * as gapicConfig from './memory_bank_service_client_config.json';
 ...
 * @memberof v1beta1
 */
export class MemoryBankServiceClient {
  ...
  memoryBankServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof MemoryBankServiceClient;
    ...
    this.descriptors.page = {
      listMemories:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'memories')
    };
    ...
    const createMemoryResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.Memory') as gax.protobuf.Type;
    const createMemoryMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateMemoryOperationMetadata') as gax.protobuf.Type;
    const updateMemoryResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.Memory') as gax.protobuf.Type;
    const updateMemoryMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateMemoryOperationMetadata') as gax.protobuf.Type;
    const deleteMemoryResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const deleteMemoryMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeleteMemoryOperationMetadata') as gax.protobuf.Type;
    const generateMemoriesResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.GenerateMemoriesResponse') as gax.protobuf.Type;
    const generateMemoriesMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.GenerateMemoriesOperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      createMemory: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createMemoryResponse.decode.bind(createMemoryResponse),
        createMemoryMetadata.decode.bind(createMemoryMetadata)),
      updateMemory: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateMemoryResponse.decode.bind(updateMemoryResponse),
        updateMemoryMetadata.decode.bind(updateMemoryMetadata)),
      deleteMemory: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteMemoryResponse.decode.bind(deleteMemoryResponse),
        deleteMemoryMetadata.decode.bind(deleteMemoryMetadata)),
      generateMemories: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        generateMemoriesResponse.decode.bind(generateMemoriesResponse),
        generateMemoriesMetadata.decode.bind(generateMemoriesMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.MemoryBankService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.memoryBankServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.MemoryBankService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.MemoryBankService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const memoryBankServiceStubMethods =
        ['createMemory', 'getMemory', 'updateMemory', 'listMemories', 'deleteMemory', 'generateMemories', 'retrieveMemories'];
    for (const methodName of memoryBankServiceStubMethods) {
      const callPromise = this.memoryBankServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 */
  getMemory(
      request?: protos.google.cloud.aiplatform.v1beta1.IGetMemoryRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IMemory,
        protos.google.cloud.aiplatform.v1beta1.IGetMemoryRequest|undefined, {}|undefined
      ]>;
  getMemory(
      request: protos.google.cloud.aiplatform.v1beta1.IGetMemoryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IMemory,
          protos.google.cloud.aiplatform.v1beta1.IGetMemoryRequest|null|undefined,
          {}|null|undefined>): void;
  getMemory(
      request: protos.google.cloud.aiplatform.v1beta1.IGetMemoryRequest,
      callback: Callback<
 ...
 */
  retrieveMemories(
      request?: protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesResponse,
        protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesRequest|undefined, {}|undefined
      ]>;
  retrieveMemories(
      request: protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesResponse,
          protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesRequest|null|undefined,
          {}|null|undefined>): void;
  retrieveMemories(
      request: protos.google.cloud.aiplatform.v1beta1.IRetrieveMemoriesRequest,
      callback: Callback<
 ...
 */
  createMemory(
      request?: protos.google.cloud.aiplatform.v1beta1.ICreateMemoryRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_MemoryBankService_CreateMemory_async
 */
  async checkCreateMemoryProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.Memory, protos.google.cloud.aiplatform.v1beta1.CreateMemoryOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.Memory, protos.google.cloud.aiplatform.v1beta1.CreateMemoryOperationMetadata>;
  }
/**
 * Update a Memory.
 *
 ...
 * region_tag:aiplatform_v1beta1_generated_MemoryBankService_UpdateMemory_async
 */
  async checkUpdateMemoryProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.Memory, protos.google.cloud.aiplatform.v1beta1.UpdateMemoryOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.Memory, protos.google.cloud.aiplatform.v1beta1.UpdateMemoryOperationMetadata>;
  }
/**
 * Delete a Memory.
 *
 ...
 */
  deleteMemory(
      request?: protos.google.cloud.aiplatform.v1beta1.IDeleteMemoryRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_MemoryBankService_DeleteMemory_async
 */
  async checkDeleteMemoryProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteMemoryOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteMemoryOperationMetadata>;
  }
/**
 * Generate memories.
 *
 ...
 */
  generateMemories(
      request?: protos.google.cloud.aiplatform.v1beta1.IGenerateMemoriesRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1beta1_generated_MemoryBankService_GenerateMemories_async
 */
  async checkGenerateMemoriesProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.GenerateMemoriesResponse, protos.google.cloud.aiplatform.v1beta1.GenerateMemoriesOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.GenerateMemoriesResponse, protos.google.cloud.aiplatform.v1beta1.GenerateMemoriesOperationMetadata>;
  }
 /**
 * List Memories.
 *
 ...
 */
  listMemories(
      request?: protos.google.cloud.aiplatform.v1beta1.IListMemoriesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IMemory[],
  ...
  listMemories(
      ...
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListMemoriesRequest,
          protos.google.cloud.aiplatform.v1beta1.IListMemoriesResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.IMemory>): void;
  listMemories(
      request: protos.google.cloud.aiplatform.v1beta1.IListMemoriesRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListMemoriesRequest,
  ...
  listMemories(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListMemoriesRequest,
      protos.google.cloud.aiplatform.v1beta1.IListMemoriesResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IMemory>|undefined = callback
 ...
 */
  listMemoriesStream(
    ...
    return this.descriptors.page.listMemories.createStream(
      this.innerApiCalls.listMemories as GaxCall,
      request,
      callSettings
    );
  }
 ...
 */
  listMemoriesAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IListMemoriesRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IMemory>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listMemories.asyncIterate(
      this.innerApiCalls['listMemories'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IMemory>;
  }
/**
