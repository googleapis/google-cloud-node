...
export class ModelGardenServiceClient {
  ...
  > | void {
    ...
    return this.innerApiCalls
      .getPublisherModel(request, options, wrappedCallback)
      ?.then(
  ...
  checkPublisherModelEulaAcceptance(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1beta1.ICheckPublisherModelEulaAcceptanceRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'checkPublisherModelEulaAcceptance response %j',
            response
          );
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .checkPublisherModelEulaAcceptance(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.IPublisherModelEulaAcceptance,
          (
  ...
  acceptPublisherModelEula(
    ...
    [
      protos.google.cloud.aiplatform.v1beta1.IPublisherModelEulaAcceptance,
      (
        | protos.google.cloud.aiplatform.v1beta1.IAcceptPublisherModelEulaRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .acceptPublisherModelEula(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.IPublisherModelEulaAcceptance,
          (
  ...
  > | void {
    ...
    return this.innerApiCalls
      .deploy(request, options, wrappedCallback)
      ?.then(
  ...
  deployPublisherModel(
    ...
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IDeployPublisherModelResponse,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .deployPublisherModel(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IDeployPublisherModelResponse,
  ...
  async checkDeployPublisherModelProgress(
    ...
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.DeployPublisherModelResponse,
  ...
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.deployPublisherModel,
      this._gaxModule.createDefaultBackoffSettings()
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.DeployPublisherModelResponse,
  ...
  exportPublisherModel(
    ...
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IExportPublisherModelResponse,
        protos.google.cloud.aiplatform.v1beta1.IExportPublisherModelOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .exportPublisherModel(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IExportPublisherModelResponse,
   ...
   * region_tag:aiplatform_v1beta1_generated_ModelGardenService_ExportPublisherModel_async
   */
  async checkExportPublisherModelProgress(
    name: string
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.ExportPublisherModelResponse,
      protos.google.cloud.aiplatform.v1beta1.ExportPublisherModelOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.exportPublisherModel,
      this._gaxModule.createDefaultBackoffSettings()
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.ExportPublisherModelResponse,
