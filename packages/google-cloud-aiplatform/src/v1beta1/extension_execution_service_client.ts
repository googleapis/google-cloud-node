...
export class ExtensionExecutionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof ExtensionExecutionServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.ExtensionExecutionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.extensionExecutionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.ExtensionExecutionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.ExtensionExecutionService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const extensionExecutionServiceStubMethods =
        ['executeExtension', 'queryExtension'];
 ...
 */
  executeExtension(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1beta1.IExecuteExtensionRequest|undefined, {}|undefined
      ]>;
  executeExtension(
      request: protos.google.cloud.aiplatform.v1beta1.IExecuteExtensionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IExecuteExtensionResponse,
          protos.google.cloud.aiplatform.v1beta1.IExecuteExtensionRequest|null|undefined,
          {}|null|undefined>): void;
  executeExtension(
      request: protos.google.cloud.aiplatform.v1beta1.IExecuteExtensionRequest,
      callback: Callback<
  ...
  executeExtension(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.executeExtension(request, options, wrappedCallback)
 ...
 */
  queryExtension(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1beta1.IQueryExtensionRequest|undefined, {}|undefined
      ]>;
  queryExtension(
      request: protos.google.cloud.aiplatform.v1beta1.IQueryExtensionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IQueryExtensionResponse,
          protos.google.cloud.aiplatform.v1beta1.IQueryExtensionRequest|null|undefined,
          {}|null|undefined>): void;
  queryExtension(
      request: protos.google.cloud.aiplatform.v1beta1.IQueryExtensionRequest,
      callback: Callback<
  ...
  queryExtension(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.queryExtension(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.IQueryExtensionResponse,
