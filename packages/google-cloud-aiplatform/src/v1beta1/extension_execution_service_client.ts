 ...
 */
import * as gapicConfig from './extension_execution_service_client_config.json';
 ...
 * @memberof v1beta1
 */
export class ExtensionExecutionServiceClient {
  ...
  extensionExecutionServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof ExtensionExecutionServiceClient;
    if (
  ...
  initialize() {
    ...
    // google.cloud.aiplatform.v1beta1.ExtensionExecutionService.
    this.extensionExecutionServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
    ...
    for (const methodName of extensionExecutionServiceStubMethods) {
      const callPromise = this.extensionExecutionServiceStub.then(
        stub =>
          (...args: Array<{}>) => {
            if (this._terminated) {
   ...
   */
  executeExtension(
    request?: protos.google.cloud.aiplatform.v1beta1.IExecuteExtensionRequest,
    options?: CallOptions
  ): Promise<
    [
      protos.google.cloud.aiplatform.v1beta1.IExecuteExtensionResponse,
      (
        | protos.google.cloud.aiplatform.v1beta1.IExecuteExtensionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    this._log.info('executeExtension request %j', request);
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info('executeExtension response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .executeExtension(request, options, wrappedCallback)
      ?.then(
   ...
   */
  queryExtension(
    request?: protos.google.cloud.aiplatform.v1beta1.IQueryExtensionRequest,
    options?: CallOptions
  ): Promise<
    [
  ...
  queryExtension(
    ...
    callback: Callback<
      protos.google.cloud.aiplatform.v1beta1.IQueryExtensionResponse,
      | protos.google.cloud.aiplatform.v1beta1.IQueryExtensionRequest
      | null
      | undefined,
      {} | null | undefined
    >
  ...
  > | void {
    ...
    this._log.info('queryExtension request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.cloud.aiplatform.v1beta1.IQueryExtensionResponse,
          | protos.google.cloud.aiplatform.v1beta1.IQueryExtensionRequest
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('queryExtension response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .queryExtension(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.IQueryExtensionResponse,
          (
   ...
   * @returns {string} Resource name string.
   */
  projectLocationReasoningEngineSessionPath(
    project: string,
    location: string,
   ...
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectLocationReasoningEngineSessionName(
    projectLocationReasoningEngineSessionName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionPathTemplate.match(
      projectLocationReasoningEngineSessionName
    ).project;
  }
   ...
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationReasoningEngineSessionName(
    projectLocationReasoningEngineSessionName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionPathTemplate.match(
      projectLocationReasoningEngineSessionName
   ...
   */
  matchReasoningEngineFromProjectLocationReasoningEngineSessionName(
    projectLocationReasoningEngineSessionName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionPathTemplate.match(
      projectLocationReasoningEngineSessionName
   ...
   */
  matchSessionFromProjectLocationReasoningEngineSessionName(
    projectLocationReasoningEngineSessionName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionPathTemplate.match(
      projectLocationReasoningEngineSessionName
   ...
   * @returns {string} Resource name string.
   */
  projectLocationReasoningEngineSessionEventPath(
    project: string,
    location: string,
    reasoningEngine: string,
    session: string,
   ...
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectLocationReasoningEngineSessionEventName(
    projectLocationReasoningEngineSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionEventPathTemplate.match(
      projectLocationReasoningEngineSessionEventName
    ).project;
  }
   ...
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationReasoningEngineSessionEventName(
    projectLocationReasoningEngineSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionEventPathTemplate.match(
      projectLocationReasoningEngineSessionEventName
   ...
   * @returns {string} A string representing the reasoning_engine.
   */
  matchReasoningEngineFromProjectLocationReasoningEngineSessionEventName(
    projectLocationReasoningEngineSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionEventPathTemplate.match(
      projectLocationReasoningEngineSessionEventName
   ...
   * @returns {string} A string representing the session.
   */
  matchSessionFromProjectLocationReasoningEngineSessionEventName(
    projectLocationReasoningEngineSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionEventPathTemplate.match(
      projectLocationReasoningEngineSessionEventName
   ...
   */
  matchEventFromProjectLocationReasoningEngineSessionEventName(
    projectLocationReasoningEngineSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationReasoningEngineSessionEventPathTemplate.match(
      projectLocationReasoningEngineSessionEventName
  ...
  matchProjectFromProjectLocationSessionName(
    ...
    return this.pathTemplates.projectLocationSessionPathTemplate.match(
   ...
   * @returns {string} Resource name string.
   */
  projectLocationSessionEventPath(
    project: string,
    location: string,
    session: string,
    event: string
   ...
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectLocationSessionEventName(
    projectLocationSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationSessionEventPathTemplate.match(
      projectLocationSessionEventName
    ).project;
  }
   ...
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationSessionEventName(
    projectLocationSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationSessionEventPathTemplate.match(
      projectLocationSessionEventName
   ...
   * @returns {string} A string representing the session.
   */
  matchSessionFromProjectLocationSessionEventName(
    projectLocationSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationSessionEventPathTemplate.match(
      projectLocationSessionEventName
   ...
   * @returns {string} A string representing the event.
   */
  matchEventFromProjectLocationSessionEventName(
    projectLocationSessionEventName: string
  ) {
    return this.pathTemplates.projectLocationSessionEventPathTemplate.match(
      projectLocationSessionEventName
