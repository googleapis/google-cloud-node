 ...
 */
  ...
  getDeploymentResourcePool(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getDeploymentResourcePool(request, options, wrappedCallback)
  ...
  createDeploymentResourcePool(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info('createDeploymentResourcePool response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('createDeploymentResourcePool request %j', request);
    return this.innerApiCalls.createDeploymentResourcePool(request, options, wrappedCallback)
 ...
 */
  ...
  updateDeploymentResourcePool(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('updateDeploymentResourcePool response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('updateDeploymentResourcePool request %j', request);
    return this.innerApiCalls.updateDeploymentResourcePool(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool, protos.google.cloud.aiplatform.v1beta1.IUpdateDeploymentResourcePoolOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 */
  ...
  deleteDeploymentResourcePool(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('deleteDeploymentResourcePool response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('deleteDeploymentResourcePool request %j', request);
    return this.innerApiCalls.deleteDeploymentResourcePool(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 */
  ...
  listDeploymentResourcePools(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListDeploymentResourcePoolsRequest,
      protos.google.cloud.aiplatform.v1beta1.IListDeploymentResourcePoolsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IDeploymentResourcePool>|undefined = callback
...
/**
 * Equivalent to `listDeploymentResourcePools`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The parent Location which owns this collection of
 ...
 */
  ...
  queryDeployedModels(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IQueryDeployedModelsRequest,
      protos.google.cloud.aiplatform.v1beta1.IQueryDeployedModelsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IDeployedModel>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
...
/**
 * Equivalent to `queryDeployedModels`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.deploymentResourcePool
 *   Required. The name of the target DeploymentResourcePool to query.
