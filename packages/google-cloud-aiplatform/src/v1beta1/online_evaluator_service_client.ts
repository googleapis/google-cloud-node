...
export class OnlineEvaluatorServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const staticMembers = this.constructor as typeof OnlineEvaluatorServiceClient;
    ...
    this.descriptors.page = {
      listOnlineEvaluators:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'onlineEvaluators')
    };
    ...
    const createOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.OnlineEvaluator') as gax.protobuf.Type;
    const createOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateOnlineEvaluatorOperationMetadata') as gax.protobuf.Type;
    const updateOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.OnlineEvaluator') as gax.protobuf.Type;
    const updateOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UpdateOnlineEvaluatorOperationMetadata') as gax.protobuf.Type;
    ...
    const deleteOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeleteOnlineEvaluatorOperationMetadata') as gax.protobuf.Type;
    const activateOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.OnlineEvaluator') as gax.protobuf.Type;
    const activateOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.ActivateOnlineEvaluatorOperationMetadata') as gax.protobuf.Type;
    const suspendOnlineEvaluatorResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.OnlineEvaluator') as gax.protobuf.Type;
    const suspendOnlineEvaluatorMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.SuspendOnlineEvaluatorOperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      createOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        createOnlineEvaluatorResponse.decode.bind(createOnlineEvaluatorResponse),
        createOnlineEvaluatorMetadata.decode.bind(createOnlineEvaluatorMetadata)),
      updateOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        updateOnlineEvaluatorResponse.decode.bind(updateOnlineEvaluatorResponse),
        updateOnlineEvaluatorMetadata.decode.bind(updateOnlineEvaluatorMetadata)),
      deleteOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteOnlineEvaluatorResponse.decode.bind(deleteOnlineEvaluatorResponse),
        deleteOnlineEvaluatorMetadata.decode.bind(deleteOnlineEvaluatorMetadata)),
      activateOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        activateOnlineEvaluatorResponse.decode.bind(activateOnlineEvaluatorResponse),
        activateOnlineEvaluatorMetadata.decode.bind(activateOnlineEvaluatorMetadata)),
      suspendOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        suspendOnlineEvaluatorResponse.decode.bind(suspendOnlineEvaluatorResponse),
        suspendOnlineEvaluatorMetadata.decode.bind(suspendOnlineEvaluatorMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.OnlineEvaluatorService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.onlineEvaluatorServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.OnlineEvaluatorService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.OnlineEvaluatorService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const onlineEvaluatorServiceStubMethods =
        ['createOnlineEvaluator', 'getOnlineEvaluator', 'updateOnlineEvaluator', 'deleteOnlineEvaluator', 'listOnlineEvaluators', 'activateOnlineEvaluator', 'suspendOnlineEvaluator'];
 ...
 */
  getOnlineEvaluator(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1beta1.IGetOnlineEvaluatorRequest|undefined, {}|undefined
      ]>;
  getOnlineEvaluator(
      request: protos.google.cloud.aiplatform.v1beta1.IGetOnlineEvaluatorRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
          protos.google.cloud.aiplatform.v1beta1.IGetOnlineEvaluatorRequest|null|undefined,
          {}|null|undefined>): void;
  getOnlineEvaluator(
      request: protos.google.cloud.aiplatform.v1beta1.IGetOnlineEvaluatorRequest,
      callback: Callback<
  ...
  getOnlineEvaluator(
    ...
    const wrappedCallback: Callback<
      ...
      : undefined;
    return this.innerApiCalls.getOnlineEvaluator(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator,
        protos.google.cloud.aiplatform.v1beta1.IGetOnlineEvaluatorRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getOnlineEvaluator response %j', response);
 ...
 */
  createOnlineEvaluator(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ICreateOnlineEvaluatorOperationMetadata>,
  ...
  createOnlineEvaluator(
    ...
    return this.innerApiCalls.createOnlineEvaluator(request, options, wrappedCallback)
 ...
 * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_CreateOnlineEvaluator_async
 */
  async checkCreateOnlineEvaluatorProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.CreateOnlineEvaluatorOperationMetadata>>{
    this._log.info('createOnlineEvaluator long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createOnlineEvaluator, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.CreateOnlineEvaluatorOperationMetadata>;
  }
/**
 ...
 */
  updateOnlineEvaluator(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.IUpdateOnlineEvaluatorOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  updateOnlineEvaluator(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateOnlineEvaluatorRequest,
  ...
  updateOnlineEvaluator(
    ...
    return this.innerApiCalls.updateOnlineEvaluator(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.IUpdateOnlineEvaluatorOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_UpdateOnlineEvaluator_async
 */
  async checkUpdateOnlineEvaluatorProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.UpdateOnlineEvaluatorOperationMetadata>>{
    this._log.info('updateOnlineEvaluator long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateOnlineEvaluator, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.UpdateOnlineEvaluatorOperationMetadata>;
  }
/**
 ...
 */
  deleteOnlineEvaluator(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteOnlineEvaluatorOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  deleteOnlineEvaluator(
      request: protos.google.cloud.aiplatform.v1beta1.IDeleteOnlineEvaluatorRequest,
  ...
  deleteOnlineEvaluator(
    ...
    return this.innerApiCalls.deleteOnlineEvaluator(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteOnlineEvaluatorOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_DeleteOnlineEvaluator_async
 */
  async checkDeleteOnlineEvaluatorProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteOnlineEvaluatorOperationMetadata>>{
    this._log.info('deleteOnlineEvaluator long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteOnlineEvaluator, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteOnlineEvaluatorOperationMetadata>;
  }
/**
 ...
 */
  activateOnlineEvaluator(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.IActivateOnlineEvaluatorOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  activateOnlineEvaluator(
      request: protos.google.cloud.aiplatform.v1beta1.IActivateOnlineEvaluatorRequest,
  ...
  activateOnlineEvaluator(
    ...
    return this.innerApiCalls.activateOnlineEvaluator(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.IActivateOnlineEvaluatorOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_ActivateOnlineEvaluator_async
 */
  async checkActivateOnlineEvaluatorProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ActivateOnlineEvaluatorOperationMetadata>>{
    this._log.info('activateOnlineEvaluator long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.activateOnlineEvaluator, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ActivateOnlineEvaluatorOperationMetadata>;
  }
/**
 ...
 */
  suspendOnlineEvaluator(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ISuspendOnlineEvaluatorOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  suspendOnlineEvaluator(
      request: protos.google.cloud.aiplatform.v1beta1.ISuspendOnlineEvaluatorRequest,
  ...
  suspendOnlineEvaluator(
    ...
    return this.innerApiCalls.suspendOnlineEvaluator(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.ISuspendOnlineEvaluatorOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:aiplatform_v1beta1_generated_OnlineEvaluatorService_SuspendOnlineEvaluator_async
 */
  async checkSuspendOnlineEvaluatorProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.SuspendOnlineEvaluatorOperationMetadata>>{
    this._log.info('suspendOnlineEvaluator long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.suspendOnlineEvaluator, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.OnlineEvaluator, protos.google.cloud.aiplatform.v1beta1.SuspendOnlineEvaluatorOperationMetadata>;
  }
 /**
 ...
 */
  ...
  listOnlineEvaluators(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator>): void;
  listOnlineEvaluators(
      request: protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsRequest,
  ...
  listOnlineEvaluators(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsRequest,
      protos.google.cloud.aiplatform.v1beta1.IListOnlineEvaluatorsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IOnlineEvaluator>|undefined = callback
