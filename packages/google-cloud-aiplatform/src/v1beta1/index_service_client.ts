...
export class IndexServiceClient {
  ...
  importIndex(
    ...
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IIndex,
        protos.google.cloud.aiplatform.v1beta1.IImportIndexOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .importIndex(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IIndex,
   ...
   * region_tag:aiplatform_v1beta1_generated_IndexService_ImportIndex_async
   */
  async checkImportIndexProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.Index,
      protos.google.cloud.aiplatform.v1beta1.ImportIndexOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.importIndex,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.Index,
