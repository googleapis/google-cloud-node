...
export class IndexEndpointServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createIndexEndpointResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.IndexEndpoint') as gax.protobuf.Type;
    const createIndexEndpointMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.CreateIndexEndpointOperationMetadata') as gax.protobuf.Type;
    ...
    const deployIndexResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeployIndexResponse') as gax.protobuf.Type;
    const deployIndexMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeployIndexOperationMetadata') as gax.protobuf.Type;
    const undeployIndexResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UndeployIndexResponse') as gax.protobuf.Type;
    const undeployIndexMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.UndeployIndexOperationMetadata') as gax.protobuf.Type;
    const mutateDeployedIndexResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.MutateDeployedIndexResponse') as gax.protobuf.Type;
    const mutateDeployedIndexMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.MutateDeployedIndexOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.IndexEndpointService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.indexEndpointServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.IndexEndpointService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.IndexEndpointService,
 ...
 */
  getIndexEndpoint(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1beta1.IGetIndexEndpointRequest|undefined, {}|undefined
      ]>;
  getIndexEndpoint(
      request: protos.google.cloud.aiplatform.v1beta1.IGetIndexEndpointRequest,
      options: CallOptions,
 ...
 */
  updateIndexEndpoint(
      ...
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IIndexEndpoint,
        protos.google.cloud.aiplatform.v1beta1.IUpdateIndexEndpointRequest|undefined, {}|undefined
      ]>;
  updateIndexEndpoint(
      request: protos.google.cloud.aiplatform.v1beta1.IUpdateIndexEndpointRequest,
      options: CallOptions,
 ...
 * region_tag:aiplatform_v1beta1_generated_IndexEndpointService_MutateDeployedIndex_async
 */
  async checkMutateDeployedIndexProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.MutateDeployedIndexResponse, protos.google.cloud.aiplatform.v1beta1.MutateDeployedIndexOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.MutateDeployedIndexResponse, protos.google.cloud.aiplatform.v1beta1.MutateDeployedIndexOperationMetadata>;
  }
 /**
 ...
 */
  ...
  listIndexEndpoints(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1beta1.IIndexEndpoint>): void;
  listIndexEndpoints(
      request: protos.google.cloud.aiplatform.v1beta1.IListIndexEndpointsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListIndexEndpointsRequest,
  ...
  listIndexEndpoints(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListIndexEndpointsRequest,
      protos.google.cloud.aiplatform.v1beta1.IListIndexEndpointsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IIndexEndpoint>|undefined = callback
