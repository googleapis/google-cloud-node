 ...
 * `src/v1beta1/reasoning_engine_runtime_revision_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './reasoning_engine_runtime_revision_service_client_config.json';
 ...
 * @memberof v1beta1
 */
export class ReasoningEngineRuntimeRevisionServiceClient {
  ...
  reasoningEngineRuntimeRevisionServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of ReasoningEngineRuntimeRevisionServiceClient.
   *
   ...
   *     const client = new ReasoningEngineRuntimeRevisionServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof ReasoningEngineRuntimeRevisionServiceClient;
    ...
    this.descriptors.page = {
      listReasoningEngineRuntimeRevisions:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'reasoningEngineRuntimeRevisions')
    };
    ...
    const deleteReasoningEngineRuntimeRevisionResponse = protoFilesRoot.lookup(
      '.google.protobuf.Empty') as gax.protobuf.Type;
    const deleteReasoningEngineRuntimeRevisionMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRuntimeRevisionOperationMetadata') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      deleteReasoningEngineRuntimeRevision: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        deleteReasoningEngineRuntimeRevisionResponse.decode.bind(deleteReasoningEngineRuntimeRevisionResponse),
        deleteReasoningEngineRuntimeRevisionMetadata.decode.bind(deleteReasoningEngineRuntimeRevisionMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.reasoningEngineRuntimeRevisionServiceStub) {
      return this.reasoningEngineRuntimeRevisionServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService.
    this.reasoningEngineRuntimeRevisionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const reasoningEngineRuntimeRevisionServiceStubMethods =
        ['getReasoningEngineRuntimeRevision', 'listReasoningEngineRuntimeRevisions', 'deleteReasoningEngineRuntimeRevision'];
    for (const methodName of reasoningEngineRuntimeRevisionServiceStubMethods) {
      const callPromise = this.reasoningEngineRuntimeRevisionServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision|ReasoningEngineRuntimeRevision}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/reasoning_engine_runtime_revision_service.get_reasoning_engine_runtime_revision.js</caption>
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineRuntimeRevisionService_GetReasoningEngineRuntimeRevision_async
 */
  getReasoningEngineRuntimeRevision(
      request?: protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRuntimeRevisionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision,
        protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRuntimeRevisionRequest|undefined, {}|undefined
      ]>;
  getReasoningEngineRuntimeRevision(
      request: protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRuntimeRevisionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision,
          protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRuntimeRevisionRequest|null|undefined,
          {}|null|undefined>): void;
  getReasoningEngineRuntimeRevision(
      request: protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRuntimeRevisionRequest,
      callback: Callback<
  ...
  getReasoningEngineRuntimeRevision(
    ...
    this._log.info('getReasoningEngineRuntimeRevision request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision,
        protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRuntimeRevisionRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('getReasoningEngineRuntimeRevision response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.getReasoningEngineRuntimeRevision(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision,
        protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRuntimeRevisionRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('getReasoningEngineRuntimeRevision response %j', response);
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/reasoning_engine_runtime_revision_service.delete_reasoning_engine_runtime_revision.js</caption>
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineRuntimeRevisionService_DeleteReasoningEngineRuntimeRevision_async
 */
  deleteReasoningEngineRuntimeRevision(
      request?: protos.google.cloud.aiplatform.v1beta1.IDeleteReasoningEngineRuntimeRevisionRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.aiplatform.v1beta1.IDeleteReasoningEngineRuntimeRevisionOperationMetadata>,
  ...
  deleteReasoningEngineRuntimeRevision(
    ...
    const wrappedCallback: Callback<
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info('deleteReasoningEngineRuntimeRevision response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('deleteReasoningEngineRuntimeRevision request %j', request);
    return this.innerApiCalls.deleteReasoningEngineRuntimeRevision(request, options, wrappedCallback)
...
/**
 * Check the status of the long running operation returned by `deleteReasoningEngineRuntimeRevision()`.
 * @param {String} name
 ...
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineRuntimeRevisionService_DeleteReasoningEngineRuntimeRevision_async
 */
  async checkDeleteReasoningEngineRuntimeRevisionProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRuntimeRevisionOperationMetadata>>{
    this._log.info('deleteReasoningEngineRuntimeRevision long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteReasoningEngineRuntimeRevision, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRuntimeRevisionOperationMetadata>;
  }
 /**
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of {@link protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision|ReasoningEngineRuntimeRevision}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listReasoningEngineRuntimeRevisionsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 */
  listReasoningEngineRuntimeRevisions(
      request?: protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision[],
        protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest|null,
        protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsResponse
      ]>;
  listReasoningEngineRuntimeRevisions(
      request: protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest,
          protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision>): void;
  listReasoningEngineRuntimeRevisions(
      request: protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest,
  ...
  listReasoningEngineRuntimeRevisions(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest,
      protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info('listReasoningEngineRuntimeRevisions values %j', values);
          callback!(error, values, nextPageRequest, rawResponse); // We verified callback above.
        }
      : undefined;
    this._log.info('listReasoningEngineRuntimeRevisions request %j', request);
    return this.innerApiCalls
      .listReasoningEngineRuntimeRevisions(request, options, wrappedCallback)
      ?.then(([response, input, output]: [
        protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision[],
        protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest|null,
        protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsResponse
      ]) => {
        this._log.info('listReasoningEngineRuntimeRevisions values %j', response);
        return [response, input, output];
      });
  }

/**
 * Equivalent to `listReasoningEngineRuntimeRevisions`, but returns a NodeJS Stream object.
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 *   Required. The resource name of the ReasoningEngine to list the
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision|ReasoningEngineRuntimeRevision} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   for more details and examples.
 */
  listReasoningEngineRuntimeRevisionsStream(
      request?: protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest,
      options?: CallOptions):
    Transform{
    request = request || {};
    ...
    const defaultCallSettings = this._defaults['listReasoningEngineRuntimeRevisions'];
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listReasoningEngineRuntimeRevisions stream %j', request);
    return this.descriptors.page.listReasoningEngineRuntimeRevisions.createStream(
      this.innerApiCalls.listReasoningEngineRuntimeRevisions as GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listReasoningEngineRuntimeRevisions`, but returns an iterable object.
 *
 ...
 *   {@link protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevision|ReasoningEngineRuntimeRevision}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/reasoning_engine_runtime_revision_service.list_reasoning_engine_runtime_revisions.js</caption>
 * region_tag:aiplatform_v1beta1_generated_ReasoningEngineRuntimeRevisionService_ListReasoningEngineRuntimeRevisions_async
 */
  listReasoningEngineRuntimeRevisionsAsync(
      request?: protos.google.cloud.aiplatform.v1beta1.IListReasoningEngineRuntimeRevisionsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = defaultCallSettings.merge(options);
    this.initialize().catch(err => {throw err});
    this._log.info('listReasoningEngineRuntimeRevisions iterate %j', request);
    return this.descriptors.page.listReasoningEngineRuntimeRevisions.asyncIterate(
      this.innerApiCalls['listReasoningEngineRuntimeRevisions'] as GaxCall,
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1beta1.IReasoningEngineRuntimeRevision>;
  }
/**
...
/**
   ...
   */
  close(): Promise<void> {
    if (this.reasoningEngineRuntimeRevisionServiceStub && !this._terminated) {
      return this.reasoningEngineRuntimeRevisionServiceStub.then(stub => {
