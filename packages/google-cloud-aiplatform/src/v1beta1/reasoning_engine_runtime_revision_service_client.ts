...
export class ReasoningEngineRuntimeRevisionServiceClient {
  ...
  reasoningEngineRuntimeRevisionServiceStub?: Promise<{
  ...
  constructor(
    ...
    const staticMembers = this
      .constructor as typeof ReasoningEngineRuntimeRevisionServiceClient;
    if (
    ...
    this.descriptors.page = {
      listReasoningEngineRuntimeRevisions: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
    ...
    this.descriptors.longrunning = {
      deleteReasoningEngineRuntimeRevision:
        new this._gaxModule.LongrunningDescriptor(
          ...
          deleteReasoningEngineRuntimeRevisionResponse.decode.bind(
            deleteReasoningEngineRuntimeRevisionResponse,
          ),
          deleteReasoningEngineRuntimeRevisionMetadata.decode.bind(
            deleteReasoningEngineRuntimeRevisionMetadata,
          ),
        ),
    };
  ...
  getReasoningEngineRuntimeRevision(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1beta1.IGetReasoningEngineRuntimeRevisionRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, options, rawResponse) => {
          this._log.info(
            'getReasoningEngineRuntimeRevision response %j',
            response,
          );
    ...
    return this.innerApiCalls
      .getReasoningEngineRuntimeRevision(request, options, wrappedCallback)
      ?.then(
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, response, rawResponse, _) => {
          this._log.info(
            'deleteReasoningEngineRuntimeRevision response %j',
            rawResponse,
          );
    ...
    return this.innerApiCalls
      .deleteReasoningEngineRuntimeRevision(request, options, wrappedCallback)
      ?.then(
   ...
   * region_tag:aiplatform_v1beta1_generated_ReasoningEngineRuntimeRevisionService_DeleteReasoningEngineRuntimeRevision_async
   */
  async checkDeleteReasoningEngineRuntimeRevisionProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.protobuf.Empty,
      protos.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRuntimeRevisionOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.deleteReasoningEngineRuntimeRevision,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      ? (error, values, nextPageRequest, rawResponse) => {
          this._log.info(
            'listReasoningEngineRuntimeRevisions values %j',
            values,
          );
  ...
  listReasoningEngineRuntimeRevisionsStream(
    ...
    const defaultCallSettings =
      this._defaults['listReasoningEngineRuntimeRevisions'];
