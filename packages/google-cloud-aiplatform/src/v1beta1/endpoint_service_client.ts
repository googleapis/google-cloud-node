...
export class EndpointServiceClient {
  ...
  constructor(
    ...
    this.descriptors.longrunning = {
      ...
      setPublisherModelConfig: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        setPublisherModelConfigResponse.decode.bind(
          setPublisherModelConfigResponse,
        ),
        setPublisherModelConfigMetadata.decode.bind(
          setPublisherModelConfigMetadata,
        ),
      ),
    };
  ...
  fetchPublisherModelConfig(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1beta1.IFetchPublisherModelConfigRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .fetchPublisherModelConfig(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig,
          (
  ...
  > | void {
    ...
    return this.innerApiCalls
      .updateEndpointLongRunning(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IEndpoint,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .mutateDeployedModel(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IMutateDeployedModelResponse,
  ...
  setPublisherModelConfig(
    ...
    [
      LROperation<
        protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig,
        protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigOperationMetadata
      >,
      protos.google.longrunning.IOperation | undefined,
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .setPublisherModelConfig(request, options, wrappedCallback)
      ?.then(
        ([response, rawResponse, _]: [
          LROperation<
            protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig,
   ...
   * region_tag:aiplatform_v1beta1_generated_EndpointService_SetPublisherModelConfig_async
   */
  async checkSetPublisherModelConfigProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1beta1.PublisherModelConfig,
      protos.google.cloud.aiplatform.v1beta1.SetPublisherModelConfigOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.setPublisherModelConfig,
      this._gaxModule.createDefaultBackoffSettings(),
    );
    return decodeOperation as LROperation<
      protos.google.cloud.aiplatform.v1beta1.PublisherModelConfig,
