...
export class EndpointServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const setPublisherModelConfigResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.PublisherModelConfig') as gax.protobuf.Type;
    const setPublisherModelConfigMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1beta1.SetPublisherModelConfigOperationMetadata') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      setPublisherModelConfig: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        setPublisherModelConfigResponse.decode.bind(setPublisherModelConfigResponse),
        setPublisherModelConfigMetadata.decode.bind(setPublisherModelConfigMetadata))
    };
  ...
  initialize() {
    ...
    const endpointServiceStubMethods =
        ['createEndpoint', 'getEndpoint', 'listEndpoints', 'updateEndpoint', 'updateEndpointLongRunning', 'deleteEndpoint', 'deployModel', 'undeployModel', 'mutateDeployedModel', 'setPublisherModelConfig', 'fetchPublisherModelConfig'];
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.PublisherModelConfig|PublisherModelConfig}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/endpoint_service.fetch_publisher_model_config.js</caption>
 * region_tag:aiplatform_v1beta1_generated_EndpointService_FetchPublisherModelConfig_async
 */
  fetchPublisherModelConfig(
      request?: protos.google.cloud.aiplatform.v1beta1.IFetchPublisherModelConfigRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig,
        protos.google.cloud.aiplatform.v1beta1.IFetchPublisherModelConfigRequest|undefined, {}|undefined
      ]>;
  fetchPublisherModelConfig(
      request: protos.google.cloud.aiplatform.v1beta1.IFetchPublisherModelConfigRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig,
          protos.google.cloud.aiplatform.v1beta1.IFetchPublisherModelConfigRequest|null|undefined,
          {}|null|undefined>): void;
  fetchPublisherModelConfig(
      request: protos.google.cloud.aiplatform.v1beta1.IFetchPublisherModelConfigRequest,
      callback: Callback<
  ...
  fetchPublisherModelConfig(
    ...
    this.initialize().catch(err => {throw err});
    this._log.info('fetchPublisherModelConfig request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig,
        protos.google.cloud.aiplatform.v1beta1.IFetchPublisherModelConfigRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('fetchPublisherModelConfig response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.fetchPublisherModelConfig(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig,
 ...
 *   {@link protos.google.cloud.aiplatform.v1beta1.DedicatedResources|DedicatedResources}
 ...
 *   Required. The name of the publisher model, in the format of
 *   `projects/{project}/locations/{location}/publishers/{publisher}/models/{model}`.
 * @param {google.cloud.aiplatform.v1beta1.PublisherModelConfig} request.publisherModelConfig
 ...
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1beta1/endpoint_service.set_publisher_model_config.js</caption>
 * region_tag:aiplatform_v1beta1_generated_EndpointService_SetPublisherModelConfig_async
 */
  setPublisherModelConfig(
      request?: protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig, protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  setPublisherModelConfig(
      request: protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigRequest,
  ...
  setPublisherModelConfig(
    ...
    const wrappedCallback: Callback<
          ...
          {}|null|undefined>|undefined = callback
      ? (error, response, rawResponse, _) => {
          this._log.info('setPublisherModelConfig response %j', rawResponse);
          callback!(error, response, rawResponse, _); // We verified callback above.
        }
      : undefined;
    this._log.info('setPublisherModelConfig request %j', request);
    return this.innerApiCalls.setPublisherModelConfig(request, options, wrappedCallback)
    ?.then(([response, rawResponse, _]: [
      LROperation<protos.google.cloud.aiplatform.v1beta1.IPublisherModelConfig, protos.google.cloud.aiplatform.v1beta1.ISetPublisherModelConfigOperationMetadata>,
      protos.google.longrunning.IOperation|undefined, {}|undefined
    ]) => {
 ...
 * region_tag:aiplatform_v1beta1_generated_EndpointService_SetPublisherModelConfig_async
 */
  async checkSetPublisherModelConfigProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.PublisherModelConfig, protos.google.cloud.aiplatform.v1beta1.SetPublisherModelConfigOperationMetadata>>{
    this._log.info('setPublisherModelConfig long-running');
    const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.setPublisherModelConfig, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1beta1.PublisherModelConfig, protos.google.cloud.aiplatform.v1beta1.SetPublisherModelConfigOperationMetadata>;
  }
 /**
 ...
 */
  ...
  listEndpoints(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1beta1.IListEndpointsRequest,
      protos.google.cloud.aiplatform.v1beta1.IListEndpointsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1beta1.IEndpoint>|undefined = callback
