...
export class ReasoningEngineExecutionServiceClient {
  ...
  constructor(
    ...
    const asyncQueryReasoningEngineResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineResponse',
  ...
  cancelAsyncQueryReasoningEngine(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1.ICancelAsyncQueryReasoningEngineRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  async checkAsyncQueryReasoningEngineProgress(
    ...
    LROperation<
      protos.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineResponse,
      protos.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineOperationMetadata
    >
  > {
