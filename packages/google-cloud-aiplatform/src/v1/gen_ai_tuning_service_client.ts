...
export class GenAiTuningServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const rebaseTunedModelResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.TuningJob') as gax.protobuf.Type;
    const rebaseTunedModelMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.RebaseTunedModelOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.GenAiTuningService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.genAiTuningServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.GenAiTuningService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.GenAiTuningService,
 ...
 */
  createTuningJob(
      request?: protos.google.cloud.aiplatform.v1.ICreateTuningJobRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.ITuningJob,
        protos.google.cloud.aiplatform.v1.ICreateTuningJobRequest|undefined, {}|undefined
      ]>;
  createTuningJob(
      request: protos.google.cloud.aiplatform.v1.ICreateTuningJobRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.ITuningJob,
          protos.google.cloud.aiplatform.v1.ICreateTuningJobRequest|null|undefined,
          {}|null|undefined>): void;
  createTuningJob(
      request: protos.google.cloud.aiplatform.v1.ICreateTuningJobRequest,
      callback: Callback<
 ...
 */
  getTuningJob(
      request?: protos.google.cloud.aiplatform.v1.IGetTuningJobRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.ITuningJob,
        protos.google.cloud.aiplatform.v1.IGetTuningJobRequest|undefined, {}|undefined
      ]>;
  getTuningJob(
      request: protos.google.cloud.aiplatform.v1.IGetTuningJobRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.ITuningJob,
          protos.google.cloud.aiplatform.v1.IGetTuningJobRequest|null|undefined,
          {}|null|undefined>): void;
  getTuningJob(
      request: protos.google.cloud.aiplatform.v1.IGetTuningJobRequest,
      callback: Callback<
 ...
 */
  cancelTuningJob(
      request?: protos.google.cloud.aiplatform.v1.ICancelTuningJobRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.cloud.aiplatform.v1.ICancelTuningJobRequest|undefined, {}|undefined
      ]>;
  cancelTuningJob(
      request: protos.google.cloud.aiplatform.v1.ICancelTuningJobRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.aiplatform.v1.ICancelTuningJobRequest|null|undefined,
          {}|null|undefined>): void;
  cancelTuningJob(
      request: protos.google.cloud.aiplatform.v1.ICancelTuningJobRequest,
      callback: Callback<
 ...
 *   Format: `projects/{project}/locations/{location}`
 * @param {google.cloud.aiplatform.v1.TunedModelRef} request.tunedModelRef
 *   Required. TunedModel reference to retrieve the legacy model information.
 * @param {google.cloud.aiplatform.v1.TuningJob} [request.tuningJob]
 *   Optional. The TuningJob to be updated. Users can use this TuningJob field
 *   to overwrite tuning configs.
 * @param {google.cloud.aiplatform.v1.GcsDestination} [request.artifactDestination]
 ...
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/gen_ai_tuning_service.rebase_tuned_model.js</caption>
 * region_tag:aiplatform_v1_generated_GenAiTuningService_RebaseTunedModel_async
 */
  rebaseTunedModel(
      request?: protos.google.cloud.aiplatform.v1.IRebaseTunedModelRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.ITuningJob, protos.google.cloud.aiplatform.v1.IRebaseTunedModelOperationMetadata>,
 ...
 * region_tag:aiplatform_v1_generated_GenAiTuningService_RebaseTunedModel_async
 */
  async checkRebaseTunedModelProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.TuningJob, protos.google.cloud.aiplatform.v1.RebaseTunedModelOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.TuningJob, protos.google.cloud.aiplatform.v1.RebaseTunedModelOperationMetadata>;
  }
 /**
 ...
 */
  listTuningJobs(
      request?: protos.google.cloud.aiplatform.v1.IListTuningJobsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.ITuningJob[],
  ...
  listTuningJobs(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.aiplatform.v1.IListTuningJobsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1.ITuningJob>): void;
  listTuningJobs(
      request: protos.google.cloud.aiplatform.v1.IListTuningJobsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListTuningJobsRequest,
  ...
  listTuningJobs(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1.IListTuningJobsRequest,
      protos.google.cloud.aiplatform.v1.IListTuningJobsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1.ITuningJob>|undefined = callback
 ...
 */
  listTuningJobsAsync(
      request?: protos.google.cloud.aiplatform.v1.IListTuningJobsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1.ITuningJob>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listTuningJobs.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1.ITuningJob>;
  }
/**
