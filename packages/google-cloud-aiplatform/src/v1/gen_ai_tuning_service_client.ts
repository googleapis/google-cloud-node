...
export class GenAiTuningServiceClient {
  ...
  constructor(
    ...
    this.descriptors.page = {
      listTuningJobs: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'tuningJobs',
      ),
      ...
      lroOptions.httpRules = [
        ...
        },
        {
          ...
          additional_bindings: [
            ...
            {
              delete:
                '/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*/operations/*}',
            },
            {
              delete:
   ...
   * region_tag:aiplatform_v1_generated_GenAiTuningService_RebaseTunedModel_async
   */
  async checkRebaseTunedModelProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1.TuningJob,
  ...
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.rebaseTunedModel,
