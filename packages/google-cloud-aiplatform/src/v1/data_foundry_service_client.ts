...
export class DataFoundryServiceClient {
  ...
  initialize() {
    ...
    const dataFoundryServiceStubMethods = ['generateSyntheticData'];
  ...
  generateSyntheticData(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    return this.innerApiCalls
      .generateSyntheticData(request, options, wrappedCallback)
      ?.then(
