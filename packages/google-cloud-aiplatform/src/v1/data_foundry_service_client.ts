 ...
 * `src/v1/data_foundry_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './data_foundry_service_client_config.json';
 ...
 * @memberof v1
 */
export class DataFoundryServiceClient {
  ...
  dataFoundryServiceStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of DataFoundryServiceClient.
   *
   ...
   *     const client = new DataFoundryServiceClient({fallback: true}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    // Ensure that options include all the required fields.
    const staticMembers = this.constructor as typeof DataFoundryServiceClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.DataFoundryService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.dataFoundryServiceStub) {
      return this.dataFoundryServiceStub;
    }

    // Put together the "service stub" for
    // google.cloud.aiplatform.v1.DataFoundryService.
    this.dataFoundryServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.DataFoundryService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.DataFoundryService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const dataFoundryServiceStubMethods =
        ['generateSyntheticData'];
    for (const methodName of dataFoundryServiceStubMethods) {
      const callPromise = this.dataFoundryServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
 ...
 * @param {google.cloud.aiplatform.v1.TaskDescriptionStrategy} request.taskDescription
 ...
 * @param {number[]} request.outputFieldSpecs
 *   Required. The schema of the desired output, defined by a list of fields.
 * @param {number[]} [request.examples]
 *   Optional. A list of few-shot examples to guide the model's output style
 *   and format.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1.GenerateSyntheticDataResponse|GenerateSyntheticDataResponse}.
 *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
 *   for more details and examples.
 * @example <caption>include:samples/generated/v1/data_foundry_service.generate_synthetic_data.js</caption>
 * region_tag:aiplatform_v1_generated_DataFoundryService_GenerateSyntheticData_async
 */
  generateSyntheticData(
      request?: protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataResponse,
        protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataRequest|undefined, {}|undefined
      ]>;
  generateSyntheticData(
      request: protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataResponse,
          protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataRequest|null|undefined,
          {}|null|undefined>): void;
  generateSyntheticData(
      request: protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataRequest,
      callback: Callback<
  ...
  generateSyntheticData(
    ...
    this._log.info('generateSyntheticData request %j', request);
    const wrappedCallback: Callback<
        protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataResponse,
        protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataRequest|null|undefined,
        {}|null|undefined>|undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('generateSyntheticData response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls.generateSyntheticData(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataResponse,
        protos.google.cloud.aiplatform.v1.IGenerateSyntheticDataRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('generateSyntheticData response %j', response);
...
/**
   ...
   */
  close(): Promise<void> {
    if (this.dataFoundryServiceStub && !this._terminated) {
      return this.dataFoundryServiceStub.then(stub => {
