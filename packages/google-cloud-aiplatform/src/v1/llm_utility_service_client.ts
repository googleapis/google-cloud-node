 ...
 */
import * as gapicConfig from './llm_utility_service_client_config.json';
 ...
 * @memberof v1
 */
export class LlmUtilityServiceClient {
  ...
  llmUtilityServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.LlmUtilityService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.llmUtilityServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.LlmUtilityService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.LlmUtilityService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const llmUtilityServiceStubMethods =
        ['countTokens', 'computeTokens'];
 ...
 */
  countTokens(
      request?: protos.google.cloud.aiplatform.v1.ICountTokensRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.ICountTokensResponse,
        protos.google.cloud.aiplatform.v1.ICountTokensRequest|undefined, {}|undefined
      ]>;
  countTokens(
      request: protos.google.cloud.aiplatform.v1.ICountTokensRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.ICountTokensResponse,
          protos.google.cloud.aiplatform.v1.ICountTokensRequest|null|undefined,
          {}|null|undefined>): void;
  countTokens(
      request: protos.google.cloud.aiplatform.v1.ICountTokensRequest,
      callback: Callback<
 ...
 */
  computeTokens(
      request?: protos.google.cloud.aiplatform.v1.IComputeTokensRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IComputeTokensResponse,
        protos.google.cloud.aiplatform.v1.IComputeTokensRequest|undefined, {}|undefined
      ]>;
  computeTokens(
      request: protos.google.cloud.aiplatform.v1.IComputeTokensRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IComputeTokensResponse,
          protos.google.cloud.aiplatform.v1.IComputeTokensRequest|null|undefined,
          {}|null|undefined>): void;
  computeTokens(
      request: protos.google.cloud.aiplatform.v1.IComputeTokensRequest,
      callback: Callback<
