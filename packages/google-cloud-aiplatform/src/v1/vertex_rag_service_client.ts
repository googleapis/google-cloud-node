...
export class VertexRagServiceClient {
  ...
  constructor(
    ...
    const asyncRetrieveContextsResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.AsyncRetrieveContextsResponse',
    ...
    this.descriptors.longrunning = {
      asyncRetrieveContexts: new this._gaxModule.LongrunningDescriptor(
        ...
        asyncRetrieveContextsResponse.decode.bind(
          asyncRetrieveContextsResponse,
        ),
        asyncRetrieveContextsMetadata.decode.bind(
          asyncRetrieveContextsMetadata,
        ),
      ),
    };
  ...
  askContexts(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.aiplatform.v1.IAskContextsResponse,
          | protos.google.cloud.aiplatform.v1.IAskContextsRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .askContexts(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1.IAskContextsResponse,
          protos.google.cloud.aiplatform.v1.IAskContextsRequest | undefined,
  ...
  > | void {
    ...
    return this.innerApiCalls
      .asyncRetrieveContexts(request, options, wrappedCallback)
      ?.then(
   ...
   * region_tag:aiplatform_v1_generated_VertexRagService_AsyncRetrieveContexts_async
   */
  async checkAsyncRetrieveContextsProgress(
    name: string,
  ): Promise<
    LROperation<
      protos.google.cloud.aiplatform.v1.AsyncRetrieveContextsResponse,
      protos.google.cloud.aiplatform.v1.AsyncRetrieveContextsOperationMetadata
    >
  > {
    ...
    const decodeOperation = new this._gaxModule.Operation(
      operation,
      this.descriptors.longrunning.asyncRetrieveContexts,
