...
export class SessionServiceClient {
  ...
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    const createSessionResponse = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.Session') as gax.protobuf.Type;
    const createSessionMetadata = protoFilesRoot.lookup(
      '.google.cloud.aiplatform.v1.CreateSessionOperationMetadata') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.aiplatform.v1.SessionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.sessionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.SessionService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.SessionService,
 ...
 */
  getSession(
      request?: protos.google.cloud.aiplatform.v1.IGetSessionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.ISession,
        protos.google.cloud.aiplatform.v1.IGetSessionRequest|undefined, {}|undefined
      ]>;
  getSession(
      request: protos.google.cloud.aiplatform.v1.IGetSessionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.ISession,
          protos.google.cloud.aiplatform.v1.IGetSessionRequest|null|undefined,
          {}|null|undefined>): void;
  getSession(
      request: protos.google.cloud.aiplatform.v1.IGetSessionRequest,
      callback: Callback<
 ...
 */
  updateSession(
      request?: protos.google.cloud.aiplatform.v1.IUpdateSessionRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.ISession,
        protos.google.cloud.aiplatform.v1.IUpdateSessionRequest|undefined, {}|undefined
      ]>;
  updateSession(
      request: protos.google.cloud.aiplatform.v1.IUpdateSessionRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.ISession,
          protos.google.cloud.aiplatform.v1.IUpdateSessionRequest|null|undefined,
          {}|null|undefined>): void;
  updateSession(
      request: protos.google.cloud.aiplatform.v1.IUpdateSessionRequest,
      callback: Callback<
 ...
 */
  appendEvent(
      request?: protos.google.cloud.aiplatform.v1.IAppendEventRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IAppendEventResponse,
        protos.google.cloud.aiplatform.v1.IAppendEventRequest|undefined, {}|undefined
      ]>;
  appendEvent(
      request: protos.google.cloud.aiplatform.v1.IAppendEventRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IAppendEventResponse,
          protos.google.cloud.aiplatform.v1.IAppendEventRequest|null|undefined,
          {}|null|undefined>): void;
  appendEvent(
      request: protos.google.cloud.aiplatform.v1.IAppendEventRequest,
      callback: Callback<
 ...
 * region_tag:aiplatform_v1_generated_SessionService_CreateSession_async
 */
  async checkCreateSessionProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.Session, protos.google.cloud.aiplatform.v1.CreateSessionOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.aiplatform.v1.Session, protos.google.cloud.aiplatform.v1.CreateSessionOperationMetadata>;
  }
/**
 ...
 */
  deleteSession(
      request?: protos.google.cloud.aiplatform.v1.IDeleteSessionRequest,
      options?: CallOptions):
      Promise<[
 ...
 * region_tag:aiplatform_v1_generated_SessionService_DeleteSession_async
 */
  async checkDeleteSessionProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1.DeleteOperationMetadata>>{
 ...
 */
  listSessions(
      request?: protos.google.cloud.aiplatform.v1.IListSessionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.ISession[],
  ...
  listSessions(
      ...
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListSessionsRequest,
          protos.google.cloud.aiplatform.v1.IListSessionsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1.ISession>): void;
  listSessions(
      request: protos.google.cloud.aiplatform.v1.IListSessionsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListSessionsRequest,
  ...
  listSessions(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1.IListSessionsRequest,
      protos.google.cloud.aiplatform.v1.IListSessionsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1.ISession>|undefined = callback
 ...
 */
  listSessionsAsync(
      request?: protos.google.cloud.aiplatform.v1.IListSessionsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1.ISession>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listSessions.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1.ISession>;
  }
 /**
 ...
 */
  listEvents(
      request?: protos.google.cloud.aiplatform.v1.IListEventsRequest,
      options?: CallOptions):
      Promise<[
  ...
  listEvents(
      ...
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListEventsRequest,
          protos.google.cloud.aiplatform.v1.IListEventsResponse|null|undefined,
          protos.google.cloud.aiplatform.v1.ISessionEvent>): void;
  listEvents(
      request: protos.google.cloud.aiplatform.v1.IListEventsRequest,
      callback: PaginationCallback<
          protos.google.cloud.aiplatform.v1.IListEventsRequest,
  ...
  listEvents(
    ...
    const wrappedCallback: PaginationCallback<
      protos.google.cloud.aiplatform.v1.IListEventsRequest,
      protos.google.cloud.aiplatform.v1.IListEventsResponse|null|undefined,
      protos.google.cloud.aiplatform.v1.ISessionEvent>|undefined = callback
      ? (error, values, nextPageRequest, rawResponse) => {
 ...
 */
  listEventsAsync(
      request?: protos.google.cloud.aiplatform.v1.IListEventsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.aiplatform.v1.ISessionEvent>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listEvents.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<protos.google.cloud.aiplatform.v1.ISessionEvent>;
  }
/**
