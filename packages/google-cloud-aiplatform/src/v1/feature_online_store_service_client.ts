...
export class FeatureOnlineStoreServiceClient {
  ...
  initialize() {
    ...
    this.featureOnlineStoreServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.aiplatform.v1.FeatureOnlineStoreService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.aiplatform.v1.FeatureOnlineStoreService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const featureOnlineStoreServiceStubMethods =
        ['fetchFeatureValues', 'searchNearestEntities', 'featureViewDirectWrite'];
 ...
 */
  fetchFeatureValues(
      request?: protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.aiplatform.v1.IFetchFeatureValuesResponse,
        protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest|undefined, {}|undefined
      ]>;
  fetchFeatureValues(
      request: protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.IFetchFeatureValuesResponse,
          protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest|null|undefined,
          {}|null|undefined>): void;
  fetchFeatureValues(
      request: protos.google.cloud.aiplatform.v1.IFetchFeatureValuesRequest,
      callback: Callback<
 ...
 */
  searchNearestEntities(
      ...
      Promise<[
        ...
        protos.google.cloud.aiplatform.v1.ISearchNearestEntitiesRequest|undefined, {}|undefined
      ]>;
  searchNearestEntities(
      request: protos.google.cloud.aiplatform.v1.ISearchNearestEntitiesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.aiplatform.v1.ISearchNearestEntitiesResponse,
          protos.google.cloud.aiplatform.v1.ISearchNearestEntitiesRequest|null|undefined,
          {}|null|undefined>): void;
  searchNearestEntities(
      request: protos.google.cloud.aiplatform.v1.ISearchNearestEntitiesRequest,
      callback: Callback<
  ...
  searchNearestEntities(
    ...
    return this.innerApiCalls.searchNearestEntities(request, options, wrappedCallback)
      ?.then(([response, options, rawResponse]: [
        protos.google.cloud.aiplatform.v1.ISearchNearestEntitiesResponse,
        protos.google.cloud.aiplatform.v1.ISearchNearestEntitiesRequest|undefined,
        {}|undefined
      ]) => {
        this._log.info('searchNearestEntities response %j', response);
        return [response, options, rawResponse];
