...
export class FeatureOnlineStoreServiceClient {
  ...
  constructor(
    ...
    this.descriptors.stream = {
      featureViewDirectWrite: new this._gaxModule.StreamDescriptor(
  ...
  generateFetchAccessToken(
    ...
    [
      ...
      (
        | protos.google.cloud.aiplatform.v1.IGenerateFetchAccessTokenRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .generateFetchAccessToken(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.aiplatform.v1.IGenerateFetchAccessTokenResponse,
          (
