 ...
 * `src/v1/api_hub_discovery_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './api_hub_discovery_client_config.json';
 ...
 * @memberof v1
 */
export class ApiHubDiscoveryClient {
  ...
  initialize() {
    ...
    if (this.apiHubDiscoveryStub) {
      return this.apiHubDiscoveryStub;
    }
