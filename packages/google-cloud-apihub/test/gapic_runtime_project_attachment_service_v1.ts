...
describe('v1.RuntimeProjectAttachmentServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          runtimeprojectattachmentserviceModule.v1
            .RuntimeProjectAttachmentServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          runtimeprojectattachmentserviceModule.v1
            .RuntimeProjectAttachmentServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        runtimeprojectattachmentserviceModule.v1
          .RuntimeProjectAttachmentServiceClient.port;
      assert(port);
  ...
  describe('createRuntimeProjectAttachment', () => {
    it('invokes createRuntimeProjectAttachment without error', async () => {
      ...
      client.innerApiCalls.createRuntimeProjectAttachment =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createRuntimeProjectAttachment(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createRuntimeProjectAttachment as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes createRuntimeProjectAttachment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createRuntimeProjectAttachment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apihub.v1.IRuntimeProjectAttachment | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRuntimeProjectAttachment', () => {
    it('invokes getRuntimeProjectAttachment without error', async () => {
      ...
      client.innerApiCalls.getRuntimeProjectAttachment =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getRuntimeProjectAttachment(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getRuntimeProjectAttachment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getRuntimeProjectAttachment as SinonStub
  ...
  describe('deleteRuntimeProjectAttachment', () => {
    it('invokes deleteRuntimeProjectAttachment without error', async () => {
      ...
      client.innerApiCalls.deleteRuntimeProjectAttachment =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteRuntimeProjectAttachment(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRuntimeProjectAttachment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRuntimeProjectAttachment as SinonStub
  ...
  describe('lookupRuntimeProjectAttachment', () => {
    it('invokes lookupRuntimeProjectAttachment without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.lookupRuntimeProjectAttachment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.lookupRuntimeProjectAttachment as SinonStub
    ...
    it('invokes lookupRuntimeProjectAttachment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.lookupRuntimeProjectAttachment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apihub.v1.ILookupRuntimeProjectAttachmentResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listRuntimeProjectAttachments', () => {
    it('invokes listRuntimeProjectAttachments without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRuntimeProjectAttachments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRuntimeProjectAttachments as SinonStub
    ...
    it('invokes listRuntimeProjectAttachments with error', async () => {
      ...
      await assert.rejects(
        client.listRuntimeProjectAttachments(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.listRuntimeProjectAttachments as SinonStub
    ...
    it('invokes listRuntimeProjectAttachmentsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.apihub.v1.RuntimeProjectAttachment
          ) => {
