  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new provisioningModule.v1.ProvisioningClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new provisioningModule.v1.ProvisioningClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new provisioningModule.v1.ProvisioningClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new provisioningModule.v1.ProvisioningClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getApiHubInstance', () => {
        it('invokes getApiHubInstance without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.apihub.v1.GetApiHubInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.GetApiHubInstanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.apihub.v1.ApiHubInstance()
            );
            client.innerApiCalls.getApiHubInstance = stubSimpleCall(expectedResponse);
            const [response] = await client.getApiHubInstance(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getApiHubInstance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getApiHubInstance as SinonStub)
        ...
        it('invokes getApiHubInstance without error using callback', async () => {
            ...
            client.innerApiCalls.getApiHubInstance = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getApiHubInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.IApiHubInstance|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getApiHubInstance with error', async () => {
            ...
            client.innerApiCalls.getApiHubInstance = stubSimpleCall(undefined, expectedError);
    ...
    describe('lookupApiHubInstance', () => {
        it('invokes lookupApiHubInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.apihub.v1.LookupApiHubInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.LookupApiHubInstanceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.apihub.v1.LookupApiHubInstanceResponse()
            );
            client.innerApiCalls.lookupApiHubInstance = stubSimpleCall(expectedResponse);
            const [response] = await client.lookupApiHubInstance(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.lookupApiHubInstance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.lookupApiHubInstance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes lookupApiHubInstance without error using callback', async () => {
            ...
            client.innerApiCalls.lookupApiHubInstance = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.lookupApiHubInstance(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.ILookupApiHubInstanceResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes lookupApiHubInstance with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.lookupApiHubInstance = stubSimpleCall(undefined, expectedError);
    ...
    describe('createApiHubInstance', () => {
        it('invokes createApiHubInstance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.apihub.v1.CreateApiHubInstanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.CreateApiHubInstanceRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createApiHubInstance = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createApiHubInstance(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createApiHubInstance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createApiHubInstance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createApiHubInstance without error using callback', async () => {
            ...
            client.innerApiCalls.createApiHubInstance = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createApiHubInstance(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.apihub.v1.IApiHubInstance, protos.google.cloud.apihub.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.apihub.v1.IApiHubInstance, protos.google.cloud.apihub.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createApiHubInstance as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createApiHubInstance with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createApiHubInstance = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.createApiHubInstance(request), expectedError);
            const actualRequest = (client.innerApiCalls.createApiHubInstance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createApiHubInstance as SinonStub)
        ...
        it('invokes createApiHubInstance with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createApiHubInstance = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createApiHubInstance(request);
        ...
        it('invokes checkCreateApiHubInstanceProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreateApiHubInstanceProgress(expectedResponse.name);
        ...
        it('invokes checkCreateApiHubInstanceProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreateApiHubInstanceProgress(''), expectedError);
