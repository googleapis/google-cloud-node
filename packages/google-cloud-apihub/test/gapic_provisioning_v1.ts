...
describe('v1.ProvisioningClient', () => {
  ...
  describe('getApiHubInstance', () => {
    it('invokes getApiHubInstance without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getApiHubInstance as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getApiHubInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getApiHubInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apihub.v1.IApiHubInstance | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getApiHubInstance with error', async () => {
      ...
      client.innerApiCalls.getApiHubInstance = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('lookupApiHubInstance', () => {
    it('invokes lookupApiHubInstance without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.lookupApiHubInstance as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.lookupApiHubInstance as SinonStub
    ...
    it('invokes lookupApiHubInstance without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.lookupApiHubInstance(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apihub.v1.ILookupApiHubInstanceResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes lookupApiHubInstance with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.lookupApiHubInstance = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createApiHubInstance', () => {
    it('invokes createApiHubInstance without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createApiHubInstance as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createApiHubInstance as SinonStub
    ...
    it('invokes createApiHubInstance with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createApiHubInstance = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteApiHubInstance', () => {
    it('invokes deleteApiHubInstance without error', async () => {
      ...
      client.innerApiCalls.deleteApiHubInstance =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteApiHubInstance(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteApiHubInstance as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteApiHubInstance as SinonStub
    ...
    it('invokes deleteApiHubInstance with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteApiHubInstance = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteApiHubInstanceProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteApiHubInstanceProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
