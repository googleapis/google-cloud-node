...
describe('v1.ApiHubClient', () => {
  ...
  describe('createApiOperation', () => {
    it('invokes createApiOperation without error', async () => {
      ...
      client.innerApiCalls.createApiOperation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createApiOperation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createApiOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createApiOperation as SinonStub
    ...
    it('invokes createApiOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createApiOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateApiOperation', () => {
    it('invokes updateApiOperation without error', async () => {
      ...
      client.innerApiCalls.updateApiOperation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateApiOperation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateApiOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateApiOperation as SinonStub
    ...
    it('invokes updateApiOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `api_operation.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateApiOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteApiOperation', () => {
    it('invokes deleteApiOperation without error', async () => {
      ...
      client.innerApiCalls.deleteApiOperation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteApiOperation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteApiOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteApiOperation as SinonStub
    ...
    it('invokes deleteApiOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteApiOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
