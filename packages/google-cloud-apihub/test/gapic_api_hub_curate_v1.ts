...
describe('v1.ApiHubCurateClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          apihubcurateModule.v1.ApiHubCurateClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          apihubcurateModule.v1.ApiHubCurateClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new apihubcurateModule.v1.ApiHubCurateClient({
          universe_domain: 'example.com',
  ...
  describe('createCuration', () => {
    it('invokes createCuration without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.createCuration as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes createCuration without error using callback', async () => {
      ...
      client.innerApiCalls.createCuration =
      ...
      const promise = new Promise((resolve, reject) => {
        client.createCuration(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apihub.v1.ICuration | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createCuration with error', async () => {
      ...
      client.innerApiCalls.createCuration = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getCuration', () => {
    it('invokes getCuration without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getCuration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getCuration as SinonStub
    ...
    it('invokes getCuration without error using callback', async () => {
      ...
      client.innerApiCalls.getCuration =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getCuration(
          request,
    ...
    it('invokes getCuration with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getCuration = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateCuration', () => {
    it('invokes updateCuration without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateCuration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateCuration as SinonStub
    ...
    it('invokes updateCuration without error using callback', async () => {
      ...
      client.innerApiCalls.updateCuration =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateCuration with error', async () => {
      ...
      const expectedHeaderRequestParams = `curation.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateCuration = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deleteCuration', () => {
    it('invokes deleteCuration without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteCuration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteCuration as SinonStub
    ...
    it('invokes deleteCuration without error using callback', async () => {
      ...
      client.innerApiCalls.deleteCuration =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deleteCuration with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteCuration = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listCurations', () => {
    it('invokes listCurations without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listCurations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listCurations as SinonStub
    ...
    it('invokes listCurations without error using callback', async () => {
      ...
      client.innerApiCalls.listCurations =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listCurations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listCurations = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listCurationsStream without error', async () => {
      ...
      client.descriptors.page.listCurations.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.apihub.v1.Curation) => {
      ...
      assert(
        (client.descriptors.page.listCurations.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listCurations, request),
      );
      assert(
        (client.descriptors.page.listCurations.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listCurations without error', async () => {
      ...
      client.descriptors.page.listCurations.asyncIterate =
