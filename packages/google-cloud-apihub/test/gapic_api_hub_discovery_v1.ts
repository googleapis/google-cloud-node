...
describe('v1.ApiHubDiscoveryClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          apihubdiscoveryModule.v1.ApiHubDiscoveryClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          apihubdiscoveryModule.v1.ApiHubDiscoveryClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new apihubdiscoveryModule.v1.ApiHubDiscoveryClient({
          universe_domain: 'example.com',
  ...
  describe('getDiscoveredApiObservation', () => {
    it('invokes getDiscoveredApiObservation without error', async () => {
      ...
      client.innerApiCalls.getDiscoveredApiObservation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDiscoveredApiObservation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDiscoveredApiObservation as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDiscoveredApiObservation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDiscoveredApiObservation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apihub.v1.IDiscoveredApiObservation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDiscoveredApiObservation with error', async () => {
      ...
      client.innerApiCalls.getDiscoveredApiObservation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDiscoveredApiObservation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDiscoveredApiObservation as SinonStub
  ...
  describe('getDiscoveredApiOperation', () => {
    it('invokes getDiscoveredApiOperation without error', async () => {
      ...
      client.innerApiCalls.getDiscoveredApiOperation =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDiscoveredApiOperation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDiscoveredApiOperation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDiscoveredApiOperation as SinonStub
    ...
    it('invokes getDiscoveredApiOperation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDiscoveredApiOperation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.apihub.v1.IDiscoveredApiOperation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDiscoveredApiOperation with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDiscoveredApiOperation = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDiscoveredApiOperation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDiscoveredApiOperation as SinonStub
  ...
  describe('listDiscoveredApiObservations', () => {
    it('invokes listDiscoveredApiObservations without error', async () => {
      ...
      client.innerApiCalls.listDiscoveredApiObservations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDiscoveredApiObservations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDiscoveredApiObservations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDiscoveredApiObservations as SinonStub
    ...
    it('invokes listDiscoveredApiObservations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDiscoveredApiObservations = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDiscoveredApiObservations(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDiscoveredApiObservations as SinonStub
    ...
    it('invokes listDiscoveredApiObservationsStream without error', async () => {
      ...
      client.descriptors.page.listDiscoveredApiObservations.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.apihub.v1.DiscoveredApiObservation,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listDiscoveredApiObservations
    ...
    it('uses async iteration with listDiscoveredApiObservations without error', async () => {
      ...
      client.descriptors.page.listDiscoveredApiObservations.asyncIterate =
  ...
  describe('listDiscoveredApiOperations', () => {
    it('invokes listDiscoveredApiOperations without error', async () => {
      ...
      client.innerApiCalls.listDiscoveredApiOperations =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDiscoveredApiOperations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDiscoveredApiOperations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDiscoveredApiOperations as SinonStub
    ...
    it('invokes listDiscoveredApiOperations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDiscoveredApiOperations = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDiscoveredApiOperations(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDiscoveredApiOperations as SinonStub
    ...
    it('invokes listDiscoveredApiOperationsStream without error', async () => {
      ...
      client.descriptors.page.listDiscoveredApiOperations.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.apihub.v1.DiscoveredApiOperation) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listDiscoveredApiOperations
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listDiscoveredApiOperations without error', async () => {
      ...
      client.descriptors.page.listDiscoveredApiOperations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
