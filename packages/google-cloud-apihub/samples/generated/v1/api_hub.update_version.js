...
function main(version, updateMask) {
  // [START apihub_v1_generated_ApiHub_UpdateVersion_async]
  /**
  ...
  async function callUpdateVersion() {
    ...
    // Run request
    const response = await apihubClient.updateVersion(request);
    console.log(response);
  }

  callUpdateVersion();
  // [END apihub_v1_generated_ApiHub_UpdateVersion_async]
}
