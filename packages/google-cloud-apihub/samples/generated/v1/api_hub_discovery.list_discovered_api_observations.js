...
function main(parent) {
  ...
  async function callListDiscoveredApiObservations() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = apihubClient.listDiscoveredApiObservationsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListDiscoveredApiObservations();
