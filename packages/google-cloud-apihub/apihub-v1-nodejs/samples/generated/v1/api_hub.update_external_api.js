...
function main(externalApi, updateMask) {
  ...
  async function callUpdateExternalApi() {
    // Construct request
    const request = {
      externalApi,
      updateMask,
    ...
    // Run request
    const response = await apihubClient.updateExternalApi(request);
    console.log(response);
  }

  callUpdateExternalApi();
