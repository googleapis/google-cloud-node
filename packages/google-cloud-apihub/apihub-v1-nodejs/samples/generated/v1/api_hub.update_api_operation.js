...
function main(apiOperation, updateMask) {
  ...
  async function callUpdateApiOperation() {
    // Construct request
    const request = {
      apiOperation,
      updateMask,
    ...
    // Run request
    const response = await apihubClient.updateApiOperation(request);
    console.log(response);
  }

  callUpdateApiOperation();
