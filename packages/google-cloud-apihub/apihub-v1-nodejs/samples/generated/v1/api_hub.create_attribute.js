...
function main(parent, attribute) {
  // [START apihub_v1_generated_ApiHub_CreateAttribute_async]
  /**
  ...
  async function callCreateAttribute() {
    // Construct request
    const request = {
      parent,
      attribute,
    ...
    // Run request
    const response = await apihubClient.createAttribute(request);
