...
describe('v1.HostProjectRegistrationServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new hostprojectregistrationserviceModule.v1.HostProjectRegistrationServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = hostprojectregistrationserviceModule.v1.HostProjectRegistrationServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = hostprojectregistrationserviceModule.v1.HostProjectRegistrationServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'apihub.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new hostprojectregistrationserviceModule.v1.HostProjectRegistrationServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new hostprojectregistrationserviceModule.v1.HostProjectRegistrationServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'apihub.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new hostprojectregistrationserviceModule.v1.HostProjectRegistrationServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new hostprojectregistrationserviceModule.v1.HostProjectRegistrationServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = hostprojectregistrationserviceModule.v1.HostProjectRegistrationServiceClient.port;
            assert(port);
    ...
    describe('createHostProjectRegistration', () => {
        it('invokes createHostProjectRegistration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.CreateHostProjectRegistrationRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.apihub.v1.HostProjectRegistration()
            );
            client.innerApiCalls.createHostProjectRegistration = stubSimpleCall(expectedResponse);
            const [response] = await client.createHostProjectRegistration(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createHostProjectRegistration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createHostProjectRegistration as SinonStub)
        ...
        it('invokes createHostProjectRegistration without error using callback', async () => {
            ...
            client.innerApiCalls.createHostProjectRegistration = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createHostProjectRegistration(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.apihub.v1.IHostProjectRegistration|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createHostProjectRegistration with error', async () => {
            ...
            client.innerApiCalls.createHostProjectRegistration = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createHostProjectRegistration(request), expectedError);
            const actualRequest = (client.innerApiCalls.createHostProjectRegistration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createHostProjectRegistration as SinonStub)
    ...
    describe('getHostProjectRegistration', () => {
        it('invokes getHostProjectRegistration without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.GetHostProjectRegistrationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.apihub.v1.HostProjectRegistration()
            );
            client.innerApiCalls.getHostProjectRegistration = stubSimpleCall(expectedResponse);
            const [response] = await client.getHostProjectRegistration(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getHostProjectRegistration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getHostProjectRegistration as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getHostProjectRegistration without error using callback', async () => {
            ...
            client.innerApiCalls.getHostProjectRegistration = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getHostProjectRegistration with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getHostProjectRegistration = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getHostProjectRegistration(request), expectedError);
            const actualRequest = (client.innerApiCalls.getHostProjectRegistration as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getHostProjectRegistration as SinonStub)
    ...
    describe('listHostProjectRegistrations', () => {
        it('invokes listHostProjectRegistrations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.apihub.v1.ListHostProjectRegistrationsRequest', ['parent']);
            request.parent = defaultValue1;
            ...
            client.innerApiCalls.listHostProjectRegistrations = stubSimpleCall(expectedResponse);
            const [response] = await client.listHostProjectRegistrations(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listHostProjectRegistrations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listHostProjectRegistrations as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listHostProjectRegistrations without error using callback', async () => {
            ...
            client.innerApiCalls.listHostProjectRegistrations = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listHostProjectRegistrations with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listHostProjectRegistrations = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listHostProjectRegistrations(request), expectedError);
            const actualRequest = (client.innerApiCalls.listHostProjectRegistrations as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listHostProjectRegistrations as SinonStub)
        ...
        it('invokes listHostProjectRegistrationsStream without error', async () => {
            ...
            assert((client.descriptors.page.listHostProjectRegistrations.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listHostProjectRegistrations, request));
            assert(
                (client.descriptors.page.listHostProjectRegistrations.createStream as SinonStub)
        ...
        it('invokes listHostProjectRegistrationsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listHostProjectRegistrations.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listHostProjectRegistrationsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.apihub.v1.HostProjectRegistration[] = [];
                stream.on('data', (response: protos.google.cloud.apihub.v1.HostProjectRegistration) => {
        ...
        it('uses async iteration with listHostProjectRegistrations without error', async () => {
            ...
            client.descriptors.page.listHostProjectRegistrations.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listHostProjectRegistrations.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listHostProjectRegistrations with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.descriptors.page.listHostProjectRegistrations.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listHostProjectRegistrationsAsync(request);
