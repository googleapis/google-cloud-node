...
class AutoMlClient {
  ...
  constructor(opts) {
    ...
    const autoMlStub = gaxGrpc.createStub(
      opts.fallback
        ? protos.lookupService('google.cloud.automl.v1.AutoMl')
        : protos.google.cloud.automl.v1.AutoMl,
      opts
    );
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Dataset]{@link google.cloud.automl.v1.Dataset}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [Dataset]{@link google.cloud.automl.v1.Dataset}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListDatasetsResponse]{@link google.cloud.automl.v1.ListDatasetsResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Dataset]{@link google.cloud.automl.v1.Dataset}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Dataset]{@link google.cloud.automl.v1.Dataset} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListDatasetsResponse]{@link google.cloud.automl.v1.ListDatasetsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Model]{@link google.cloud.automl.v1.Model}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [Model]{@link google.cloud.automl.v1.Model}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListModelsResponse]{@link google.cloud.automl.v1.ListModelsResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Model]{@link google.cloud.automl.v1.Model}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Model]{@link google.cloud.automl.v1.Model} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListModelsResponse]{@link google.cloud.automl.v1.ListModelsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [ModelEvaluation]{@link google.cloud.automl.v1.ModelEvaluation}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [ModelEvaluation]{@link google.cloud.automl.v1.ModelEvaluation}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListModelEvaluationsResponse]{@link google.cloud.automl.v1.ListModelEvaluationsResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [ModelEvaluation]{@link google.cloud.automl.v1.ModelEvaluation}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [ModelEvaluation]{@link google.cloud.automl.v1.ModelEvaluation} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListModelEvaluationsResponse]{@link google.cloud.automl.v1.ListModelEvaluationsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
