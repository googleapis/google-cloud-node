 ...
 * @see [google.cloud.automl.v1.NormalizedVertex definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/automl/v1/geometry.proto}
 */
 ...
 *
 *   This object should have the same structure as [NormalizedVertex]{@link google.cloud.automl.v1.NormalizedVertex}
 *
 * @typedef BoundingPoly
 * @memberof google.cloud.automl.v1
 * @see [google.cloud.automl.v1.BoundingPoly definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/automl/v1/geometry.proto}
 */
const BoundingPoly = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};