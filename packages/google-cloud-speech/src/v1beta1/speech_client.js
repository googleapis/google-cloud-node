...
class SpeechClient {
  ...
  constructor(opts) {
    ...
    var asyncRecognizeResponse = protoFilesRoot.lookup(
      'google.cloud.speech.v1beta1.AsyncRecognizeResponse'
    );
    var asyncRecognizeMetadata = protoFilesRoot.lookup(
    ...
    this._descriptors.longrunning = {
      asyncRecognize: new gax.LongrunningDescriptor(
        ...
        asyncRecognizeResponse.decode.bind(asyncRecognizeResponse),
        asyncRecognizeMetadata.decode.bind(asyncRecognizeMetadata)
      ),
    };
    ...
    var speechStub = gaxGrpc.createStub(
      protos.google.cloud.speech.v1beta1.Speech,
      opts
    );
   ...
   *
   *   The second parameter to the callback is an object representing [SyncRecognizeResponse]{@link google.cloud.speech.v1beta1.SyncRecognizeResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing [SyncRecognizeResponse]{@link google.cloud.speech.v1beta1.SyncRecognizeResponse}.
   ...
   *   });
   */
  syncRecognize(request, options, callback) {
    ...
    return this._innerApiCalls.syncRecognize(request, options, callback);
  }
   ...
   *   });
   */
  asyncRecognize(request, options, callback) {
    if (options instanceof Function && callback === undefined) {
      callback = options;
      options = {};
    }
    ...
    return this._innerApiCalls.asyncRecognize(request, options, callback);
  }
   ...
   *   representing [StreamingRecognizeRequest]{@link google.cloud.speech.v1beta1.StreamingRecognizeRequest} for write() method, and
   *   will emit objects representing [StreamingRecognizeResponse]{@link google.cloud.speech.v1beta1.StreamingRecognizeResponse} on 'data' event asynchronously.
   *
   * @example
   *
   * const speech = require('@google-cloud/speech');
