...
proto3.util.setEnumType(ErrorReason, "google.api.ErrorReason", [
  { no: 0, name: "ERROR_REASON_UNSPECIFIED" },
  { no: 1, name: "SERVICE_DISABLED" },
  { no: 2, name: "BILLING_DISABLED" },
  { no: 3, name: "API_KEY_INVALID" },
  { no: 4, name: "API_KEY_SERVICE_BLOCKED" },
  { no: 7, name: "API_KEY_HTTP_REFERRER_BLOCKED" },
  { no: 8, name: "API_KEY_IP_ADDRESS_BLOCKED" },
  { no: 9, name: "API_KEY_ANDROID_APP_BLOCKED" },
  { no: 13, name: "API_KEY_IOS_APP_BLOCKED" },
  { no: 5, name: "RATE_LIMIT_EXCEEDED" },
  { no: 6, name: "RESOURCE_QUOTA_EXCEEDED" },
  { no: 10, name: "LOCATION_TAX_POLICY_VIOLATED" },
  { no: 11, name: "USER_PROJECT_DENIED" },
  { no: 12, name: "CONSUMER_SUSPENDED" },
  { no: 14, name: "CONSUMER_INVALID" },
  { no: 15, name: "SECURITY_POLICY_VIOLATED" },
  { no: 16, name: "ACCESS_TOKEN_EXPIRED" },
  { no: 17, name: "ACCESS_TOKEN_SCOPE_INSUFFICIENT" },
  { no: 18, name: "ACCOUNT_STATE_INVALID" },
  { no: 19, name: "ACCESS_TOKEN_TYPE_UNSUPPORTED" },
  { no: 20, name: "CREDENTIALS_MISSING" },
  { no: 21, name: "RESOURCE_PROJECT_INVALID" },
  { no: 23, name: "SESSION_COOKIE_INVALID" },
  { no: 24, name: "USER_BLOCKED_BY_ADMIN" },
  { no: 25, name: "RESOURCE_USAGE_RESTRICTION_VIOLATED" },
  { no: 26, name: "SYSTEM_PARAMETER_UNSUPPORTED" },
  { no: 27, name: "ORG_RESTRICTION_VIOLATION" },
  { no: 28, name: "ORG_RESTRICTION_HEADER_INVALID" },
]);
