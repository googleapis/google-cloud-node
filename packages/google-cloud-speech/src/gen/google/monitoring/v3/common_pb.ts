...
// Retrieve enum metadata with: proto3.getEnumType(ComparisonType)
proto3.util.setEnumType(ComparisonType, "google.monitoring.v3.ComparisonType", [
  { no: 0, name: "COMPARISON_UNSPECIFIED" },
  { no: 1, name: "COMPARISON_GT" },
  { no: 2, name: "COMPARISON_GE" },
  { no: 3, name: "COMPARISON_LT" },
  { no: 4, name: "COMPARISON_LE" },
  { no: 5, name: "COMPARISON_EQ" },
  { no: 6, name: "COMPARISON_NE" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(ServiceTier)
proto3.util.setEnumType(ServiceTier, "google.monitoring.v3.ServiceTier", [
  { no: 0, name: "SERVICE_TIER_UNSPECIFIED" },
  { no: 1, name: "SERVICE_TIER_BASIC" },
  { no: 2, name: "SERVICE_TIER_PREMIUM" },
]);
...
proto3.util.setEnumType(Aggregation_Aligner, "google.monitoring.v3.Aggregation.Aligner", [
  ...
  { no: 23, name: "ALIGN_PERCENT_CHANGE" },
]);
