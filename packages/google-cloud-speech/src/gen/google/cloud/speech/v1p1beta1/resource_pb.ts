...
export class CustomClass extends Message<CustomClass> {
  ...
  static readonly typeName = "google.cloud.speech.v1p1beta1.CustomClass";
...
export class CustomClass_ClassItem extends Message<CustomClass_ClassItem> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.speech.v1p1beta1.CustomClass.ClassItem";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class PhraseSet extends Message<PhraseSet> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.speech.v1p1beta1.PhraseSet";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class PhraseSet_Phrase extends Message<PhraseSet_Phrase> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.speech.v1p1beta1.PhraseSet.Phrase";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export class SpeechAdaptation extends Message<SpeechAdaptation> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.speech.v1p1beta1.SpeechAdaptation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class SpeechAdaptation_ABNFGrammar extends Message<SpeechAdaptation_ABNFGrammar> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.speech.v1p1beta1.SpeechAdaptation.ABNFGrammar";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 */
export class TranscriptNormalization extends Message<TranscriptNormalization> {
  /**
  ...
  constructor(data?: PartialMessage<TranscriptNormalization>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.speech.v1p1beta1.TranscriptNormalization";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "entries", kind: "message", T: TranscriptNormalization_Entry, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TranscriptNormalization {
    return new TranscriptNormalization().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TranscriptNormalization {
    return new TranscriptNormalization().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TranscriptNormalization {
    return new TranscriptNormalization().fromJsonString(jsonString, options);
  }

  static equals(a: TranscriptNormalization | PlainMessage<TranscriptNormalization> | undefined, b: TranscriptNormalization | PlainMessage<TranscriptNormalization> | undefined): boolean {
    return proto3.util.equals(TranscriptNormalization, a, b);
  }
}
 ...
 */
export class TranscriptNormalization_Entry extends Message<TranscriptNormalization_Entry> {
  /**
  ...
  constructor(data?: PartialMessage<TranscriptNormalization_Entry>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.cloud.speech.v1p1beta1.TranscriptNormalization.Entry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TranscriptNormalization_Entry {
    return new TranscriptNormalization_Entry().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TranscriptNormalization_Entry {
    return new TranscriptNormalization_Entry().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TranscriptNormalization_Entry {
    return new TranscriptNormalization_Entry().fromJsonString(jsonString, options);
  }

  static equals(a: TranscriptNormalization_Entry | PlainMessage<TranscriptNormalization_Entry> | undefined, b: TranscriptNormalization_Entry | PlainMessage<TranscriptNormalization_Entry> | undefined): boolean {
    return proto3.util.equals(TranscriptNormalization_Entry, a, b);
  }
}
