 ...
 * `src/v1/user_list_global_license_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './user_list_global_license_service_client_config.json';
 ...
 * @memberof v1
 */
export class UserListGlobalLicenseServiceClient {
  ...
  initialize() {
    ...
    if (this.userListGlobalLicenseServiceStub) {
      return this.userListGlobalLicenseServiceStub;
    }
