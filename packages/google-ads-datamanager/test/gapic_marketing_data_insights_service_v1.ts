...
describe('v1.MarketingDataInsightsServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          marketingdatainsightsserviceModule.v1
            .MarketingDataInsightsServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          marketingdatainsightsserviceModule.v1
            .MarketingDataInsightsServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'datamanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        marketingdatainsightsserviceModule.v1.MarketingDataInsightsServiceClient
          .port;
      assert(port);
  ...
  describe('retrieveInsights', () => {
    it('invokes retrieveInsights without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.ads.datamanager.v1.RetrieveInsightsRequest',
        ['parent'],
      );
      ...
      const actualRequest = (
        client.innerApiCalls.retrieveInsights as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes retrieveInsights without error using callback', async () => {
      ...
      client.innerApiCalls.retrieveInsights =
      ...
      const promise = new Promise((resolve, reject) => {
        client.retrieveInsights(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.datamanager.v1.IRetrieveInsightsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes retrieveInsights with error', async () => {
      ...
      client.innerApiCalls.retrieveInsights = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('Path templates', () => {
    describe('partnerLink', async () => {
      ...
      await client.initialize();
      client.pathTemplates.partnerLinkPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.partnerLinkPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('partnerLinkPath', () => {
        const result = client.partnerLinkPath(
          'accountTypeValue',
          'accountValue',
          'partnerLinkValue',
        );
        ...
        assert(
          (client.pathTemplates.partnerLinkPathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchAccountTypeFromPartnerLinkName', () => {
        ...
        assert(
          (client.pathTemplates.partnerLinkPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('userList', async () => {
      ...
      await client.initialize();
      client.pathTemplates.userListPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.userListPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('userListPath', () => {
        const result = client.userListPath(
          'accountTypeValue',
          'accountValue',
          'userListValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.userListPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchAccountTypeFromUserListName', () => {
        ...
        assert.strictEqual(result, 'accountTypeValue');
        assert(
          (client.pathTemplates.userListPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('userListDirectLicense', async () => {
      ...
      await client.initialize();
      client.pathTemplates.userListDirectLicensePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.userListDirectLicensePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('userListDirectLicensePath', () => {
        const result = client.userListDirectLicensePath(
          'accountTypeValue',
          'accountValue',
          'userListDirectLicenseValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
      ...
      it('matchAccountTypeFromUserListDirectLicenseName', () => {
        const result =
          client.matchAccountTypeFromUserListDirectLicenseName(fakePath);
        assert.strictEqual(result, 'accountTypeValue');
        assert(
          (
            client.pathTemplates.userListDirectLicensePathTemplate
      ...
      it('matchAccountFromUserListDirectLicenseName', () => {
        const result =
          client.matchAccountFromUserListDirectLicenseName(fakePath);
        assert.strictEqual(result, 'accountValue');
        assert(
          (
            client.pathTemplates.userListDirectLicensePathTemplate
      ...
      it('matchUserListDirectLicenseFromUserListDirectLicenseName', () => {
        const result =
          client.matchUserListDirectLicenseFromUserListDirectLicenseName(
            fakePath,
          );
    ...
    describe('userListGlobalLicense', async () => {
      ...
      await client.initialize();
      client.pathTemplates.userListGlobalLicensePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.userListGlobalLicensePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('userListGlobalLicensePath', () => {
        const result = client.userListGlobalLicensePath(
          'accountTypeValue',
          'accountValue',
          'userListGlobalLicenseValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.userListGlobalLicensePathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchAccountTypeFromUserListGlobalLicenseName', () => {
        const result =
          client.matchAccountTypeFromUserListGlobalLicenseName(fakePath);
        assert.strictEqual(result, 'accountTypeValue');
        assert(
          (
            client.pathTemplates.userListGlobalLicensePathTemplate
      ...
      it('matchAccountFromUserListGlobalLicenseName', () => {
        const result =
          client.matchAccountFromUserListGlobalLicenseName(fakePath);
        assert.strictEqual(result, 'accountValue');
        assert(
          (
            client.pathTemplates.userListGlobalLicensePathTemplate
      ...
      it('matchUserListGlobalLicenseFromUserListGlobalLicenseName', () => {
        const result =
          client.matchUserListGlobalLicenseFromUserListGlobalLicenseName(
            fakePath,
          );
    ...
    describe('userListGlobalLicenseCustomerInfo', async () => {
      ...
      it('userListGlobalLicenseCustomerInfoPath', () => {
        const result = client.userListGlobalLicenseCustomerInfoPath(
          'accountTypeValue',
          'accountValue',
          'userListGlobalLicenseValue',
          'licenseCustomerInfoValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.userListGlobalLicenseCustomerInfoPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchAccountTypeFromUserListGlobalLicenseCustomerInfoName', () => {
        const result =
          client.matchAccountTypeFromUserListGlobalLicenseCustomerInfoName(
            fakePath,
          );
        assert.strictEqual(result, 'accountTypeValue');
        assert(
      ...
      it('matchAccountFromUserListGlobalLicenseCustomerInfoName', () => {
        const result =
          client.matchAccountFromUserListGlobalLicenseCustomerInfoName(
            fakePath,
          );
        assert.strictEqual(result, 'accountValue');
        assert(
      ...
      it('matchUserListGlobalLicenseFromUserListGlobalLicenseCustomerInfoName', () => {
        const result =
          client.matchUserListGlobalLicenseFromUserListGlobalLicenseCustomerInfoName(
            fakePath,
          );
        assert.strictEqual(result, 'userListGlobalLicenseValue');
        assert(
      ...
      it('matchLicenseCustomerInfoFromUserListGlobalLicenseCustomerInfoName', () => {
        const result =
          client.matchLicenseCustomerInfoFromUserListGlobalLicenseCustomerInfoName(
            fakePath,
          );
