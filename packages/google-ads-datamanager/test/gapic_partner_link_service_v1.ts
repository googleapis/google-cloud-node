...
describe('v1.PartnerLinkServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          partnerlinkserviceModule.v1.PartnerLinkServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          partnerlinkserviceModule.v1.PartnerLinkServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'datamanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new partnerlinkserviceModule.v1.PartnerLinkServiceClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'datamanager.example.com');
          if (saved) {
  ...
  describe('createPartnerLink', () => {
    it('invokes createPartnerLink without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.createPartnerLink as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes createPartnerLink without error using callback', async () => {
      ...
      client.innerApiCalls.createPartnerLink =
      ...
      const promise = new Promise((resolve, reject) => {
        client.createPartnerLink(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.datamanager.v1.IPartnerLink | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes createPartnerLink with error', async () => {
      ...
      client.innerApiCalls.createPartnerLink = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('deletePartnerLink', () => {
    it('invokes deletePartnerLink without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deletePartnerLink as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deletePartnerLink as SinonStub
    ...
    it('invokes deletePartnerLink without error using callback', async () => {
      ...
      client.innerApiCalls.deletePartnerLink =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes deletePartnerLink with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deletePartnerLink = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('searchPartnerLinks', () => {
    it('invokes searchPartnerLinks without error', async () => {
      ...
      client.innerApiCalls.searchPartnerLinks =
        stubSimpleCall(expectedResponse);
      const [response] = await client.searchPartnerLinks(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.searchPartnerLinks as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.searchPartnerLinks as SinonStub
    ...
    it('invokes searchPartnerLinks with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.searchPartnerLinks = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes searchPartnerLinksStream without error', async () => {
      ...
      client.descriptors.page.searchPartnerLinks.createStream =
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.ads.datamanager.v1.PartnerLink) => {
      ...
      assert(
        (client.descriptors.page.searchPartnerLinks.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.searchPartnerLinks, request),
      );
      assert(
        (client.descriptors.page.searchPartnerLinks.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with searchPartnerLinks without error', async () => {
      ...
      client.descriptors.page.searchPartnerLinks.asyncIterate =
