...
describe('v1.IngestionServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          ingestionserviceModule.v1.IngestionServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          ingestionserviceModule.v1.IngestionServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'datamanager.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new ingestionserviceModule.v1.IngestionServiceClient({
          universe_domain: 'example.com',
  ...
  describe('ingestAudienceMembers', () => {
    ...
    it('invokes ingestAudienceMembers without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.ingestAudienceMembers(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.datamanager.v1.IIngestAudienceMembersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes ingestAudienceMembers with error', async () => {
      ...
      client.innerApiCalls.ingestAudienceMembers = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('removeAudienceMembers', () => {
    it('invokes removeAudienceMembers without error', async () => {
      ...
      client.innerApiCalls.removeAudienceMembers =
        stubSimpleCall(expectedResponse);
    ...
    it('invokes removeAudienceMembers without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.removeAudienceMembers(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.datamanager.v1.IRemoveAudienceMembersResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes removeAudienceMembers with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.removeAudienceMembers = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
  ...
  describe('ingestEvents', () => {
    ...
    it('invokes ingestEvents without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.ingestEvents(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.datamanager.v1.IIngestEventsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes ingestEvents with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.ingestEvents = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('retrieveRequestStatus', () => {
    it('invokes retrieveRequestStatus without error', async () => {
      ...
      client.innerApiCalls.retrieveRequestStatus =
        stubSimpleCall(expectedResponse);
    ...
    it('invokes retrieveRequestStatus without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.retrieveRequestStatus(
          ...
          (
            err?: Error | null,
            result?: protos.google.ads.datamanager.v1.IRetrieveRequestStatusResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes retrieveRequestStatus with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.retrieveRequestStatus = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
