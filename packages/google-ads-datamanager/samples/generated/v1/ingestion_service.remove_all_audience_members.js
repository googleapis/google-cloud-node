...
function main(destinations) {
  ...
  async function callRemoveAllAudienceMembers() {
    // Construct request
    const request = {
      destinations,
    };
    ...
    // Run request
    const response = await datamanagerClient.removeAllAudienceMembers(request);
    console.log(response);
  }

  callRemoveAllAudienceMembers();
