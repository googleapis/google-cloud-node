...
function main(parent) {
  // [START datamanager_v1_generated_UserListGlobalLicenseService_ListUserListGlobalLicenses_async]
  /**
  ...
  async function callListUserListGlobalLicenses() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = datamanagerClient.listUserListGlobalLicensesAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListUserListGlobalLicenses();
  // [END datamanager_v1_generated_UserListGlobalLicenseService_ListUserListGlobalLicenses_async]
}
