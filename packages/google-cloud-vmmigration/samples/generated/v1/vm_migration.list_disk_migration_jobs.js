...
function main(parent) {
  // [START vmmigration_v1_generated_VmMigration_ListDiskMigrationJobs_async]
  /**
  ...
  async function callListDiskMigrationJobs() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const iterable = vmmigrationClient.listDiskMigrationJobsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callListDiskMigrationJobs();
  // [END vmmigration_v1_generated_VmMigration_ListDiskMigrationJobs_async]
}
