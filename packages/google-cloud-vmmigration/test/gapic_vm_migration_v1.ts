...
describe('v1.VmMigrationClient', () => {
  ...
  describe('getImageImport', () => {
    it('invokes getImageImport without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getImageImport as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getImageImport as SinonStub
    ...
    it('invokes getImageImport without error using callback', async () => {
      ...
      client.innerApiCalls.getImageImport =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getImageImport(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.vmmigration.v1.IImageImport | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getImageImport with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getImageImport = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getImageImportJob', () => {
    it('invokes getImageImportJob without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getImageImportJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getImageImportJob as SinonStub
    ...
    it('invokes getImageImportJob without error using callback', async () => {
      ...
      client.innerApiCalls.getImageImportJob =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getImageImportJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.vmmigration.v1.IImageImportJob | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getImageImportJob with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getImageImportJob = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getDiskMigrationJob', () => {
    it('invokes getDiskMigrationJob without error', async () => {
      ...
      client.innerApiCalls.getDiskMigrationJob =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDiskMigrationJob(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDiskMigrationJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDiskMigrationJob as SinonStub
    ...
    it('invokes getDiskMigrationJob without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDiskMigrationJob(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.vmmigration.v1.IDiskMigrationJob | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDiskMigrationJob with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDiskMigrationJob = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('extendMigration', () => {
    it('invokes extendMigration without error', async () => {
      ...
      client.innerApiCalls.extendMigration =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.extendMigration(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.extendMigration as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.extendMigration as SinonStub
    ...
    it('invokes extendMigration with call error', async () => {
      ...
      const expectedHeaderRequestParams = `migrating_vm=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.extendMigration = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('createImageImport', () => {
    it('invokes createImageImport without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createImageImport as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createImageImport as SinonStub
    ...
    it('invokes createImageImport with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createImageImport = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateImageImportProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateImageImportProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteImageImport', () => {
    it('invokes deleteImageImport without error', async () => {
      ...
      client.innerApiCalls.deleteImageImport =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteImageImport(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteImageImport as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteImageImport as SinonStub
    ...
    it('invokes deleteImageImport with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteImageImport = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteImageImportProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteImageImportProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('cancelImageImportJob', () => {
    it('invokes cancelImageImportJob without error', async () => {
      ...
      client.innerApiCalls.cancelImageImportJob =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.cancelImageImportJob(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.cancelImageImportJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.cancelImageImportJob as SinonStub
    ...
    it('invokes cancelImageImportJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.cancelImageImportJob = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCancelImageImportJobProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCancelImageImportJobProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createDiskMigrationJob', () => {
    it('invokes createDiskMigrationJob without error', async () => {
      ...
      client.innerApiCalls.createDiskMigrationJob =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createDiskMigrationJob(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDiskMigrationJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDiskMigrationJob as SinonStub
    ...
    it('invokes createDiskMigrationJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDiskMigrationJob = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createDiskMigrationJob(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createDiskMigrationJob as SinonStub
  ...
  describe('updateDiskMigrationJob', () => {
    it('invokes updateDiskMigrationJob without error', async () => {
      ...
      client.innerApiCalls.updateDiskMigrationJob =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateDiskMigrationJob(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDiskMigrationJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDiskMigrationJob as SinonStub
    ...
    it('invokes updateDiskMigrationJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `disk_migration_job.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDiskMigrationJob = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateDiskMigrationJob(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateDiskMigrationJob as SinonStub
  ...
  describe('deleteDiskMigrationJob', () => {
    it('invokes deleteDiskMigrationJob without error', async () => {
      ...
      client.innerApiCalls.deleteDiskMigrationJob =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteDiskMigrationJob(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDiskMigrationJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDiskMigrationJob as SinonStub
    ...
    it('invokes deleteDiskMigrationJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDiskMigrationJob = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteDiskMigrationJob(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteDiskMigrationJob as SinonStub
    ...
    it('invokes checkDeleteDiskMigrationJobProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteDiskMigrationJobProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('runDiskMigrationJob', () => {
    it('invokes runDiskMigrationJob without error', async () => {
      ...
      client.innerApiCalls.runDiskMigrationJob =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.runDiskMigrationJob(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.runDiskMigrationJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.runDiskMigrationJob as SinonStub
    ...
    it('invokes runDiskMigrationJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.runDiskMigrationJob = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkRunDiskMigrationJobProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkRunDiskMigrationJobProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('cancelDiskMigrationJob', () => {
    it('invokes cancelDiskMigrationJob without error', async () => {
      ...
      client.innerApiCalls.cancelDiskMigrationJob =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.cancelDiskMigrationJob(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.cancelDiskMigrationJob as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.cancelDiskMigrationJob as SinonStub
    ...
    it('invokes cancelDiskMigrationJob with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.cancelDiskMigrationJob = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.cancelDiskMigrationJob(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.cancelDiskMigrationJob as SinonStub
  ...
  describe('fetchStorageInventory', () => {
    it('invokes fetchStorageInventory without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.vmmigration.v1.SourceStorageResource(),
        ),
        generateSampleMessage(
          new protos.google.cloud.vmmigration.v1.SourceStorageResource(),
        ),
      ...
      client.innerApiCalls.fetchStorageInventory =
        stubSimpleCall(expectedResponse);
      const [response] = await client.fetchStorageInventory(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.fetchStorageInventory as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.fetchStorageInventory as SinonStub
    ...
    it('invokes fetchStorageInventory with error', async () => {
      ...
      const expectedHeaderRequestParams = `source=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.fetchStorageInventory = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.fetchStorageInventory(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.fetchStorageInventory as SinonStub
    ...
    it('invokes fetchStorageInventoryStream without error', async () => {
      ...
      client.descriptors.page.fetchStorageInventory.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.vmmigration.v1.SourceStorageResource,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.fetchStorageInventory
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.fetchStorageInventory, request),
      );
      assert(
        (
          client.descriptors.page.fetchStorageInventory
    ...
    it('uses async iteration with fetchStorageInventory without error', async () => {
      ...
      client.descriptors.page.fetchStorageInventory.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listImageImports', () => {
    it('invokes listImageImports without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listImageImports as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listImageImports as SinonStub
    ...
    it('invokes listImageImports without error using callback', async () => {
      ...
      client.innerApiCalls.listImageImports =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listImageImports with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listImageImports = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listImageImportsStream without error', async () => {
      ...
      client.descriptors.page.listImageImports.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.vmmigration.v1.ImageImport) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listImageImports.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listImageImports, request),
      );
      assert(
        (client.descriptors.page.listImageImports.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listImageImports without error', async () => {
      ...
      client.descriptors.page.listImageImports.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listImageImportJobs', () => {
    it('invokes listImageImportJobs without error', async () => {
      ...
      client.innerApiCalls.listImageImportJobs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listImageImportJobs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listImageImportJobs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listImageImportJobs as SinonStub
    ...
    it('invokes listImageImportJobs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listImageImportJobs = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listImageImportJobsStream without error', async () => {
      ...
      client.descriptors.page.listImageImportJobs.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.vmmigration.v1.ImageImportJob) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listImageImportJobs.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listImageImportJobs, request),
      );
      assert(
        (client.descriptors.page.listImageImportJobs.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listImageImportJobs without error', async () => {
      ...
      client.descriptors.page.listImageImportJobs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listDiskMigrationJobs', () => {
    it('invokes listDiskMigrationJobs without error', async () => {
      ...
      client.innerApiCalls.listDiskMigrationJobs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDiskMigrationJobs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDiskMigrationJobs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDiskMigrationJobs as SinonStub
    ...
    it('invokes listDiskMigrationJobs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDiskMigrationJobs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDiskMigrationJobs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDiskMigrationJobs as SinonStub
    ...
    it('invokes listDiskMigrationJobsStream without error', async () => {
      ...
      client.descriptors.page.listDiskMigrationJobs.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.vmmigration.v1.DiskMigrationJob) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listDiskMigrationJobs
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listDiskMigrationJobs, request),
      );
      assert(
        (
          client.descriptors.page.listDiskMigrationJobs
    ...
    it('uses async iteration with listDiskMigrationJobs without error', async () => {
      ...
      client.descriptors.page.listDiskMigrationJobs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('diskMigrationJob', async () => {
      ...
      await client.initialize();
      client.pathTemplates.diskMigrationJobPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.diskMigrationJobPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('diskMigrationJobPath', () => {
        const result = client.diskMigrationJobPath(
          'projectValue',
          'locationValue',
          'sourceValue',
          'diskMigrationJobValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
      ...
      it('matchProjectFromDiskMigrationJobName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.diskMigrationJobPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchDiskMigrationJobFromDiskMigrationJobName', () => {
        const result =
          client.matchDiskMigrationJobFromDiskMigrationJobName(fakePath);
    ...
    describe('imageImport', async () => {
      ...
      await client.initialize();
      client.pathTemplates.imageImportPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.imageImportPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('imageImportPath', () => {
        const result = client.imageImportPath(
          'projectValue',
          'locationValue',
          'jobValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.imageImportPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromImageImportName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.imageImportPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('imageImportJob', async () => {
      ...
      await client.initialize();
      client.pathTemplates.imageImportJobPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.imageImportJobPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('imageImportJobPath', () => {
        const result = client.imageImportJobPath(
          'projectValue',
          'locationValue',
          'jobValue',
          'resultValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.imageImportJobPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromImageImportJobName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.imageImportJobPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
