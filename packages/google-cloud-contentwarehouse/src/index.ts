...
const DocumentLinkServiceClient = v1.DocumentLinkServiceClient;
type DocumentLinkServiceClient = v1.DocumentLinkServiceClient;
const DocumentSchemaServiceClient = v1.DocumentSchemaServiceClient;
