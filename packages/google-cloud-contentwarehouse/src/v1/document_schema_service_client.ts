...
export class DocumentSchemaServiceClient {
   ...
   *   The first element of the array is an object representing [DocumentSchema]{@link google.cloud.contentwarehouse.v1.DocumentSchema}.
   *   Please see the
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [DocumentSchema]{@link google.cloud.contentwarehouse.v1.DocumentSchema}.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing [DocumentSchema]{@link google.cloud.contentwarehouse.v1.DocumentSchema} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   [DocumentSchema]{@link google.cloud.contentwarehouse.v1.DocumentSchema}. The API will be called under the hood as needed, once per the page,
