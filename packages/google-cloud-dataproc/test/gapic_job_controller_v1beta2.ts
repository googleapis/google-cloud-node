...
describe('v1beta2.JobControllerClient', () => {
    ...
    describe('submitJob', () => {
        it('invokes submitJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.Job());
        ...
        it('invokes submitJob without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.submitJob(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataproc.v1beta2.IJob|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getJob', () => {
        it('invokes getJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.GetJobRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.Job());
    ...
    describe('updateJob', () => {
        it('invokes updateJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.UpdateJobRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.Job());
    ...
    describe('cancelJob', () => {
        it('invokes cancelJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.CancelJobRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.Job());
    ...
    describe('deleteJob', () => {
        it('invokes deleteJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.DeleteJobRequest());
            const expectedOptions = {};
    ...
    describe('listJobs', () => {
        it('invokes listJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.ListJobsRequest());
            const expectedOptions = {};
        ...
        it('invokes listJobsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataproc.v1beta2.Job) => {
        ...
        it('uses async iteration with listJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.ListJobsRequest());const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.Job()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.Job()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.Job()),
            ];
