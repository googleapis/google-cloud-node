...
describe('v1.ClusterControllerClient', () => {
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1.Cluster());
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.CreateClusterRequest());
            const expectedOptions = {};
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.UpdateClusterRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.DeleteClusterRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
    ...
    describe('diagnoseCluster', () => {
        it('invokes diagnoseCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.DiagnoseClusterRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
        ...
        it('invokes diagnoseCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.diagnoseCluster(
                    request,
                    (err?: Error|null, 
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataproc.v1.IDiagnoseClusterResults>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataproc.v1.IDiagnoseClusterResults>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.diagnoseCluster as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.ListClustersRequest());
            const expectedOptions = {};
        ...
        it('uses async iteration with listClusters without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.ListClustersRequest());const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataproc.v1.Cluster()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1.Cluster()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1.Cluster()),
            ];
        ...
        it('uses async iteration with listClusters with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.ListClustersRequest());const expectedError = new Error('expected');
