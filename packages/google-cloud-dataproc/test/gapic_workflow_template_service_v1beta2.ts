...
describe('v1beta2.WorkflowTemplateServiceClient', () => {
    ...
    describe('createWorkflowTemplate', () => {
        it('invokes createWorkflowTemplate without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.CreateWorkflowTemplateRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.WorkflowTemplate());
        ...
        it('invokes createWorkflowTemplate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createWorkflowTemplate(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dataproc.v1beta2.IWorkflowTemplate|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getWorkflowTemplate', () => {
        it('invokes getWorkflowTemplate without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.GetWorkflowTemplateRequest());
            request.name = '';
    ...
    describe('updateWorkflowTemplate', () => {
        it('invokes updateWorkflowTemplate without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.UpdateWorkflowTemplateRequest());
            request.template = {};
    ...
    describe('deleteWorkflowTemplate', () => {
        it('invokes deleteWorkflowTemplate without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.DeleteWorkflowTemplateRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('instantiateWorkflowTemplate', () => {
        it('invokes instantiateWorkflowTemplate without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.InstantiateWorkflowTemplateRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes instantiateWorkflowTemplate without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.instantiateWorkflowTemplate(
                    request,
                    (err?: Error|null, 
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataproc.v1beta2.IWorkflowMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dataproc.v1beta2.IWorkflowMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.instantiateWorkflowTemplate as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('instantiateInlineWorkflowTemplate', () => {
        it('invokes instantiateInlineWorkflowTemplate without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.InstantiateInlineWorkflowTemplateRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listWorkflowTemplates', () => {
        it('invokes listWorkflowTemplates without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.ListWorkflowTemplatesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.WorkflowTemplate()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.WorkflowTemplate()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1beta2.WorkflowTemplate()),
            ];
        ...
        it('invokes listWorkflowTemplatesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dataproc.v1beta2.WorkflowTemplate) => {
