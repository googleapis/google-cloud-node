...
describe('v1.JobControllerClient', () => {
    ...
    describe('submitJob', () => {
        it('invokes submitJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dataproc.v1.Job());
    ...
    describe('listJobs', () => {
        ...
        it('uses async iteration with listJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.ListJobsRequest());const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataproc.v1.Job()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1.Job()),
              generateSampleMessage(new protos.google.cloud.dataproc.v1.Job()),
            ];
        ...
        it('uses async iteration with listJobs with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dataproc.v1.ListJobsRequest());const expectedError = new Error('expected');
