 ...
 * `src/v1beta2/autoscaling_policy_service_client_config.json`.
...
export class AutoscalingPolicyServiceClient {
   ...
   *   [AutoscalingPolicy]{@link google.cloud.dataproc.v1beta2.AutoscalingPolicy}. The API will be called under the hood as needed, once per the page,
