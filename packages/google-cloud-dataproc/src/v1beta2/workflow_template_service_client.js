...
class WorkflowTemplateServiceClient {
  ...
  constructor(opts) {
    ...
    this._pathTemplates = {
      ...
      workflowTemplatePathTemplate: new gaxModule.PathTemplate(
    ...
    this._descriptors.page = {
      listWorkflowTemplates: new gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'templates'
      ),
    ...
    for (const methodName of workflowTemplateServiceStubMethods) {
      const innerCallPromise = workflowTemplateServiceStub.then(
        stub => (...args) => {
