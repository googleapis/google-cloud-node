...
export class WorkflowTemplateServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the WorkflowTemplateServiceClient constructor.
    this._gaxModule = opts.fallback ? gax.fallback : gax;

    // Create a `gaxGrpc` object, with any grpc-specific options
    // sent to the client.
    opts.scopes = (this
      .constructor as typeof WorkflowTemplateServiceClient).scopes;
  ...
  /**
   * Equivalent to {@link listWorkflowTemplates}, but returns an iterable object.
   *
