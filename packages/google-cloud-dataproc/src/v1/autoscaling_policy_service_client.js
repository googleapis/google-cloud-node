...
class AutoscalingPolicyServiceClient {
  ...
  constructor(opts) {
    ...
    const autoscalingPolicyServiceStub = gaxGrpc.createStub(
      opts.fallback
        ...
        : protos.google.cloud.dataproc.v1.AutoscalingPolicyService,
      opts
    );
   ...
   *
   *   The second parameter to the callback is an object representing [AutoscalingPolicy]{@link google.cloud.dataproc.v1.AutoscalingPolicy}.
   ...
   *
   * const client = new dataproc.v1.AutoscalingPolicyServiceClient({
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [AutoscalingPolicy]{@link google.cloud.dataproc.v1.AutoscalingPolicy}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListAutoscalingPoliciesResponse]{@link google.cloud.dataproc.v1.ListAutoscalingPoliciesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The first element is Array of [AutoscalingPolicy]{@link google.cloud.dataproc.v1.AutoscalingPolicy} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListAutoscalingPoliciesResponse]{@link google.cloud.dataproc.v1.ListAutoscalingPoliciesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
