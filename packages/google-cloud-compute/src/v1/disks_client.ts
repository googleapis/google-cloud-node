...
export class DisksClient {
  ...
  initialize() {
    ...
    const disksStubMethods =
        ['addResourcePolicies', 'aggregatedList', 'bulkInsert', 'bulkSetLabels', 'createSnapshot', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'removeResourcePolicies', 'resize', 'setIamPolicy', 'setLabels', 'startAsyncReplication', 'stopAsyncReplication', 'stopGroupAsyncReplication', 'testIamPermissions', 'update', 'updateKmsKey'];
 ...
 */
  ...
  startAsyncReplication(
      ...
      callback: Callback<
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IStartAsyncReplicationDiskRequest|null|undefined,
          {}|null|undefined>): void;
  startAsyncReplication(
      request: protos.google.cloud.compute.v1.IStartAsyncReplicationDiskRequest,
      callback: Callback<
 ...
 */
  ...
  stopAsyncReplication(
      ...
      callback: Callback<
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IStopAsyncReplicationDiskRequest|null|undefined,
          {}|null|undefined>): void;
  stopAsyncReplication(
      request: protos.google.cloud.compute.v1.IStopAsyncReplicationDiskRequest,
      callback: Callback<
 ...
 */
  ...
  stopGroupAsyncReplication(
      ...
      callback: Callback<
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IStopGroupAsyncReplicationDiskRequest|null|undefined,
          {}|null|undefined>): void;
  stopGroupAsyncReplication(
      request: protos.google.cloud.compute.v1.IStopGroupAsyncReplicationDiskRequest,
      callback: Callback<
 ...
 */
  ...
  updateKmsKey(
      ...
      callback: Callback<
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IUpdateKmsKeyDiskRequest|null|undefined,
          {}|null|undefined>): void;
  updateKmsKey(
      request: protos.google.cloud.compute.v1.IUpdateKmsKeyDiskRequest,
      callback: Callback<
 ...
 */
  aggregatedListAsync(
    ...
    return this.descriptors.page.aggregatedList.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<[string, protos.google.cloud.compute.v1.IDisksScopedList]>;
  }
 /**
