 ...
 */
import * as gapicConfig from './networks_client_config.json';
...
export class NetworksClient {
  ...
  networksStub?: Promise<{[name: string]: Function}>;
  ...
  > | void {
    ...
    return this.innerApiCalls
      .addPeering(request, options, wrappedCallback)
      ?.then(
   ...
   * @param {google.cloud.compute.v1.NetworksCancelRequestRemovePeeringRequest} request.networksCancelRequestRemovePeeringRequestResource
   *   The body resource for this request
   * @param {string} request.project
   *   Project ID for this request.
   * @param {string} request.requestId
   ...
   *   and might get backwards-incompatible changes at any time.
   *   `.promise()` is not supported yet.
   * @example <caption>include:samples/generated/v1/networks.cancel_request_remove_peering.js</caption>
   * region_tag:compute_v1_generated_Networks_CancelRequestRemovePeering_async
   */
  cancelRequestRemovePeering(
    request?: protos.google.cloud.compute.v1.ICancelRequestRemovePeeringNetworkRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<protos.google.cloud.compute.v1.IOperation, null>,
  ...
  cancelRequestRemovePeering(
    ...
    callback: Callback<
      protos.google.cloud.compute.v1.IOperation,
      | protos.google.cloud.compute.v1.ICancelRequestRemovePeeringNetworkRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    this._log.info('cancelRequestRemovePeering request %j', request);
    const wrappedCallback:
      | Callback<
          protos.google.cloud.compute.v1.IOperation,
          | protos.google.cloud.compute.v1.ICancelRequestRemovePeeringNetworkRequest
      ...
      | undefined = callback
      ? (error, response, nextRequest, rawResponse) => {
          this._log.info('cancelRequestRemovePeering response %j', rawResponse);
          callback!(error, response, nextRequest, rawResponse); // We verified `callback` above.
        }
      : undefined;
    return this.innerApiCalls
      .cancelRequestRemovePeering(request, options, wrappedCallback)
      ?.then(
        ([response, operation, rawResponse]: [
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IOperation,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .removePeering(request, options, wrappedCallback)
      ?.then(
        ([response, operation, rawResponse]: [
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IOperation,
   ...
   */
  requestRemovePeering(
    request?: protos.google.cloud.compute.v1.IRequestRemovePeeringNetworkRequest,
    options?: CallOptions,
  ): Promise<
    [
      LROperation<protos.google.cloud.compute.v1.IOperation, null>,
  ...
  requestRemovePeering(
    ...
    callback: Callback<
      protos.google.cloud.compute.v1.IOperation,
      | protos.google.cloud.compute.v1.IRequestRemovePeeringNetworkRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .requestRemovePeering(request, options, wrappedCallback)
      ?.then(
        ([response, operation, rawResponse]: [
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IOperation,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .switchToCustomMode(request, options, wrappedCallback)
      ?.then(
        ([response, operation, rawResponse]: [
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IOperation,
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      : undefined;
    return this.innerApiCalls
      .updatePeering(request, options, wrappedCallback)
      ?.then(
        ([response, operation, rawResponse]: [
          protos.google.cloud.compute.v1.IOperation,
          protos.google.cloud.compute.v1.IOperation,
  ...
  list(
    ...
    callback: PaginationCallback<
      ...
      protos.google.cloud.compute.v1.INetworkList | null | undefined,
      protos.google.cloud.compute.v1.INetwork
    >,
  ): void;
  list(
