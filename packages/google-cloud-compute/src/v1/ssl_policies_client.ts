...
export class SslPoliciesClient {
   ...
   *   as tuple [string, {@link google.cloud.compute.v1.SslPoliciesScopedList | SslPoliciesScopedList}]. The API will be called under the hood as needed, once per the page,
