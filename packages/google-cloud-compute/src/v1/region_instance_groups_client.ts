 ...
 */
  testIamPermissions(
      request?: protos.google.cloud.compute.v1.ITestIamPermissionsRegionInstanceGroupRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.compute.v1.ITestPermissionsResponse,
        protos.google.cloud.compute.v1.ITestIamPermissionsRegionInstanceGroupRequest|undefined, {}|undefined
      ]>;
  testIamPermissions(
      request: protos.google.cloud.compute.v1.ITestIamPermissionsRegionInstanceGroupRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.ITestPermissionsResponse,
          protos.google.cloud.compute.v1.ITestIamPermissionsRegionInstanceGroupRequest|null|undefined,
          {}|null|undefined>): void;
  testIamPermissions(
      request: protos.google.cloud.compute.v1.ITestIamPermissionsRegionInstanceGroupRequest,
      callback: Callback<
