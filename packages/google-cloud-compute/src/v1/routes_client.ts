...
export class RoutesClient {
  ...
  delete(
    ...
    [
      ...
      protos.google.cloud.compute.v1.IDeleteRouteRequest | undefined,
      {} | undefined
    ]
  >;
  delete(
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing [Route]{@link google.cloud.compute.v1.Route}.
   *   Please see the
   *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
   *   for more details and examples.
   * @example
  ...
  insert(
    ...
    [
      protos.google.cloud.compute.v1.IOperation,
      protos.google.cloud.compute.v1.IInsertRouteRequest | undefined,
      {} | undefined
    ]
  >;
  insert(
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Route]{@link google.cloud.compute.v1.Route}.
   ...
   *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
   * @returns {Stream}
   *   An object stream which emits an object representing [Route]{@link google.cloud.compute.v1.Route} on 'data' event.
   *   The client library will perform auto-pagination by default: it will call the API as many
   ...
   *   [Route]{@link google.cloud.compute.v1.Route}. The API will be called under the hood as needed, once per the page,
