...
export class SslCertificatesClient {
   ...
   *   as tuple [string, [SslCertificatesScopedList]{@link google.cloud.compute.v1.SslCertificatesScopedList}]. The API will be called under the hood as needed, once per the page,
