...
const GlobalVmExtensionPoliciesClient = v1.GlobalVmExtensionPoliciesClient;
type GlobalVmExtensionPoliciesClient = v1.GlobalVmExtensionPoliciesClient;
const HealthChecksClient = v1.HealthChecksClient;
type HealthChecksClient = v1.HealthChecksClient;
const HostsClient = v1.HostsClient;
type HostsClient = v1.HostsClient;
...
const ProjectViewsClient = v1.ProjectViewsClient;
type ProjectViewsClient = v1.ProjectViewsClient;
...
const ReliabilityRisksClient = v1.ReliabilityRisksClient;
type ReliabilityRisksClient = v1.ReliabilityRisksClient;
...
const RolloutPlansClient = v1.RolloutPlansClient;
type RolloutPlansClient = v1.RolloutPlansClient;
const RolloutsClient = v1.RolloutsClient;
type RolloutsClient = v1.RolloutsClient;
...
export {v1small, v1, v1beta, AcceleratorTypesClient, AddressesClient, AdviceClient, AutoscalersClient, BackendBucketsClient, BackendServicesClient, CrossSiteNetworksClient, DiskTypesClient, DisksClient, ExternalVpnGatewaysClient, FirewallPoliciesClient, FirewallsClient, ForwardingRulesClient, FutureReservationsClient, GlobalAddressesClient, GlobalForwardingRulesClient, GlobalNetworkEndpointGroupsClient, GlobalOperationsClient, GlobalOrganizationOperationsClient, GlobalPublicDelegatedPrefixesClient, GlobalVmExtensionPoliciesClient, HealthChecksClient, HostsClient, ImageFamilyViewsClient, ImagesClient, InstanceGroupManagerResizeRequestsClient, InstanceGroupManagersClient, InstanceGroupsClient, InstanceSettingsServiceClient, InstanceTemplatesClient, InstancesClient, InstantSnapshotGroupsClient, InstantSnapshotsClient, InterconnectAttachmentGroupsClient, InterconnectAttachmentsClient, InterconnectGroupsClient, InterconnectLocationsClient, InterconnectRemoteLocationsClient, InterconnectsClient, LicenseCodesClient, LicensesClient, MachineImagesClient, MachineTypesClient, NetworkAttachmentsClient, NetworkEdgeSecurityServicesClient, NetworkEndpointGroupsClient, NetworkFirewallPoliciesClient, NetworkProfilesClient, NetworksClient, NodeGroupsClient, NodeTemplatesClient, NodeTypesClient, OrganizationSecurityPoliciesClient, PacketMirroringsClient, PreviewFeaturesClient, ProjectViewsClient, ProjectsClient, PublicAdvertisedPrefixesClient, PublicDelegatedPrefixesClient, RegionAutoscalersClient, RegionBackendBucketsClient, RegionBackendServicesClient, RegionCommitmentsClient, RegionCompositeHealthChecksClient, RegionDiskTypesClient, RegionDisksClient, RegionHealthAggregationPoliciesClient, RegionHealthCheckServicesClient, RegionHealthChecksClient, RegionHealthSourcesClient, RegionInstanceGroupManagerResizeRequestsClient, RegionInstanceGroupManagersClient, RegionInstanceGroupsClient, RegionInstanceTemplatesClient, RegionInstancesClient, RegionInstantSnapshotGroupsClient, RegionInstantSnapshotsClient, RegionNetworkEndpointGroupsClient, RegionNetworkFirewallPoliciesClient, RegionNotificationEndpointsClient, RegionOperationsClient, RegionSecurityPoliciesClient, RegionSnapshotSettingsClient, RegionSnapshotsClient, RegionSslCertificatesClient, RegionSslPoliciesClient, RegionTargetHttpProxiesClient, RegionTargetHttpsProxiesClient, RegionTargetTcpProxiesClient, RegionUrlMapsClient, RegionZonesClient, RegionsClient, ReliabilityRisksClient, ReservationBlocksClient, ReservationSlotsClient, ReservationSubBlocksClient, ReservationsClient, ResourcePoliciesClient, RolloutPlansClient, RolloutsClient, RoutersClient, RoutesClient, SecurityPoliciesClient, ServiceAttachmentsClient, SnapshotSettingsServiceClient, SnapshotsClient, SslCertificatesClient, SslPoliciesClient, StoragePoolTypesClient, StoragePoolsClient, SubnetworksClient, TargetGrpcProxiesClient, TargetHttpProxiesClient, TargetHttpsProxiesClient, TargetInstancesClient, TargetPoolsClient, TargetSslProxiesClient, TargetTcpProxiesClient, TargetVpnGatewaysClient, UrlMapsClient, VpnGatewaysClient, VpnTunnelsClient, WireGroupsClient, ZoneOperationsClient, ZoneVmExtensionPoliciesClient, ZonesClient};
