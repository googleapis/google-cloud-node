...
function main() {
  ...
  const instantSnapshotGroupsClient = new compute.InstantSnapshotGroupsClient();
  ...
  const regionBackendBucketsClient = new compute.RegionBackendBucketsClient();
  ...
  const regionCompositeHealthChecksClient = new compute.RegionCompositeHealthChecksClient();
  const regionDisksClient = new compute.RegionDisksClient();
  const regionDiskTypesClient = new compute.RegionDiskTypesClient();
  const regionHealthAggregationPoliciesClient = new compute.RegionHealthAggregationPoliciesClient();
  ...
  const regionHealthSourcesClient = new compute.RegionHealthSourcesClient();
  ...
  const regionInstantSnapshotGroupsClient = new compute.RegionInstantSnapshotGroupsClient();
  ...
  const rolloutPlansClient = new compute.RolloutPlansClient();
  const rolloutsClient = new compute.RolloutsClient();
  ...
  const zoneVmExtensionPoliciesClient = new compute.ZoneVmExtensionPoliciesClient();
}
