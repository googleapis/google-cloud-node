...
function doStuffWithAdviceClient(client: AdviceClient) {
  client.close();
}
...
function doStuffWithCrossSiteNetworksClient(client: CrossSiteNetworksClient) {
  client.close();
}
...
function doStuffWithFutureReservationsClient(client: FutureReservationsClient) {
  client.close();
}
...
function doStuffWithGlobalVmExtensionPoliciesClient(
...
function doStuffWithInstantSnapshotGroupsClient(
...
function doStuffWithInterconnectAttachmentGroupsClient(
...
function doStuffWithOrganizationSecurityPoliciesClient(
...
function doStuffWithPreviewFeaturesClient(client: PreviewFeaturesClient) {
  client.close();
}
...
function doStuffWithRegionBackendBucketsClient(
...
function doStuffWithRegionCompositeHealthChecksClient(
  client: RegionCompositeHealthChecksClient,
) {
  client.close();
}
...
function doStuffWithRegionHealthAggregationPoliciesClient(
...
function doStuffWithRegionHealthSourcesClient(
  client: RegionHealthSourcesClient,
) {
  client.close();
}
function doStuffWithRegionInstanceGroupManagerResizeRequestsClient(
...
function doStuffWithRegionInstantSnapshotGroupsClient(
...
function doStuffWithRegionSnapshotsClient(client: RegionSnapshotsClient) {
  client.close();
}
function doStuffWithRegionSnapshotSettingsClient(
...
function doStuffWithReservationSlotsClient(client: ReservationSlotsClient) {
  client.close();
}
function doStuffWithReservationSubBlocksClient(
...
function doStuffWithRolloutPlansClient(client: RolloutPlansClient) {
  client.close();
}
function doStuffWithRolloutsClient(client: RolloutsClient) {
  client.close();
}
...
function doStuffWithWireGroupsClient(client: WireGroupsClient) {
  client.close();
}
...
function doStuffWithZoneVmExtensionPoliciesClient(
...
function main() {
  ...
  // check that the client instance can be created
  const adviceClient = new AdviceClient();
  doStuffWithAdviceClient(adviceClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const crossSiteNetworksClient = new CrossSiteNetworksClient();
  doStuffWithCrossSiteNetworksClient(crossSiteNetworksClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const futureReservationsClient = new FutureReservationsClient();
  doStuffWithFutureReservationsClient(futureReservationsClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const globalVmExtensionPoliciesClient = new GlobalVmExtensionPoliciesClient();
  doStuffWithGlobalVmExtensionPoliciesClient(globalVmExtensionPoliciesClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const instantSnapshotGroupsClient = new InstantSnapshotGroupsClient();
  doStuffWithInstantSnapshotGroupsClient(instantSnapshotGroupsClient);
  // check that the client instance can be created
  const instantSnapshotsClient = new InstantSnapshotsClient();
  doStuffWithInstantSnapshotsClient(instantSnapshotsClient);
  // check that the client instance can be created
  const interconnectAttachmentGroupsClient =
    new InterconnectAttachmentGroupsClient();
  doStuffWithInterconnectAttachmentGroupsClient(
    interconnectAttachmentGroupsClient,
  );
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const organizationSecurityPoliciesClient =
    new OrganizationSecurityPoliciesClient();
  doStuffWithOrganizationSecurityPoliciesClient(
    organizationSecurityPoliciesClient,
  );
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const previewFeaturesClient = new PreviewFeaturesClient();
  doStuffWithPreviewFeaturesClient(previewFeaturesClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const regionBackendBucketsClient = new RegionBackendBucketsClient();
  doStuffWithRegionBackendBucketsClient(regionBackendBucketsClient);
  // check that the client instance can be created
  ...
  const regionCompositeHealthChecksClient =
    new RegionCompositeHealthChecksClient();
  doStuffWithRegionCompositeHealthChecksClient(
    regionCompositeHealthChecksClient,
  );
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const regionHealthAggregationPoliciesClient =
    new RegionHealthAggregationPoliciesClient();
  doStuffWithRegionHealthAggregationPoliciesClient(
    regionHealthAggregationPoliciesClient,
  );
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const regionHealthSourcesClient = new RegionHealthSourcesClient();
  doStuffWithRegionHealthSourcesClient(regionHealthSourcesClient);
  // check that the client instance can be created
  const regionInstanceGroupManagerResizeRequestsClient =
    new RegionInstanceGroupManagerResizeRequestsClient();
  doStuffWithRegionInstanceGroupManagerResizeRequestsClient(
    regionInstanceGroupManagerResizeRequestsClient,
  );
  // check that the client instance can be created
  ...
  const regionInstantSnapshotGroupsClient =
    new RegionInstantSnapshotGroupsClient();
  doStuffWithRegionInstantSnapshotGroupsClient(
    regionInstantSnapshotGroupsClient,
  );
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const regionSnapshotsClient = new RegionSnapshotsClient();
  doStuffWithRegionSnapshotsClient(regionSnapshotsClient);
  // check that the client instance can be created
  const regionSnapshotSettingsClient = new RegionSnapshotSettingsClient();
  doStuffWithRegionSnapshotSettingsClient(regionSnapshotSettingsClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const reservationSlotsClient = new ReservationSlotsClient();
  doStuffWithReservationSlotsClient(reservationSlotsClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const rolloutPlansClient = new RolloutPlansClient();
  doStuffWithRolloutPlansClient(rolloutPlansClient);
  // check that the client instance can be created
  const rolloutsClient = new RolloutsClient();
  doStuffWithRolloutsClient(rolloutsClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const wireGroupsClient = new WireGroupsClient();
  doStuffWithWireGroupsClient(wireGroupsClient);
  // check that the client instance can be created
  ...
  // check that the client instance can be created
  const zoneVmExtensionPoliciesClient = new ZoneVmExtensionPoliciesClient();
  doStuffWithZoneVmExtensionPoliciesClient(zoneVmExtensionPoliciesClient);
}
