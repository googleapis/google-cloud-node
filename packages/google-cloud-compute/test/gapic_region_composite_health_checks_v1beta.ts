...
describe('v1beta.RegionCompositeHealthChecksClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new regioncompositehealthchecksModule.v1beta.RegionCompositeHealthChecksClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regioncompositehealthchecksModule.v1beta
            .RegionCompositeHealthChecksClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          regioncompositehealthchecksModule.v1beta
            .RegionCompositeHealthChecksClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        regioncompositehealthchecksModule.v1beta
          .RegionCompositeHealthChecksClient.port;
      assert(port);
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteRegionCompositeHealthCheckRequest',
        ['project'],
      );
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetRegionCompositeHealthCheckRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ICompositeHealthCheck | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getHealth without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getHealth(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ICompositeHealthCheckHealth | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertRegionCompositeHealthCheckRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchRegionCompositeHealthCheckRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AggregatedListRegionCompositeHealthChecksRequest',
        ['project'],
      );
      request.project = defaultValue1;
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1beta.CompositeHealthChecksScopedList(),
          ),
        ],
        [
          'tuple_key_2',
      ...
      const responses: Array<
        [
          string,
          protos.google.cloud.compute.v1beta.ICompositeHealthChecksScopedList,
        ]
      > = [];
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.compute.v1beta.ICompositeHealthCheck[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.compute.v1beta.CompositeHealthCheck,
          ) => {
