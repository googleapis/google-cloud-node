...
describe('v1beta.InstanceGroupManagersClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          instancegroupmanagersModule.v1beta.InstanceGroupManagersClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        instancegroupmanagersModule.v1beta.InstanceGroupManagersClient.port;
      assert(port);
  ...
  describe('applyUpdatesToInstances', () => {
    it('invokes applyUpdatesToInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ApplyUpdatesToInstancesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('configureAcceleratorTopologies', () => {
    it('invokes configureAcceleratorTopologies without error', async () => {
      const client =
        new instancegroupmanagersModule.v1beta.InstanceGroupManagersClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ConfigureAcceleratorTopologiesInstanceGroupManagerRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ConfigureAcceleratorTopologiesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.configureAcceleratorTopologies =
        stubSimpleCall(expectedResponse);
      const [response] = await client.configureAcceleratorTopologies(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.configureAcceleratorTopologies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.configureAcceleratorTopologies as SinonStub
    ...
    it('invokes configureAcceleratorTopologies without error using callback', async () => {
      const client =
        new instancegroupmanagersModule.v1beta.InstanceGroupManagersClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.configureAcceleratorTopologies =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.configureAcceleratorTopologies(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IOperation | null,
    ...
    it('invokes configureAcceleratorTopologies with error', async () => {
      const client =
        new instancegroupmanagersModule.v1beta.InstanceGroupManagersClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance_group_manager=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.configureAcceleratorTopologies = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.configureAcceleratorTopologies(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.configureAcceleratorTopologies as SinonStub
    ...
    it('invokes configureAcceleratorTopologies with closed client', async () => {
      const client =
        new instancegroupmanagersModule.v1beta.InstanceGroupManagersClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('createInstances', () => {
    it('invokes createInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.CreateInstancesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('deleteInstances', () => {
    it('invokes deleteInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteInstancesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('deletePerInstanceConfigs', () => {
    it('invokes deletePerInstanceConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeletePerInstanceConfigsInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('getAvailableAcceleratorTopologies', () => {
    it('invokes getAvailableAcceleratorTopologies without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetAvailableAcceleratorTopologiesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.getAvailableAcceleratorTopologies =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.getAvailableAcceleratorTopologies(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getAvailableAcceleratorTopologies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getAvailableAcceleratorTopologies as SinonStub
    ...
    it('invokes getAvailableAcceleratorTopologies without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAvailableAcceleratorTopologies(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IInstanceGroupManagersGetAvailableAcceleratorTopologiesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAvailableAcceleratorTopologies with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&resource_id=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getAvailableAcceleratorTopologies = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getAvailableAcceleratorTopologies(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getAvailableAcceleratorTopologies as SinonStub
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patchPerInstanceConfigs', () => {
    it('invokes patchPerInstanceConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchPerInstanceConfigsInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('recreateInstances', () => {
    it('invokes recreateInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.RecreateInstancesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('resize', () => {
    it('invokes resize without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResizeInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('resizeAdvanced', () => {
    it('invokes resizeAdvanced without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResizeAdvancedInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('resumeInstances', () => {
    it('invokes resumeInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResumeInstancesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setAutoHealingPolicies', () => {
    it('invokes setAutoHealingPolicies without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetAutoHealingPoliciesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setInstanceTemplate', () => {
    it('invokes setInstanceTemplate without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetInstanceTemplateInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setTargetPools', () => {
    it('invokes setTargetPools without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetTargetPoolsInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('startInstances', () => {
    it('invokes startInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.StartInstancesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('stopInstances', () => {
    it('invokes stopInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.StopInstancesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('suspendInstances', () => {
    it('invokes suspendInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SuspendInstancesInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.TestIamPermissionsInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('update', () => {
    it('invokes update without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('updatePerInstanceConfigs', () => {
    it('invokes updatePerInstanceConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdatePerInstanceConfigsInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AggregatedListInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1beta.InstanceGroupManagersScopedList(),
          ),
        ],
        [
          'tuple_key_2',
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('listErrors', () => {
    it('invokes listErrors without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListErrorsInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('listManagedInstances', () => {
    it('invokes listManagedInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListManagedInstancesInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('listPerInstanceConfigs', () => {
    it('invokes listPerInstanceConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListPerInstanceConfigsInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
