...
describe('v1beta.TargetHttpsProxiesClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new targethttpsproxiesModule.v1beta.TargetHttpsProxiesClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          targethttpsproxiesModule.v1beta.TargetHttpsProxiesClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          targethttpsproxiesModule.v1beta.TargetHttpsProxiesClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        targethttpsproxiesModule.v1beta.TargetHttpsProxiesClient.port;
      assert(port);
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.DeleteTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteTargetHttpsProxyRequest',
        ['project'],
      );
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&target_https_proxy=${defaultValue2 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.TargetHttpsProxy(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ITargetHttpsProxy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.InsertTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PatchTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setCertificateMap', () => {
    it('invokes setCertificateMap without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.SetCertificateMapTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetCertificateMapTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setQuicOverride', () => {
    it('invokes setQuicOverride without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.SetQuicOverrideTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetQuicOverrideTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setSslCertificates', () => {
    it('invokes setSslCertificates without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.SetSslCertificatesTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetSslCertificatesTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setSslPolicy', () => {
    it('invokes setSslPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.SetSslPolicyTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetSslPolicyTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setUrlMap', () => {
    it('invokes setUrlMap without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.SetUrlMapTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetUrlMapTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.TestIamPermissionsTargetHttpsProxyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.TestIamPermissionsTargetHttpsProxyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.AggregatedListTargetHttpsProxiesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1beta.TargetHttpsProxiesScopedList(),
          ),
        ],
        [
          'tuple_key_2',
      ...
      const responses: Array<
        [
          string,
          protos.google.cloud.compute.v1beta.ITargetHttpsProxiesScopedList,
        ]
      > = [];
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ListTargetHttpsProxiesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListTargetHttpsProxiesRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1beta.TargetHttpsProxy[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.TargetHttpsProxy) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      client.descriptors.page.list.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.compute.v1beta.ITargetHttpsProxy[] =
        [];
