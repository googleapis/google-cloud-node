...
import * as organizationrolloutplansModule from '../src';
...
describe('v1beta.OrganizationRolloutPlansClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new organizationrolloutplansModule.v1beta.OrganizationRolloutPlansClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          organizationrolloutplansModule.v1beta.OrganizationRolloutPlansClient
            .servicePath;
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.organizationRolloutPlansStub, undefined);
      await client.initialize();
      assert(client.organizationRolloutPlansStub);
    });
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.DeleteOrganizationRolloutPlanRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteOrganizationRolloutPlanRequest',
        ['organization'],
      );
      ...
      request.rolloutPlan = defaultValue2;
      const expectedHeaderRequestParams = `organization=${defaultValue1 ?? ''}&rollout_plan=${defaultValue2 ?? ''}`;
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetOrganizationRolloutPlanRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetOrganizationRolloutPlanRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `organization=${defaultValue1 ?? ''}&rollout_plan=${defaultValue2 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.RolloutPlan(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IRolloutPlan | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.InsertOrganizationRolloutPlanRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertOrganizationRolloutPlanRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ListOrganizationRolloutPlansRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListOrganizationRolloutPlansRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const expectedHeaderRequestParams = `organization=${defaultValue1 ?? ''}`;
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1beta.RolloutPlan[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.RolloutPlan) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      const responses: protos.google.cloud.compute.v1beta.IRolloutPlan[] = [];
