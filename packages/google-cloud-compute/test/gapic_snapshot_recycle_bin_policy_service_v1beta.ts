...
import * as snapshotrecyclebinpolicyserviceModule from '../src';
...
describe('v1beta.SnapshotRecycleBinPolicyServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new snapshotrecyclebinpolicyserviceModule.v1beta.SnapshotRecycleBinPolicyServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          snapshotrecyclebinpolicyserviceModule.v1beta
            .SnapshotRecycleBinPolicyServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          snapshotrecyclebinpolicyserviceModule.v1beta
            .SnapshotRecycleBinPolicyServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        snapshotrecyclebinpolicyserviceModule.v1beta
          .SnapshotRecycleBinPolicyServiceClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.snapshotRecycleBinPolicyServiceStub, undefined);
      await client.initialize();
      assert(client.snapshotRecycleBinPolicyServiceStub);
    });
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetSnapshotRecycleBinPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetSnapshotRecycleBinPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.SnapshotRecycleBinPolicy(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ISnapshotRecycleBinPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PatchSnapshotRecycleBinPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchSnapshotRecycleBinPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
