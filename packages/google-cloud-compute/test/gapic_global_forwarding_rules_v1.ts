...
describe('v1.GlobalForwardingRulesClient', () => {
  ...
  it('has servicePath', () => {
    const servicePath =
      globalforwardingrulesModule.v1.GlobalForwardingRulesClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      globalforwardingrulesModule.v1.GlobalForwardingRulesClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const expectedHeaderRequestParams = 'project=&forwarding_rule=';
