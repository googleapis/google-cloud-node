...
import * as globalforwardingrulesModule from '../src';
...
describe('v1.GlobalForwardingRulesClient', () => {
    ...
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = globalforwardingrulesModule.v1.GlobalForwardingRulesClient.servicePath;
...
<<<<<<< HEAD
    it('has port', () => {
      const port =
        globalforwardingrulesModule.v1.GlobalForwardingRulesClient.port;
      assert(port);
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IForwardingRule | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1.ForwardingRule[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.ForwardingRule) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      const responses: protos.google.cloud.compute.v1.IForwardingRule[] = [];
...
=======
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = globalforwardingrulesModule.v1.GlobalForwardingRulesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
>>>>>>> e7e9fc358f4a9717c33bd318da587d88ec01fa21
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new globalforwardingrulesModule.v1.GlobalForwardingRulesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new globalforwardingrulesModule.v1.GlobalForwardingRulesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new globalforwardingrulesModule.v1.GlobalForwardingRulesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new globalforwardingrulesModule.v1.GlobalForwardingRulesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = globalforwardingrulesModule.v1.GlobalForwardingRulesClient.port;
            assert(port);
            assert(typeof port === 'number');
        });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteGlobalForwardingRuleRequest', ['forwardingRule']);
            request.forwardingRule = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&forwarding_rule=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetGlobalForwardingRuleRequest', ['forwardingRule']);
            request.forwardingRule = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&forwarding_rule=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.ForwardingRule()
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IForwardingRule|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchGlobalForwardingRuleRequest', ['forwardingRule']);
            request.forwardingRule = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&forwarding_rule=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsGlobalForwardingRuleRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&resource=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setTarget', () => {
        it('invokes setTarget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetTargetGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetTargetGlobalForwardingRuleRequest', ['forwardingRule']);
            request.forwardingRule = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&forwarding_rule=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
            ...
            const [response] = await client.setTarget(request);
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            const actualRequest = (client.innerApiCalls.setTarget as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setTarget as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes setTarget without error using callback', async () => {
            ...
            client.innerApiCalls.setTarget = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.setTarget(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IOperation|null) => {
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListGlobalForwardingRulesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.ForwardingRule()),
              generateSampleMessage(new protos.google.cloud.compute.v1.ForwardingRule()),
              generateSampleMessage(new protos.google.cloud.compute.v1.ForwardingRule()),
            ];
            client.innerApiCalls.list = stubSimpleCall(expectedResponse);
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1.ForwardingRule[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1.ForwardingRule) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
