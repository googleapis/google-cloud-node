...
describe('v1beta.DiskSettingsServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new disksettingsserviceModule.v1beta.DiskSettingsServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          disksettingsserviceModule.v1beta.DiskSettingsServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        disksettingsserviceModule.v1beta.DiskSettingsServiceClient.port;
      assert(port);
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IDiskSettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchDiskSettingRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
