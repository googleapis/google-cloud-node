...
describe('v1beta.OrganizationSecurityPoliciesClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new organizationsecuritypoliciesModule.v1beta.OrganizationSecurityPoliciesClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          organizationsecuritypoliciesModule.v1beta
            .OrganizationSecurityPoliciesClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          organizationsecuritypoliciesModule.v1beta
            .OrganizationSecurityPoliciesClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        organizationsecuritypoliciesModule.v1beta
          .OrganizationSecurityPoliciesClient.port;
      assert(port);
  ...
  describe('addAssociation', () => {
    it('invokes addAssociation without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.AddAssociationOrganizationSecurityPolicyRequest(),
      );
  ...
  describe('addRule', () => {
    it('invokes addRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.AddRuleOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AddRuleOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
  ...
  describe('copyRules', () => {
    it('invokes copyRules without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.CopyRulesOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.CopyRulesOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.copyRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.copyRules as SinonStub
    ...
    it('invokes copyRules without error using callback', async () => {
      ...
      client.innerApiCalls.copyRules =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.copyRules(
          request,
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.DeleteOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ISecurityPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getAssociation', () => {
    it('invokes getAssociation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetAssociationOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetAssociationOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.SecurityPolicyAssociation(),
      );
    ...
    it('invokes getAssociation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAssociation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ISecurityPolicyAssociation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getRule', () => {
    it('invokes getRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetRuleOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetRuleOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
    ...
    it('invokes getRule without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRule(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ISecurityPolicyRule | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.InsertOrganizationSecurityPolicyRequest(),
      );
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.Operation(),
      );
  ...
  describe('listAssociations', () => {
    it('invokes listAssociations without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ListAssociationsOrganizationSecurityPolicyRequest(),
      );
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.OrganizationSecurityPoliciesListAssociationsResponse(),
      );
    ...
    it('invokes listAssociations without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listAssociations(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IOrganizationSecurityPoliciesListAssociationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listPreconfiguredExpressionSets', () => {
    it('invokes listPreconfiguredExpressionSets without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ListPreconfiguredExpressionSetsOrganizationSecurityPoliciesRequest(),
      );
      const expectedResponse = generateSampleMessage(
    ...
    it('invokes listPreconfiguredExpressionSets without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPreconfiguredExpressionSets(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ISecurityPoliciesListPreconfiguredExpressionSetsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('move', () => {
    it('invokes move without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.MoveOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.MoveOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PatchOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
  ...
  describe('patchRule', () => {
    it('invokes patchRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PatchRuleOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchRuleOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
  ...
  describe('removeAssociation', () => {
    it('invokes removeAssociation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.RemoveAssociationOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.RemoveAssociationOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
  ...
  describe('removeRule', () => {
    it('invokes removeRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.RemoveRuleOrganizationSecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.RemoveRuleOrganizationSecurityPolicyRequest',
        ['securityPolicy'],
      );
      request.securityPolicy = defaultValue1;
      const expectedHeaderRequestParams = `security_policy=${defaultValue1 ?? ''}`;
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ListOrganizationSecurityPoliciesRequest(),
      );
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.compute.v1beta.ISecurityPolicy[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.SecurityPolicy) => {
