...
describe('v1beta.SnapshotSettingsServiceClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new snapshotsettingsserviceModule.v1beta.SnapshotSettingsServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          snapshotsettingsserviceModule.v1beta.SnapshotSettingsServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        snapshotsettingsserviceModule.v1beta.SnapshotSettingsServiceClient.port;
      assert(port);
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchSnapshotSettingRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
