    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IStoragePool | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1.StoragePoolsScopedList()
          ),
        ],
        [
          'tuple_key_2',
      ...
      const responses: Array<
        [string, protos.google.cloud.compute.v1.IStoragePoolsScopedList]
      > = [];
