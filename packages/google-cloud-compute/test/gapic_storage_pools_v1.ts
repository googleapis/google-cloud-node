...
describe('v1.StoragePoolsClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          storagepoolsModule.v1.StoragePoolsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          storagepoolsModule.v1.StoragePoolsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new storagepoolsModule.v1.StoragePoolsClient({
          universe_domain: 'example.com',
  ...
  describe('list', () => {
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.StoragePool) => {
  ...
  describe('listDisks', () => {
    it('invokes listDisks without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1.StoragePoolDisk()
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1.StoragePoolDisk()
        ),
    ...
    it('invokes listDisks without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listDisks(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IStoragePoolDisk[] | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listDisksStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.StoragePoolDisk) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
