...
import * as hostsModule from '../src';
...
describe('v1.HostsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new hostsModule.v1.HostsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = hostsModule.v1.HostsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint = hostsModule.v1.HostsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new hostsModule.v1.HostsClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = hostsModule.v1.HostsClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.hostsStub, undefined);
      await client.initialize();
      assert(client.hostsStub);
    });
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.GetHostRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.GetHostRequest',
        ['project'],
      );
      ...
      request.association = defaultValue3;
      const defaultValue4 = getTypeDefaultValue(
        '.google.cloud.compute.v1.GetHostRequest',
        ['host'],
      );
      request.host = defaultValue4;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&association=${defaultValue3 ?? ''}&host=${defaultValue4 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.Host(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IHost | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getVersion', () => {
    it('invokes getVersion without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.GetVersionHostRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.ListHostsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.ListHostsRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      request.association = defaultValue3;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&association=${defaultValue3 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.compute.v1.Host()),
        generateSampleMessage(new protos.google.cloud.compute.v1.Host()),
        generateSampleMessage(new protos.google.cloud.compute.v1.Host()),
      ];
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1.Host[] = [];
        stream.on('data', (response: protos.google.cloud.compute.v1.Host) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      const responses: protos.google.cloud.compute.v1.IHost[] = [];
