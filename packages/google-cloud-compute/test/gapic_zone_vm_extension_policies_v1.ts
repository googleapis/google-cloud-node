...
describe('v1.ZoneVmExtensionPoliciesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new zonevmextensionpoliciesModule.v1.ZoneVmExtensionPoliciesClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = zonevmextensionpoliciesModule.v1.ZoneVmExtensionPoliciesClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = zonevmextensionpoliciesModule.v1.ZoneVmExtensionPoliciesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new zonevmextensionpoliciesModule.v1.ZoneVmExtensionPoliciesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new zonevmextensionpoliciesModule.v1.ZoneVmExtensionPoliciesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new zonevmextensionpoliciesModule.v1.ZoneVmExtensionPoliciesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new zonevmextensionpoliciesModule.v1.ZoneVmExtensionPoliciesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = zonevmextensionpoliciesModule.v1.ZoneVmExtensionPoliciesClient.port;
            assert(port);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.DeleteZoneVmExtensionPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteZoneVmExtensionPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteZoneVmExtensionPolicyRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteZoneVmExtensionPolicyRequest', ['vmExtensionPolicy']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.GetZoneVmExtensionPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetZoneVmExtensionPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetZoneVmExtensionPolicyRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetZoneVmExtensionPolicyRequest', ['vmExtensionPolicy']);
            request.vmExtensionPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&vm_extension_policy=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.VmExtensionPolicy()
            );
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IVmExtensionPolicy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.InsertZoneVmExtensionPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertZoneVmExtensionPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertZoneVmExtensionPolicyRequest', ['zone']);
            request.zone = defaultValue2;
    ...
    describe('update', () => {
        it('invokes update without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.UpdateZoneVmExtensionPolicyRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.UpdateZoneVmExtensionPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.UpdateZoneVmExtensionPolicyRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.UpdateZoneVmExtensionPolicyRequest', ['vmExtensionPolicy']);
            request.vmExtensionPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&vm_extension_policy=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.ListZoneVmExtensionPoliciesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListZoneVmExtensionPoliciesRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListZoneVmExtensionPoliciesRequest', ['zone']);
            request.zone = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.VmExtensionPolicy()),
              generateSampleMessage(new protos.google.cloud.compute.v1.VmExtensionPolicy()),
              generateSampleMessage(new protos.google.cloud.compute.v1.VmExtensionPolicy()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1.VmExtensionPolicy[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1.VmExtensionPolicy) => {
        ...
        it('uses async iteration with list without error', async () => {
            ...
            const responses: protos.google.cloud.compute.v1.IVmExtensionPolicy[] = [];
