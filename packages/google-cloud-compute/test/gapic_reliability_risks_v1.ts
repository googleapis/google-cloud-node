...
describe('v1.ReliabilityRisksClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new reliabilityrisksModule.v1.ReliabilityRisksClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          reliabilityrisksModule.v1.ReliabilityRisksClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          reliabilityrisksModule.v1.ReliabilityRisksClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new reliabilityrisksModule.v1.ReliabilityRisksClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = reliabilityrisksModule.v1.ReliabilityRisksClient.port;
      assert(port);
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.GetReliabilityRiskRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.GetReliabilityRiskRequest',
        ['project'],
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.ReliabilityRisk(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IReliabilityRisk | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.ListReliabilityRisksRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.ListReliabilityRisksRequest',
        ['project'],
      );
      request.project = defaultValue1;
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1.ReliabilityRisk[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.ReliabilityRisk) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      const responses: protos.google.cloud.compute.v1.IReliabilityRisk[] = [];
