...
describe('v1beta.ReservationSubBlocksClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new reservationsubblocksModule.v1beta.ReservationSubBlocksClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          reservationsubblocksModule.v1beta.ReservationSubBlocksClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        reservationsubblocksModule.v1beta.ReservationSubBlocksClient.port;
      assert(port);
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IReservationSubBlocksGetResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getVersion', () => {
    it('invokes getVersion without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetVersionReservationSubBlockRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('reportFaulty', () => {
    it('invokes reportFaulty without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ReportFaultyReservationSubBlockRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.reportFaulty as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.reportFaulty as SinonStub
    ...
    it('invokes reportFaulty without error using callback', async () => {
      ...
      client.innerApiCalls.reportFaulty =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.reportFaulty(
          request,
    ...
    it('invokes reportFaulty with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&parent_name=${defaultValue3 ?? ''}&reservation_sub_block=${defaultValue4 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.reportFaulty = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes list without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.ReservationSubBlock(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.ReservationSubBlock(),
        ),
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.compute.v1beta.IReservationSubBlock[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.compute.v1beta.ReservationSubBlock,
          ) => {
