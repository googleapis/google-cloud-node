...
describe('v1beta.VpnGatewaysClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          vpngatewaysModule.v1beta.VpnGatewaysClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          vpngatewaysModule.v1beta.VpnGatewaysClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new vpngatewaysModule.v1beta.VpnGatewaysClient({
          universe_domain: 'example.com',
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteVpnGatewayRequest',
        ['project'],
      );
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetVpnGatewayRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IVpnGateway | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getStatus', () => {
    it('invokes getStatus without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetStatusVpnGatewayRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getStatus without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getStatus(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IVpnGatewaysGetStatusResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertVpnGatewayRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setLabels', () => {
    it('invokes setLabels without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetLabelsVpnGatewayRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.TestIamPermissionsVpnGatewayRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1beta.VpnGatewaysScopedList(),
          ),
        ],
        [
          'tuple_key_2',
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListVpnGatewaysRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.VpnGateway) => {
