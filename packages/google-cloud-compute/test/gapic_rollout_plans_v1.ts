...
describe('v1.RolloutPlansClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new rolloutplansModule.v1.RolloutPlansClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          rolloutplansModule.v1.RolloutPlansClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          rolloutplansModule.v1.RolloutPlansClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new rolloutplansModule.v1.RolloutPlansClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = rolloutplansModule.v1.RolloutPlansClient.port;
      assert(port);
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.DeleteRolloutPlanRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.DeleteRolloutPlanRequest',
        ['project'],
      );
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.GetRolloutPlanRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&rollout_plan=${defaultValue2 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.RolloutPlan(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IRolloutPlan | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.InsertRolloutPlanRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.InsertRolloutPlanRequest',
        ['project'],
      );
      request.project = defaultValue1;
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.ListRolloutPlansRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.compute.v1.RolloutPlan()),
        generateSampleMessage(new protos.google.cloud.compute.v1.RolloutPlan()),
        generateSampleMessage(new protos.google.cloud.compute.v1.RolloutPlan()),
      ];
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1.RolloutPlan[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.RolloutPlan) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      const responses: protos.google.cloud.compute.v1.IRolloutPlan[] = [];
