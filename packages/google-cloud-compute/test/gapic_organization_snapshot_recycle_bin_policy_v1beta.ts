...
import * as organizationsnapshotrecyclebinpolicyModule from '../src';
...
describe('v1beta.OrganizationSnapshotRecycleBinPolicyClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new organizationsnapshotrecyclebinpolicyModule.v1beta.OrganizationSnapshotRecycleBinPolicyClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          organizationsnapshotrecyclebinpolicyModule.v1beta
            .OrganizationSnapshotRecycleBinPolicyClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          organizationsnapshotrecyclebinpolicyModule.v1beta
            .OrganizationSnapshotRecycleBinPolicyClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        organizationsnapshotrecyclebinpolicyModule.v1beta
          .OrganizationSnapshotRecycleBinPolicyClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(
        client.organizationSnapshotRecycleBinPolicyStub,
        undefined,
      );
      await client.initialize();
      assert(client.organizationSnapshotRecycleBinPolicyStub);
    });
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetOrganizationSnapshotRecycleBinPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetOrganizationSnapshotRecycleBinPolicyRequest',
        ['organization'],
      );
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PatchOrganizationSnapshotRecycleBinPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchOrganizationSnapshotRecycleBinPolicyRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const expectedHeaderRequestParams = `organization=${defaultValue1 ?? ''}`;
