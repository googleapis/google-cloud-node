...
describe('v1beta.ExternalVpnGatewaysClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new externalvpngatewaysModule.v1beta.ExternalVpnGatewaysClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = externalvpngatewaysModule.v1beta.ExternalVpnGatewaysClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = externalvpngatewaysModule.v1beta.ExternalVpnGatewaysClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new externalvpngatewaysModule.v1beta.ExternalVpnGatewaysClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new externalvpngatewaysModule.v1beta.ExternalVpnGatewaysClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new externalvpngatewaysModule.v1beta.ExternalVpnGatewaysClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new externalvpngatewaysModule.v1beta.ExternalVpnGatewaysClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = externalvpngatewaysModule.v1beta.ExternalVpnGatewaysClient.port;
            assert(port);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.DeleteExternalVpnGatewayRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeleteExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeleteExternalVpnGatewayRequest', ['externalVpnGateway']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.GetExternalVpnGatewayRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetExternalVpnGatewayRequest', ['externalVpnGateway']);
            request.externalVpnGateway = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&external_vpn_gateway=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.ExternalVpnGateway()
            );
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1beta.IExternalVpnGateway|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.InsertExternalVpnGatewayRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.InsertExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.SetLabelsExternalVpnGatewayRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetLabelsExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetLabelsExternalVpnGatewayRequest', ['resource']);
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.TestIamPermissionsExternalVpnGatewayRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.TestIamPermissionsExternalVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.TestIamPermissionsExternalVpnGatewayRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&resource=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.ListExternalVpnGatewaysRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.ListExternalVpnGatewaysRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1beta.ExternalVpnGateway()),
              generateSampleMessage(new protos.google.cloud.compute.v1beta.ExternalVpnGateway()),
              generateSampleMessage(new protos.google.cloud.compute.v1beta.ExternalVpnGateway()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1beta.ExternalVpnGateway[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1beta.ExternalVpnGateway) => {
        ...
        it('uses async iteration with list without error', async () => {
            ...
            const responses: protos.google.cloud.compute.v1beta.IExternalVpnGateway[] = [];
