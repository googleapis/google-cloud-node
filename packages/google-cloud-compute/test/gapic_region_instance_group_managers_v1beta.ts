...
describe('v1beta.RegionInstanceGroupManagersClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regioninstancegroupmanagersModule.v1beta
            .RegionInstanceGroupManagersClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          regioninstancegroupmanagersModule.v1beta
            .RegionInstanceGroupManagersClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        regioninstancegroupmanagersModule.v1beta
          .RegionInstanceGroupManagersClient.port;
      assert(port);
  ...
  describe('adoptInstances', () => {
    it('invokes adoptInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AdoptInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.adoptInstances as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.adoptInstances as SinonStub
    ...
    it('invokes adoptInstances without error using callback', async () => {
      ...
      client.innerApiCalls.adoptInstances =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes adoptInstances with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&instance_group_manager=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.adoptInstances = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('applyUpdatesToInstances', () => {
    it('invokes applyUpdatesToInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ApplyUpdatesToInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('createInstances', () => {
    it('invokes createInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.CreateInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('deleteInstances', () => {
    it('invokes deleteInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('deletePerInstanceConfigs', () => {
    it('invokes deletePerInstanceConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeletePerInstanceConfigsRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IInstanceGroupManager | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patchPerInstanceConfigs', () => {
    it('invokes patchPerInstanceConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchPerInstanceConfigsRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('recreateInstances', () => {
    it('invokes recreateInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.RecreateInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('resize', () => {
    it('invokes resize without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResizeRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('resizeAdvanced', () => {
    it('invokes resizeAdvanced without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResizeAdvancedRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.resizeAdvanced as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.resizeAdvanced as SinonStub
    ...
    it('invokes resizeAdvanced without error using callback', async () => {
      ...
      client.innerApiCalls.resizeAdvanced =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes resizeAdvanced with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&instance_group_manager=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.resizeAdvanced = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('resumeInstances', () => {
    it('invokes resumeInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResumeInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setAutoHealingPolicies', () => {
    it('invokes setAutoHealingPolicies without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetAutoHealingPoliciesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.setAutoHealingPolicies =
        stubSimpleCall(expectedResponse);
      const [response] = await client.setAutoHealingPolicies(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.setAutoHealingPolicies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.setAutoHealingPolicies as SinonStub
    ...
    it('invokes setAutoHealingPolicies with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&instance_group_manager=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.setAutoHealingPolicies = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.setAutoHealingPolicies(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.setAutoHealingPolicies as SinonStub
  ...
  describe('setInstanceTemplate', () => {
    it('invokes setInstanceTemplate without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetInstanceTemplateRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setTargetPools', () => {
    it('invokes setTargetPools without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetTargetPoolsRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('startInstances', () => {
    it('invokes startInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.StartInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('stopInstances', () => {
    it('invokes stopInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.StopInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('suspendInstances', () => {
    it('invokes suspendInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SuspendInstancesRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.TestIamPermissionsRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('update', () => {
    it('invokes update without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('updatePerInstanceConfigs', () => {
    it('invokes updatePerInstanceConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdatePerInstanceConfigsRegionInstanceGroupManagerRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListRegionInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.compute.v1beta.InstanceGroupManager,
          ) => {
  ...
  describe('listErrors', () => {
    it('invokes listErrors without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListErrorsRegionInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.InstanceManagedByIgmError(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.InstanceManagedByIgmError(),
        ),
    ...
    it('invokes listErrorsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.compute.v1beta.InstanceManagedByIgmError,
          ) => {
            responses.push(response);
          },
        );
  ...
  describe('listManagedInstances', () => {
    it('invokes listManagedInstances without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListManagedInstancesRegionInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.ManagedInstance(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.ManagedInstance(),
        ),
    ...
    it('invokes listManagedInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.ManagedInstance) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listPerInstanceConfigs', () => {
    it('invokes listPerInstanceConfigs without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListPerInstanceConfigsRegionInstanceGroupManagersRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.PerInstanceConfig(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.PerInstanceConfig(),
        ),
    ...
    it('invokes listPerInstanceConfigsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.PerInstanceConfig) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
