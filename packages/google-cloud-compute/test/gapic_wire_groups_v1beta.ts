...
describe('v1beta.WireGroupsClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          wiregroupsModule.v1beta.WireGroupsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          wiregroupsModule.v1beta.WireGroupsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new wiregroupsModule.v1beta.WireGroupsClient({
          universe_domain: 'example.com',
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetWireGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IWireGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertWireGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchWireGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListWireGroupsRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.WireGroup) => {
