...
describe('v1.InstanceSettingsServiceClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new instancesettingsserviceModule.v1.InstanceSettingsServiceClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = instancesettingsserviceModule.v1.InstanceSettingsServiceClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = instancesettingsserviceModule.v1.InstanceSettingsServiceClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new instancesettingsserviceModule.v1.InstanceSettingsServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new instancesettingsserviceModule.v1.InstanceSettingsServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new instancesettingsserviceModule.v1.InstanceSettingsServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new instancesettingsserviceModule.v1.InstanceSettingsServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = instancesettingsserviceModule.v1.InstanceSettingsServiceClient.port;
            assert(port);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInstanceSettingRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInstanceSettingRequest', ['zone']);
            request.zone = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.InstanceSettings()
            );
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IInstanceSettings|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchInstanceSettingRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.PatchInstanceSettingRequest', ['zone']);
            request.zone = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
...
<<<<<<< HEAD
    ...
    it('has close method for the non-initialized client', done => {
      const client =
        new instancesettingsserviceModule.v1.InstanceSettingsServiceClient({
          auth: googleAuth,
          projectId: 'bogus',
        });
      assert.strictEqual(client.instanceSettingsServiceStub, undefined);
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IInstanceSettings | null
          ) => {
            if (err) {
              reject(err);
            } else {
