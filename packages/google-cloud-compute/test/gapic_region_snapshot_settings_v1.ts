...
describe('v1.RegionSnapshotSettingsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new regionsnapshotsettingsModule.v1.RegionSnapshotSettingsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regionsnapshotsettingsModule.v1.RegionSnapshotSettingsClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        regionsnapshotsettingsModule.v1.RegionSnapshotSettingsClient.port;
      assert(port);
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.GetRegionSnapshotSettingRequest',
        ['project'],
      );
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.PatchRegionSnapshotSettingRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
