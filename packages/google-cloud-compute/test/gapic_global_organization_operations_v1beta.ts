...
describe('v1beta.GlobalOrganizationOperationsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new globalorganizationoperationsModule.v1beta.GlobalOrganizationOperationsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          globalorganizationoperationsModule.v1beta
    ...
    it('has port', () => {
      const port =
        globalorganizationoperationsModule.v1beta
          .GlobalOrganizationOperationsClient.port;
      assert(port);
    ...
    it('invokes delete without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.delete(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IDeleteGlobalOrganizationOperationResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetGlobalOrganizationOperationRequest',
        ['operation'],
      );
      request.operation = defaultValue1;
      const expectedHeaderRequestParams = `operation=${defaultValue1 ?? ''}`;
