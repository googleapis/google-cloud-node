...
describe('v1.InstanceGroupsClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          instancegroupsModule.v1.InstanceGroupsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          instancegroupsModule.v1.InstanceGroupsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new instancegroupsModule.v1.InstanceGroupsClient({
          universe_domain: 'example.com',
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.TestIamPermissionsInstanceGroupRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('list', () => {
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.InstanceGroup) => {
  ...
  describe('listInstances', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listInstances(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.compute.v1.IInstanceWithNamedPorts[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listInstancesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.InstanceWithNamedPorts) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
