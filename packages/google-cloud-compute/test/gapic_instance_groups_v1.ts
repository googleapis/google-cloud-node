...
import * as instancegroupsModule from '../src';
...
describe('v1.InstanceGroupsClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new instancegroupsModule.v1.InstanceGroupsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = instancegroupsModule.v1.InstanceGroupsClient.servicePath;
...
<<<<<<< HEAD
  ...
  describe('addInstances', () => {
    it('invokes addInstances without error', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance_group=${defaultValue3 ?? ''}`;
    ...
    it('invokes addInstances without error using callback', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.addInstances =
    ...
    it('invokes addInstances with error', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.addInstances = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes addInstances with closed client', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IInstanceGroup | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('removeInstances', () => {
    it('invokes removeInstances without error', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
    ...
    it('invokes removeInstances without error using callback', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.removeInstances =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.removeInstances(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IOperation | null
    ...
    it('invokes removeInstances with error', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance_group=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.removeInstances = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes removeInstances with closed client', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('setNamedPorts', () => {
    it('invokes setNamedPorts without error', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
    ...
    it('invokes setNamedPorts without error using callback', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      client.innerApiCalls.setNamedPorts =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes setNamedPorts with error', async () => {
      const client = new instancegroupsModule.v1.InstanceGroupsClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance_group=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.setNamedPorts = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.AggregatedListInstanceGroupsRequest()
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1.InstanceGroupsScopedList()
          ),
        ],
        [
          'tuple_key_2',
...
=======
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = instancegroupsModule.v1.InstanceGroupsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
>>>>>>> e7e9fc358f4a9717c33bd318da587d88ec01fa21
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new instancegroupsModule.v1.InstanceGroupsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new instancegroupsModule.v1.InstanceGroupsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new instancegroupsModule.v1.InstanceGroupsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new instancegroupsModule.v1.InstanceGroupsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = instancegroupsModule.v1.InstanceGroupsClient.port;
            assert(port);
    ...
    describe('addInstances', () => {
        it('invokes addInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.AddInstancesInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.AddInstancesInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.AddInstancesInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
            ...
            const [response] = await client.addInstances(request);
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            const actualRequest = (client.innerApiCalls.addInstances as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.addInstances as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes addInstances without error using callback', async () => {
            ...
            client.innerApiCalls.addInstances = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addInstances(
                    request,
        ...
        it('invokes addInstances with error', async () => {
            ...
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.addInstances = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.addInstances(request), expectedError);
            const actualRequest = (client.innerApiCalls.addInstances as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.InstanceGroup()
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IInstanceGroup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('removeInstances', () => {
        it('invokes removeInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.RemoveInstancesInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.RemoveInstancesInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.RemoveInstancesInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
            ...
            const [response] = await client.removeInstances(request);
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeInstances as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.removeInstances as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes removeInstances without error using callback', async () => {
            ...
            client.innerApiCalls.removeInstances = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.removeInstances(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IOperation|null) => {
        ...
        it('invokes removeInstances with error', async () => {
            ...
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.removeInstances = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.removeInstances(request), expectedError);
            const actualRequest = (client.innerApiCalls.removeInstances as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
    ...
    describe('setNamedPorts', () => {
        it('invokes setNamedPorts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetNamedPortsInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetNamedPortsInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetNamedPortsInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
            ...
            const [response] = await client.setNamedPorts(request);
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            const actualRequest = (client.innerApiCalls.setNamedPorts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.setNamedPorts as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes setNamedPorts without error using callback', async () => {
            ...
            client.innerApiCalls.setNamedPorts = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.setNamedPorts(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IOperation|null) => {
        ...
        it('invokes setNamedPorts with error', async () => {
            ...
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.setNamedPorts = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.setNamedPorts(request), expectedError);
            const actualRequest = (client.innerApiCalls.setNamedPorts as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.AggregatedListInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;
            const expectedResponse = [
              ['tuple_key_1', generateSampleMessage(new protos.google.cloud.compute.v1.InstanceGroupsScopedList())],
              ['tuple_key_2', generateSampleMessage(new protos.google.cloud.compute.v1.InstanceGroupsScopedList())],
              ['tuple_key_3', generateSampleMessage(new protos.google.cloud.compute.v1.InstanceGroupsScopedList())],
            ];
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.ListInstanceGroupsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstanceGroupsRequest', ['zone']);
            request.zone = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.InstanceGroup()),
              generateSampleMessage(new protos.google.cloud.compute.v1.InstanceGroup()),
              generateSampleMessage(new protos.google.cloud.compute.v1.InstanceGroup()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1.InstanceGroup[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1.InstanceGroup) => {
        ...
        it('uses async iteration with list without error', async () => {
            ...
            const responses: protos.google.cloud.compute.v1.IInstanceGroup[] = [];
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.ListInstancesInstanceGroupsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstancesInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstancesInstanceGroupsRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListInstancesInstanceGroupsRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&zone=${defaultValue2 ?? '' }&instance_group=${defaultValue3 ?? '' }`;const expectedResponse = [
        ...
        it('invokes listInstances without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listInstances(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IInstanceWithNamedPorts[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('uses async iteration with listInstances without error', async () => {
            ...
            const responses: protos.google.cloud.compute.v1.IInstanceWithNamedPorts[] = [];
