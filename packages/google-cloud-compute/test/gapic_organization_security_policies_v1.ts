  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          organizationsecuritypoliciesModule.v1
    ...
    it('has port', () => {
      const port =
        organizationsecuritypoliciesModule.v1.OrganizationSecurityPoliciesClient
          .port;
      assert(port);
    ...
    it('invokes getAssociation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAssociation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ISecurityPolicyAssociation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listAssociations without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listAssociations(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IOrganizationSecurityPoliciesListAssociationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
