...
describe('v1.ProjectViewsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new projectviewsModule.v1.ProjectViewsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          projectviewsModule.v1.ProjectViewsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          projectviewsModule.v1.ProjectViewsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new projectviewsModule.v1.ProjectViewsClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = projectviewsModule.v1.ProjectViewsClient.port;
      assert(port);
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.GetProjectViewRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.ProjectView(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IProjectView | null,
          ) => {
            if (err) {
              reject(err);
            } else {
