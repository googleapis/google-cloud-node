  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          imageviewsModule.v1beta.ImageViewsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          imageviewsModule.v1beta.ImageViewsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new imageviewsModule.v1beta.ImageViewsClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = imageviewsModule.v1beta.ImageViewsClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.imageViewsStub, undefined);
      await client.initialize();
      assert(client.imageViewsStub);
    });
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetImageViewRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetImageViewRequest',
        ['project'],
      );
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&region=${defaultValue2 ?? ''}&resource_id=${defaultValue3 ?? ''}`;
