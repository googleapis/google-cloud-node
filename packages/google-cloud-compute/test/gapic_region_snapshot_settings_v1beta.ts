...
describe('v1beta.RegionSnapshotSettingsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new regionsnapshotsettingsModule.v1beta.RegionSnapshotSettingsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regionsnapshotsettingsModule.v1beta.RegionSnapshotSettingsClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        regionsnapshotsettingsModule.v1beta.RegionSnapshotSettingsClient.port;
      assert(port);
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ISnapshotSettings | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchRegionSnapshotSettingRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
