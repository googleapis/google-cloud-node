...
describe('v1.NetworksClient', () => {
  ...
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new networksModule.v1.NetworksClient({
          universe_domain: 'example.com',
  ...
  describe('cancelRequestRemovePeering', () => {
    it('invokes cancelRequestRemovePeering without error', async () => {
      const client = new networksModule.v1.NetworksClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1.CancelRequestRemovePeeringNetworkRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.CancelRequestRemovePeeringNetworkRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.cancelRequestRemovePeering =
        stubSimpleCall(expectedResponse);
      const [response] = await client.cancelRequestRemovePeering(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.cancelRequestRemovePeering as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.cancelRequestRemovePeering as SinonStub
    ...
    it('invokes cancelRequestRemovePeering without error using callback', async () => {
      const client = new networksModule.v1.NetworksClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
    ...
    it('invokes cancelRequestRemovePeering with error', async () => {
      const client = new networksModule.v1.NetworksClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
      ...
      await assert.rejects(
        client.cancelRequestRemovePeering(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.cancelRequestRemovePeering as SinonStub
    ...
    it('invokes cancelRequestRemovePeering with closed client', async () => {
      const client = new networksModule.v1.NetworksClient({
        auth: googleAuth,
        projectId: 'bogus',
      });
  ...
  describe('requestRemovePeering', () => {
    it('invokes requestRemovePeering without error', async () => {
      ...
      client.innerApiCalls.requestRemovePeering =
        stubSimpleCall(expectedResponse);
      const [response] = await client.requestRemovePeering(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.requestRemovePeering as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.requestRemovePeering as SinonStub
    ...
    it('invokes requestRemovePeering with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&network=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.requestRemovePeering = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('listPeeringRoutes', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPeeringRoutes(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.compute.v1.IExchangedPeeringRoute[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listPeeringRoutesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.ExchangedPeeringRoute) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
