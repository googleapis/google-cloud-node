...
describe('v1beta.InstancesClient', () => {
  ...
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new instancesModule.v1beta.InstancesClient({
          universe_domain: 'example.com',
  ...
  describe('addNetworkInterface', () => {
    it('invokes addNetworkInterface without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AddNetworkInterfaceInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.addNetworkInterface =
        stubSimpleCall(expectedResponse);
      const [response] = await client.addNetworkInterface(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.addNetworkInterface as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.addNetworkInterface as SinonStub
    ...
    it('invokes addNetworkInterface with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.addNetworkInterface = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('addResourcePolicies', () => {
    it('invokes addResourcePolicies without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AddResourcePoliciesInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('attachDisk', () => {
    it('invokes attachDisk without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AttachDiskInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('bulkInsert', () => {
    it('invokes bulkInsert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.BulkInsertInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('deleteAccessConfig', () => {
    it('invokes deleteAccessConfig without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteAccessConfigInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('deleteNetworkInterface', () => {
    it('invokes deleteNetworkInterface without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteNetworkInterfaceInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteNetworkInterface =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteNetworkInterface(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteNetworkInterface as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteNetworkInterface as SinonStub
    ...
    it('invokes deleteNetworkInterface with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteNetworkInterface = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteNetworkInterface(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteNetworkInterface as SinonStub
  ...
  describe('detachDisk', () => {
    it('invokes detachDisk without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DetachDiskInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IInstance | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getEffectiveFirewalls', () => {
    it('invokes getEffectiveFirewalls without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetEffectiveFirewallsInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getEffectiveFirewalls without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEffectiveFirewalls(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IInstancesGetEffectiveFirewallsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getGuestAttributes', () => {
    it('invokes getGuestAttributes without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetGuestAttributesInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getGuestAttributes without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGuestAttributes(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IGuestAttributes | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getIamPolicy', () => {
    it('invokes getIamPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetIamPolicyInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('getPartnerMetadata', () => {
    it('invokes getPartnerMetadata without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetPartnerMetadataInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.getPartnerMetadata =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getPartnerMetadata(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getPartnerMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getPartnerMetadata as SinonStub
    ...
    it('invokes getPartnerMetadata without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getPartnerMetadata(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IPartnerMetadata | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPartnerMetadata with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getPartnerMetadata = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getScreenshot', () => {
    it('invokes getScreenshot without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetScreenshotInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getScreenshot without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getScreenshot(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IScreenshot | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getSerialPortOutput', () => {
    it('invokes getSerialPortOutput without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetSerialPortOutputInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getSerialPortOutput without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSerialPortOutput(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ISerialPortOutput | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getShieldedInstanceIdentity', () => {
    it('invokes getShieldedInstanceIdentity without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetShieldedInstanceIdentityInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getShieldedInstanceIdentity without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getShieldedInstanceIdentity(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IShieldedInstanceIdentity | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getShieldedVmIdentity', () => {
    it('invokes getShieldedVmIdentity without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetShieldedVmIdentityInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.getShieldedVmIdentity =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getShieldedVmIdentity(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getShieldedVmIdentity as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getShieldedVmIdentity as SinonStub
    ...
    it('invokes getShieldedVmIdentity without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getShieldedVmIdentity(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IShieldedVmIdentity | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getShieldedVmIdentity with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getShieldedVmIdentity = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getShieldedVmIdentity(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getShieldedVmIdentity as SinonStub
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patchPartnerMetadata', () => {
    it('invokes patchPartnerMetadata without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchPartnerMetadataInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.patchPartnerMetadata =
        stubSimpleCall(expectedResponse);
      const [response] = await client.patchPartnerMetadata(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.patchPartnerMetadata as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.patchPartnerMetadata as SinonStub
    ...
    it('invokes patchPartnerMetadata with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.patchPartnerMetadata = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('performMaintenance', () => {
    it('invokes performMaintenance without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PerformMaintenanceInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('removeResourcePolicies', () => {
    it('invokes removeResourcePolicies without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.RemoveResourcePoliciesInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('reportHostAsFaulty', () => {
    it('invokes reportHostAsFaulty without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ReportHostAsFaultyInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('reset', () => {
    it('invokes reset without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResetInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('resume', () => {
    it('invokes resume without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResumeInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('sendDiagnosticInterrupt', () => {
    it('invokes sendDiagnosticInterrupt without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SendDiagnosticInterruptInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes sendDiagnosticInterrupt without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.sendDiagnosticInterrupt(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ISendDiagnosticInterruptInstanceResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('setDeletionProtection', () => {
    it('invokes setDeletionProtection without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetDeletionProtectionInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setDiskAutoDelete', () => {
    it('invokes setDiskAutoDelete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetDiskAutoDeleteInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setIamPolicy', () => {
    it('invokes setIamPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetIamPolicyInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setLabels', () => {
    it('invokes setLabels without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetLabelsInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setMachineResources', () => {
    it('invokes setMachineResources without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetMachineResourcesInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setMachineType', () => {
    it('invokes setMachineType without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetMachineTypeInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setMetadata', () => {
    it('invokes setMetadata without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetMetadataInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setMinCpuPlatform', () => {
    it('invokes setMinCpuPlatform without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetMinCpuPlatformInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setName', () => {
    it('invokes setName without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetNameInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setScheduling', () => {
    it('invokes setScheduling without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetSchedulingInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setSecurityPolicy', () => {
    it('invokes setSecurityPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetSecurityPolicyInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setServiceAccount', () => {
    it('invokes setServiceAccount without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetServiceAccountInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setShieldedInstanceIntegrityPolicy', () => {
    it('invokes setShieldedInstanceIntegrityPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetShieldedInstanceIntegrityPolicyInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setShieldedVmIntegrityPolicy', () => {
    it('invokes setShieldedVmIntegrityPolicy without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetShieldedVmIntegrityPolicyInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.setShieldedVmIntegrityPolicy =
        stubSimpleCall(expectedResponse);
      const [response] = await client.setShieldedVmIntegrityPolicy(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.setShieldedVmIntegrityPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.setShieldedVmIntegrityPolicy as SinonStub
    ...
    it('invokes setShieldedVmIntegrityPolicy with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.setShieldedVmIntegrityPolicy = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.setShieldedVmIntegrityPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.setShieldedVmIntegrityPolicy as SinonStub
  ...
  describe('setTags', () => {
    it('invokes setTags without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetTagsInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('simulateMaintenanceEvent', () => {
    it('invokes simulateMaintenanceEvent without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SimulateMaintenanceEventInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('start', () => {
    it('invokes start without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.StartInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('startWithEncryptionKey', () => {
    it('invokes startWithEncryptionKey without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.StartWithEncryptionKeyInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('stop', () => {
    it('invokes stop without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.StopInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('suspend', () => {
    it('invokes suspend without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SuspendInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.TestIamPermissionsInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes testIamPermissions without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.testIamPermissions(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.ITestPermissionsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('update', () => {
    it('invokes update without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('updateAccessConfig', () => {
    it('invokes updateAccessConfig without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateAccessConfigInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('updateDisplayDevice', () => {
    it('invokes updateDisplayDevice without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateDisplayDeviceInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('updateNetworkInterface', () => {
    it('invokes updateNetworkInterface without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateNetworkInterfaceInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('updateShieldedInstanceConfig', () => {
    it('invokes updateShieldedInstanceConfig without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateShieldedInstanceConfigInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('updateShieldedVmConfig', () => {
    it('invokes updateShieldedVmConfig without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.UpdateShieldedVmConfigInstanceRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.updateShieldedVmConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateShieldedVmConfig(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateShieldedVmConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateShieldedVmConfig as SinonStub
    ...
    it('invokes updateShieldedVmConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&zone=${defaultValue2 ?? ''}&instance=${defaultValue3 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateShieldedVmConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateShieldedVmConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateShieldedVmConfig as SinonStub
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AggregatedListInstancesRequest',
        ['project'],
      );
      request.project = defaultValue1;
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1beta.InstancesScopedList(),
          ),
        ],
        [
          'tuple_key_2',
      ...
      const responses: Array<
        [string, protos.google.cloud.compute.v1beta.IInstancesScopedList]
      > = [];
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListInstancesRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.Instance) => {
  ...
  describe('listReferrers', () => {
    it('invokes listReferrers without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListReferrersInstancesRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.Reference(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.Reference(),
        ),
    ...
    it('invokes listReferrers without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listReferrers(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IReference[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listReferrersStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.Reference) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
