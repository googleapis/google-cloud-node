...
describe('v1.RegionInstanceGroupManagerResizeRequestsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new regioninstancegroupmanagerresizerequestsModule.v1.RegionInstanceGroupManagerResizeRequestsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regioninstancegroupmanagerresizerequestsModule.v1
            .RegionInstanceGroupManagerResizeRequestsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        ...
        const apiEndpoint =
          regioninstancegroupmanagerresizerequestsModule.v1
            .RegionInstanceGroupManagerResizeRequestsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        regioninstancegroupmanagerresizerequestsModule.v1
          .RegionInstanceGroupManagerResizeRequestsClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(
        client.regionInstanceGroupManagerResizeRequestsStub,
        undefined,
      );
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.GetRegionInstanceGroupManagerResizeRequestRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IInstanceGroupManagerResizeRequest | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.compute.v1.InstanceGroupManagerResizeRequest,
          ) => {
