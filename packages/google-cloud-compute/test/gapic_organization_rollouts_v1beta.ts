...
import * as organizationrolloutsModule from '../src';
...
describe('v1beta.OrganizationRolloutsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new organizationrolloutsModule.v1beta.OrganizationRolloutsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          organizationrolloutsModule.v1beta.OrganizationRolloutsClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        organizationrolloutsModule.v1beta.OrganizationRolloutsClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.organizationRolloutsStub, undefined);
      await client.initialize();
      assert(client.organizationRolloutsStub);
    });
  ...
  describe('advance', () => {
    it('invokes advance without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.AdvanceOrganizationRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AdvanceOrganizationRolloutRequest',
        ['organization'],
      );
      ...
      const expectedHeaderRequestParams = `organization=${defaultValue1 ?? ''}&rollout=${defaultValue2 ?? ''}`;
  ...
  describe('cancel', () => {
    it('invokes cancel without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.CancelOrganizationRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.CancelOrganizationRolloutRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (client.innerApiCalls.cancel as SinonStub).getCall(
        0,
      ).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.cancel as SinonStub
      ).getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
      assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
    });
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.DeleteOrganizationRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteOrganizationRolloutRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetOrganizationRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetOrganizationRolloutRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `organization=${defaultValue1 ?? ''}&rollout=${defaultValue2 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.Rollout(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IRollout | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('pause', () => {
    it('invokes pause without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PauseOrganizationRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PauseOrganizationRolloutRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('resume', () => {
    it('invokes resume without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ResumeOrganizationRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ResumeOrganizationRolloutRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ListOrganizationRolloutsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListOrganizationRolloutsRequest',
        ['organization'],
      );
      request.organization = defaultValue1;
      const expectedHeaderRequestParams = `organization=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.compute.v1beta.Rollout()),
        generateSampleMessage(new protos.google.cloud.compute.v1beta.Rollout()),
        generateSampleMessage(new protos.google.cloud.compute.v1beta.Rollout()),
      ];
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1beta.Rollout[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.Rollout) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      const responses: protos.google.cloud.compute.v1beta.IRollout[] = [];
