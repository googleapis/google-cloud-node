...
describe('v1.RegionInstantSnapshotsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new regioninstantsnapshotsModule.v1.RegionInstantSnapshotsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regioninstantsnapshotsModule.v1.RegionInstantSnapshotsClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        regioninstantsnapshotsModule.v1.RegionInstantSnapshotsClient.port;
      assert(port);
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IInstantSnapshot | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.InstantSnapshot) => {
