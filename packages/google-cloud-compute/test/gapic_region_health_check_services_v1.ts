...
describe('v1.RegionHealthCheckServicesClient', () => {
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.AggregatedListRegionHealthCheckServicesRequest',
        ['project'],
      );
      request.project = defaultValue1;
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1.HealthCheckServicesScopedList(),
          ),
        ],
        [
          'tuple_key_2',
    ...
    it('uses async iteration with aggregatedList with error', async () => {
      ...
      await assert.rejects(async () => {
        const responses: Array<
          [
            string,
            protos.google.cloud.compute.v1.IHealthCheckServicesScopedList,
          ]
        > = [];
        for await (const resource of iterable) {
          responses.push(resource!);
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.compute.v1.IHealthCheckService[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
