...
describe('v1beta.HostsClient', () => {
  ...
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new hostsModule.v1beta.HostsClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = hostsModule.v1beta.HostsClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint = hostsModule.v1beta.HostsClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new hostsModule.v1beta.HostsClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = hostsModule.v1beta.HostsClient.port;
      assert(port);
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetHostRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetHostRequest',
        ['project'],
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.Host(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IHost | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getVersion', () => {
    it('invokes getVersion without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetVersionHostRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetVersionHostRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ListHostsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListHostsRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedResponse = [
        generateSampleMessage(new protos.google.cloud.compute.v1beta.Host()),
        generateSampleMessage(new protos.google.cloud.compute.v1beta.Host()),
        generateSampleMessage(new protos.google.cloud.compute.v1beta.Host()),
      ];
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1beta.Host[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.Host) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      const responses: protos.google.cloud.compute.v1beta.IHost[] = [];
