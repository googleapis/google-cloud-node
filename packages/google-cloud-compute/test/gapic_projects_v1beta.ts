...
describe('v1beta.ProjectsClient', () => {
  ...
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new projectsModule.v1beta.ProjectsClient({
          universe_domain: 'example.com',
  ...
  describe('disableXpnResource', () => {
    it('invokes disableXpnResource without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DisableXpnResourceProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('enableXpnHost', () => {
    it('invokes enableXpnHost without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.EnableXpnHostProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('enableXpnResource', () => {
    it('invokes enableXpnResource without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.EnableXpnResourceProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IProject | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getXpnHost', () => {
    it('invokes getXpnHost without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetXpnHostProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('moveDisk', () => {
    it('invokes moveDisk without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.MoveDiskProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('moveInstance', () => {
    it('invokes moveInstance without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.MoveInstanceProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('setCloudArmorTier', () => {
    it('invokes setCloudArmorTier without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetCloudArmorTierProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
      ...
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.setCloudArmorTier as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.setCloudArmorTier as SinonStub
    ...
    it('invokes setCloudArmorTier without error using callback', async () => {
      ...
      client.innerApiCalls.setCloudArmorTier =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes setCloudArmorTier with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.setCloudArmorTier = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('setCommonInstanceMetadata', () => {
    it('invokes setCommonInstanceMetadata without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetCommonInstanceMetadataProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('setDefaultNetworkTier', () => {
    it('invokes setDefaultNetworkTier without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetDefaultNetworkTierProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('setManagedProtectionTier', () => {
    it('invokes setManagedProtectionTier without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetManagedProtectionTierProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.setManagedProtectionTier =
        stubSimpleCall(expectedResponse);
      const [response] = await client.setManagedProtectionTier(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.setManagedProtectionTier as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.setManagedProtectionTier as SinonStub
    ...
    it('invokes setManagedProtectionTier with error', async () => {
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.setManagedProtectionTier = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.setManagedProtectionTier(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.setManagedProtectionTier as SinonStub
  ...
  describe('setUsageExportBucket', () => {
    it('invokes setUsageExportBucket without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetUsageExportBucketProjectRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
  ...
  describe('getXpnResources', () => {
    it('invokes getXpnResources without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetXpnResourcesProjectsRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.XpnResourceId(),
        ),
        generateSampleMessage(
          new protos.google.cloud.compute.v1beta.XpnResourceId(),
        ),
    ...
    it('invokes getXpnResources without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getXpnResources(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IXpnResourceId[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getXpnResourcesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.XpnResourceId) => {
  ...
  describe('listXpnHosts', () => {
    it('invokes listXpnHosts without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListXpnHostsProjectsRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
    ...
    it('invokes listXpnHostsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.Project) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
