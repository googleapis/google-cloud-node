...
describe('v1beta.NetworkFirewallPoliciesClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient.port;
      assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
      ...
      assert.strictEqual(client.networkFirewallPoliciesStub, undefined);
  ...
  describe('addAssociation', () => {
    it('invokes addAssociation without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.AddAssociationNetworkFirewallPolicyRequest(),
      );
  ...
  describe('addPacketMirroringRule', () => {
    it('invokes addPacketMirroringRule without error', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.AddPacketMirroringRuleNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AddPacketMirroringRuleNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.addPacketMirroringRule =
        stubSimpleCall(expectedResponse);
      const [response] = await client.addPacketMirroringRule(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.addPacketMirroringRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.addPacketMirroringRule as SinonStub
    ...
    it('invokes addPacketMirroringRule without error using callback', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
    ...
    it('invokes addPacketMirroringRule with error', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&firewall_policy=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.addPacketMirroringRule = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.addPacketMirroringRule(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.addPacketMirroringRule as SinonStub
    ...
    it('invokes addPacketMirroringRule with closed client', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('addRule', () => {
    it('invokes addRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.AddRuleNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AddRuleNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('cloneRules', () => {
    it('invokes cloneRules without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.CloneRulesNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.CloneRulesNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.DeleteNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.DeleteNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&firewall_policy=${defaultValue2 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.FirewallPolicy(),
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IFirewallPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getAssociation', () => {
    it('invokes getAssociation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetAssociationNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetAssociationNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&firewall_policy=${defaultValue2 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.FirewallPolicyAssociation(),
      );
    ...
    it('invokes getAssociation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAssociation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IFirewallPolicyAssociation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getIamPolicy', () => {
    it('invokes getIamPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetIamPolicyNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetIamPolicyNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('getPacketMirroringRule', () => {
    it('invokes getPacketMirroringRule without error', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetPacketMirroringRuleNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetPacketMirroringRuleNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&firewall_policy=${defaultValue2 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.FirewallPolicyRule(),
      );
      client.innerApiCalls.getPacketMirroringRule =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getPacketMirroringRule(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getPacketMirroringRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getPacketMirroringRule as SinonStub
    ...
    it('invokes getPacketMirroringRule without error using callback', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.getPacketMirroringRule =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getPacketMirroringRule(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IFirewallPolicyRule | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getPacketMirroringRule with error', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&firewall_policy=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getPacketMirroringRule = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getPacketMirroringRule(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getPacketMirroringRule as SinonStub
    ...
    it('invokes getPacketMirroringRule with closed client', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('getRule', () => {
    it('invokes getRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.GetRuleNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.GetRuleNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('insert', () => {
    it('invokes insert without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.InsertNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.InsertNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PatchNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('patchPacketMirroringRule', () => {
    it('invokes patchPacketMirroringRule without error', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PatchPacketMirroringRuleNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchPacketMirroringRuleNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.patchPacketMirroringRule =
        stubSimpleCall(expectedResponse);
      const [response] = await client.patchPacketMirroringRule(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.patchPacketMirroringRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.patchPacketMirroringRule as SinonStub
    ...
    it('invokes patchPacketMirroringRule without error using callback', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.patchPacketMirroringRule =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.patchPacketMirroringRule(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IOperation | null,
    ...
    it('invokes patchPacketMirroringRule with error', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&firewall_policy=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.patchPacketMirroringRule = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.patchPacketMirroringRule(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.patchPacketMirroringRule as SinonStub
    ...
    it('invokes patchPacketMirroringRule with closed client', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('patchRule', () => {
    it('invokes patchRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.PatchRuleNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.PatchRuleNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('removeAssociation', () => {
    it('invokes removeAssociation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.RemoveAssociationNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.RemoveAssociationNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('removePacketMirroringRule', () => {
    it('invokes removePacketMirroringRule without error', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.RemovePacketMirroringRuleNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.RemovePacketMirroringRuleNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
      ...
      client.innerApiCalls.removePacketMirroringRule =
        stubSimpleCall(expectedResponse);
      const [response] = await client.removePacketMirroringRule(request);
      assert.deepStrictEqual(response.latestResponse, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.removePacketMirroringRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.removePacketMirroringRule as SinonStub
    ...
    it('invokes removePacketMirroringRule without error using callback', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      client.innerApiCalls.removePacketMirroringRule =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.removePacketMirroringRule(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1beta.IOperation | null,
    ...
    it('invokes removePacketMirroringRule with error', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
      ...
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}&firewall_policy=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.removePacketMirroringRule = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.removePacketMirroringRule(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.removePacketMirroringRule as SinonStub
    ...
    it('invokes removePacketMirroringRule with closed client', async () => {
      const client =
        new networkfirewallpoliciesModule.v1beta.NetworkFirewallPoliciesClient({
          auth: googleAuth,
          projectId: 'bogus',
  ...
  describe('removeRule', () => {
    it('invokes removeRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.RemoveRuleNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.RemoveRuleNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('setIamPolicy', () => {
    it('invokes setIamPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.SetIamPolicyNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.SetIamPolicyNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('testIamPermissions', () => {
    it('invokes testIamPermissions without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.TestIamPermissionsNetworkFirewallPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.TestIamPermissionsNetworkFirewallPolicyRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.AggregatedListNetworkFirewallPoliciesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.AggregatedListNetworkFirewallPoliciesRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1beta.FirewallPoliciesScopedList(),
          ),
        ],
        [
          'tuple_key_2',
      ...
      const responses: Array<
        [string, protos.google.cloud.compute.v1beta.IFirewallPoliciesScopedList]
      > = [];
    ...
    it('uses async iteration with aggregatedList with error', async () => {
      ...
      await assert.rejects(async () => {
        const responses: Array<
          [
            string,
            protos.google.cloud.compute.v1beta.IFirewallPoliciesScopedList,
          ]
        > = [];
        for await (const resource of iterable) {
          responses.push(resource!);
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.compute.v1beta.ListNetworkFirewallPoliciesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1beta.ListNetworkFirewallPoliciesRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const expectedHeaderRequestParams = `project=${defaultValue1 ?? ''}`;
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.compute.v1beta.FirewallPolicy[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1beta.FirewallPolicy) => {
    ...
    it('uses async iteration with list without error', async () => {
      ...
      client.descriptors.page.list.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.compute.v1beta.IFirewallPolicy[] =
        [];
