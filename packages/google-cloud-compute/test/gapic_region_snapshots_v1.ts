...
describe('v1.RegionSnapshotsClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new regionsnapshotsModule.v1.RegionSnapshotsClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = regionsnapshotsModule.v1.RegionSnapshotsClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = regionsnapshotsModule.v1.RegionSnapshotsClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new regionsnapshotsModule.v1.RegionSnapshotsClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new regionsnapshotsModule.v1.RegionSnapshotsClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new regionsnapshotsModule.v1.RegionSnapshotsClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new regionsnapshotsModule.v1.RegionSnapshotsClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = regionsnapshotsModule.v1.RegionSnapshotsClient.port;
            assert(port);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.DeleteRegionSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteRegionSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteRegionSnapshotRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.DeleteRegionSnapshotRequest', ['snapshot']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.GetRegionSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetRegionSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetRegionSnapshotRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetRegionSnapshotRequest', ['snapshot']);
            request.snapshot = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&snapshot=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.GetIamPolicyRegionSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetIamPolicyRegionSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetIamPolicyRegionSnapshotRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.GetIamPolicyRegionSnapshotRequest', ['resource']);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.InsertRegionSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertRegionSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.InsertRegionSnapshotRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.SetIamPolicyRegionSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetIamPolicyRegionSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetIamPolicyRegionSnapshotRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetIamPolicyRegionSnapshotRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&resource=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Policy()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.SetLabelsRegionSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsRegionSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsRegionSnapshotRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.SetLabelsRegionSnapshotRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&resource=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.TestIamPermissionsRegionSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.TestIamPermissionsRegionSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.TestIamPermissionsRegionSnapshotRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.TestIamPermissionsRegionSnapshotRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&resource=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateKmsKey', () => {
        it('invokes updateKmsKey without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.UpdateKmsKeyRegionSnapshotRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.UpdateKmsKeyRegionSnapshotRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.UpdateKmsKeyRegionSnapshotRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('.google.cloud.compute.v1.UpdateKmsKeyRegionSnapshotRequest', ['snapshot']);
            request.snapshot = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&region=${defaultValue2 ?? '' }&snapshot=${defaultValue3 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1.ListRegionSnapshotsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListRegionSnapshotsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1.ListRegionSnapshotsRequest', ['region']);
            request.region = defaultValue2;
