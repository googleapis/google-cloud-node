...
describe('v1.RegionCompositeHealthChecksClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          regioncompositehealthchecksModule.v1.RegionCompositeHealthChecksClient
            .servicePath;
  ...
  describe('delete', () => {
    it('invokes delete without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.DeleteRegionCompositeHealthCheckRequest',
        ['project'],
      );
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ICompositeHealthCheck | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getHealth', () => {
    it('invokes getHealth without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.GetHealthRegionCompositeHealthCheckRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes getHealth without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getHealth(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ICompositeHealthCheckHealth | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('aggregatedList', () => {
    it('uses async iteration with aggregatedList without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.AggregatedListRegionCompositeHealthChecksRequest',
        ['project'],
      );
      request.project = defaultValue1;
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1.CompositeHealthChecksScopedList(),
          ),
        ],
        [
          'tuple_key_2',
      ...
      const responses: Array<
        [
          string,
          protos.google.cloud.compute.v1.ICompositeHealthChecksScopedList,
        ]
      > = [];
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.compute.v1.ListRegionCompositeHealthChecksRequest',
        ['project'],
      );
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue(
    ...
    it('invokes listStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.compute.v1.CompositeHealthCheck) => {
