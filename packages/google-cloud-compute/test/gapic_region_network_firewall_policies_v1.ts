...
<<<<<<< HEAD
    it('has port', () => {
      const port =
        regionnetworkfirewallpoliciesModule.v1
    ...
    it('should create a client with no option', () => {
      const client =
        new regionnetworkfirewallpoliciesModule.v1.RegionNetworkFirewallPoliciesClient();
      assert(client);
    });
    ...
    it('invokes getEffectiveFirewalls without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEffectiveFirewalls(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IRegionNetworkFirewallPoliciesGetEffectiveFirewallsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
...
>>>>>>> e7e9fc358f4a9717c33bd318da587d88ec01fa21
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new regionnetworkfirewallpoliciesModule.v1.RegionNetworkFirewallPoliciesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new regionnetworkfirewallpoliciesModule.v1.RegionNetworkFirewallPoliciesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new regionnetworkfirewallpoliciesModule.v1.RegionNetworkFirewallPoliciesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new regionnetworkfirewallpoliciesModule.v1.RegionNetworkFirewallPoliciesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
