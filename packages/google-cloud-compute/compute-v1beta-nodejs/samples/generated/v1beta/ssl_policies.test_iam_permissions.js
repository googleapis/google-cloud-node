...
function main(project, resource, testPermissionsRequestResource) {
  // [START compute_v1beta_generated_SslPolicies_TestIamPermissions_async]
  /**
  ...
  const {SslPoliciesClient} = require('@google-cloud/compute').v1beta;
  ...
  // [END compute_v1beta_generated_SslPolicies_TestIamPermissions_async]
}
