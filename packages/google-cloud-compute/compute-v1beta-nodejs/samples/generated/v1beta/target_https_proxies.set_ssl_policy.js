...
function main(project, sslPolicyReferenceResource, targetHttpsProxy) {
  // [START compute_v1beta_generated_TargetHttpsProxies_SetSslPolicy_async]
  /**
  ...
  const {TargetHttpsProxiesClient} = require('@google-cloud/compute').v1beta;
  ...
  callSetSslPolicy();
  // [END compute_v1beta_generated_TargetHttpsProxies_SetSslPolicy_async]
}
