...
describe('v1beta.ImagesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new imagesModule.v1beta.ImagesClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = imagesModule.v1beta.ImagesClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = imagesModule.v1beta.ImagesClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'compute.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new imagesModule.v1beta.ImagesClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new imagesModule.v1beta.ImagesClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'compute.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new imagesModule.v1beta.ImagesClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new imagesModule.v1beta.ImagesClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = imagesModule.v1beta.ImagesClient.port;
            assert(port);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.DeleteImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeleteImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeleteImageRequest', ['image']);
    ...
    describe('deprecate', () => {
        it('invokes deprecate without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.DeprecateImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeprecateImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.DeprecateImageRequest', ['image']);
            request.image = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&image=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.GetImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetImageRequest', ['image']);
            request.image = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&image=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Image()
            );
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1beta.IImage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getFromFamily', () => {
        it('invokes getFromFamily without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.GetFromFamilyImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetFromFamilyImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetFromFamilyImageRequest', ['family']);
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.GetIamPolicyImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetIamPolicyImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.GetIamPolicyImageRequest', ['resource']);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.InsertImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.InsertImageRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.PatchImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.PatchImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.PatchImageRequest', ['image']);
            request.image = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&image=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Operation()
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.SetIamPolicyImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetIamPolicyImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetIamPolicyImageRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&resource=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Policy()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.SetLabelsImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetLabelsImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.SetLabelsImageRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&resource=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.Operation()
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.TestIamPermissionsImageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.TestIamPermissionsImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.TestIamPermissionsImageRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }&resource=${defaultValue2 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.compute.v1beta.ListImagesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.compute.v1beta.ListImagesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1beta.Image()),
              generateSampleMessage(new protos.google.cloud.compute.v1beta.Image()),
              generateSampleMessage(new protos.google.cloud.compute.v1beta.Image()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1beta.Image[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1beta.Image) => {
        ...
        it('uses async iteration with list without error', async () => {
            ...
            const responses: protos.google.cloud.compute.v1beta.IImage[] = [];
