...
function main(project) {
  // [START compute_v1beta_generated_Addresses_AggregatedList_async]
  /**
  ...
  const {AddressesClient} = require('@google-cloud/compute').v1beta;
  ...
  callAggregatedList();
  // [END compute_v1beta_generated_Addresses_AggregatedList_async]
}
