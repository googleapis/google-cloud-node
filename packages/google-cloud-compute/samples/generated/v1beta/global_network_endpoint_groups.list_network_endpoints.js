...
function main(networkEndpointGroup, project) {
  // [START compute_v1beta_generated_GlobalNetworkEndpointGroups_ListNetworkEndpoints_async]
  /**
  ...
  const {GlobalNetworkEndpointGroupsClient} = require('@google-cloud/compute').v1beta;
  ...
  // [END compute_v1beta_generated_GlobalNetworkEndpointGroups_ListNetworkEndpoints_async]
}
