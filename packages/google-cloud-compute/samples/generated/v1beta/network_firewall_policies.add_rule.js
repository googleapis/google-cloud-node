...
function main(firewallPolicy, firewallPolicyRuleResource, project) {
  // [START compute_v1beta_generated_NetworkFirewallPolicies_AddRule_async]
  /**
  ...
  const {NetworkFirewallPoliciesClient} = require('@google-cloud/compute').v1beta;
  ...
  callAddRule();
  // [END compute_v1beta_generated_NetworkFirewallPolicies_AddRule_async]
}
