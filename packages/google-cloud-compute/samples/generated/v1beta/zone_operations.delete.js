...
function main(operation, project, zone) {
  // [START compute_v1beta_generated_ZoneOperations_Delete_async]
  /**
  ...
  const {ZoneOperationsClient} = require('@google-cloud/compute').v1beta;
  ...
  callDelete();
  // [END compute_v1beta_generated_ZoneOperations_Delete_async]
}
