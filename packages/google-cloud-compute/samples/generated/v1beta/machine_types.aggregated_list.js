...
function main(project) {
  // [START compute_v1beta_generated_MachineTypes_AggregatedList_async]
  /**
  ...
  const {MachineTypesClient} = require('@google-cloud/compute').v1beta;
  ...
  callAggregatedList();
  // [END compute_v1beta_generated_MachineTypes_AggregatedList_async]
}
