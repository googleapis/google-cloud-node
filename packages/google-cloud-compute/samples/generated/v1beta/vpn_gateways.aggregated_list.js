...
function main(project) {
  // [START compute_v1beta_generated_VpnGateways_AggregatedList_async]
  /**
  ...
  const {VpnGatewaysClient} = require('@google-cloud/compute').v1beta;
  ...
  callAggregatedList();
  // [END compute_v1beta_generated_VpnGateways_AggregatedList_async]
}
