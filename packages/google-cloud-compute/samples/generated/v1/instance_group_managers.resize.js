...
function main(instanceGroupManager, project, size, zone) {
  // [START compute_v1_generated_InstanceGroupManagers_Resize_async]
  /**
  ...
  callResize();
  // [END compute_v1_generated_InstanceGroupManagers_Resize_async]
}
