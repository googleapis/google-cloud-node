...
function main(association, project, zone) {
  // [START compute_v1_generated_Hosts_List_async]
  /**
  ...
  const {HostsClient} = require('@google-cloud/compute').v1;

  // Instantiates a client
  const computeClient = new HostsClient();
  ...
  callList();
  // [END compute_v1_generated_Hosts_List_async]
}
