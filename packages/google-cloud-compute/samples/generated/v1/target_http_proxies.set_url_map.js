...
function main(project, targetHttpProxy, urlMapReferenceResource) {
  // [START compute_v1_generated_TargetHttpProxies_SetUrlMap_async]
  /**
  ...
  callSetUrlMap();
  // [END compute_v1_generated_TargetHttpProxies_SetUrlMap_async]
}
