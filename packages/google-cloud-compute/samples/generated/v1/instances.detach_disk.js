...
function main(deviceName, instance, project, zone) {
  // [START compute_v1_generated_Instances_DetachDisk_async]
  /**
  ...
  callDetachDisk();
  // [END compute_v1_generated_Instances_DetachDisk_async]
}
