...
function main(parentName, project, reservationSlot, zone) {
  // [START compute_v1_generated_ReservationSlots_GetHealth_async]
  /**
  ...
  callGetHealth();
  // [END compute_v1_generated_ReservationSlots_GetHealth_async]
}
