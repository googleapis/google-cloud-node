...
function main(forwardingRule, project, region, targetReferenceResource) {
  ...
  async function callSetTarget() {
    ...
    // Run request
    const response = await computeClient.setTarget(request);
