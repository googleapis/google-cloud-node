...
function main(name) {
  // [START configdelivery_v1_generated_ConfigDelivery_DeleteFleetPackage_async]
  /**
  ...
  async function callDeleteFleetPackage() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await configdeliveryClient.deleteFleetPackage(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callDeleteFleetPackage();
  // [END configdelivery_v1_generated_ConfigDelivery_DeleteFleetPackage_async]
}
