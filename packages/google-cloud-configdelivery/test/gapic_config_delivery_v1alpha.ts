...
describe('v1alpha.ConfigDeliveryClient', () => {
    describe('Common methods', () => {
        it('has apiEndpoint', () => {
            const client = new configdeliveryModule.v1alpha.ConfigDeliveryClient();
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = configdeliveryModule.v1alpha.ConfigDeliveryClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = configdeliveryModule.v1alpha.ConfigDeliveryClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'configdelivery.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new configdeliveryModule.v1alpha.ConfigDeliveryClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'configdelivery.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new configdeliveryModule.v1alpha.ConfigDeliveryClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'configdelivery.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new configdeliveryModule.v1alpha.ConfigDeliveryClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new configdeliveryModule.v1alpha.ConfigDeliveryClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });

        it('has port', () => {
            const port = configdeliveryModule.v1alpha.ConfigDeliveryClient.port;
            assert(port);
    ...
    describe('getResourceBundle', () => {
        it('invokes getResourceBundle without error', async () => {
            ...
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.GetResourceBundleRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.GetResourceBundleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.ResourceBundle()
            );
        ...
        it('invokes getResourceBundle without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getResourceBundle(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1alpha.IResourceBundle|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getFleetPackage', () => {
        it('invokes getFleetPackage without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.GetFleetPackageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.GetFleetPackageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.FleetPackage()
            );
        ...
        it('invokes getFleetPackage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFleetPackage(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1alpha.IFleetPackage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRelease', () => {
        it('invokes getRelease without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.GetReleaseRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.GetReleaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.Release()
            );
        ...
        it('invokes getRelease without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRelease(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1alpha.IRelease|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getVariant', () => {
        it('invokes getVariant without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.GetVariantRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.GetVariantRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.Variant()
            );
        ...
        it('invokes getVariant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getVariant(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1alpha.IVariant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRollout', () => {
        it('invokes getRollout without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.GetRolloutRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.GetRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.Rollout()
            );
        ...
        it('invokes getRollout without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRollout(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1alpha.IRollout|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createResourceBundle', () => {
        it('invokes createResourceBundle without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.CreateResourceBundleRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.CreateResourceBundleRequest', ['parent']);
        ...
        it('invokes createResourceBundle without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createResourceBundle(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1alpha.IResourceBundle, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1alpha.IResourceBundle, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createResourceBundle as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateResourceBundle', () => {
        it('invokes updateResourceBundle without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.UpdateResourceBundleRequest()
            );
            request.resourceBundle ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.UpdateResourceBundleRequest', ['resourceBundle', 'name']);
    ...
    describe('deleteResourceBundle', () => {
        it('invokes deleteResourceBundle without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.DeleteResourceBundleRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.DeleteResourceBundleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteResourceBundle without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteResourceBundle(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteResourceBundle as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createFleetPackage', () => {
        it('invokes createFleetPackage without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.CreateFleetPackageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.CreateFleetPackageRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createFleetPackage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFleetPackage(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1alpha.IFleetPackage, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1alpha.IFleetPackage, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFleetPackage as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateFleetPackage', () => {
        it('invokes updateFleetPackage without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.UpdateFleetPackageRequest()
            );
            request.fleetPackage ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.UpdateFleetPackageRequest', ['fleetPackage', 'name']);
    ...
    describe('deleteFleetPackage', () => {
        it('invokes deleteFleetPackage without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.DeleteFleetPackageRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.DeleteFleetPackageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createRelease', () => {
        it('invokes createRelease without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.CreateReleaseRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.CreateReleaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createRelease without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createRelease(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1alpha.IRelease, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1alpha.IRelease, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRelease as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateRelease', () => {
        it('invokes updateRelease without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.UpdateReleaseRequest()
            );
            request.release ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.UpdateReleaseRequest', ['release', 'name']);
    ...
    describe('deleteRelease', () => {
        it('invokes deleteRelease without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.DeleteReleaseRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.DeleteReleaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createVariant', () => {
        it('invokes createVariant without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.CreateVariantRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.CreateVariantRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createVariant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createVariant(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1alpha.IVariant, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1alpha.IVariant, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createVariant as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateVariant', () => {
        it('invokes updateVariant without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.UpdateVariantRequest()
            );
            request.variant ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.UpdateVariantRequest', ['variant', 'name']);
    ...
    describe('deleteVariant', () => {
        it('invokes deleteVariant without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.DeleteVariantRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.DeleteVariantRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('suspendRollout', () => {
        it('invokes suspendRollout without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.SuspendRolloutRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.SuspendRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes suspendRollout without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suspendRollout(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1alpha.IRollout, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1alpha.IRollout, protos.google.cloud.configdelivery.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suspendRollout as SinonStub)
                .getCall(0).args[0];
    ...
    describe('resumeRollout', () => {
        it('invokes resumeRollout without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.ResumeRolloutRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.ResumeRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('abortRollout', () => {
        it('invokes abortRollout without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.AbortRolloutRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.AbortRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listResourceBundles', () => {
        it('invokes listResourceBundles without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.ListResourceBundlesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.ListResourceBundlesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.ResourceBundle()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.ResourceBundle()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.ResourceBundle()),
            ];
        ...
        it('invokes listResourceBundlesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.configdelivery.v1alpha.ResourceBundle[] = [];
                stream.on('data', (response: protos.google.cloud.configdelivery.v1alpha.ResourceBundle) => {
        ...
        it('uses async iteration with listResourceBundles without error', async () => {
            ...
            const responses: protos.google.cloud.configdelivery.v1alpha.IResourceBundle[] = [];
    ...
    describe('listFleetPackages', () => {
        it('invokes listFleetPackages without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.ListFleetPackagesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.ListFleetPackagesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.FleetPackage()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.FleetPackage()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.FleetPackage()),
            ];
        ...
        it('invokes listFleetPackagesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.configdelivery.v1alpha.FleetPackage[] = [];
                stream.on('data', (response: protos.google.cloud.configdelivery.v1alpha.FleetPackage) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listFleetPackages without error', async () => {
            ...
            const responses: protos.google.cloud.configdelivery.v1alpha.IFleetPackage[] = [];
    ...
    describe('listReleases', () => {
        it('invokes listReleases without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.ListReleasesRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.ListReleasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Release()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Release()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Release()),
            ];
        ...
        it('invokes listReleasesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.configdelivery.v1alpha.Release[] = [];
                stream.on('data', (response: protos.google.cloud.configdelivery.v1alpha.Release) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listReleases without error', async () => {
            ...
            const responses: protos.google.cloud.configdelivery.v1alpha.IRelease[] = [];
    ...
    describe('listVariants', () => {
        it('invokes listVariants without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.ListVariantsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.ListVariantsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Variant()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Variant()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Variant()),
            ];
        ...
        it('invokes listVariantsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.configdelivery.v1alpha.Variant[] = [];
                stream.on('data', (response: protos.google.cloud.configdelivery.v1alpha.Variant) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listVariants without error', async () => {
            ...
            const responses: protos.google.cloud.configdelivery.v1alpha.IVariant[] = [];
    ...
    describe('listRollouts', () => {
        it('invokes listRollouts without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.configdelivery.v1alpha.ListRolloutsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1alpha.ListRolloutsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Rollout()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Rollout()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1alpha.Rollout()),
            ];
        ...
        it('invokes listRolloutsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.configdelivery.v1alpha.Rollout[] = [];
                stream.on('data', (response: protos.google.cloud.configdelivery.v1alpha.Rollout) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listRollouts without error', async () => {
            ...
            const responses: protos.google.cloud.configdelivery.v1alpha.IRollout[] = [];
