  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          configdeliveryModule.v1alpha.ConfigDeliveryClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          configdeliveryModule.v1alpha.ConfigDeliveryClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'configdelivery.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        it('sets apiEndpoint from environment variable', () => {
          ...
          const client =
            new configdeliveryModule.v1alpha.ConfigDeliveryClient();
          const servicePath = client.apiEndpoint;
          assert.strictEqual(servicePath, 'configdelivery.example.com');
          if (saved) {
    ...
    it('invokes getResourceBundle without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getResourceBundle(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1alpha.IResourceBundle | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFleetPackage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFleetPackage(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1alpha.IFleetPackage | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRelease without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRelease(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1alpha.IRelease | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getVariant without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getVariant(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1alpha.IVariant | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRollout without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRollout(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1alpha.IRollout | null,
          ) => {
            if (err) {
              reject(err);
            } else {
        ...
        client.createResourceBundle(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.configdelivery.v1alpha.IOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes listResourceBundlesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.configdelivery.v1alpha.ResourceBundle,
          ) => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listFleetPackages(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.configdelivery.v1alpha.IFleetPackage[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFleetPackagesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.configdelivery.v1alpha.FleetPackage,
          ) => {
            responses.push(response);
          },
        );
  ...
  describe('listReleases', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listReleases(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.configdelivery.v1alpha.IRelease[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listReleasesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1alpha.Release) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listVariants', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listVariants(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.configdelivery.v1alpha.IVariant[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listVariantsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1alpha.Variant) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listRollouts', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRollouts(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.configdelivery.v1alpha.IRollout[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listRolloutsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1alpha.Rollout) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
