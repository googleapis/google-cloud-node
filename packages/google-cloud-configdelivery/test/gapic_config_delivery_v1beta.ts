...
describe('v1beta.ConfigDeliveryClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = configdeliveryModule.v1beta.ConfigDeliveryClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = configdeliveryModule.v1beta.ConfigDeliveryClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'configdelivery.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new configdeliveryModule.v1beta.ConfigDeliveryClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'configdelivery.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new configdeliveryModule.v1beta.ConfigDeliveryClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'configdelivery.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new configdeliveryModule.v1beta.ConfigDeliveryClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new configdeliveryModule.v1beta.ConfigDeliveryClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getResourceBundle', () => {
        it('invokes getResourceBundle without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.GetResourceBundleRequest', ['name']);
        ...
        it('invokes getResourceBundle without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getResourceBundle(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1beta.IResourceBundle|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getFleetPackage', () => {
        it('invokes getFleetPackage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.GetFleetPackageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getFleetPackage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getFleetPackage(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1beta.IFleetPackage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRelease', () => {
        it('invokes getRelease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.GetReleaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getRelease without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRelease(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1beta.IRelease|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getVariant', () => {
        it('invokes getVariant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.GetVariantRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getVariant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getVariant(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1beta.IVariant|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getRollout', () => {
        it('invokes getRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.GetRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes getRollout without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getRollout(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.configdelivery.v1beta.IRollout|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createResourceBundle', () => {
        it('invokes createResourceBundle without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.CreateResourceBundleRequest', ['parent']);
        ...
        it('invokes createResourceBundle without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createResourceBundle(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1beta.IResourceBundle, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1beta.IResourceBundle, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createResourceBundle as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateResourceBundle', () => {
        it('invokes updateResourceBundle without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.UpdateResourceBundleRequest', ['resourceBundle', 'name']);
    ...
    describe('deleteResourceBundle', () => {
        it('invokes deleteResourceBundle without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.DeleteResourceBundleRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteResourceBundle without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteResourceBundle(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteResourceBundle as SinonStub)
                .getCall(0).args[0];
    ...
    describe('createFleetPackage', () => {
        it('invokes createFleetPackage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.CreateFleetPackageRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createFleetPackage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFleetPackage(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1beta.IFleetPackage, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1beta.IFleetPackage, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createFleetPackage as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateFleetPackage', () => {
        it('invokes updateFleetPackage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.UpdateFleetPackageRequest', ['fleetPackage', 'name']);
    ...
    describe('deleteFleetPackage', () => {
        it('invokes deleteFleetPackage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.DeleteFleetPackageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createRelease', () => {
        it('invokes createRelease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.CreateReleaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createRelease without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createRelease(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1beta.IRelease, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1beta.IRelease, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createRelease as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateRelease', () => {
        it('invokes updateRelease without error', async () => {
            ...
            request.release ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.UpdateReleaseRequest', ['release', 'name']);
    ...
    describe('deleteRelease', () => {
        it('invokes deleteRelease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.DeleteReleaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createVariant', () => {
        it('invokes createVariant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.CreateVariantRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes createVariant without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createVariant(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1beta.IVariant, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1beta.IVariant, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createVariant as SinonStub)
                .getCall(0).args[0];
    ...
    describe('updateVariant', () => {
        it('invokes updateVariant without error', async () => {
            ...
            request.variant ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.UpdateVariantRequest', ['variant', 'name']);
    ...
    describe('deleteVariant', () => {
        it('invokes deleteVariant without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.DeleteVariantRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('suspendRollout', () => {
        it('invokes suspendRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.SuspendRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes suspendRollout without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.suspendRollout(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.configdelivery.v1beta.IRollout, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.configdelivery.v1beta.IRollout, protos.google.cloud.configdelivery.v1beta.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.suspendRollout as SinonStub)
                .getCall(0).args[0];
    ...
    describe('resumeRollout', () => {
        it('invokes resumeRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.ResumeRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('abortRollout', () => {
        it('invokes abortRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.AbortRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listResourceBundles', () => {
        it('invokes listResourceBundles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.ListResourceBundlesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.ResourceBundle()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.ResourceBundle()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.ResourceBundle()),
            ];
        ...
        it('invokes listResourceBundlesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.configdelivery.v1beta.ResourceBundle) => {
    ...
    describe('listFleetPackages', () => {
        it('invokes listFleetPackages without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.ListFleetPackagesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.FleetPackage()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.FleetPackage()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.FleetPackage()),
            ];
        ...
        it('invokes listFleetPackagesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.configdelivery.v1beta.FleetPackage) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listReleases', () => {
        it('invokes listReleases without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.ListReleasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Release()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Release()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Release()),
            ];
        ...
        it('invokes listReleasesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.configdelivery.v1beta.Release) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listVariants', () => {
        it('invokes listVariants without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.ListVariantsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Variant()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Variant()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Variant()),
            ];
        ...
        it('invokes listVariantsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.configdelivery.v1beta.Variant) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listRollouts', () => {
        it('invokes listRollouts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.configdelivery.v1beta.ListRolloutsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Rollout()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Rollout()),
              generateSampleMessage(new protos.google.cloud.configdelivery.v1beta.Rollout()),
            ];
        ...
        it('invokes listRolloutsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.configdelivery.v1beta.Rollout) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
