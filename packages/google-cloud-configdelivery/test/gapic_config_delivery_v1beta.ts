...
describe('v1beta.ConfigDeliveryClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client = new configdeliveryModule.v1beta.ConfigDeliveryClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          configdeliveryModule.v1beta.ConfigDeliveryClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          configdeliveryModule.v1beta.ConfigDeliveryClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'configdelivery.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'configdelivery.configured.example.com',
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new configdeliveryModule.v1beta.ConfigDeliveryClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = configdeliveryModule.v1beta.ConfigDeliveryClient.port;
      assert(port);
  ...
  describe('getResourceBundle', () => {
    it('invokes getResourceBundle without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.GetResourceBundleRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.ResourceBundle(),
      );
      ...
      const actualRequest = (
        client.innerApiCalls.getResourceBundle as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getResourceBundle without error using callback', async () => {
      ...
      client.innerApiCalls.getResourceBundle =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getResourceBundle(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1beta.IResourceBundle | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getResourceBundle with error', async () => {
      ...
      client.innerApiCalls.getResourceBundle = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getFleetPackage', () => {
    it('invokes getFleetPackage without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.GetFleetPackageRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes getFleetPackage without error using callback', async () => {
      ...
      client.innerApiCalls.getFleetPackage =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getFleetPackage(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1beta.IFleetPackage | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFleetPackage with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getFleetPackage = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getRelease', () => {
    it('invokes getRelease without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.GetReleaseRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.Release(),
      );
    ...
    it('invokes getRelease without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRelease(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1beta.IRelease | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getVariant', () => {
    it('invokes getVariant without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.GetVariantRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes getVariant without error using callback', async () => {
      ...
      client.innerApiCalls.getVariant =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getVariant(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1beta.IVariant | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getVariant with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getVariant = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getRollout', () => {
    it('invokes getRollout without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.GetRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.Rollout(),
      );
    ...
    it('invokes getRollout without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRollout(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1beta.IRollout | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createResourceBundle', () => {
    it('invokes createResourceBundle without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.CreateResourceBundleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createResourceBundle =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createResourceBundle(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createResourceBundle as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createResourceBundle as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.createResourceBundle(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.configdelivery.v1beta.IResourceBundle,
              protos.google.cloud.configdelivery.v1beta.IOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
    ...
    it('invokes createResourceBundle with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createResourceBundle = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateResourceBundleProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateResourceBundleProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateResourceBundle', () => {
    it('invokes updateResourceBundle without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.UpdateResourceBundleRequest(),
      );
      ...
      client.innerApiCalls.updateResourceBundle =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateResourceBundle(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateResourceBundle as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateResourceBundle as SinonStub
    ...
    it('invokes updateResourceBundle with call error', async () => {
      ...
      const expectedHeaderRequestParams = `resource_bundle.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateResourceBundle = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateResourceBundleProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateResourceBundleProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteResourceBundle', () => {
    it('invokes deleteResourceBundle without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.DeleteResourceBundleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteResourceBundle =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteResourceBundle(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteResourceBundle as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteResourceBundle as SinonStub
    ...
    it('invokes deleteResourceBundle with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteResourceBundle = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteResourceBundleProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteResourceBundleProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createFleetPackage', () => {
    it('invokes createFleetPackage without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.CreateFleetPackageRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createFleetPackage =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createFleetPackage(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createFleetPackage as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createFleetPackage as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.createFleetPackage(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.configdelivery.v1beta.IFleetPackage,
              protos.google.cloud.configdelivery.v1beta.IOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes createFleetPackage with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createFleetPackage = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateFleetPackageProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateFleetPackageProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateFleetPackage', () => {
    it('invokes updateFleetPackage without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.UpdateFleetPackageRequest(),
      );
      ...
      client.innerApiCalls.updateFleetPackage =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateFleetPackage(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateFleetPackage as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateFleetPackage as SinonStub
    ...
    it('invokes updateFleetPackage with call error', async () => {
      ...
      const expectedHeaderRequestParams = `fleet_package.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateFleetPackage = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateFleetPackageProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateFleetPackageProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteFleetPackage', () => {
    it('invokes deleteFleetPackage without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.DeleteFleetPackageRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteFleetPackage =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteFleetPackage(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteFleetPackage as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteFleetPackage as SinonStub
    ...
    it('invokes deleteFleetPackage with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteFleetPackage = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteFleetPackageProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteFleetPackageProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createRelease', () => {
    it('invokes createRelease without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.CreateReleaseRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const promise = new Promise((resolve, reject) => {
        client.createRelease(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.configdelivery.v1beta.IRelease,
              protos.google.cloud.configdelivery.v1beta.IOperationMetadata
            > | null,
          ) => {
            if (err) {
  ...
  describe('updateRelease', () => {
    it('invokes updateRelease without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.UpdateReleaseRequest(),
      );
      request.release ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.updateRelease =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateRelease(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateRelease as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateRelease as SinonStub
    ...
    it('invokes updateRelease with call error', async () => {
      ...
      const expectedHeaderRequestParams = `release.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateRelease = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateReleaseProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateReleaseProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteRelease', () => {
    it('invokes deleteRelease without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.DeleteReleaseRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteRelease =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteRelease(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRelease as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRelease as SinonStub
    ...
    it('invokes deleteRelease with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteRelease = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteReleaseProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteReleaseProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createVariant', () => {
    it('invokes createVariant without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.CreateVariantRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createVariant =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createVariant(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createVariant as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createVariant as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.createVariant(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.configdelivery.v1beta.IVariant,
              protos.google.cloud.configdelivery.v1beta.IOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes createVariant with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createVariant = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateVariantProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateVariantProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateVariant', () => {
    it('invokes updateVariant without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.UpdateVariantRequest(),
      );
      request.variant ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.updateVariant =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateVariant(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateVariant as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateVariant as SinonStub
    ...
    it('invokes updateVariant with call error', async () => {
      ...
      const expectedHeaderRequestParams = `variant.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateVariant = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateVariantProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateVariantProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteVariant', () => {
    it('invokes deleteVariant without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.DeleteVariantRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteVariant =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteVariant(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteVariant as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteVariant as SinonStub
    ...
    it('invokes deleteVariant with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteVariant = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteVariantProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteVariantProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('suspendRollout', () => {
    it('invokes suspendRollout without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.SuspendRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.suspendRollout =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.suspendRollout(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.suspendRollout as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.suspendRollout as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.suspendRollout(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.configdelivery.v1beta.IRollout,
              protos.google.cloud.configdelivery.v1beta.IOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes suspendRollout with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.suspendRollout = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkSuspendRolloutProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkSuspendRolloutProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('resumeRollout', () => {
    it('invokes resumeRollout without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.ResumeRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.resumeRollout =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.resumeRollout(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.resumeRollout as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.resumeRollout as SinonStub
    ...
    it('invokes resumeRollout with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.resumeRollout = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkResumeRolloutProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkResumeRolloutProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('abortRollout', () => {
    it('invokes abortRollout without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.AbortRolloutRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.abortRollout as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.abortRollout as SinonStub
    ...
    it('invokes abortRollout without error using callback', async () => {
      ...
      client.innerApiCalls.abortRollout =
        stubLongRunningCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.abortRollout(
          request,
    ...
    it('invokes abortRollout with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.abortRollout = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('listResourceBundles', () => {
    it('invokes listResourceBundles without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.ListResourceBundlesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listResourceBundles =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listResourceBundles(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listResourceBundles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listResourceBundles as SinonStub
    ...
    it('invokes listResourceBundles with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listResourceBundles = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listResourceBundlesStream without error', async () => {
      ...
      client.descriptors.page.listResourceBundles.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listResourceBundlesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.configdelivery.v1beta.ResourceBundle[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.configdelivery.v1beta.ResourceBundle,
          ) => {
      ...
      assert(
        (client.descriptors.page.listResourceBundles.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listResourceBundles, request),
      );
      assert(
        (client.descriptors.page.listResourceBundles.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listResourceBundles without error', async () => {
      ...
      client.descriptors.page.listResourceBundles.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.configdelivery.v1beta.IResourceBundle[] =
        [];
  ...
  describe('listFleetPackages', () => {
    it('invokes listFleetPackages without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.ListFleetPackagesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listFleetPackages as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listFleetPackages as SinonStub
    ...
    it('invokes listFleetPackages without error using callback', async () => {
      ...
      client.innerApiCalls.listFleetPackages =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listFleetPackages(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.configdelivery.v1beta.IFleetPackage[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFleetPackages with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listFleetPackages = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listFleetPackagesStream without error', async () => {
      ...
      client.descriptors.page.listFleetPackages.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listFleetPackagesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.configdelivery.v1beta.FleetPackage[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.configdelivery.v1beta.FleetPackage,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (client.descriptors.page.listFleetPackages.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listFleetPackages, request),
      );
      assert(
        (client.descriptors.page.listFleetPackages.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listFleetPackages without error', async () => {
      ...
      client.descriptors.page.listFleetPackages.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.configdelivery.v1beta.IFleetPackage[] =
        [];
  ...
  describe('listReleases', () => {
    it('invokes listReleases without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.ListReleasesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const promise = new Promise((resolve, reject) => {
        client.listReleases(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.configdelivery.v1beta.IRelease[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listReleasesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.configdelivery.v1beta.Release[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1beta.Release) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listReleases without error', async () => {
      ...
      client.descriptors.page.listReleases.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.configdelivery.v1beta.IRelease[] =
        [];
  ...
  describe('listVariants', () => {
    it('invokes listVariants without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.ListVariantsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listVariants as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listVariants as SinonStub
    ...
    it('invokes listVariants without error using callback', async () => {
      ...
      client.innerApiCalls.listVariants =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listVariants(
          request,
          (
            err?: Error | null,
            result?:
              protos.google.cloud.configdelivery.v1beta.IVariant[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listVariants with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listVariants = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listVariantsStream without error', async () => {
      ...
      client.descriptors.page.listVariants.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listVariantsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.configdelivery.v1beta.Variant[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1beta.Variant) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listVariants.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listVariants, request),
      );
      assert(
        (client.descriptors.page.listVariants.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listVariantsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listVariants.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listVariantsStream(request);
    ...
    it('uses async iteration with listVariants without error', async () => {
      ...
      client.descriptors.page.listVariants.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.configdelivery.v1beta.IVariant[] =
        [];
  ...
  describe('listRollouts', () => {
    it('invokes listRollouts without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.configdelivery.v1beta.ListRolloutsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const promise = new Promise((resolve, reject) => {
        client.listRollouts(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.configdelivery.v1beta.IRollout[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listRolloutsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.configdelivery.v1beta.Rollout[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1beta.Rollout) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
    ...
    it('uses async iteration with listRollouts without error', async () => {
      ...
      client.descriptors.page.listRollouts.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.configdelivery.v1beta.IRollout[] =
        [];
  ...
  describe('Path templates', () => {
    describe('fleetPackage', async () => {
      ...
      await client.initialize();
      client.pathTemplates.fleetPackagePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.fleetPackagePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('fleetPackagePath', () => {
        const result = client.fleetPackagePath(
          'projectValue',
          'locationValue',
          'fleetPackageValue',
        );
        ...
        assert(
          (client.pathTemplates.fleetPackagePathTemplate.render as SinonStub)
            .getCall(-1)
      ...
      it('matchProjectFromFleetPackageName', () => {
        ...
        assert(
          (client.pathTemplates.fleetPackagePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
    ...
    describe('resourceBundle', async () => {
      ...
      await client.initialize();
      client.pathTemplates.resourceBundlePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.resourceBundlePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('resourceBundlePath', () => {
        const result = client.resourceBundlePath(
          'projectValue',
          'locationValue',
          'resourceBundleValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.resourceBundlePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromResourceBundleName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.resourceBundlePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchResourceBundleFromResourceBundleName', () => {
        const result =
          client.matchResourceBundleFromResourceBundleName(fakePath);
        assert.strictEqual(result, 'resourceBundleValue');
        assert(
          (client.pathTemplates.resourceBundlePathTemplate.match as SinonStub)
            .getCall(-1)
    ...
    describe('variant', async () => {
      ...
      await client.initialize();
      client.pathTemplates.variantPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.variantPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('variantPath', () => {
        const result = client.variantPath(
          'projectValue',
          'locationValue',
          'resourceBundleValue',
          'releaseValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.variantPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromVariantName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.variantPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
