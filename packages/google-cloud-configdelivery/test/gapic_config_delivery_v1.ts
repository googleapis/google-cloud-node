  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          configdeliveryModule.v1.ConfigDeliveryClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          configdeliveryModule.v1.ConfigDeliveryClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'configdelivery.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new configdeliveryModule.v1.ConfigDeliveryClient({
          universe_domain: 'example.com',
    ...
    it('invokes getResourceBundle without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getResourceBundle(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1.IResourceBundle | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFleetPackage without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFleetPackage(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1.IFleetPackage | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRelease without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRelease(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1.IRelease | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getVariant without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getVariant(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1.IVariant | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getRollout without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getRollout(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.configdelivery.v1.IRollout | null,
          ) => {
            if (err) {
              reject(err);
            } else {
        ...
        client.createResourceBundle(
          ...
          (
            ...
            result?: LROperation<
              ...
              protos.google.cloud.configdelivery.v1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
              reject(err);
      ...
      const promise = new Promise((resolve, reject) => {
        client.createRelease(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.configdelivery.v1.IRelease,
              protos.google.cloud.configdelivery.v1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createVariant(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.configdelivery.v1.IVariant,
              protos.google.cloud.configdelivery.v1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
      ...
      const promise = new Promise((resolve, reject) => {
        client.suspendRollout(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.configdelivery.v1.IRollout,
              protos.google.cloud.configdelivery.v1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
  ...
  describe('listResourceBundles', () => {
    ...
    it('invokes listResourceBundlesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1.ResourceBundle) => {
  ...
  describe('listFleetPackages', () => {
    ...
    it('invokes listFleetPackagesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1.FleetPackage) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listReleases', () => {
    ...
    it('invokes listReleasesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1.Release) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listVariants', () => {
    ...
    it('invokes listVariantsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1.Variant) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listRollouts', () => {
    ...
    it('invokes listRolloutsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.configdelivery.v1.Rollout) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
