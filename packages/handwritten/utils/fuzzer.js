...
Fuzzer.prototype.generate.array = function(
  len,
  ofOneType,
  currentDepth,
  allowedDepth
...
Fuzzer.prototype.generate.object = function(
  numProperties,
  currentDepth,
  allowedDepth
) {
...
Fuzzer.prototype._generateValuesForFuzzTyping = function(
  typesToFuzzOnEach,
  index
) {
  var args = [];
...
Fuzzer.prototype.fuzzFunctionForTypes = function(
  fnToFuzz,
  expectsArgTypes,
  cb,
  withContext
