...
describe('v2alpha1.TpuClient', () => {
  describe('Common methods', () => {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new tpuModule.v2alpha1.TpuClient({
          universe_domain: 'example.com',
  ...
  describe('getNode', () => {
    it('invokes getNode without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.tpu.v2alpha1.GetNodeRequest',
        ['name']
      );
    ...
    it('invokes getQueuedResource without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getQueuedResource(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.tpu.v2alpha1.IQueuedResource | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('createNode', () => {
    it('invokes createNode without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.tpu.v2alpha1.CreateNodeRequest',
        ['parent']
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
  ...
  describe('deleteNode', () => {
    it('invokes deleteNode without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.tpu.v2alpha1.DeleteNodeRequest',
        ['name']
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('stopNode', () => {
    it('invokes stopNode without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.tpu.v2alpha1.StopNodeRequest',
        ['name']
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('startNode', () => {
    it('invokes startNode without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.tpu.v2alpha1.StartNodeRequest',
        ['name']
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
  ...
  describe('updateNode', () => {
    it('invokes updateNode without error', async () => {
      ...
      request.node ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.tpu.v2alpha1.UpdateNodeRequest',
        ['node', 'name']
      );
  ...
  describe('performMaintenance', () => {
    ...
    it('invokes performMaintenance with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.performMaintenance = stubLongRunningCall(
        undefined,
        expectedError
      );
    ...
    it('invokes checkPerformMaintenanceProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkPerformMaintenanceProgress(
        expectedResponse.name
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('performMaintenanceQueuedResource', () => {
    it('invokes performMaintenanceQueuedResource without error', async () => {
      ...
      client.innerApiCalls.performMaintenanceQueuedResource =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.performMaintenanceQueuedResource(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.performMaintenanceQueuedResource as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.performMaintenanceQueuedResource as SinonStub
    ...
    it('invokes performMaintenanceQueuedResource with call error', async () => {
      ...
      await assert.rejects(
        client.performMaintenanceQueuedResource(request),
        expectedError
      );
      const actualRequest = (
        client.innerApiCalls.performMaintenanceQueuedResource as SinonStub
    ...
    it('invokes checkPerformMaintenanceQueuedResourceProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkPerformMaintenanceQueuedResourceProgress(
          expectedResponse.name
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkPerformMaintenanceQueuedResourceProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkPerformMaintenanceQueuedResourceProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('simulateMaintenanceEvent', () => {
    ...
    it('invokes simulateMaintenanceEvent with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.simulateMaintenanceEvent = stubLongRunningCall(
        undefined,
        expectedError
      );
      await assert.rejects(
    ...
    it('invokes checkSimulateMaintenanceEventProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkSimulateMaintenanceEventProgress(
          expectedResponse.name
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkSimulateMaintenanceEventProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkSimulateMaintenanceEventProgress(''),
        expectedError
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listQueuedResources', () => {
    ...
    it('invokes listQueuedResourcesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.tpu.v2alpha1.QueuedResource) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
  ...
  describe('listReservations', () => {
    it('invokes listReservations without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.tpu.v2alpha1.Reservation()
        ),
        generateSampleMessage(
          new protos.google.cloud.tpu.v2alpha1.Reservation()
        ),
    ...
    it('invokes listReservations without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listReservations(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.tpu.v2alpha1.IReservation[] | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listReservationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.tpu.v2alpha1.Reservation) => {
            responses.push(response);
          }
        );
        stream.on('end', () => {
