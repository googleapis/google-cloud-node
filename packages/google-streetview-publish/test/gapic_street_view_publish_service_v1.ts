...
describe('v1.StreetViewPublishServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new streetviewpublishserviceModule.v1.StreetViewPublishServiceClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'streetviewpublish.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new streetviewpublishserviceModule.v1.StreetViewPublishServiceClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'streetviewpublish.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new streetviewpublishserviceModule.v1.StreetViewPublishServiceClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'streetviewpublish.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new streetviewpublishserviceModule.v1.StreetViewPublishServiceClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getPhoto', () => {
        it('invokes getPhoto without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.streetview.publish.v1.GetPhotoRequest', ['photoId']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPhoto as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPhoto as SinonStub)
    ...
    describe('updatePhoto', () => {
        it('invokes updatePhoto without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.streetview.publish.v1.UpdatePhotoRequest', ['photo', 'photoId', 'id']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updatePhoto as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updatePhoto as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deletePhoto', () => {
        it('invokes deletePhoto without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.streetview.publish.v1.DeletePhotoRequest', ['photoId']);
            request.photoId = defaultValue1;
            const expectedHeaderRequestParams = `photo_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePhoto as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePhoto as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('startPhotoSequenceUpload', () => {
        it('invokes startPhotoSequenceUpload without error', async () => {
            ...
            client.innerApiCalls.startPhotoSequenceUpload = stubSimpleCall(expectedResponse);
        ...
        it('invokes startPhotoSequenceUpload without error using callback', async () => {
            ...
            client.innerApiCalls.startPhotoSequenceUpload = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes startPhotoSequenceUpload with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.startPhotoSequenceUpload = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.startPhotoSequenceUpload(request), expectedError);
        });
    ...
    describe('deletePhotoSequence', () => {
        it('invokes deletePhotoSequence without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.streetview.publish.v1.DeletePhotoSequenceRequest', ['sequenceId']);
            request.sequenceId = defaultValue1;
            const expectedHeaderRequestParams = `sequence_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deletePhotoSequence = stubSimpleCall(expectedResponse);
            const [response] = await client.deletePhotoSequence(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deletePhotoSequence as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deletePhotoSequence as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deletePhotoSequence without error using callback', async () => {
            ...
            client.innerApiCalls.deletePhotoSequence = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deletePhotoSequence with error', async () => {
            ...
            const expectedHeaderRequestParams = `sequence_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deletePhotoSequence = stubSimpleCall(undefined, expectedError);
    ...
    describe('createPhotoSequence', () => {
        it('invokes createPhotoSequence without error', async () => {
            ...
            client.innerApiCalls.createPhotoSequence = stubLongRunningCall(expectedResponse);
        ...
        it('invokes createPhotoSequence without error using callback', async () => {
            ...
            client.innerApiCalls.createPhotoSequence = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPhotoSequence(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.streetview.publish.v1.IPhotoSequence, protos.google.protobuf.IEmpty>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.streetview.publish.v1.IPhotoSequence, protos.google.protobuf.IEmpty>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
        });
        ...
        it('invokes createPhotoSequence with call error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createPhotoSequence = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createPhotoSequence with LRO error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createPhotoSequence = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createPhotoSequence(request);
        ...
        it('invokes checkCreatePhotoSequenceProgress without error', async () => {
            ...
            const decodedOperation = await client.checkCreatePhotoSequenceProgress(expectedResponse.name);
        ...
        it('invokes checkCreatePhotoSequenceProgress with error', async () => {
            ...
            await assert.rejects(client.checkCreatePhotoSequenceProgress(''), expectedError);
    ...
    describe('getPhotoSequence', () => {
        it('invokes getPhotoSequence without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.streetview.publish.v1.GetPhotoSequenceRequest', ['sequenceId']);
            request.sequenceId = defaultValue1;
            const expectedHeaderRequestParams = `sequence_id=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.getPhotoSequence = stubLongRunningCall(expectedResponse);
            const [operation] = await client.getPhotoSequence(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getPhotoSequence as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getPhotoSequence as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getPhotoSequence without error using callback', async () => {
            ...
            client.innerApiCalls.getPhotoSequence = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes getPhotoSequence with call error', async () => {
            ...
            const expectedHeaderRequestParams = `sequence_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getPhotoSequence = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes getPhotoSequence with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `sequence_id=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getPhotoSequence = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.getPhotoSequence(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.getPhotoSequence as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkGetPhotoSequenceProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkGetPhotoSequenceProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkGetPhotoSequenceProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkGetPhotoSequenceProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listPhotoSequences', () => {
        it('invokes listPhotoSequences without error', async () => {
            ...
            client.innerApiCalls.listPhotoSequences = stubSimpleCall(expectedResponse);
        ...
        it('invokes listPhotoSequences without error using callback', async () => {
            ...
            client.innerApiCalls.listPhotoSequences = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listPhotoSequences with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listPhotoSequences = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listPhotoSequencesStream without error', async () => {
            ...
            client.descriptors.page.listPhotoSequences.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listPhotoSequences.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPhotoSequences, request));
        });
        ...
        it('invokes listPhotoSequencesStream with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listPhotoSequences.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPhotoSequencesStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.longrunning.Operation[] = [];
                stream.on('data', (response: protos.google.longrunning.Operation) => {
        ...
        it('uses async iteration with listPhotoSequences without error', async () => {
            ...
            client.descriptors.page.listPhotoSequences.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listPhotoSequences with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.descriptors.page.listPhotoSequences.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPhotoSequencesAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.longrunning.IOperation[] = [];
                for await (const resource of iterable) {
