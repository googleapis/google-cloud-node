...
describe('v1beta.UsageServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          usageserviceModule.v1beta.UsageServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          usageserviceModule.v1beta.UsageServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'capacityplanner.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    if (typeof process === 'object' && 'env' in process) {
      describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
        ...
        it('value configured in code has priority over environment variable', () => {
          ...
          assert.strictEqual(
            servicePath,
            'capacityplanner.configured.example.com',
          );
          if (saved) {
            process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
          } else {
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new usageserviceModule.v1beta.UsageServiceClient({
          universe_domain: 'example.com',
  ...
  describe('queryUsageHistories', () => {
    it('invokes queryUsageHistories without error', async () => {
      ...
      client.innerApiCalls.queryUsageHistories =
        stubSimpleCall(expectedResponse);
      const [response] = await client.queryUsageHistories(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryUsageHistories as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes queryUsageHistories without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.queryUsageHistories(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.capacityplanner.v1beta.IQueryUsageHistoriesResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes queryUsageHistories with error', async () => {
      ...
      client.innerApiCalls.queryUsageHistories = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('queryForecasts', () => {
    it('invokes queryForecasts without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryForecasts as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.queryForecasts as SinonStub
    ...
    it('invokes queryForecasts without error using callback', async () => {
      ...
      client.innerApiCalls.queryForecasts =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.queryForecasts(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.capacityplanner.v1beta.IQueryForecastsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes queryForecasts with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.queryForecasts = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('queryReservations', () => {
    it('invokes queryReservations without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.queryReservations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.queryReservations as SinonStub
    ...
    it('invokes queryReservations without error using callback', async () => {
      ...
      client.innerApiCalls.queryReservations =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.queryReservations(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.capacityplanner.v1beta.IQueryReservationsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes queryReservations with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.queryReservations = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('exportUsageHistories', () => {
    it('invokes exportUsageHistories without error', async () => {
      ...
      client.innerApiCalls.exportUsageHistories =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.exportUsageHistories(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportUsageHistories as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportUsageHistories as SinonStub
    ...
    it('invokes exportUsageHistories with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportUsageHistories = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkExportUsageHistoriesProgress without error', async () => {
      ...
      const decodedOperation = await client.checkExportUsageHistoriesProgress(
    ...
    it('invokes checkExportUsageHistoriesProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkExportUsageHistoriesProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('exportForecasts', () => {
    it('invokes exportForecasts without error', async () => {
      ...
      client.innerApiCalls.exportForecasts =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.exportForecasts(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportForecasts as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportForecasts as SinonStub
    ...
    it('invokes exportForecasts with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportForecasts = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkExportForecastsProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkExportForecastsProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkExportForecastsProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkExportForecastsProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('exportReservationsUsage', () => {
    it('invokes exportReservationsUsage without error', async () => {
      ...
      client.innerApiCalls.exportReservationsUsage =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.exportReservationsUsage(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.exportReservationsUsage as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.exportReservationsUsage as SinonStub
    ...
    it('invokes exportReservationsUsage with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.exportReservationsUsage = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.exportReservationsUsage(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.exportReservationsUsage as SinonStub
    ...
    it('invokes checkExportReservationsUsageProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkExportReservationsUsageProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkExportReservationsUsageProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkExportReservationsUsageProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('Path templates', () => {
    describe('folderLocationForecasts', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderLocationForecastsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderLocationForecastsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderLocationForecastsPath', () => {
        const result = client.folderLocationForecastsPath(
          'folderValue',
          'locationValue',
          'forecastValue',
        );
        ...
        assert(
          (
            client.pathTemplates.folderLocationForecastsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
      ...
      it('matchFolderFromFolderLocationForecastsName', () => {
        const result =
          client.matchFolderFromFolderLocationForecastsName(fakePath);
      ...
      it('matchLocationFromFolderLocationForecastsName', () => {
        const result =
          client.matchLocationFromFolderLocationForecastsName(fakePath);
      ...
      it('matchForecastFromFolderLocationForecastsName', () => {
        const result =
          client.matchForecastFromFolderLocationForecastsName(fakePath);
    ...
    describe('folderLocationReservations', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderLocationReservationsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderLocationReservationsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderLocationReservationsPath', () => {
        const result = client.folderLocationReservationsPath(
          'folderValue',
          'locationValue',
          'reservationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.folderLocationReservationsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchFolderFromFolderLocationReservationsName', () => {
        const result =
          client.matchFolderFromFolderLocationReservationsName(fakePath);
        assert.strictEqual(result, 'folderValue');
        assert(
          (
            client.pathTemplates.folderLocationReservationsPathTemplate
      ...
      it('matchLocationFromFolderLocationReservationsName', () => {
        const result =
          client.matchLocationFromFolderLocationReservationsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.folderLocationReservationsPathTemplate
      ...
      it('matchReservationFromFolderLocationReservationsName', () => {
        const result =
          client.matchReservationFromFolderLocationReservationsName(fakePath);
    ...
    describe('organizationLocationForecasts', async () => {
      ...
      it('organizationLocationForecastsPath', () => {
        const result = client.organizationLocationForecastsPath(
          'organizationValue',
          'locationValue',
          'forecastValue',
        );
        ...
        assert(
          (
            client.pathTemplates.organizationLocationForecastsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationLocationForecastsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationForecastsName(
            fakePath,
          );
      ...
      it('matchLocationFromOrganizationLocationForecastsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationForecastsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.organizationLocationForecastsPathTemplate
      ...
      it('matchForecastFromOrganizationLocationForecastsName', () => {
        const result =
          client.matchForecastFromOrganizationLocationForecastsName(fakePath);
        assert.strictEqual(result, 'forecastValue');
        assert(
          (
            client.pathTemplates.organizationLocationForecastsPathTemplate
    ...
    describe('organizationLocationReservations', async () => {
      ...
      it('organizationLocationReservationsPath', () => {
        const result = client.organizationLocationReservationsPath(
          'organizationValue',
          'locationValue',
          'reservationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.organizationLocationReservationsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationLocationReservationsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationReservationsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationReservationsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationReservationsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchReservationFromOrganizationLocationReservationsName', () => {
        const result =
          client.matchReservationFromOrganizationLocationReservationsName(
            fakePath,
          );
        assert.strictEqual(result, 'reservationValue');
        assert(
    ...
    describe('projectLocationForecasts', async () => {
      ...
      await client.initialize();
      client.pathTemplates.projectLocationForecastsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationForecastsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationForecastsPath', () => {
        const result = client.projectLocationForecastsPath(
          'projectValue',
          'locationValue',
          'forecastValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationForecastsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationForecastsName', () => {
        const result =
          client.matchProjectFromProjectLocationForecastsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationForecastsPathTemplate
      ...
      it('matchLocationFromProjectLocationForecastsName', () => {
        const result =
          client.matchLocationFromProjectLocationForecastsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationForecastsPathTemplate
      ...
      it('matchForecastFromProjectLocationForecastsName', () => {
        const result =
          client.matchForecastFromProjectLocationForecastsName(fakePath);
        assert.strictEqual(result, 'forecastValue');
        assert(
          (
            client.pathTemplates.projectLocationForecastsPathTemplate
    ...
    describe('projectLocationReservations', async () => {
      ...
      client.pathTemplates.projectLocationReservationsPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.projectLocationReservationsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationReservationsPath', () => {
        const result = client.projectLocationReservationsPath(
          'projectValue',
          'locationValue',
          'reservationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationReservationsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationReservationsName', () => {
        const result =
          client.matchProjectFromProjectLocationReservationsName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.projectLocationReservationsPathTemplate
      ...
      it('matchLocationFromProjectLocationReservationsName', () => {
        const result =
          client.matchLocationFromProjectLocationReservationsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationReservationsPathTemplate
      ...
      it('matchReservationFromProjectLocationReservationsName', () => {
        const result =
          client.matchReservationFromProjectLocationReservationsName(fakePath);
        assert.strictEqual(result, 'reservationValue');
        assert(
          (
            client.pathTemplates.projectLocationReservationsPathTemplate
