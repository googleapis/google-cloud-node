...
function main(parent) {
  // [START capacityplanner_v1beta_generated_UsageService_QueryForecasts_async]
  /**
  ...
  async function callQueryForecasts() {
    // Construct request
    const request = {
      parent,
    };
    ...
    // Run request
    const response = await capacityplannerClient.queryForecasts(request);
    console.log(response);
  }

  callQueryForecasts();
  // [END capacityplanner_v1beta_generated_UsageService_QueryForecasts_async]
}
