...
function main(name) {
  ...
  async function callGetResourceEnrollmentStatus() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await auditmanagerClient.getResourceEnrollmentStatus(request);
    console.log(response);
  }

  callGetResourceEnrollmentStatus();
