...
function main(name) {
  // [START auditmanager_v1_generated_AuditManager_GetAuditSchedule_async]
  /**
  ...
  async function callGetAuditSchedule() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await auditmanagerClient.getAuditSchedule(request);
    console.log(response);
  }

  callGetAuditSchedule();
  // [END auditmanager_v1_generated_AuditManager_GetAuditSchedule_async]
}
