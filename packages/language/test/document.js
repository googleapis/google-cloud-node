...
describe('Document', function() {
  ...
  describe('annotate', function() {
    it('should make the correct API request', function(done) {
      document.api.Language = {
        annotateText: function(request) {
          assert.strictEqual(request.document, document.document);
          ...
          assert.strictEqual(request.encodingType, document.encodingType);
    ...
    describe('error', function() {
      ...
      beforeEach(function() {
        document.api.Language = {
          annotateText: function(request, callback) {
  ...
  describe('detectEntities', function() {
    it('should make the correct API request', function(done) {
      document.api.Language = {
        analyzeEntities: function(request) {
          assert.strictEqual(request.document, document.document);
          assert.strictEqual(request.encodingType, document.encodingType);
          done();
        }
    ...
    describe('error', function() {
      ...
      beforeEach(function() {
        document.api.Language = {
          analyzeEntities: function(request, callback) {
            callback(error, apiResponse);
          }
        };
      });
  ...
  describe('detectSentiment', function() {
    it('should make the correct API request', function(done) {
      document.api.Language = {
        analyzeSentiment: function(request) {
          assert.strictEqual(request.document, document.document);
          assert.strictEqual(request.encodingType, document.encodingType);
          done();
        }
    ...
    describe('error', function() {
      ...
      beforeEach(function() {
        document.api.Language = {
          analyzeSentiment: function(request, callback) {
            callback(error, apiResponse);
          }
        };
      });
