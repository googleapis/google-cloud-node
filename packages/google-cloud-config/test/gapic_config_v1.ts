...
describe('v1.ConfigClient', () => {
  ...
  describe('getResourceChange', () => {
    it('invokes getResourceChange without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getResourceChange as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getResourceChange as SinonStub
    ...
    it('invokes getResourceChange without error using callback', async () => {
      ...
      client.innerApiCalls.getResourceChange =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getResourceChange(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.config.v1.IResourceChange | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getResourceChange with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getResourceChange = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getResourceDrift', () => {
    it('invokes getResourceDrift without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getResourceDrift as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getResourceDrift as SinonStub
    ...
    it('invokes getResourceDrift without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getResourceDrift(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.config.v1.IResourceDrift | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getResourceDrift with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getResourceDrift = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getAutoMigrationConfig', () => {
    it('invokes getAutoMigrationConfig without error', async () => {
      ...
      client.innerApiCalls.getAutoMigrationConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getAutoMigrationConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getAutoMigrationConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getAutoMigrationConfig as SinonStub
    ...
    it('invokes getAutoMigrationConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getAutoMigrationConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.config.v1.IAutoMigrationConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAutoMigrationConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getAutoMigrationConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getAutoMigrationConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getAutoMigrationConfig as SinonStub
  ...
  describe('getDeploymentGroup', () => {
    it('invokes getDeploymentGroup without error', async () => {
      ...
      client.innerApiCalls.getDeploymentGroup =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDeploymentGroup(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDeploymentGroup as SinonStub
    ...
    it('invokes getDeploymentGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeploymentGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.config.v1.IDeploymentGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDeploymentGroup with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDeploymentGroup = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getDeploymentGroupRevision', () => {
    it('invokes getDeploymentGroupRevision without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.config.v1.GetDeploymentGroupRevisionRequest',
        ['name'],
      );
      request.name = defaultValue1;
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.getDeploymentGroupRevision =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDeploymentGroupRevision(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDeploymentGroupRevision as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getDeploymentGroupRevision as SinonStub
    ...
    it('invokes getDeploymentGroupRevision without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDeploymentGroupRevision(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.config.v1.IDeploymentGroupRevision | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDeploymentGroupRevision with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getDeploymentGroupRevision = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getDeploymentGroupRevision(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getDeploymentGroupRevision as SinonStub
  ...
  describe('updateAutoMigrationConfig', () => {
    it('invokes updateAutoMigrationConfig without error', async () => {
      ...
      client.innerApiCalls.updateAutoMigrationConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateAutoMigrationConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAutoMigrationConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAutoMigrationConfig as SinonStub
    ...
    it('invokes updateAutoMigrationConfig with call error', async () => {
      ...
      const expectedHeaderRequestParams = `auto_migration_config.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAutoMigrationConfig = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateAutoMigrationConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateAutoMigrationConfig as SinonStub
    ...
    it('invokes checkUpdateAutoMigrationConfigProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkUpdateAutoMigrationConfigProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('createDeploymentGroup', () => {
    it('invokes createDeploymentGroup without error', async () => {
      ...
      client.innerApiCalls.createDeploymentGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createDeploymentGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDeploymentGroup as SinonStub
    ...
    it('invokes createDeploymentGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDeploymentGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createDeploymentGroup as SinonStub
    ...
    it('invokes checkCreateDeploymentGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkCreateDeploymentGroupProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateDeploymentGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateDeploymentGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateDeploymentGroup', () => {
    it('invokes updateDeploymentGroup without error', async () => {
      ...
      client.innerApiCalls.updateDeploymentGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateDeploymentGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDeploymentGroup as SinonStub
    ...
    it('invokes updateDeploymentGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `deployment_group.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDeploymentGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateDeploymentGroup as SinonStub
    ...
    it('invokes checkUpdateDeploymentGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkUpdateDeploymentGroupProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateDeploymentGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateDeploymentGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteDeploymentGroup', () => {
    it('invokes deleteDeploymentGroup without error', async () => {
      ...
      client.innerApiCalls.deleteDeploymentGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteDeploymentGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDeploymentGroup as SinonStub
    ...
    it('invokes deleteDeploymentGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDeploymentGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteDeploymentGroup as SinonStub
    ...
    it('invokes checkDeleteDeploymentGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation = await client.checkDeleteDeploymentGroupProgress(
        expectedResponse.name,
      );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteDeploymentGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteDeploymentGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('provisionDeploymentGroup', () => {
    it('invokes provisionDeploymentGroup without error', async () => {
      ...
      client.innerApiCalls.provisionDeploymentGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.provisionDeploymentGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.provisionDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.provisionDeploymentGroup as SinonStub
    ...
    it('invokes provisionDeploymentGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.provisionDeploymentGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.provisionDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.provisionDeploymentGroup as SinonStub
    ...
    it('invokes checkProvisionDeploymentGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkProvisionDeploymentGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkProvisionDeploymentGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkProvisionDeploymentGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deprovisionDeploymentGroup', () => {
    it('invokes deprovisionDeploymentGroup without error', async () => {
      ...
      client.innerApiCalls.deprovisionDeploymentGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deprovisionDeploymentGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deprovisionDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deprovisionDeploymentGroup as SinonStub
    ...
    it('invokes deprovisionDeploymentGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deprovisionDeploymentGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deprovisionDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deprovisionDeploymentGroup as SinonStub
    ...
    it('invokes checkDeprovisionDeploymentGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeprovisionDeploymentGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeprovisionDeploymentGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeprovisionDeploymentGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listResourceChanges', () => {
    it('invokes listResourceChanges without error', async () => {
      ...
      client.innerApiCalls.listResourceChanges =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listResourceChanges(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listResourceChanges as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listResourceChanges as SinonStub
    ...
    it('invokes listResourceChanges with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listResourceChanges = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listResourceChangesStream without error', async () => {
      ...
      client.descriptors.page.listResourceChanges.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.config.v1.ResourceChange) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listResourceChanges.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listResourceChanges, request),
      );
      assert(
        (client.descriptors.page.listResourceChanges.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listResourceChanges without error', async () => {
      ...
      client.descriptors.page.listResourceChanges.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listResourceDrifts', () => {
    it('invokes listResourceDrifts without error', async () => {
      ...
      client.innerApiCalls.listResourceDrifts =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listResourceDrifts(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listResourceDrifts as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listResourceDrifts as SinonStub
    ...
    it('invokes listResourceDrifts with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listResourceDrifts = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listResourceDriftsStream without error', async () => {
      ...
      client.descriptors.page.listResourceDrifts.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.config.v1.ResourceDrift) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listResourceDrifts.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listResourceDrifts, request),
      );
      assert(
        (client.descriptors.page.listResourceDrifts.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listResourceDrifts without error', async () => {
      ...
      client.descriptors.page.listResourceDrifts.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listDeploymentGroups', () => {
    it('invokes listDeploymentGroups without error', async () => {
      ...
      client.innerApiCalls.listDeploymentGroups =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDeploymentGroups(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDeploymentGroups as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDeploymentGroups as SinonStub
    ...
    it('invokes listDeploymentGroups with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDeploymentGroups = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listDeploymentGroupsStream without error', async () => {
      ...
      client.descriptors.page.listDeploymentGroups.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.config.v1.DeploymentGroup) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listDeploymentGroups.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDeploymentGroups, request),
      );
      assert(
        (client.descriptors.page.listDeploymentGroups.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listDeploymentGroups without error', async () => {
      ...
      client.descriptors.page.listDeploymentGroups.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listDeploymentGroupRevisions', () => {
    it('invokes listDeploymentGroupRevisions without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.config.v1.ListDeploymentGroupRevisionsRequest',
        ['parent'],
      );
      request.parent = defaultValue1;
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      ...
      client.innerApiCalls.listDeploymentGroupRevisions =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDeploymentGroupRevisions(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDeploymentGroupRevisions as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDeploymentGroupRevisions as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.listDeploymentGroupRevisions(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.config.v1.IDeploymentGroupRevision[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listDeploymentGroupRevisions with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDeploymentGroupRevisions = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDeploymentGroupRevisions(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDeploymentGroupRevisions as SinonStub
    ...
    it('invokes listDeploymentGroupRevisionsStream without error', async () => {
      ...
      client.descriptors.page.listDeploymentGroupRevisions.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.config.v1.DeploymentGroupRevision) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (
          client.descriptors.page.listDeploymentGroupRevisions
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listDeploymentGroupRevisions without error', async () => {
      ...
      client.descriptors.page.listDeploymentGroupRevisions.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    describe('autoMigrationConfig', async () => {
      ...
      await client.initialize();
      client.pathTemplates.autoMigrationConfigPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.autoMigrationConfigPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('autoMigrationConfigPath', () => {
        const result = client.autoMigrationConfigPath(
          'projectValue',
          'locationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.autoMigrationConfigPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
      ...
      it('matchLocationFromAutoMigrationConfigName', () => {
        const result =
          client.matchLocationFromAutoMigrationConfigName(fakePath);
    ...
    describe('deploymentGroup', async () => {
      ...
      await client.initialize();
      client.pathTemplates.deploymentGroupPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.deploymentGroupPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('deploymentGroupPath', () => {
        const result = client.deploymentGroupPath(
          'projectValue',
          'locationValue',
          'deploymentGroupValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.deploymentGroupPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromDeploymentGroupName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.deploymentGroupPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchDeploymentGroupFromDeploymentGroupName', () => {
        const result =
          client.matchDeploymentGroupFromDeploymentGroupName(fakePath);
    ...
    describe('deploymentGroupRevision', async () => {
      ...
      await client.initialize();
      client.pathTemplates.deploymentGroupRevisionPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.deploymentGroupRevisionPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('deploymentGroupRevisionPath', () => {
        const result = client.deploymentGroupRevisionPath(
          'projectValue',
          'locationValue',
          'deploymentGroupValue',
          'revisionValue',
        ...
        assert(
          (
            client.pathTemplates.deploymentGroupRevisionPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromDeploymentGroupRevisionName', () => {
        const result =
          client.matchProjectFromDeploymentGroupRevisionName(fakePath);
        assert.strictEqual(result, 'projectValue');
        assert(
          (
            client.pathTemplates.deploymentGroupRevisionPathTemplate
      ...
      it('matchLocationFromDeploymentGroupRevisionName', () => {
        const result =
          client.matchLocationFromDeploymentGroupRevisionName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.deploymentGroupRevisionPathTemplate
      ...
      it('matchDeploymentGroupFromDeploymentGroupRevisionName', () => {
        const result =
          client.matchDeploymentGroupFromDeploymentGroupRevisionName(fakePath);
        assert.strictEqual(result, 'deploymentGroupValue');
        assert(
          (
            client.pathTemplates.deploymentGroupRevisionPathTemplate
      ...
      it('matchRevisionFromDeploymentGroupRevisionName', () => {
        const result =
          client.matchRevisionFromDeploymentGroupRevisionName(fakePath);
    ...
    describe('resourceChange', async () => {
      ...
      await client.initialize();
      client.pathTemplates.resourceChangePathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.resourceChangePathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('resourceChangePath', () => {
        const result = client.resourceChangePath(
          'projectValue',
          'locationValue',
          'previewValue',
          'resourceChangeValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.resourceChangePathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromResourceChangeName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.resourceChangePathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
      ...
      it('matchResourceChangeFromResourceChangeName', () => {
        const result =
          client.matchResourceChangeFromResourceChangeName(fakePath);
    ...
    describe('resourceDrift', async () => {
      ...
      await client.initialize();
      client.pathTemplates.resourceDriftPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.resourceDriftPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('resourceDriftPath', () => {
        const result = client.resourceDriftPath(
          'projectValue',
          'locationValue',
          'previewValue',
          'resourceDriftValue',
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.resourceDriftPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromResourceDriftName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.resourceDriftPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
