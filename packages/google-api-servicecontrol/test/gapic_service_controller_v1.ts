...
describe('v1.ServiceControllerClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new servicecontrollerModule.v1.ServiceControllerClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'servicecontrol.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new servicecontrollerModule.v1.ServiceControllerClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'servicecontrol.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new servicecontrollerModule.v1.ServiceControllerClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new servicecontrollerModule.v1.ServiceControllerClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('check', () => {
        it('invokes check without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.servicecontrol.v1.CheckRequest', ['serviceName']);
    ...
    describe('report', () => {
        it('invokes report without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.api.servicecontrol.v1.ReportRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const expectedHeaderRequestParams = `service_name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
