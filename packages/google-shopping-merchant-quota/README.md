...
[![npm version](https://img.shields.io/npm/v/@google-cloud/quota.svg)](https://www.npmjs.org/package/@google-cloud/quota)
...
```bash
npm install @google-cloud/quota
```
...
For example, `npm install @google-cloud/quota@legacy-8` installs client libraries
