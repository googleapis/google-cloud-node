...
describe('v1alpha.WebSecurityScannerClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          websecurityscannerModule.v1alpha.WebSecurityScannerClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          websecurityscannerModule.v1alpha.WebSecurityScannerClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'websecurityscanner.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('has port', () => {
      const port =
        websecurityscannerModule.v1alpha.WebSecurityScannerClient.port;
      assert(port);
    ...
    it('invokes createScanConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createScanConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.websecurityscanner.v1alpha.IScanConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes startScanRun without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.startScanRun(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.websecurityscanner.v1alpha.IScanRun | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getFinding without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFinding(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.websecurityscanner.v1alpha.IFinding | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFindingTypeStats without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listFindingTypeStats(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.websecurityscanner.v1alpha.IListFindingTypeStatsResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listScanConfigsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.websecurityscanner.v1alpha.ScanConfig,
          ) => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listScanRuns(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.websecurityscanner.v1alpha.IScanRun[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listScanRunsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.websecurityscanner.v1alpha.ScanRun,
          ) => {
            responses.push(response);
          },
        );
  ...
  describe('listCrawledUrls', () => {
    it('invokes listCrawledUrls without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.websecurityscanner.v1alpha.CrawledUrl(),
        ),
        generateSampleMessage(
          new protos.google.cloud.websecurityscanner.v1alpha.CrawledUrl(),
        ),
    ...
    it('invokes listCrawledUrlsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.websecurityscanner.v1alpha.CrawledUrl,
          ) => {
            responses.push(response);
          },
        );
      ...
      const promise = new Promise((resolve, reject) => {
        client.listFindings(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.websecurityscanner.v1alpha.IFinding[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listFindingsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.websecurityscanner.v1alpha.Finding,
          ) => {
            responses.push(response);
          },
        );
