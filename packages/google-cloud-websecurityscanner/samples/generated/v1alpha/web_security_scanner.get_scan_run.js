...
function main(name) {
  // [START websecurityscanner_v1alpha_generated_WebSecurityScanner_GetScanRun_async]
  /**
  ...
  callGetScanRun();
  // [END websecurityscanner_v1alpha_generated_WebSecurityScanner_GetScanRun_async]
}
