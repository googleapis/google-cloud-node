...
describe('v1.CloudRedisClusterClient', () => {
    describe('Common methods', () => {
        ...
        if (typeof process === 'object' && typeof process.emitWarning === 'function') {
            it('throws DeprecationWarning if static servicePath is used', () => {
                ...
                const servicePath = cloudredisclusterModule.v1.CloudRedisClusterClient.servicePath;
            ...
            it('throws DeprecationWarning if static apiEndpoint is used', () => {
                const stub = sinon.stub(process, 'emitWarning');
                const apiEndpoint = cloudredisclusterModule.v1.CloudRedisClusterClient.apiEndpoint;
                assert.strictEqual(apiEndpoint, 'redis.googleapis.com');
                assert(stub.called);
                stub.restore();
            });
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new cloudredisclusterModule.v1.CloudRedisClusterClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'redis.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new cloudredisclusterModule.v1.CloudRedisClusterClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'redis.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new cloudredisclusterModule.v1.CloudRedisClusterClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new cloudredisclusterModule.v1.CloudRedisClusterClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('getCluster', () => {
        it('invokes getCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.GetClusterRequest', ['name']);
        ...
        it('invokes getCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCluster(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.redis.cluster.v1.ICluster|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getClusterCertificateAuthority', () => {
        it('invokes getClusterCertificateAuthority without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.GetClusterCertificateAuthorityRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.CertificateAuthority()
            );
            client.innerApiCalls.getClusterCertificateAuthority = stubSimpleCall(expectedResponse);
            const [response] = await client.getClusterCertificateAuthority(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getClusterCertificateAuthority as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getClusterCertificateAuthority as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getClusterCertificateAuthority without error using callback', async () => {
            ...
            client.innerApiCalls.getClusterCertificateAuthority = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getClusterCertificateAuthority(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.redis.cluster.v1.ICertificateAuthority|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getClusterCertificateAuthority with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getClusterCertificateAuthority = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getClusterCertificateAuthority(request), expectedError);
            const actualRequest = (client.innerApiCalls.getClusterCertificateAuthority as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getClusterCertificateAuthority as SinonStub)
    ...
    describe('getSharedRegionalCertificateAuthority', () => {
        it('invokes getSharedRegionalCertificateAuthority without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.GetSharedRegionalCertificateAuthorityRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.GetSharedRegionalCertificateAuthorityRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.SharedRegionalCertificateAuthority()
            );
        ...
        it('invokes getSharedRegionalCertificateAuthority without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSharedRegionalCertificateAuthority(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.redis.cluster.v1.ISharedRegionalCertificateAuthority|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBackupCollection', () => {
        it('invokes getBackupCollection without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.GetBackupCollectionRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.GetBackupCollectionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.BackupCollection()
            );
        ...
        it('invokes getBackupCollection without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBackupCollection(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.redis.cluster.v1.IBackupCollection|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBackup', () => {
        it('invokes getBackup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.GetBackupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.GetBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.Backup()
            );
        ...
        it('invokes getBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBackup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.redis.cluster.v1.IBackup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateCluster', () => {
        it('invokes updateCluster without error', async () => {
            ...
            request.cluster ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.UpdateClusterRequest', ['cluster', 'name']);
        ...
        it('invokes updateCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.redis.cluster.v1.ICluster, protos.google.protobuf.IAny>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.redis.cluster.v1.ICluster, protos.google.protobuf.IAny>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateCluster as SinonStub)
                .getCall(0).args[0];
    ...
    describe('deleteCluster', () => {
        it('invokes deleteCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.DeleteClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes deleteCluster without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteCluster(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.protobuf.IAny>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
    ...
    describe('createCluster', () => {
        it('invokes createCluster without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.CreateClusterRequest', ['parent']);
    ...
    describe('rescheduleClusterMaintenance', () => {
        it('invokes rescheduleClusterMaintenance without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.RescheduleClusterMaintenanceRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.RescheduleClusterMaintenanceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.rescheduleClusterMaintenance = stubLongRunningCall(expectedResponse);
            const [operation] = await client.rescheduleClusterMaintenance(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rescheduleClusterMaintenance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rescheduleClusterMaintenance as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes rescheduleClusterMaintenance without error using callback', async () => {
            ...
            client.innerApiCalls.rescheduleClusterMaintenance = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes rescheduleClusterMaintenance with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.rescheduleClusterMaintenance = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.rescheduleClusterMaintenance(request), expectedError);
            const actualRequest = (client.innerApiCalls.rescheduleClusterMaintenance as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.rescheduleClusterMaintenance as SinonStub)
        ...
        it('invokes rescheduleClusterMaintenance with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.rescheduleClusterMaintenance = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.rescheduleClusterMaintenance(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.rescheduleClusterMaintenance as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkRescheduleClusterMaintenanceProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkRescheduleClusterMaintenanceProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkRescheduleClusterMaintenanceProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkRescheduleClusterMaintenanceProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteBackup', () => {
        it('invokes deleteBackup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.DeleteBackupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.DeleteBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('exportBackup', () => {
        it('invokes exportBackup without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.ExportBackupRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.ExportBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes exportBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportBackup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.redis.cluster.v1.IBackup, protos.google.protobuf.IAny>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.redis.cluster.v1.IBackup, protos.google.protobuf.IAny>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.exportBackup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('backupCluster', () => {
        it('invokes backupCluster without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.BackupClusterRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.BackupClusterRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.backupCluster = stubLongRunningCall(expectedResponse);
            const [operation] = await client.backupCluster(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.backupCluster as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.backupCluster as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes backupCluster without error using callback', async () => {
            ...
            client.innerApiCalls.backupCluster = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes backupCluster with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.backupCluster = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes backupCluster with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedError = new Error('expected');
            client.innerApiCalls.backupCluster = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.backupCluster(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.backupCluster as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkBackupClusterProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBackupClusterProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkBackupClusterProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBackupClusterProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('listClusters', () => {
        it('invokes listClusters without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.ListClustersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.Cluster()),
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.Cluster()),
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.Cluster()),
            ];
        ...
        it('invokes listClustersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.redis.cluster.v1.Cluster) => {
    ...
    describe('listBackupCollections', () => {
        it('invokes listBackupCollections without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.ListBackupCollectionsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.ListBackupCollectionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.BackupCollection()),
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.BackupCollection()),
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.BackupCollection()),
            ];
        ...
        it('invokes listBackupCollectionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.redis.cluster.v1.BackupCollection[] = [];
                stream.on('data', (response: protos.google.cloud.redis.cluster.v1.BackupCollection) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listBackupCollections without error', async () => {
            ...
            const responses: protos.google.cloud.redis.cluster.v1.IBackupCollection[] = [];
    ...
    describe('listBackups', () => {
        it('invokes listBackups without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(
              new protos.google.cloud.redis.cluster.v1.ListBackupsRequest()
            );
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.redis.cluster.v1.ListBackupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.Backup()),
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.Backup()),
              generateSampleMessage(new protos.google.cloud.redis.cluster.v1.Backup()),
            ];
        ...
        it('invokes listBackupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.redis.cluster.v1.Backup[] = [];
                stream.on('data', (response: protos.google.cloud.redis.cluster.v1.Backup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listBackups without error', async () => {
            ...
            const responses: protos.google.cloud.redis.cluster.v1.IBackup[] = [];
    ...
    describe('Path templates', () => {
        ...
        describe('certificateAuthority', async () => {
            ...
            it('certificateAuthorityPath', () => {
                const result = client.certificateAuthorityPath("projectValue", "locationValue", "clusterValue");
                assert.strictEqual(result, fakePath);
            ...
            it('matchClusterFromCertificateAuthorityName', () => {
                const result = client.matchClusterFromCertificateAuthorityName(fakePath);
