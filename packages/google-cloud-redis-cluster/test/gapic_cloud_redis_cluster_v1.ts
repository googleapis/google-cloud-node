...
describe('v1.CloudRedisClusterClient', () => {
  ...
  describe('getSharedRegionalCertificateAuthority', () => {
    it('invokes getSharedRegionalCertificateAuthority without error', async () => {
      ...
      client.innerApiCalls.getSharedRegionalCertificateAuthority =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.getSharedRegionalCertificateAuthority(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getSharedRegionalCertificateAuthority as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getSharedRegionalCertificateAuthority as SinonStub
    ...
    it('invokes getSharedRegionalCertificateAuthority without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSharedRegionalCertificateAuthority(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.redis.cluster.v1.ISharedRegionalCertificateAuthority | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getSharedRegionalCertificateAuthority with error', async () => {
      ...
      await assert.rejects(
        client.getSharedRegionalCertificateAuthority(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getSharedRegionalCertificateAuthority as SinonStub
    ...
    it('invokes getBackupCollection without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackupCollection(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.redis.cluster.v1.IBackupCollection | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBackup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.redis.cluster.v1.IBackup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listBackupCollections', () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listBackupCollections(
          ...
          (
            err?: Error | null,
            result?:
              protos.google.cloud.redis.cluster.v1.IBackupCollection[] | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listBackupCollectionsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.redis.cluster.v1.BackupCollection) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('listBackups', () => {
    ...
    it('invokes listBackupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.redis.cluster.v1.Backup) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
  ...
  describe('Path templates', () => {
    ...
    describe('sharedRegionalCertificateAuthority', async () => {
      ...
      it('sharedRegionalCertificateAuthorityPath', () => {
        const result = client.sharedRegionalCertificateAuthorityPath(
          'projectValue',
          'locationValue',
        );
        assert.strictEqual(result, fakePath);
      ...
      it('matchProjectFromSharedRegionalCertificateAuthorityName', () => {
        const result =
          client.matchProjectFromSharedRegionalCertificateAuthorityName(
            fakePath,
          );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromSharedRegionalCertificateAuthorityName', () => {
        const result =
          client.matchLocationFromSharedRegionalCertificateAuthorityName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
