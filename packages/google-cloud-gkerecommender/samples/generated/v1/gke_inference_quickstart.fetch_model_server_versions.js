...
function main(model, modelServer) {
  // [START gkerecommender_v1_generated_GkeInferenceQuickstart_FetchModelServerVersions_async]
  /**
  ...
  async function callFetchModelServerVersions() {
    // Construct request
    const request = {
      model,
      modelServer,
    ...
    // Run request
    const iterable = gkerecommenderClient.fetchModelServerVersionsAsync(request);
    for await (const response of iterable) {
        console.log(response);
    }
  }

  callFetchModelServerVersions();
  // [END gkerecommender_v1_generated_GkeInferenceQuickstart_FetchModelServerVersions_async]
}
