...
class ProductSearchClient {
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Product]{@link google.cloud.vision.v1.Product}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [Product]{@link google.cloud.vision.v1.Product}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListProductsResponse]{@link google.cloud.vision.v1.ListProductsResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Product]{@link google.cloud.vision.v1.Product}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Product]{@link google.cloud.vision.v1.Product} in a single response.
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListProductsResponse]{@link google.cloud.vision.v1.ListProductsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
   ...
   *
   * const product = {};
   * client.updateProduct({product: product})
   *   .then(responses => {
   *     const response = responses[0];
   *     // doThingsWith(response)
   *   })
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [ReferenceImage]{@link google.cloud.vision.v1.ReferenceImage}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListReferenceImagesResponse]{@link google.cloud.vision.v1.ListReferenceImagesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListReferenceImagesResponse]{@link google.cloud.vision.v1.ListReferenceImagesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
   ...
   *
   * const formattedName = client.productSetPath('[PROJECT]', '[LOCATION]', '[PRODUCT_SET]');
   * const formattedProduct = client.productPath('[PROJECT]', '[LOCATION]', '[PRODUCT]');
   * const request = {
   *   name: formattedName,
   ...
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListProductsInProductSetResponse]{@link google.cloud.vision.v1.ListProductsInProductSetResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Product]{@link google.cloud.vision.v1.Product}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   ...
   *   The second element is the next request object if the response
   *   indicates the next page exists, or null. The third element is
   *   an object representing [ListProductsInProductSetResponse]{@link google.cloud.vision.v1.ListProductsInProductSetResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
