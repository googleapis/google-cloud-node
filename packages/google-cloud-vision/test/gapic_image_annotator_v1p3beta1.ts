...
describe('v1p3beta1.ImageAnnotatorClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new imageannotatorModule.v1p3beta1.ImageAnnotatorClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'vision.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new imageannotatorModule.v1p3beta1.ImageAnnotatorClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'vision.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new imageannotatorModule.v1p3beta1.ImageAnnotatorClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new imageannotatorModule.v1p3beta1.ImageAnnotatorClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
        ...
        it('invokes asyncBatchAnnotateFiles without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.asyncBatchAnnotateFiles(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vision.v1p3beta1.IAsyncBatchAnnotateFilesResponse, protos.google.cloud.vision.v1p3beta1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vision.v1p3beta1.IAsyncBatchAnnotateFilesResponse, protos.google.cloud.vision.v1p3beta1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
        });
