...
describe('ProductSearchClient', () => {
  it('has servicePath', () => {
    const servicePath = visionModule.v1p3beta1.ProductSearchClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint = visionModule.v1p3beta1.ProductSearchClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port = visionModule.v1p3beta1.ProductSearchClient.port;
    assert(port);
...
describe('ImageAnnotatorClient', () => {
  it('has servicePath', () => {
    const servicePath = visionModule.v1p3beta1.ImageAnnotatorClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint = visionModule.v1p3beta1.ImageAnnotatorClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port = visionModule.v1p3beta1.ImageAnnotatorClient.port;
    assert(port);
    assert(typeof port === 'number');
  });
