...
describe('v1p4beta1.ProductSearchClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new productsearchModule.v1p4beta1.ProductSearchClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'vision.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new productsearchModule.v1p4beta1.ProductSearchClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'vision.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new productsearchModule.v1p4beta1.ProductSearchClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new productsearchModule.v1p4beta1.ProductSearchClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createProductSet', () => {
        it('invokes createProductSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.CreateProductSetRequest', ['parent']);
    ...
    describe('getProductSet', () => {
        it('invokes getProductSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.GetProductSetRequest', ['name']);
    ...
    describe('updateProductSet', () => {
        it('invokes updateProductSet without error', async () => {
            ...
            request.productSet ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.UpdateProductSetRequest', ['productSet', 'name']);
    ...
    describe('deleteProductSet', () => {
        it('invokes deleteProductSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.DeleteProductSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createProduct', () => {
        it('invokes createProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.CreateProductRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getProduct', () => {
        it('invokes getProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.GetProductRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.vision.v1p4beta1.Product()
    ...
    describe('updateProduct', () => {
        it('invokes updateProduct without error', async () => {
            ...
            request.product ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.UpdateProductRequest', ['product', 'name']);
    ...
    describe('deleteProduct', () => {
        it('invokes deleteProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.DeleteProductRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createReferenceImage', () => {
        it('invokes createReferenceImage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.CreateReferenceImageRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteReferenceImage', () => {
        it('invokes deleteReferenceImage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.DeleteReferenceImageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getReferenceImage', () => {
        it('invokes getReferenceImage without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.GetReferenceImageRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.vision.v1p4beta1.ReferenceImage()
    ...
    describe('addProductToProductSet', () => {
        it('invokes addProductToProductSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.AddProductToProductSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('removeProductFromProductSet', () => {
        it('invokes removeProductFromProductSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.RemoveProductFromProductSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('importProductSets', () => {
        it('invokes importProductSets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.ImportProductSetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes importProductSets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importProductSets(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.vision.v1p4beta1.IImportProductSetsResponse, protos.google.cloud.vision.v1p4beta1.IBatchOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.vision.v1p4beta1.IImportProductSetsResponse, protos.google.cloud.vision.v1p4beta1.IBatchOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importProductSets as SinonStub)
                .getCall(0).args[0];
    ...
    describe('purgeProducts', () => {
        it('invokes purgeProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.PurgeProductsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes purgeProducts without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.purgeProducts(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vision.v1p4beta1.IBatchOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.vision.v1p4beta1.IBatchOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeProducts as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listProductSets', () => {
        it('invokes listProductSets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.ListProductSetsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listProducts', () => {
        it('invokes listProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.ListProductsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listReferenceImages', () => {
        it('invokes listReferenceImages without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.ListReferenceImagesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? '' }`;const expectedResponse = [
    ...
    describe('listProductsInProductSet', () => {
        it('invokes listProductsInProductSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.vision.v1p4beta1.ListProductsInProductSetRequest', ['name']);
            request.name = defaultValue1;
