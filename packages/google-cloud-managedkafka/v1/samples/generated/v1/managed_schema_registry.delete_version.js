...
function main(name) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_DeleteVersion_async]
  /**
  ...
  async function callDeleteVersion() {
    ...
    // Run request
    const response = await schemaregistryClient.deleteVersion(request);
    console.log(response);
  }

  callDeleteVersion();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_DeleteVersion_async]
}
