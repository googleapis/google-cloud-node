...
function main(name) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_GetRawSchemaVersion_async]
  /**
  ...
  async function callGetRawSchemaVersion() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const response = await schemaregistryClient.getRawSchemaVersion(request);
    console.log(response);
  }

  callGetRawSchemaVersion();
