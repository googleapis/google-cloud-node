...
function main(parent, schema) {
  // [START managedkafka_v1_generated_ManagedSchemaRegistry_LookupVersion_async]
  /**
  ...
  async function callLookupVersion() {
    // Construct request
    const request = {
      parent,
      schema,
    ...
    // Run request
    const response = await schemaregistryClient.lookupVersion(request);
    console.log(response);
  }

  callLookupVersion();
  // [END managedkafka_v1_generated_ManagedSchemaRegistry_LookupVersion_async]
}
