...
describe('v1.NetAppClient', () => {
  ...
  describe('getHostGroup', () => {
    it('invokes getHostGroup without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getHostGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getHostGroup as SinonStub
    ...
    it('invokes getHostGroup without error using callback', async () => {
      ...
      client.innerApiCalls.getHostGroup =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getHostGroup(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.netapp.v1.IHostGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('executeOntapPost', () => {
    it('invokes executeOntapPost without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.executeOntapPost as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.executeOntapPost as SinonStub
    ...
    it('invokes executeOntapPost without error using callback', async () => {
      ...
      client.innerApiCalls.executeOntapPost =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.executeOntapPost(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.netapp.v1.IExecuteOntapPostResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes executeOntapPost with error', async () => {
      ...
      const expectedHeaderRequestParams = `ontap_path=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.executeOntapPost = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('executeOntapGet', () => {
    it('invokes executeOntapGet without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.executeOntapGet as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.executeOntapGet as SinonStub
    ...
    it('invokes executeOntapGet without error using callback', async () => {
      ...
      client.innerApiCalls.executeOntapGet =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.executeOntapGet(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.netapp.v1.IExecuteOntapGetResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes executeOntapGet with error', async () => {
      ...
      const expectedHeaderRequestParams = `ontap_path=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.executeOntapGet = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('executeOntapDelete', () => {
    it('invokes executeOntapDelete without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.executeOntapDelete as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.executeOntapDelete as SinonStub
    ...
    it('invokes executeOntapDelete without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.executeOntapDelete(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.netapp.v1.IExecuteOntapDeleteResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes executeOntapDelete with error', async () => {
      ...
      const expectedHeaderRequestParams = `ontap_path=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.executeOntapDelete = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('executeOntapPatch', () => {
    it('invokes executeOntapPatch without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.executeOntapPatch as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.executeOntapPatch as SinonStub
    ...
    it('invokes executeOntapPatch without error using callback', async () => {
      ...
      client.innerApiCalls.executeOntapPatch =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.executeOntapPatch(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.netapp.v1.IExecuteOntapPatchResponse | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes executeOntapPatch with error', async () => {
      ...
      const expectedHeaderRequestParams = `ontap_path=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.executeOntapPatch = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('establishVolumePeering', () => {
    it('invokes establishVolumePeering without error', async () => {
      ...
      client.innerApiCalls.establishVolumePeering =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.establishVolumePeering(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.establishVolumePeering as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.establishVolumePeering as SinonStub
    ...
    it('invokes establishVolumePeering with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.establishVolumePeering = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.establishVolumePeering(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.establishVolumePeering as SinonStub
  ...
  describe('restoreBackupFiles', () => {
    it('invokes restoreBackupFiles without error', async () => {
      ...
      client.innerApiCalls.restoreBackupFiles =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.restoreBackupFiles(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.restoreBackupFiles as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.restoreBackupFiles as SinonStub
      ...
      const promise = new Promise((resolve, reject) => {
        client.restoreBackupFiles(
          ...
          (
            err?: Error | null,
            result?: LROperation<
              protos.google.cloud.netapp.v1.IRestoreBackupFilesResponse,
              protos.google.cloud.netapp.v1.IOperationMetadata
            > | null,
          ) => {
            if (err) {
    ...
    it('invokes restoreBackupFiles with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.restoreBackupFiles = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkRestoreBackupFilesProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkRestoreBackupFilesProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createHostGroup', () => {
    it('invokes createHostGroup without error', async () => {
      ...
      client.innerApiCalls.createHostGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createHostGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createHostGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createHostGroup as SinonStub
    ...
    it('invokes createHostGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createHostGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
  ...
  describe('updateHostGroup', () => {
    it('invokes updateHostGroup without error', async () => {
      ...
      client.innerApiCalls.updateHostGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateHostGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateHostGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateHostGroup as SinonStub
    ...
    it('invokes updateHostGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `host_group.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateHostGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateHostGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateHostGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteHostGroup', () => {
    it('invokes deleteHostGroup without error', async () => {
      ...
      client.innerApiCalls.deleteHostGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteHostGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteHostGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteHostGroup as SinonStub
    ...
    it('invokes deleteHostGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteHostGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteHostGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteHostGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listHostGroups', () => {
    it('invokes listHostGroups without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listHostGroups as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listHostGroups as SinonStub
    ...
    it('invokes listHostGroups without error using callback', async () => {
      ...
      client.innerApiCalls.listHostGroups =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listHostGroups with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listHostGroups = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listHostGroupsStream without error', async () => {
      ...
      client.descriptors.page.listHostGroups.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.netapp.v1.HostGroup) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listHostGroups.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listHostGroups, request),
      );
      assert(
        (client.descriptors.page.listHostGroups.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listHostGroups without error', async () => {
      ...
      client.descriptors.page.listHostGroups.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('Path templates', () => {
    ...
    describe('hostGroup', async () => {
      ...
      await client.initialize();
      client.pathTemplates.hostGroupPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.hostGroupPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('hostGroupPath', () => {
        const result = client.hostGroupPath(
          'projectValue',
          'locationValue',
          'hostGroupValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.hostGroupPathTemplate.render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters),
        );
      });
      ...
      it('matchProjectFromHostGroupName', () => {
        ...
        assert.strictEqual(result, 'projectValue');
        assert(
          (client.pathTemplates.hostGroupPathTemplate.match as SinonStub)
            .getCall(-1)
            .calledWith(fakePath),
        );
      });
