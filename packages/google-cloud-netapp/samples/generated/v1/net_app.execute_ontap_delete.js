...
function main(ontapPath) {
  ...
  async function callExecuteOntapDelete() {
    // Construct request
    const request = {
      ontapPath,
    };
    ...
    // Run request
    const response = await netappClient.executeOntapDelete(request);
    console.log(response);
  }

  callExecuteOntapDelete();
