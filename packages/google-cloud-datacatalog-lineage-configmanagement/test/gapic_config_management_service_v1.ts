...
describe('v1.ConfigManagementServiceClient', () => {
  describe('Common methods', () => {
    it('has apiEndpoint', () => {
      const client =
        new configmanagementserviceModule.v1.ConfigManagementServiceClient();
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          configmanagementserviceModule.v1.ConfigManagementServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        configmanagementserviceModule.v1.ConfigManagementServiceClient.port;
      assert(port);
    ...
    it('invokes getConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.datacatalog.lineage.configmanagement.v1.IConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('Path templates', () => {
    describe('folderLocationConfig', async () => {
      ...
      await client.initialize();
      client.pathTemplates.folderLocationConfigPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderLocationConfigPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderLocationConfigPath', () => {
        const result = client.folderLocationConfigPath(
          'folderValue',
          'locationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.folderLocationConfigPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
      ...
      it('matchLocationFromFolderLocationConfigName', () => {
        const result =
          client.matchLocationFromFolderLocationConfigName(fakePath);
    ...
    describe('organizationLocationConfig', async () => {
      ...
      await client.initialize();
      client.pathTemplates.organizationLocationConfigPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.organizationLocationConfigPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('organizationLocationConfigPath', () => {
        const result = client.organizationLocationConfigPath(
          'organizationValue',
          'locationValue',
        );
        assert.strictEqual(result, fakePath);
        assert(
          (
            client.pathTemplates.organizationLocationConfigPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationLocationConfigName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationConfigName(fakePath);
      ...
      it('matchLocationFromOrganizationLocationConfigName', () => {
        const result =
          client.matchLocationFromOrganizationLocationConfigName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.organizationLocationConfigPathTemplate
