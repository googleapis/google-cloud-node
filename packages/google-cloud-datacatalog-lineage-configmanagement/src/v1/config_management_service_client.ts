 ...
 * `src/v1/config_management_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './config_management_service_client_config.json';
...
export class ConfigManagementServiceClient {
  ...
  initialize() {
    ...
    if (this.configManagementServiceStub) {
      return this.configManagementServiceStub;
    }
 ...
 */
  ...
  /**
   * Return a fully-qualified folderLocationConfig resource name string.
   *
   * @param {string} folder
  ...
  /**
   * Parse the folder from FolderLocationConfig resource.
   *
   * @param {string} folderLocationConfigName
   *   A fully-qualified path representing folder_location_config resource.
  ...
  /**
   * Parse the location from FolderLocationConfig resource.
   *
   * @param {string} folderLocationConfigName
   *   A fully-qualified path representing folder_location_config resource.
  ...
  /**
   * Return a fully-qualified organizationLocationConfig resource name string.
   *
  ...
  /**
   * Parse the organization from OrganizationLocationConfig resource.
   *
   * @param {string} organizationLocationConfigName
  ...
  /**
   * Parse the location from OrganizationLocationConfig resource.
   *
   * @param {string} organizationLocationConfigName
   *   A fully-qualified path representing organization_location_config resource.
   * @returns {string} A string representing the location.
