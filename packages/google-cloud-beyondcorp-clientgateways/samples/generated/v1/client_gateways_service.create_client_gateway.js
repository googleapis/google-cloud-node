...
function main(parent, clientGateway) {
  ...
  async function callCreateClientGateway() {
    // Construct request
    const request = {
      parent,
      clientGateway,
    ...
    // Run request
    const [operation] = await clientgatewaysClient.createClientGateway(request);
    const [response] = await operation.promise();
    console.log(response);
  }

  callCreateClientGateway();
