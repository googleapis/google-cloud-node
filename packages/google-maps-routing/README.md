...
# [Routes API: Nodejs Client][homepage]
...
* [Routes API Nodejs Client API Reference](https://cloud.google.com/nodejs/docs/reference/routing/latest)
...
1.  [Enable the Routes API API][enable_api].
...
`@googlemaps/routing` uses Google Maps Platform services. Use of Google
...
[homepage_samples]: https://github.com/googleapis/google-cloud-node/blob/main/packages/google-maps-routing/samples
[homepage_changelog]: https://github.com/googleapis/google-cloud-node/blob/main/packages/google-maps-routing/CHANGELOG.md
[homepage]: https://github.com/googleapis/google-cloud-node/blob/main/packages/google-maps-routing
