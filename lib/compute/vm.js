 ...
 *
 * @param {string} machineType - new machine type (see [list of machine types]{@link https://cloud.google.com/compute/docs/machine-types})
 * @param {function=} callback - The callback function.
 * @param {?error} callback.err - An error returned while making this request.
 * @param {module:compute/operation} callback.operation - An operation object
 *     that can be used to check the status of the request.
...
VM.prototype.setMachineType = function(machineType, callback) {
  ...
  var machineTypeUrl = 'zones/' + this.zone.name + '/machineTypes/' + machineType;
