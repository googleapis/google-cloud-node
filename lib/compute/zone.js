 ...
 *
 * @param {object=} options - MachineType search options.
 * @param {boolean} options.autoPaginate - Have pagination handled
 *     automatically. Default: true.
 * @param {number} options.maxApiCalls - Maximum number of API calls to make.
 ...
 * @param {function} callback - The callback function.
 * @param {?error} callback.err - An error returned while making this request.
 * @param {module:compute/machineType} callback.firewalls - MachineType objects
 *     from this network.
 * @param {?object} callback.nextQuery - If present, query with this object to
 *     check for more results.
 * @param {object} callback.apiResponse - The full API response.
 *
 * @example
 * zone.getMachineTypes(function(err, machineType) {
 ...
 *
 * //-
 * // Get the machineType from your project as a readable object stream.
 * //-
 * zone.getMachineTypes()
 *   .on('error', console.error)
 ...
 *
 * @resource [MachineType Overview]{@link https://cloud.google.com/compute/docs/reference/v1/machineTypes}
 *
