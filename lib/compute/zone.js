 ...
 * @example
 * //-
 * // Create a persistent disk using the latest Ubuntu version as the source image.
 * //-
 * var config = {
 *   os: 'ubuntu',
 *   sizeGb: 10
 ...
 *
 * //-
 * // Create a persistent disk using the latest Ubuntu version from your project as the source image.
 * //-
 * var config = {
 ...
 *
 * //-
 * // Create a new instance using the latest Debian version from your project as the source image
 * // for a new boot disk.
 * //-
 * var config = {
