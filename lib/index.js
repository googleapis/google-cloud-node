...
/**
 * The [Google Compute Engine API]{@link http://goo.gl/Mggjcd} gives developers
 * the ability to manage VM instances, disks, networks, load balancing, health
 * checks, and many other compute constructs.
 *
 * @type {module:compute}
 *
 ...
 * // }
 */
gcloud.compute = require('./compute');
