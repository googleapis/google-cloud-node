 ...
 *     of the signed url.
 * @param {string} config.cname - if google storage bucket is accesed via 
 *     cname, ie. https://cdn.example.com, use instead of default host
 * @param {function=} callback - The callback function.
 * @param {?error} callback.err - An error returned while making this request
...
File.prototype.getSignedUrl = function(config, callback) {
  ...
  var host = config.cname || 'https://storage.googleapis.com/' + this.bucket.name;
