 ...
 *
 * //-
 * // Using delimiter and prefix parameter for results in directory-like mode.
 * // In conjunction with the prefix filter, the use of the delimiter parameter
 * // allows the list method to operate like a directory listing, despite the
 * // object namespace being flat. For example, if delimiter were set to "/",
 * // then listing objects from a bucket that contains the objects "a/b", "a/c",
 * // "d", "e", "e/f" would return objects "d" and "e", and prefixes "a/" and "e/".
 * //-
 * var query = { delimiter: "/" };
