...
WriteStream.prototype.open = function() {
  ...
  this.conn.createAuthorizedReq({
    method: 'POST',
    uri: this.url,
    qs: { uploadType: 'media', name: this.name },
    headers: {
...
WriteStream.prototype.write = function(chunk, encoding, callback) {
  this.remoteStream.write(chunk, encoding, callback);
};

WriteStream.prototype.end = function(chunk, encoding, callback) {
  this.remoteStream.end(chunk, encoding, callback);
};
...
Bucket.prototype.copy = function(srcName, destName, acl, opt_callback) {
...
Bucket.prototype.del = function(name, callback) {
...
Bucket.prototype.createWriteStream = function(name, metadata) {
  return new WriteStream(this.conn, STORAGE_UPLOAD_BASE_URL + '/' + this.bucketName + '/o', name, metadata);
};
