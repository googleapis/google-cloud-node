...
* **firestore:** Add `ifNull` and `coalesce` expressions ([#7857](https://github.com/googleapis/google-cloud-node/pull/7857))
* **firestore:** Defer pipeline user data validation to `execute()` ([#7816](https://github.com/googleapis/google-cloud-node/pull/7816))
* **firestore:** Global option to turn on implicit orderby ([#7641](https://github.com/googleapis/google-cloud-node/pull/7641))
* **firestore:** Add logical expressions ([#7589](https://github.com/googleapis/google-cloud-node/pull/7589))


### Bug Fixes

* **firestore:** Update pipeline tests for backend changes ([e8755b5](https://github.com/googleapis/google-cloud-node/commit/e8755b5f490e6eca885804792a18119a7a822a0a), [e5dd91e](https://github.com/googleapis/google-cloud-node/commit/e5dd91e03595452fc1dece58ca6b0c553f72398f))
