    ...
    assert.success(function () {
      helper.versionGTE(
        ...
        assert.success(function (isGreater) {
          ...
          client.query('CREATE TABLE IF NOT EXISTS column_err_test(spanner_pk_id BIGINT GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE) PRIMARY KEY, a int NOT NULL)', function (err) {
            assert.ifError(err)
    ...
    assert.success(function () {
      helper.versionGTE(
        ...
        assert.success(function (isGreater) {
          ...
          client.query('CREATE TABLE IF NOT EXISTS constraint_err_test(spanner_pk_id BIGINT GENERATED BY DEFAULT AS IDENTITY (BIT_REVERSED_POSITIVE) PRIMARY KEY, a int)', function (err) {
            assert.ifError(err)
