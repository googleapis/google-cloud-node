...
// pg_sleep and pg_stat_activity / pg_terminate_backend are not supported by Cloud Spanner
suite.skip('client end during query execution of prepared statement', function (done) {
...
suite.skip('query killed during query execution of prepared statement', function (done) {
