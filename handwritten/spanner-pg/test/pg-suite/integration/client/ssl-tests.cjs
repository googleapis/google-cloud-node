...
// PostgreSQL TLS ALPN handshake tests are unsupported in gRPC spanner-pg
suite.skip('can connect with ssl', function (done) {
  const config = {
    ...helper.config,
    ssl: {
...
if (!helper.args.native) {
  suite.skip('can connect with direct SSL negotiation', async () => {
