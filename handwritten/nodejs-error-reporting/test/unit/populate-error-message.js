...
var populateErrorMessage = require('../../src/populate-error-message.js').populateErrorMessage;
...
describe('populate-error-message', function() {
  ...
  it('Message Field: Should set the message as the stack given an Error', function() {
  ...
  it('Message Field: Should set the field given valid input given an object', function() {
    var err = {};
    var MESSAGE = 'test';
    err = {message: MESSAGE};
    populateErrorMessage(err, em);
  ...
  it('User Field: Should set the field given valid input given an Error', function() {
    var err = new Error();
  ...
  it('User Field: Should default the field given invalid input given an Error', function() {
    var err = new Error();
  ...
  it('User Field: Should set the field given valid input given an object', function() {
    var err = {};
    var USER = 'test';
    err.user = USER;
    populateErrorMessage(err, em);
  ...
  it('FilePath Field: Should set the field given valid input given an object', function() {
    var err = {};
    var PATH = 'test';
    err.filePath = PATH;
    populateErrorMessage(err, em);
  ...
  it('LineNumber Field: Should set the field given valid input given an object', function() {
    var err = {};
    var LINE_NUMBER = 10;
