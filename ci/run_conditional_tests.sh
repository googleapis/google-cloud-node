...
# A script file for running a GAPIC package test.
test_package_script="${PROJECT_ROOT}/ci/run_single_package_test.sh"
...
# Install all root and package/* dependencies at once (allowing for dedpulication).
